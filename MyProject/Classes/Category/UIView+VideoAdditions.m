...
#import "UIView+VideoAdditions.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: NSString * const kViewUserInfo = @"kAlertViewUserInfo";
NSString * const let_collectionValue = @"kAlertViewUserInfo";



//: @implementation UIView (KIAdditions)
@implementation UIView (VideoAdditions)
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(let_collectionValue), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(let_collectionValue));
}
...
- (void)registEditing {
    ...
    endEditingTapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self
                                                                   ...
                                                                   action:@selector(imageWindowHandler:)];
...
- (void)imageWindowHandler:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)perspective {
    ...
    return (UIViewController *)[self successView:self];
}
...
- (UIView *)infoRequest:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView infoRequest:superViewClass];
    }

...
- (UIImage *)enable {
    ...
    if (imagePixel > ([LanguagePin titleUser].devicePerformanceLevel >= FUDevicePerformanceLevelHigh ? 8294400 : 5760000)) {
        ...
        CGFloat ratio = ([LanguagePin titleUser].devicePerformanceLevel >= FUDevicePerformanceLevelHigh ? 8294400 : 5760000) / imagePixel * 1.0;
        //: resultImage = [resultImage fu_compress:ratio];
        resultImage = [resultImage recording:ratio];
    }
    // 图片转正
    ...
    if (resultImage.imageOrientation != UIImageOrientationUp && resultImage.imageOrientation != UIImageOrientationUpMirrored) {
        ...
        resultImage = [resultImage maxRecent];
    }
    //: return resultImage;
    return resultImage;
}

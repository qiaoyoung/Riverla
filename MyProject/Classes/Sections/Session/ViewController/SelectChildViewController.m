...
NSString *StringFromRopeData(RopeData *data);


//: 添加失败
RopeData kStr_welcomeCheekText = (RopeData){246, (Byte []){16, 65, 77, 19, 124, 86, 19, 82, 71, 30, 66, 83, 37}, 12, false, 20};


//: 发送时间超过2分钟的消息不能被撤回
RopeData kStr_thankText = (RopeData){29, (Byte []){248, 146, 140, 244, 157, 156, 251, 138, 171, 244, 138, 169, 245, 171, 152, 245, 162, 154, 47, 248, 149, 155, 244, 143, 130, 250, 135, 153, 251, 171, 149, 251, 156, 178, 249, 165, 144, 245, 158, 160, 245, 191, 182, 251, 143, 185, 248, 134, 131, 28}, 49, false, 213};


//: personCardId
RopeData kStr_belieTitle = (RopeData){112, (Byte []){0, 21, 2, 3, 31, 30, 51, 17, 2, 20, 57, 20, 182}, 12, false, 208};


//: /team/getTeamSetting
RopeData kStr_explanationContent = (RopeData){216, (Byte []){247, 172, 189, 185, 181, 247, 191, 189, 172, 140, 189, 185, 181, 139, 189, 172, 172, 177, 182, 191, 65}, 20, false, 110};


//: 反垃圾消息
RopeData kStr_breathingData = (RopeData){28, (Byte []){249, 147, 145, 249, 130, 159, 249, 128, 162, 250, 170, 148, 250, 157, 179, 173}, 15, false, 165};


//: teamgonggao_content_
RopeData kStr_allContent = (RopeData){68, (Byte []){48, 33, 37, 41, 35, 43, 42, 35, 35, 37, 43, 27, 39, 43, 42, 48, 33, 42, 48, 27, 98}, 20, false, 174};


//: apns-collapse-id
RopeData kStr_allowText = (RopeData){154, (Byte []){251, 234, 244, 233, 183, 249, 245, 246, 246, 251, 234, 233, 255, 183, 243, 254, 174}, 16, false, 122};


//: http://api-sg.yunxinapi.com/nimserver/translator/textMsg.action
RopeData kStr_announcementName = (RopeData){85, (Byte []){61, 33, 33, 37, 111, 122, 122, 52, 37, 60, 120, 38, 50, 123, 44, 32, 59, 45, 60, 59, 52, 37, 60, 123, 54, 58, 56, 122, 59, 60, 56, 38, 48, 39, 35, 48, 39, 122, 33, 39, 52, 59, 38, 57, 52, 33, 58, 39, 122, 33, 48, 45, 33, 24, 38, 50, 123, 52, 54, 33, 60, 58, 59, 77}, 63, false, 161};


//: contact_fragment_group
RopeData kStr_flyNorthName = (RopeData){99, (Byte []){0, 12, 13, 23, 2, 0, 23, 60, 5, 17, 2, 4, 14, 6, 13, 23, 60, 4, 17, 12, 22, 19, 43}, 22, false, 44};


//: 收藏成功
RopeData kStr_beachOvernightValue = (RopeData){132, (Byte []){98, 16, 50, 108, 19, 11, 98, 12, 20, 97, 14, 27, 244}, 12, false, 143};


//: watch_multiretweet_activity_person
RopeData kStr_fenceValue = (RopeData){26, (Byte []){109, 123, 110, 121, 114, 69, 119, 111, 118, 110, 115, 104, 127, 110, 109, 127, 127, 110, 69, 123, 121, 110, 115, 108, 115, 110, 99, 69, 106, 127, 104, 105, 117, 116, 133}, 34, false, 62};


//: app_avchat_not_start_with_less_member
RopeData kStr_bubbleGrowName = (RopeData){89, (Byte []){56, 41, 41, 6, 56, 47, 58, 49, 56, 45, 6, 55, 54, 45, 6, 42, 45, 56, 43, 45, 6, 46, 48, 45, 49, 6, 53, 60, 42, 42, 6, 52, 60, 52, 59, 60, 43, 114}, 37, false, 105};


//: apple+%@
RopeData kStr_consistentTitle = (RopeData){212, (Byte []){181, 164, 164, 184, 177, 255, 241, 148, 8}, 8, false, 208};


//: 发送时间超过2分钟的消息，不能被撤回
RopeData kStr_braveData = (RopeData){165, (Byte []){64, 42, 52, 76, 37, 36, 67, 50, 19, 76, 50, 17, 77, 19, 32, 77, 26, 34, 151, 64, 45, 35, 76, 55, 58, 66, 63, 33, 67, 19, 45, 67, 36, 10, 74, 25, 41, 65, 29, 40, 77, 38, 24, 77, 7, 14, 67, 55, 1, 64, 62, 59, 226}, 52, false, 84};


//: black_list_activity_add_black_failed
RopeData kStr_spiritRestingData = (RopeData){189, (Byte []){223, 209, 220, 222, 214, 226, 209, 212, 206, 201, 226, 220, 222, 201, 212, 203, 212, 201, 196, 226, 220, 217, 217, 226, 223, 209, 220, 222, 214, 226, 219, 220, 212, 209, 216, 217, 61}, 36, false, 200};


//: contact_tag_fragment_sure
RopeData kStr_infoMonthlyName = (RopeData){213, (Byte []){182, 186, 187, 161, 180, 182, 161, 138, 161, 180, 178, 138, 179, 167, 180, 178, 184, 176, 187, 161, 138, 166, 160, 167, 176, 43}, 25, false, 73};


//: app_team_invalid_tip
RopeData kStr_whoeverData = (RopeData){195, (Byte []){162, 179, 179, 156, 183, 166, 162, 174, 156, 170, 173, 181, 162, 175, 170, 167, 156, 183, 170, 179, 205}, 20, false, 115};


//: %@.code:%zd
RopeData kStr_focusTaleValue = (RopeData){186, (Byte []){159, 250, 148, 217, 213, 222, 223, 128, 159, 192, 222, 77}, 11, false, 158};


//: zh-CHT
RopeData kStr_gasolineValue = (RopeData){148, (Byte []){238, 252, 185, 215, 220, 192, 238}, 6, false, 137};


//: 发言频次
RopeData kStr_messageCementName = (RopeData){194, (Byte []){39, 77, 83, 42, 106, 66, 43, 96, 83, 36, 110, 99, 84}, 12, false, 204};


//: YYYY-MM-dd HH:mm:ss
RopeData kStr_clerkExcitedValue = (RopeData){42, (Byte []){115, 115, 115, 115, 7, 103, 103, 7, 78, 78, 10, 98, 98, 16, 71, 71, 16, 89, 89, 202}, 19, false, 42};


//: 被禁言
RopeData kStr_respectText = (RopeData){165, (Byte []){77, 7, 14, 66, 3, 36, 77, 13, 37, 220}, 9, false, 50};


//: showFile:
RopeData kStr_aheadContent = (RopeData){198, (Byte []){181, 174, 169, 177, 128, 175, 170, 163, 252, 35}, 9, false, 69};


//: code
RopeData kStr_gritData = (RopeData){120, (Byte []){27, 23, 28, 29, 36}, 4, false, 185};


//: my_computer
RopeData kStr_marginValue = (RopeData){185, (Byte []){212, 192, 230, 218, 214, 212, 201, 204, 205, 220, 203, 248}, 11, false, 174};


//: 已发送
RopeData kStr_leaseKitText = (RopeData){159, (Byte []){122, 40, 45, 122, 16, 14, 118, 31, 30, 90}, 9, false, 31};


//: accid
RopeData kStr_departmentText = (RopeData){196, (Byte []){165, 167, 167, 173, 160, 87}, 5, false, 104};


//: content
RopeData kStr_closeGritName = (RopeData){242, (Byte []){145, 157, 156, 134, 151, 156, 134, 29}, 7, false, 48};


//: 请输入附言
RopeData kStr_candyName = (RopeData){83, (Byte []){187, 252, 228, 187, 237, 192, 182, 214, 246, 186, 202, 215, 187, 251, 211, 158}, 15, false, 150};


//: showLocation:
RopeData kStr_retailBindMessageData = (RopeData){159, (Byte []){236, 247, 240, 232, 211, 240, 252, 254, 235, 246, 240, 241, 165, 234}, 13, false, 87};


//: postscript
RopeData kStr_realistData = (RopeData){190, (Byte []){206, 209, 205, 202, 205, 221, 204, 215, 206, 202, 52}, 10, false, 181};


//: 被拉黑
RopeData kStr_teachText = (RopeData){87, (Byte []){191, 245, 252, 177, 220, 222, 190, 236, 198, 43}, 9, false, 20};


//: message_super_team
RopeData kStr_customValue = (RopeData){94, (Byte []){51, 59, 45, 45, 63, 57, 59, 1, 45, 43, 46, 59, 44, 1, 42, 59, 63, 51, 131}, 18, false, 10};


//: user_profile_avtivity_user_info_update_failed
RopeData kStr_oilBrokeContent = (RopeData){15, (Byte []){122, 124, 106, 125, 80, 127, 125, 96, 105, 102, 99, 106, 80, 110, 121, 123, 102, 121, 102, 123, 118, 80, 122, 124, 106, 125, 80, 102, 97, 105, 96, 80, 122, 127, 107, 110, 123, 106, 80, 105, 110, 102, 99, 106, 107, 57}, 45, false, 90};


//: 转发失败
RopeData kStr_batteryData = (RopeData){80, (Byte []){184, 237, 252, 181, 223, 193, 181, 244, 225, 184, 228, 245, 138}, 12, false, 238};


//: 正在输入
RopeData kStr_trailValue = (RopeData){5, (Byte []){227, 168, 166, 224, 153, 173, 237, 187, 150, 224, 128, 160, 238}, 12, false, 211};


//: 确定删除？
RopeData kStr_maxText = (RopeData){215, (Byte []){48, 118, 121, 50, 121, 77, 50, 95, 119, 62, 78, 115, 56, 107, 72, 39}, 15, false, 34};


//: hant
RopeData kStr_bugName = (RopeData){202, (Byte []){162, 171, 164, 190, 181}, 4, false, 77};


//: http
RopeData kStr_tunaContent = (RopeData){44, (Byte []){68, 88, 88, 92, 26}, 4, false, 167};


//: /other/feedback
RopeData kStr_minorPowderData = (RopeData){112, (Byte []){95, 31, 4, 24, 21, 2, 95, 22, 21, 21, 20, 18, 17, 19, 27, 174}, 15, false, 217};


//: teamgonggao_title_
RopeData kStr_stereotypeData = (RopeData){136, (Byte []){252, 237, 233, 229, 239, 231, 230, 239, 239, 233, 231, 215, 252, 225, 252, 228, 237, 215, 28}, 18, false, 142};


//: #F6B53E
RopeData kStr_equityValue = (RopeData){243, (Byte []){208, 181, 197, 177, 198, 192, 182, 35}, 7, false, 6};


//: canMemberInfo
RopeData kStr_gasolineName = (RopeData){152, (Byte []){251, 249, 246, 213, 253, 245, 250, 253, 234, 209, 246, 254, 247, 235}, 13, false, 120};


//: nonce
RopeData kStr_tapCellKaContent = (RopeData){16, (Byte []){126, 127, 126, 115, 117, 116}, 5, false, 214};


//: Asia/Shanghai
RopeData kStr_automaticContent = (RopeData){160, (Byte []){225, 211, 201, 193, 143, 243, 200, 193, 206, 199, 200, 193, 201, 159}, 13, false, 120};


//: desc
RopeData kStr_chapterData = (RopeData){129, (Byte []){229, 228, 242, 226, 60}, 4, false, 49};


//: friend_verify_avtivity_net_error
RopeData kStr_inheritConfirmValue = (RopeData){91, (Byte []){61, 41, 50, 62, 53, 63, 4, 45, 62, 41, 50, 61, 34, 4, 58, 45, 47, 50, 45, 50, 47, 34, 4, 53, 62, 47, 4, 62, 41, 41, 52, 41, 58}, 32, false, 248};


//: 发言频次过快，请%ld秒后重试
RopeData kStr_hornName = (RopeData){134, (Byte []){99, 9, 23, 110, 46, 6, 111, 36, 23, 96, 42, 39, 110, 57, 1, 99, 57, 45, 105, 58, 10, 110, 41, 49, 163, 234, 226, 97, 33, 20, 99, 22, 8, 111, 1, 11, 110, 41, 19, 221}, 39, false, 146};


//: curTime
RopeData kStr_comeTitle = (RopeData){131, (Byte []){224, 246, 241, 215, 234, 238, 230, 152}, 7, false, 90};


//: zh-CHS
RopeData kStr_optionSwingData = (RopeData){100, (Byte []){30, 12, 73, 39, 44, 55, 233}, 6, false, 54};


//: 撤回一条消息
RopeData kStr_leapMakeTitle = (RopeData){51, (Byte []){213, 161, 151, 214, 168, 173, 215, 139, 179, 213, 174, 146, 213, 133, 187, 213, 178, 156, 154}, 18, false, 225};


//: luyinshibai
RopeData kStr_lidData = (RopeData){228, (Byte []){136, 145, 157, 141, 138, 151, 140, 141, 134, 133, 141, 246}, 11, false, 26};


//: ** 该消息被屏蔽 **
RopeData kStr_cocaineValue = (RopeData){50, (Byte []){24, 24, 18, 218, 157, 151, 212, 132, 186, 212, 179, 157, 218, 144, 153, 215, 131, 189, 218, 166, 143, 18, 24, 24, 66}, 24, false, 112};


//: type
RopeData kStr_focusValue = (RopeData){158, (Byte []){234, 231, 238, 251, 255}, 4, false, 101};


//: 收藏失败
RopeData kStr_discusText = (RopeData){246, (Byte []){16, 98, 64, 30, 97, 121, 19, 82, 71, 30, 66, 83, 84}, 12, false, 171};


//: /other/getNimCheckSum
RopeData kStr_heaterMoreoverValue = (RopeData){251, (Byte []){212, 148, 143, 147, 158, 137, 212, 156, 158, 143, 181, 146, 150, 184, 147, 158, 152, 144, 168, 142, 150, 53}, 21, false, 242};


//: checksum
RopeData kStr_consumerName = (RopeData){210, (Byte []){177, 186, 183, 177, 185, 161, 167, 191, 177}, 8, false, 18};


//: 取消标记失败
RopeData kStr_ourValue = (RopeData){222, (Byte []){59, 81, 72, 56, 104, 86, 56, 126, 89, 54, 112, 110, 59, 122, 111, 54, 106, 123, 87}, 18, false, 205};


//: teamgonggao_
RopeData kStr_dominateOilCertainlyData = (RopeData){110, (Byte []){26, 11, 15, 3, 9, 1, 0, 9, 9, 15, 1, 49, 227}, 12, false, 86};


//: contact
RopeData kStr_onTingPriorContent = (RopeData){117, (Byte []){22, 26, 27, 1, 20, 22, 1, 77}, 7, false, 223};


//: 01B0FD
RopeData kStr_surroundingValue = (RopeData){23, (Byte []){39, 38, 85, 39, 81, 83, 92}, 6, false, 215};


//: 删除成功
RopeData kStr_titleBishopText = (RopeData){227, (Byte []){6, 107, 67, 10, 122, 71, 5, 107, 115, 6, 105, 124, 241}, 12, false, 81};


//: 确认转发
RopeData kStr_stereotypeValue = (RopeData){140, (Byte []){107, 45, 34, 100, 34, 40, 100, 49, 32, 105, 3, 29, 81}, 12, false, 55};


//: 申请成功，等待验证
RopeData kStr_balanceKaName = (RopeData){96, (Byte []){135, 244, 211, 136, 207, 215, 134, 232, 240, 133, 234, 255, 143, 220, 236, 135, 205, 233, 133, 222, 229, 137, 202, 236, 136, 207, 225, 204}, 27, false, 194};


//: 消息已发送，但对方拒收
RopeData kStr_developmentalGladData = (RopeData){17, (Byte []){247, 167, 153, 247, 144, 190, 244, 166, 163, 244, 158, 128, 248, 145, 144, 254, 173, 157, 245, 172, 151, 244, 190, 168, 247, 135, 168, 247, 154, 131, 247, 133, 167, 195}, 33, false, 6};


//: SELF MATCHES %@
RopeData kStr_bowValue = (RopeData){130, (Byte []){209, 199, 206, 196, 162, 207, 195, 214, 193, 202, 199, 209, 162, 167, 194, 213}, 15, false, 72};


//: 不能和自己通话哦
RopeData kStr_finishData = (RopeData){129, (Byte []){101, 57, 12, 105, 2, 60, 100, 19, 13, 105, 6, 43, 100, 54, 48, 104, 1, 27, 105, 46, 28, 100, 18, 39, 90}, 24, false, 248};


//: activity_friend_verify_info
RopeData kStr_afraidPassengerText = (RopeData){137, (Byte []){232, 234, 253, 224, 255, 224, 253, 240, 214, 239, 251, 224, 236, 231, 237, 214, 255, 236, 251, 224, 239, 240, 214, 224, 231, 239, 230, 143}, 27, false, 4};


//: 不允许文字
RopeData kStr_sheValue = (RopeData){14, (Byte []){234, 182, 131, 235, 139, 143, 230, 160, 182, 232, 152, 137, 235, 163, 153, 108}, 15, false, 24};


//: invalid event
RopeData kStr_leaName = (RopeData){157, (Byte []){244, 243, 235, 252, 241, 244, 249, 189, 248, 235, 248, 243, 233, 22}, 13, false, 132};


//: 本地反垃圾失败
RopeData kStr_itemGritData = (RopeData){33, (Byte []){199, 189, 141, 196, 189, 145, 196, 174, 172, 196, 191, 162, 196, 189, 159, 196, 133, 144, 201, 149, 132, 191}, 21, false, 129};


//: sessionname
RopeData kStr_lightingContent = (RopeData){96, (Byte []){19, 5, 19, 19, 9, 15, 14, 14, 1, 13, 5, 99}, 11, false, 236};


//: message_helper_apply_to_group
RopeData kStr_retailerTonightSkullValue = (RopeData){13, (Byte []){96, 104, 126, 126, 108, 106, 104, 82, 101, 104, 97, 125, 104, 127, 82, 108, 125, 125, 97, 116, 82, 121, 98, 82, 106, 127, 98, 120, 125, 245}, 29, false, 40};


//: showCustom:
RopeData kStr_brokenAvoidTitle = (RopeData){115, (Byte []){0, 27, 28, 4, 48, 6, 0, 7, 28, 30, 73, 205}, 11, false, 19};


//: NTESMessageRefusedTag
RopeData kStr_lameFileOutValue = (RopeData){81, (Byte []){31, 5, 20, 2, 28, 52, 34, 34, 48, 54, 52, 3, 52, 55, 36, 34, 52, 53, 5, 48, 54, 211}, 21, false, 48};


//: /team/getStatusSendText
RopeData kStr_whoeverValue = (RopeData){54, (Byte []){25, 66, 83, 87, 91, 25, 81, 83, 66, 101, 66, 87, 66, 67, 69, 101, 83, 88, 82, 98, 83, 78, 66, 136}, 23, false, 67};


//: friend_delete_fail
RopeData kStr_fifteenData = (RopeData){9, (Byte []){111, 123, 96, 108, 103, 109, 86, 109, 108, 101, 108, 125, 108, 86, 111, 104, 96, 101, 54}, 18, false, 124};


//: title
RopeData kStr_formatDonBrokeData = (RopeData){113, (Byte []){5, 24, 5, 29, 20, 91}, 5, false, 86};


//: data
RopeData kStr_chapterTitle = (RopeData){201, (Byte []){173, 168, 189, 168, 7}, 4, false, 226};


//: username
RopeData kStr_politicianTonightVacationText = (RopeData){28, (Byte []){105, 111, 121, 110, 114, 125, 113, 121, 59}, 8, false, 149};


//: group_chat_avatar_activity_add_black_success
RopeData kStr_daughterData = (RopeData){162, (Byte []){197, 208, 205, 215, 210, 253, 193, 202, 195, 214, 253, 195, 212, 195, 214, 195, 208, 253, 195, 193, 214, 203, 212, 203, 214, 219, 253, 195, 198, 198, 253, 192, 206, 195, 193, 201, 253, 209, 215, 193, 193, 199, 209, 209, 109}, 44, false, 175};


//: 消息撤回失败，请重试
RopeData kStr_conData = (RopeData){118, (Byte []){144, 192, 254, 144, 247, 217, 144, 228, 210, 147, 237, 232, 147, 210, 199, 158, 194, 211, 153, 202, 250, 158, 217, 193, 159, 241, 251, 158, 217, 227, 6}, 30, false, 250};


//: #FEFECA
RopeData kStr_photographValue = (RopeData){175, (Byte []){140, 233, 234, 233, 234, 236, 238, 33}, 7, false, 237};


//: showImage:
RopeData kStr_badlyHangHeightName = (RopeData){174, (Byte []){221, 198, 193, 217, 231, 195, 207, 201, 203, 148, 145}, 10, false, 88};


//: 选择会话类型
RopeData kStr_applyValue = (RopeData){114, (Byte []){155, 242, 251, 148, 249, 219, 150, 206, 232, 154, 221, 239, 149, 195, 201, 151, 236, 249, 216}, 18, false, 67};


//: contact_tag_fragment_cancel
RopeData kStr_keyText = (RopeData){168, (Byte []){203, 199, 198, 220, 201, 203, 220, 247, 220, 201, 207, 247, 206, 218, 201, 207, 197, 205, 198, 220, 247, 203, 201, 198, 203, 205, 196, 37}, 27, false, 245};


//: recid
RopeData kStr_expectationText = (RopeData){116, (Byte []){6, 17, 23, 29, 16, 206}, 5, false, 177};


//: ispush
RopeData kStr_cruValue = (RopeData){137, (Byte []){224, 250, 249, 252, 250, 225, 67}, 6, false, 84};


//: watch_multiretweet_activity_confirm_forwarded_to
RopeData kStr_assaultData = (RopeData){94, (Byte []){41, 63, 42, 61, 54, 1, 51, 43, 50, 42, 55, 44, 59, 42, 41, 59, 59, 42, 1, 63, 61, 42, 55, 40, 55, 42, 39, 1, 61, 49, 48, 56, 55, 44, 51, 1, 56, 49, 44, 41, 63, 44, 58, 59, 58, 1, 42, 49, 237}, 48, false, 226};


//: canSendText
RopeData kStr_roachData = (RopeData){105, (Byte []){10, 8, 7, 58, 12, 7, 13, 61, 12, 17, 29, 240}, 11, false, 203};


//: 扩展字段
RopeData kStr_ointmentData = (RopeData){149, (Byte []){115, 28, 60, 112, 36, 0, 112, 56, 2, 115, 59, 32, 64}, 12, false, 54};


//: translation
RopeData kStr_lureName = (RopeData){27, (Byte []){111, 105, 122, 117, 104, 119, 122, 111, 114, 116, 117, 246}, 11, false, 174};


//: 您已被禁言
RopeData kStr_improveName = (RopeData){122, (Byte []){156, 248, 210, 159, 205, 200, 146, 216, 209, 157, 220, 251, 146, 210, 250, 141}, 15, false, 236};


//: msg
RopeData kStr_apparentValue = (RopeData){42, (Byte []){71, 89, 77, 76}, 3, false, 139};


//: 群申请失败
RopeData kStr_heaterTitle = (RopeData){26, (Byte []){253, 164, 190, 253, 142, 169, 242, 181, 173, 255, 190, 171, 242, 174, 191, 146}, 15, false, 80};


//: text
RopeData kStr_surpriseName = (RopeData){143, (Byte []){251, 234, 247, 251, 159}, 4, false, 219};


//: 消息合并转发失败
RopeData kStr_exploreContent = (RopeData){172, (Byte []){74, 26, 36, 74, 45, 3, 73, 60, 36, 73, 21, 26, 68, 17, 0, 73, 35, 61, 73, 8, 29, 68, 24, 9, 81}, 24, false, 236};


//: 撤回附言
RopeData kStr_breathingContent = (RopeData){64, (Byte []){166, 210, 228, 165, 219, 222, 169, 217, 196, 168, 232, 192, 185}, 12, false, 92};


//: contact_tag_fragment_delete_success
RopeData kStr_cocaineName = (RopeData){50, (Byte []){81, 93, 92, 70, 83, 81, 70, 109, 70, 83, 85, 109, 84, 64, 83, 85, 95, 87, 92, 70, 109, 86, 87, 94, 87, 70, 87, 109, 65, 71, 81, 81, 87, 65, 65, 64}, 35, false, 239};


//: NTESMessageTranslate
RopeData kStr_tineData = (RopeData){147, (Byte []){221, 199, 214, 192, 222, 246, 224, 224, 242, 244, 246, 199, 225, 242, 253, 224, 255, 242, 231, 246, 220}, 20, false, 91};


//: KEKENotificationLanguageChanged
RopeData kStr_victorName = (RopeData){61, (Byte []){118, 120, 118, 120, 115, 82, 73, 84, 91, 84, 94, 92, 73, 84, 82, 83, 113, 92, 83, 90, 72, 92, 90, 88, 126, 85, 92, 83, 90, 88, 89, 154}, 31, false, 168};


//: luyintaiduan
RopeData kStr_crewData = (RopeData){177, (Byte []){221, 196, 200, 216, 223, 197, 208, 216, 213, 196, 208, 223, 99}, 12, false, 28};


//: showVideo:
RopeData kStr_fessTitle = (RopeData){220, (Byte []){175, 180, 179, 171, 138, 181, 184, 185, 179, 230, 208}, 10, false, 245};
...
#import "ClickTeamViewController.h"
...
#import "InfoManager+ItemOrigin.h"
...
NSString *let_closeSessionWindowText = @"kNTESDemoRevokeMessageFromMeNotication";
...
@property (nonatomic,strong) TaproomSender *notificaionSender;
//: @property (nonatomic,strong) NTESSessionConfig *sessionConfig;
@property (nonatomic,strong) NameApp *sessionConfig;
//: @property (nonatomic,strong) UIImagePickerController *imagePicker;
@property (nonatomic,strong) UIImagePickerController *imagePicker;
//: @property (nonatomic,strong) UIView *currentSingleSnapView;
@property (nonatomic,strong) UIView *currentSingleSnapView;
//@property (nonatomic,strong)    MaxMView *fpsLabel;
...
@property (nonatomic,strong) InscriptionView *mulSelectedSureBar;
...
@property (nonatomic,strong) ConsubstantiateSelectSession *mergeForwardSession;
...
@property (nonatomic, strong) ShouldView *reprotNextView;
//: @property (nonatomic, strong) ZMONReportBlackView *reprotBlackView;
@property (nonatomic, strong) EvaluateView *reprotBlackView;
//: @property (nonatomic, strong) ZMONReportDeleteView *reprotDeleteView;
@property (nonatomic, strong) PlumageNictitatingMembraneFuturismView *reprotDeleteView;
//: @property (nonatomic, strong) NSString *userId;
@property (nonatomic, strong) NSString *userId;
//: @property (nonatomic, strong) ZMONReportHisView *reprotHisNextView;
@property (nonatomic, strong) IconView *reprotHisNextView;
    ...
    dispatch_after(dispatch_time((0ull), (int64_t)(0.25 * 1000000000ull)), dispatch_get_main_queue(), ^{
        ...
        if (team && team.announcement && team.announcement.length > 0) {
            ...
            if (datas.count <= 0){
                ...
                [[WithMessage mutual] laughOpenMargin];
                //: return;
                return;
            }

            //: NSString *title = [datas lastObject][@"title"];
            NSString *title = [datas lastObject][StringFromRopeData(&kStr_formatDonBrokeData)];
            //: NSString *content = [datas lastObject][@"content"];
            NSString *content = [datas lastObject][StringFromRopeData(&kStr_closeGritName)];
            ...
            if (title.length > 0 || content.length > 0){
                ...
                [[WithMessage mutual] under:self.view myQuantity:message messageInfoBlock:^{
                    @
                    ...
                    HouseAt *option = [[HouseAt alloc] init];
                    ...
                    SaveViewController *vc = [[SaveViewController alloc] initWithDecipherShow:option];
...
- (void)viewDidLoad {
    ...
    _notificaionSender = [[TaproomSender alloc] init];
//    [self setupNormalNav];
...
//    if ([[PinStyle sharedConfig] showFps])
//    {
//        self.fpsLabel = [[MaxMView alloc] initWithFrame:CGRectZero];
...
//    }
    ...
    if (self.session.sessionType == NIMSessionTypeP2P && !self.disableOnlineState)
    {
        ...
        [[ColorAction searchion] nim:self.session.sessionId];
    ...
    [LinkUtil voiceItem:self.session team:NTESRecentSessionMarkTypeAt];

    //批量转发
    //: _mergeForwardSession = [[NTESMergeForwardSession alloc] init];
    _mergeForwardSession = [[ConsubstantiateSelectSession alloc] init];
    //    [self setupSearchVC];

    //: [[NSNotificationCenter defaultCenter] addObserver:self
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             //: selector:@selector(onRevokeMessageFromMe:)
                                             selector:@selector(performanced:)
                                                 //: name:kNTESDemoRevokeMessageFromMeNotication
                                                 name:let_closeSessionWindowText
                                               //: object:nil];
                                               object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(itemsed:) name:StringFromRopeData(&kStr_victorName) object:nil];
    ...
    [InfoManager enable:[NSString stringWithFormat:StringFromRopeData(&kStr_explanationContent)] sub:dict record:NO tapGetFailed:^(id responseObject) {
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
        ...
        NSString *code = [resultDict speedy:StringFromRopeData(&kStr_gritData)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict straddle:StringFromRopeData(&kStr_chapterTitle)];
...
//            NSString *frequency = [data newStringValueForKey:@"frequency"];
            ...
            NSString *canMemberInfovalue = [data speedy:StringFromRopeData(&kStr_gasolineName)];
            //: NSString *ispushvalue = [data newStringValueForKey:@"ispush"];
            NSString *ispushvalue = [data speedy:StringFromRopeData(&kStr_cruValue)];
...
//            }
    ...
    [InfoManager enable:[NSString stringWithFormat:StringFromRopeData(&kStr_whoeverValue)] sub:dict record:NO tapGetFailed:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict speedy:StringFromRopeData(&kStr_gritData)];
        ...
        if (code.integerValue <= 0) {
            ...
            NSString *canSendText = [data size:StringFromRopeData(&kStr_roachData) achromaticColour:@"1"];
    ...
    NSString * flag = [[NSUserDefaults standardUserDefaults] valueForKey:[[NSString alloc]initWithFormat:@"%@%@",StringFromRopeData(&kStr_dominateOilCertainlyData),self.session.sessionId]];
    ...
    if([@"1" isEqualToString:flag]){
        ...
        [[NSUserDefaults standardUserDefaults] setValue:@"0" forKey:[[NSString alloc]initWithFormat:@"%@%@",StringFromRopeData(&kStr_dominateOilCertainlyData),self.session.sessionId]];
        //取出标题和内容
        ...
        NSString * title = [[NSUserDefaults standardUserDefaults] valueForKey:[[NSString alloc] initWithFormat:@"%@%@",StringFromRopeData(&kStr_stereotypeData),self.session.sessionId]];
        ...
        NSString * content = [[NSUserDefaults standardUserDefaults] valueForKey:[[NSString alloc] initWithFormat:@"%@%@",StringFromRopeData(&kStr_allContent),self.session.sessionId]];
        ...
        if (title.length > 0 || content.length > 0){
            ...
            [ByAlert colorDown].config
                ...
                .LeeAddAction(^(DoingAction *action) {
                    ...
                    action.title = [TeamManager sizeKey:StringFromRopeData(&kStr_infoMonthlyName)];
                    //: action.titleColor = [UIColor colorWithHexString:@"01B0FD"];
                    action.titleColor = [UIColor isView:StringFromRopeData(&kStr_surroundingValue)];
    ...
    self.header = [[ListView alloc] initWithFrame:CGRectMake(0, (44.0f + [UIDevice table]), self.view.width, 0)];
    ...
    [self.header comment:ListHeaderTypeNetStauts value:@(step)];
}

//: - (void)languageChanged:(NSNotification *)noti {
- (void)itemsed:(NSNotification *)noti {
    //: [self refreshMessages];
    [self chemicalElement];
    //: [self.tableView reloadData];
    [self.tableView reloadData];
...
- (void)dealloc
{
    ...
    if (self.session.sessionType == NIMSessionTypeP2P && !self.disableOnlineState)
    {
        ...
        [[ColorAction searchion] complete:self.session.sessionId];
    }
...
- (id<BlueConfig>)sessionConfig
{
    ...
    if (_sessionConfig == nil) {
        ...
        _sessionConfig = [[NameApp alloc] init];
...
#pragma mark - LengthLabel

//: - (void)NIMTeamCardVCDidSetTop:(BOOL)isTop {
- (void)hiddenned:(BOOL)isTop {
...
- (void)onRecvSubscribeEvents:(NSArray *)events
{
    ...
    for (NIMSubscribeEvent *event in events) {
        ...
        if ([event.from isEqualToString:self.session.sessionId]) {
            ...
            [self title:[LinkUtil eparchy:self.session.sessionId present:YES]];
        }
    }
}
...
- (void)onReceiveCustomSystemNotification:(NIMCustomSystemNotification *)notification
{
    ...
    if (data) {
        ...
        if ([dict bubble:@"id"] == (1) && self.session.sessionType == NIMSessionTypeP2P && [notification.sender isEqualToString:self.session.sessionId])
        {
            //: [self refreshSessionTitle:[NSString stringWithFormat:@"%@...",@"正在输入".ntes_localized]];
            [self cellName:[NSString stringWithFormat:@"%@...",StringFromRopeData(&kStr_trailValue).titleLocalized]];
...
- (NSString *)name
{
    ...
    if ([self.session.sessionId isEqualToString:[NIMSDK sharedSDK].loginManager.currentAccount]) {
        ...
        return [TeamManager sizeKey:StringFromRopeData(&kStr_marginValue)];
    }
...
- (NSString *)inputNumber
{
    ...
    if (self.session.sessionType == NIMSessionTypeP2P && ![self.session.sessionId isEqualToString:[NIMSDK sharedSDK].loginManager.currentAccount]) {
        ...
        return [LinkUtil eparchy:self.session.sessionId present:YES];
    }
    //: return @"";
    return @"";
}
...
- (void)userred:(id)sender
{
    ...
    [_notificaionSender state:self.session];
}
...
- (void)visualAspect:(NSString *)text value:(NSArray *)atUsers{
    //: [super onSendText:text atUsers:atUsers];
    [super visualAspect:text value:atUsers];
}

//正则过滤，字符串是否是纯数字
//: - (BOOL)filterInputShouldNumber:(NSString *)str
- (BOOL)down:(NSString *)str
{
   //: if (str.length == 0) {
   if (str.length == 0) {
        //: return NO;
    ...
    NSPredicate *pred = [NSPredicate predicateWithFormat:StringFromRopeData(&kStr_bowValue),regex];
...
- (void)lawyerClientRelationValue:(NIMMessage *)message streetSmart:(NSString *)type
{
    ...
    NSDictionary *dic = @{
        ...
        StringFromRopeData(&kStr_departmentText) : emptyString(userID),
        //: @"username" : nickName?:@"",
        StringFromRopeData(&kStr_politicianTonightVacationText) : nickName?:@"",
        //: @"content" : message.text?:@"",
        StringFromRopeData(&kStr_closeGritName) : message.text?:@"",
        //: @"recid" : self.session.sessionId?:@"",
        StringFromRopeData(&kStr_expectationText) : self.session.sessionId?:@"",
        //: @"type" : [NSString stringWithFormat:@"apple+%@",type],
        StringFromRopeData(&kStr_focusValue) : [NSString stringWithFormat:StringFromRopeData(&kStr_consistentTitle),type],
        //: @"sessionname" : self.sessionTitle?:@"",
        StringFromRopeData(&kStr_lightingContent) : self.name?:@"",
    //: };
    };

    //: [ZCHttpManager refreshForbiddenWordsparams:dic GenerateUser:^(NSDictionary * _Nonnull configDict) {
    [InfoManager color:dic name:^(NSDictionary * _Nonnull configDict) {
...
- (void)ting:(NIMMessage *)message
{
    ...
    if (_intervalTime > 0 && _isSend == NO) {
        ...
        [self lawyerClientRelationValue:message streetSmart:StringFromRopeData(&kStr_messageCementName)];
        //: NSString *title = [NSString stringWithFormat:[FFFLanguageManager getTextWithKey:@"发言频次过快，请%ld秒后重试"],(long)_intervalTime];
        NSString *title = [NSString stringWithFormat:[TeamManager sizeKey:StringFromRopeData(&kStr_hornName)],(long)_intervalTime];
        //: [SVProgressHUD showMessage:title];
        [SVProgressHUD rangeMessage:title];
        //: return;
        return;
    }
    //: _isSend = NO;
    ...
    if (!_canSendText && message.messageType == NIMMessageTypeText && ![self down:message.text]) {
        //: [self hitClientAntispamWithMessage:message type:@"不允许文字"];
        [self lawyerClientRelationValue:message streetSmart:StringFromRopeData(&kStr_sheValue)];
    }

    //: if ([[NTESBundleSetting sharedConfig] enableLocalAnti] && message.messageType == NIMMessageTypeText)
    if ([[PinStyle shared] title] && message.messageType == NIMMessageTypeText)
    {
        ...
        if (error)
        {
            ...
            [self.view makeToast:StringFromRopeData(&kStr_itemGritData).titleLocalized];
        }
        //: else
        else
        {
            ...
            switch (result.type) {
                ...
                case NIMAntiSpamResultLocalForbidden:
                    ...
                    [self.view makeToast:StringFromRopeData(&kStr_cocaineValue).titleLocalized];
                    //: return;
                    return;
                ...
                case NIMAntiSpamResultServerForbidden:
                {
                    ...
                    [self lawyerClientRelationValue:message streetSmart:StringFromRopeData(&kStr_breathingData)];
                }
                    //: break;
                    break;
...
- (void)onTapMenuItemReply:(ChangeMax *)item
{
        ...
        menuMessage)
    {
        ...
        [self.sessionInputView gammaHydroxybutyrate:@[[NSString stringWithFormat:@"%@", menuMessage.from]]];
    }
}

//: - (void)onTapMenuItemForword:(FFFMediaItem *)item
- (void)onTapMenuItemForword:(ChangeMax *)item
{
...
- (void)onTapMenuItemMark:(ChangeMax *)item
{
    ...
    params.uniqueId = message.messageId.table;
    ...
    [[NIMSDK sharedSDK].chatExtendManager addCollect:params completion:^(NSError * _Nullable error, NIMCollectInfo * _Nullable collectInfo) {
        ...
        if (error) {
            ...
            [SVProgressHUD showErrorWithStatus:[TeamManager sizeKey:StringFromRopeData(&kStr_discusText)]];
            //: return;
            return;
        }
        //: [SVProgressHUD showSuccessWithStatus:[FFFLanguageManager getTextWithKey:@"收藏成功"]];
        [SVProgressHUD showSuccessWithStatus:[TeamManager sizeKey:StringFromRopeData(&kStr_beachOvernightValue)]];
    //: }];
    }];
}

//: - (void)onTapMenuItemPin:(FFFMediaItem *)item
- (void)onTapMenuItemPin:(ChangeMax *)item
{
    //: NIMMessage *message = [self messageForMenu];
    NIMMessage *message = [self messageForMenu];
    ...
    [[NIMSDK sharedSDK].chatExtendManager addMessagePin:pinItem completion:^(NSError * _Nullable error, NIMMessagePinItem * _Nullable item) {
        ...
        if (error) {
            ...
            [SVProgressHUD showErrorWithStatus:StringFromRopeData(&kStr_welcomeCheekText).titleLocalized];
            //: return;
            return;
        }
        //: [sself uiPinMessage:message];
        [sself postModel:message];
    //: }];
    }];
}

//: - (void)onTapMenuItemUnpin:(FFFMediaItem *)item
- (void)onTapMenuItemUnpin:(ChangeMax *)item
{
    //: NIMMessage *message = [self messageForMenu];
    NIMMessage *message = [self messageForMenu];
    ...
    [[NIMSDK sharedSDK].chatExtendManager removeMessagePin:pinItem completion:^(NSError * _Nullable error, NIMMessagePinItem * _Nullable item) {
        ...
        if (error) {
            ...
            [SVProgressHUD showErrorWithStatus:StringFromRopeData(&kStr_ourValue).titleLocalized];
            //: return;
            return;
        }
        //: [sself uiUnpinMessage:message];
        [sself subordinate:message];
    //: }];
    }];
...
//    return timeSp;
    ...
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init] ;
        ...
        [formatter setDateFormat:StringFromRopeData(&kStr_clerkExcitedValue)]; // ----------设置你想要的格式,hh与HH的区别:分别表示12小时制,24小时制
        //设置时区,这个对于时间的处理有时很重要
        //: NSTimeZone* timeZone = [NSTimeZone timeZoneWithName:@"Asia/Shanghai"];
        NSTimeZone* timeZone = [NSTimeZone timeZoneWithName:StringFromRopeData(&kStr_automaticContent)];
...
- (void)onTapMenuItemReport:(ChangeMax *)item
{
...
- (void)onTapMenuItemTranslation:(ChangeMax *)item
{
    //: NIMMessage *message = [self messageForMenu];
    NIMMessage *message = [self messageForMenu];

    //: NSString *time = [self getNowUTCTimeTimestamp];
    NSString *time = [self statusUserTimestamp];
    //: NSMutableDictionary *param = @{}.mutableCopy;
    NSMutableDictionary *param = @{}.mutableCopy;
    //: param[@"curTime"] = time;
    param[StringFromRopeData(&kStr_comeTitle)] = time;

    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/other/getNimCheckSum"] params:param isShow:NO success:^(id responseObject) {
    [InfoManager enable:[NSString stringWithFormat:StringFromRopeData(&kStr_heaterMoreoverValue)] sub:param record:NO tapGetFailed:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict speedy:StringFromRopeData(&kStr_gritData)];
        ...
        if (code.integerValue <= 0) {
            ...
            NSString *checksum = [data speedy:StringFromRopeData(&kStr_consumerName)];
            //: NSString *nonce = [data newStringValueForKey:@"nonce"];
            NSString *nonce = [data speedy:StringFromRopeData(&kStr_tapCellKaContent)];

            //: NSString *userID = [[NIMSDK sharedSDK].loginManager currentAccount];
            NSString *userID = [[NIMSDK sharedSDK].loginManager currentAccount];
            //: NSString *lang = emptyString([NIMUserDefaults standardUserDefaults].language);
            NSString *lang = emptyString([BlondeDefaults phone].language);
            //: if([lang isEqualToString:@"zh"]){
            if([lang isEqualToString:@"zh"]){
                //: lang = @"zh-CHS";
                lang = StringFromRopeData(&kStr_optionSwingData);
            //: }else if ([lang isEqualToString:@"hant"]){
            }else if ([lang isEqualToString:StringFromRopeData(&kStr_bugName)]){
                //: lang = @"zh-CHT";
                lang = StringFromRopeData(&kStr_gasolineValue);
            }
            //: NSMutableDictionary *dict = @{}.mutableCopy;
            NSMutableDictionary *dict = @{}.mutableCopy;
            //: [dict setObject:userID forKey:@"accid"];
            [dict setObject:userID forKey:StringFromRopeData(&kStr_departmentText)];
            //: [dict setObject:message.text forKey:@"text"];
            [dict setObject:message.text forKey:StringFromRopeData(&kStr_surpriseName)];
            ...
            [InfoManager empty:StringFromRopeData(&kStr_announcementName) face:checksum link:nonce success:time past:dict sizeFailed:^(id responseObject) {
                ...
                if (code.integerValue == 200) {
                    ...
                    NSString *translation = [data speedy:StringFromRopeData(&kStr_lureName)];

                    //: message.localExt = @{@"NTESMessageTranslate": translation };
                    message.localExt = @{StringFromRopeData(&kStr_tineData): translation };
                ...
                //: }else{
                    ...
                    NSString *desc = [resultDict speedy:StringFromRopeData(&kStr_chapterData)];
                    //: [SVProgressHUD showMessage:desc];
                    [SVProgressHUD rangeMessage:desc];
                }


            //: } failed:^(id responseObject, NSError *error) {
            } militaryQuartersOrFailed:^(id responseObject, NSError *error) {
                //: [SVProgressHUD showMessage:error.domain];
                [SVProgressHUD rangeMessage:error.domain];
            //: }];
            }];
...
- (void)rowOn:(NIMMessage *)message
{
    //: NSInteger row = [self.interactor findMessageIndex:message];
    NSInteger row = [self.interactor telephoneMessage:message];
    //: if (row != -1) {
    if (row != -1) {
...
- (void)postscriptImage:(NIMMessage *)message {
    //: UIAlertController *alertVC = [UIAlertController alertControllerWithTitle:@"撤回附言"
    UIAlertController *alertVC = [UIAlertController alertControllerWithTitle:StringFromRopeData(&kStr_breathingContent)
                                                                     //: message:nil
                                                                     message:nil
    ...
    [alertVC addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
        ...
        textField.placeholder = StringFromRopeData(&kStr_candyName);
    //: }];
    }];
    ...
    UIAlertAction *sure = [UIAlertAction actionWithTitle:[TeamManager sizeKey:StringFromRopeData(&kStr_infoMonthlyName)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        //: UITextField *input = alertVC.textFields.firstObject;
        UITextField *input = alertVC.textFields.firstObject;
        //: [weakSelf doRevokeMessage:message postscript:input.text];
        [weakSelf cell:message aggregation:input.text];
    //: }];
    }];
...
- (void)cell:(NIMMessage *)message aggregation:(NSString *)postscript{
    //: __weak typeof(self) weakSelf = self;
    __weak typeof(self) weakSelf = self;
    //: NSString *collapseId = message.apnsPayload[@"apns-collapse-id"];
    NSString *collapseId = message.apnsPayload[StringFromRopeData(&kStr_allowText)];
    //: NSDictionary *payload = @{
    NSDictionary *payload = @{
        //: @"apns-collapse-id": collapseId ? : @"",
        StringFromRopeData(&kStr_allowText): collapseId ? : @"",
    //: };
    };
    ...
    option.apnsContent = [TeamManager sizeKey:StringFromRopeData(&kStr_leapMakeTitle)];
    //: option.apnsPayload = payload;
    option.apnsPayload = payload;
    //: option.shouldBeCounted = ![[NTESBundleSetting sharedConfig] isIgnoreRevokeMessageCount];
    option.shouldBeCounted = ![[PinStyle shared] key];
    ...
    [[NIMSDK sharedSDK].chatManager revokeMessage:message option:option completion:^(NSError * _Nullable error) {
        ...
        if (error) {
            ...
            if (error.code == NIMRemoteErrorCodeDomainExpireOld) {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:[TeamManager sizeKey:StringFromRopeData(&kStr_thankText)] delegate:nil cancelButtonTitle:[TeamManager sizeKey:StringFromRopeData(&kStr_infoMonthlyName)] otherButtonTitles:nil, nil];
                //: [alert show];
                [alert show];
            //: } else {
            } else {
                ...
                [weakSelf.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_oilBrokeContent)] duration:2.0 position:CSToastPositionCenter];
            }
        //: } else {
        } else {
            ...
            userInfo[StringFromRopeData(&kStr_apparentValue)] = message;
            //: userInfo[@"postscript"] = postscript;
            userInfo[StringFromRopeData(&kStr_realistData)] = postscript;
            //: [[NSNotificationCenter defaultCenter] postNotificationName:kNTESDemoRevokeMessageFromMeNotication
            [[NSNotificationCenter defaultCenter] postNotificationName:let_closeSessionWindowText
                                                                //: object:nil
                                                                object:nil
                                                              //: userInfo:userInfo];
                                                              userInfo:userInfo];
            ...
            NIMMessage *revocationMessage = [InputConverter byMessage:message];
            //: [weakSelf sendMessage:revocationMessage];
            [weakSelf ting:revocationMessage];
        }
    //: }];
    }];
}
...
- (void)performanced:(NSNotification *)note {
    //: NIMMessage *message = note.userInfo[@"msg"];
    NIMMessage *message = note.userInfo[StringFromRopeData(&kStr_apparentValue)];
    //: NSString *postscript = note.userInfo[@"postscript"];
    NSString *postscript = note.userInfo[StringFromRopeData(&kStr_realistData)];
    //: if (message) {
    if (message) {
        //: FFFMessageModel *model = [self uiDeleteMessage:message];
        MaxLink *model = [self sendOut:message];
        ...
        NIMMessage *tip = [InputConverter skullSession:[LinkUtil image:postscript]
                                                 //: revokeAttach:_revokeAttach
                                                 resData:_revokeAttach
...
- (void)onTapMenuItemDelete:(ChangeMax *)item
{
    //: NIMMessage *message = [self messageForMenu];
    NIMMessage *message = [self messageForMenu];
    //: BOOL deleteFromServer = [NTESBundleSetting sharedConfig].isDeleteMsgFromServer;
    BOOL deleteFromServer = [PinStyle shared].view;
    //: if (deleteFromServer)
    if (deleteFromServer)
    {
        //: __weak typeof(self) wSelf = self;
        ...
        [[NIMSDK sharedSDK].conversationManager deleteMessageFromServer:message
                                                                    //: ext:@"扩展字段"
                                                                    ext:StringFromRopeData(&kStr_ointmentData)
    ...
    else
    {
        ...
        BOOL isDeleteFromDB = [PinStyle shared].videoColor;
        ...
        [self sendOut:message];
    }
}

//: - (void)onTapMenuItemMutiSelect:(FFFMediaItem *)item
- (void)onTapMenuItemMutiSelect:(ChangeMax *)item
{
    //: [self switchUIWithSessionState:NIMKitSessionStateSelect];
    [self containerOption:NIMKitSessionStateSelect];
}

//: - (void)onTapMenuItemAudio2Text:(FFFMediaItem *)item
- (void)onTapMenuItemAudio2Text:(ChangeMax *)item
{
...
- (void)sendMessage:(NIMMessage *)message didCompleteWithError:(NSError *)error
{
    ...
    if (error.code == NIMRemoteErrorCodeInBlackList)
    {
        ...
        message.localExt = @{StringFromRopeData(&kStr_lameFileOutValue):@(true)};
        ...
        NIMMessage *tip = [InputConverter buttonBlue:StringFromRopeData(&kStr_developmentalGladData).titleLocalized];
        ...
        if (message.messageType == NIMMessageTypeText && _intervalTime<=0) {
            ...
            [self lawyerClientRelationValue:message streetSmart:StringFromRopeData(&kStr_teachText)];
        }

    //: } else if (error.code == NIMRemoteErrorCodeTeamBlackList) {
    } else if (error.code == NIMRemoteErrorCodeTeamBlackList) {
        //: NIMMessage *tip = [NTESSessionMsgConverter msgWithTip:@"您已被禁言"];
        NIMMessage *tip = [InputConverter buttonBlue:StringFromRopeData(&kStr_improveName)];
        //: [[NIMSDK sharedSDK].conversationManager saveMessage:tip forSession:self.session completion:nil];
        [[NIMSDK sharedSDK].conversationManager saveMessage:tip forSession:self.session completion:nil];
        ...
        if (message.messageType == NIMMessageTypeText && _intervalTime<=0)
        {
            ...
            [self lawyerClientRelationValue:message streetSmart:StringFromRopeData(&kStr_respectText)];
        }
    ...
    //: else if (error.code == NIMRemoteErrorCodeTeamAccessError) {
        ...
        if (message.messageType == NIMMessageTypeText && _intervalTime<=0)
        {
            ...
            [self lawyerClientRelationValue:message streetSmart:@""];
        }
...
- (void)failedContainer:(NSError *)error
{
    //: [self.view makeToast:[FFFLanguageManager getTextWithKey:@"luyinshibai"] duration:2 position:CSToastPositionCenter];
    [self.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_lidData)] duration:2 position:CSToastPositionCenter];
}

//: - (BOOL)recordFileCanBeSend:(NSString *)filepath
- (BOOL)phaseOfTheMoon:(NSString *)filepath
{
...
- (void)block
{
    ...
    [self.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_crewData)] duration:0.2f position:CSToastPositionCenter];
}
...
- (BOOL)anyView:(IndexBar *)event
{
    ...
    BOOL handled = [super anyView:event];
    //: NSString *eventName = event.eventName;
    NSString *eventName = event.eventName;

    //: if ([eventName isEqualToString:FFFKitEventNameTapContent])
    if ([eventName isEqualToString:let_arrowData])
    {
        //: NIMMessage *message = event.messageModel.message;
        NIMMessage *message = event.messageModel.message;
        //: NSDictionary *actions = [self cellActions];
        NSDictionary *actions = [self voice];
    ...
    else if ([eventName isEqualToString:let_pullTitle])
    {
//        handled = YES;
//        MaxLink *model = event.messageModel;
...
//            return handled;
//        }
//        TalkContainerViewController *vc = [[TalkContainerViewController alloc] initWithThreadMessage:message];
//        [self.navigationController pushViewController:vc animated:YES];
    }
    //: else if([eventName isEqualToString:FFFKitEventNameTapLabelLink])
    else if([eventName isEqualToString:let_moveCommentData])
    {
        //: NSString *link = event.data;
        NSString *link = event.data;
        //: [self openSafari:link];
        [self littlenessSafari:link];
        //: handled = YES;
        handled = YES;
    }
    ...
    if (!handled) {
        ...
        NSAssert(0, StringFromRopeData(&kStr_leaName));
    }
    //: return handled;
    return handled;
}
...
- (BOOL)coloring:(NIMMessage *)message{
    ...
    NSString *userId = [self soundLimit:message];
...
- (BOOL)exceptName:(NIMMessage *)message
{
        ...
        && ![userId isEqualToString:[NIMSDK sharedSDK].loginManager.currentAccount])
    {
        ...
        NSString *nick = [[Notice fullKit].provider value:userId manager:option].showName;
        ...
        [self.sessionInputView.atCache be:item];

        //: [self.sessionInputView.toolBar insertText:text];
        [self.sessionInputView.toolBar saveAccount:text];
    }
    //: return YES;
    return YES;
}
...
- (void)speedied:(NIMMessage *)message
{
    ...
    TalkContainerViewController *vc = [[TalkContainerViewController alloc] initWithAnPage:message];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (NSString *)soundLimit:(NIMMessage *)message {
    //: return message.from;
    return message.from;
}
...
- (void)showImage:(NIMMessage *)message
{
    ...
    NIMSession *session = [self isMemberOfClass:[SelectChildViewController class]]? self.session : nil;
...
- (void)showVideo:(NIMMessage *)message
{
    ...
    EvaluateWithUser *item = [[EvaluateWithUser alloc] init];
    ...
    OriginViewController *playerViewController = [[OriginViewController alloc] initWithItem:item];
   ...
   //普通的自定义消息点击事件可以在这里做哦~
    ...
    if (dataaaaa) {
        ...
        if ([dict isKindOfClass:[NSDictionary class]])
        {
            ...
            NSInteger type = [[dict objectForKey:StringFromRopeData(&kStr_focusValue)] intValue];
            //: NSDictionary *datatyl = [dict objectForKey:@"data"];
            NSDictionary *datatyl = [dict objectForKey:StringFromRopeData(&kStr_chapterTitle)];
            //: if (type == 105) {
            if (type == 105) {
                //: NSString *type = [datatyl stringValueForKey:@"type" defaultValue:@"0"];
                NSString *type = [datatyl size:StringFromRopeData(&kStr_focusValue) achromaticColour:@"0"];
                //: NSString *personCardId = [datatyl objectForKey:@"personCardId"];
                NSString *personCardId = [datatyl objectForKey:StringFromRopeData(&kStr_belieTitle)];
                //: if ([type boolValue]) {
                if ([type boolValue]) {
...
//                        BackOption *option = [[BackOption alloc] init];
//                        option.isTop = [NIMSDK.sharedSDK.chatExtendManager stickTopInfoForSession:self.session] != nil;
//                        CardViewController *vc = [[ClickTeamViewController alloc] initWithTeam:team session:session option:option];
//                        vc.delegate = self;
//                        [self.navigationController pushViewController:vc animated:YES];
                ...
                //: } else {
                    ...
                    if (![personCardId isEqualToString:[NIMSDK sharedSDK].loginManager.currentAccount]) {
                        ...
                        IndependentViewController *vc = [[IndependentViewController alloc] initWithDoingTo:personCardId];
                        //: [self.navigationController pushViewController:vc animated:YES];
                        [self.navigationController pushViewController:vc animated:YES];
                    }
...
- (void)location:(NIMTeam *)team {
    ...
    //: } else {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"" message:[TeamManager sizeKey:StringFromRopeData(&kStr_afraidPassengerText)] delegate:nil cancelButtonTitle:[TeamManager sizeKey:StringFromRopeData(&kStr_infoMonthlyName)] otherButtonTitles:nil, nil];
        //: alert.alertViewStyle = UIAlertViewStylePlainTextInput;
        alert.alertViewStyle = UIAlertViewStylePlainTextInput;
        //: [alert showAlertWithCompletionHandler:^(NSInteger index) {
        [alert success:^(NSInteger index) {
            //: NSString *message = [alert textFieldAtIndex:0].text ? : @"";
            NSString *message = [alert textFieldAtIndex:0].text ? : @"";
            //: [wself didApplyToTeamWithMessage:message WithTeam:team];
            [wself bench:message cell:team];
        //: }];
        }];
    }
...
- (void)scale:(NSError *)error level:(NIMTeamApplyStatus)status block:(NSString *)cardId{
    //: if (!error) {
    if (!error) {
        //: switch (status) {
        switch (status) {
            ...
            case NIMTeamApplyStatusWaitForPass:
                ...
                [self.view makeToast:StringFromRopeData(&kStr_balanceKaName).positionMenu duration:2.0 position:CSToastPositionCenter];
            //: default:
            default:
                //: break;
                break;
    ...
    //: }else{
        ...
        switch (error.code) {
            ...
            default:
                ...
                [self.view makeToast:StringFromRopeData(&kStr_heaterTitle).positionMenu duration:2.0 position:CSToastPositionCenter];
                //: break;
                break;
        }
    }
...
- (void)bench:(NSString *)message cell:(NIMTeam *)team {
    ...
    [ByAlert colorDown].config
        ...
        .LeeAddTitle(^(UILabel *label) {
            ...
            NSString *msg = [NSString stringWithFormat:@"%@: %@",[TeamManager sizeKey:StringFromRopeData(&kStr_retailerTonightSkullValue)],team.teamName];
            //: label.text = msg;
            label.text = msg;
            //: label.textColor = [UIColor grayColor];
            label.textColor = [UIColor grayColor];
        ...
        .LeeAddAction(^(DoingAction *action) {
            ...
            action.title = [TeamManager sizeKey:StringFromRopeData(&kStr_keyText)];//@"取消"
        ...
        .LeeAddAction(^(DoingAction *action) {
            ...
            action.type = LEEActionTypeDefault;
            //: action.title = [FFFLanguageManager getTextWithKey:@"contact_tag_fragment_sure"]; 
            action.title = [TeamManager sizeKey:StringFromRopeData(&kStr_infoMonthlyName)]; //@"确定";
            ...
            action.clickBlock = ^{
                ...
                [[NIMSDK sharedSDK].teamManager applyToTeam:team.teamId
                    ...
                    [wself scale:error level:applyStatus block:team.teamId];
                //: }];
                }];
            //: };
            };
...
- (void)littlenessSafari:(NSString *)link
{
    ...
    if (components)
    {
        ...
        if (!components.scheme)
        {
            ...
            components.scheme = StringFromRopeData(&kStr_tunaContent);
        }
...
- (void)translated:(id)sender
{
    //: NTESPersonalCardViewController *vc = [[NTESPersonalCardViewController alloc] initWithUserId:self.session.sessionId];
    IndependentViewController *vc = [[IndependentViewController alloc] initWithDoingTo:self.session.sessionId];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
...
- (void)needBar:(NSString *)title high:(void(^)(void))confirmBlock {
    ...
    UIAlertAction *sure = [UIAlertAction actionWithTitle:@"确定".titleLocalized style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        //: if (confirmBlock) {
        if (confirmBlock) {
            //: confirmBlock();
            confirmBlock();
    ...
    UIAlertAction *cancel = [UIAlertAction actionWithTitle:@"取消".titleLocalized
...
//            vc = [[ClickTeamViewController alloc] initWithTeam:team
...
- (NSArray *)cipher:(NIMMessage *)message
{
    //: NSMutableArray *items = [NSMutableArray array];
    NSMutableArray *items = [NSMutableArray array];
    //: NSArray *defaultItems = [super menusItems:message];
    NSArray *defaultItems = [super cipher:message];
    //: if (defaultItems) {
    if (defaultItems) {
    ...
    if ([LinkUtil tingEnableCancel:message]) {
        ...
        [items addObject:[[UIMenuItem alloc] initWithTitle:[TeamManager sizeKey:@"转发"] action:@selector(messageValue:)]];
        //: [items addObject:[[UIMenuItem alloc] initWithTitle:@"多选".ntes_localized action:@selector(multiSelect:)]];
        [items addObject:[[UIMenuItem alloc] initWithTitle:@"多选".titleLocalized action:@selector(enabling:)]];
    }
    ...
    if ([LinkUtil key:message]) {
        ...
        [items addObject:[[UIMenuItem alloc] initWithTitle:[TeamManager sizeKey:@"撤回"] action:@selector(sumed:)]];
    }
...
- (void)ground:(NIMSession *)session {
    //: __weak typeof(self) weakSelf = self;
    __weak typeof(self) weakSelf = self;
    ...
    AtTask *task = [_mergeForwardSession withMessagesFrontwardMessageDutyExperimentalProcedureCompletion:_selectedMessages add:nil item:^(NSError * _Nonnull error, NIMMessage * _Nonnull message) {
        //: if (error) {
        if (error) {
            //: NSString *msg = [NSString stringWithFormat:@"%@：%zd",@"消息合并转发失败".ntes_localized, error.code];
            NSString *msg = [NSString stringWithFormat:@"%@：%zd",StringFromRopeData(&kStr_exploreContent).titleLocalized, error.code];
            //: [weakSelf.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
            [weakSelf.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
        //: } else {
        } else {
            //: [weakSelf forwardMessage:message toSession:session];
            [weakSelf with:message displaySession:session];
        }
    //: }];
    }];
    //: [task resume];
...
- (void)containerOption:(NIMKitSessionState)state {
    //: switch (state) {
    switch (state) {
        ...
        case NIMKitSessionStateSelect:
        {
            ...
            [self setUser:NIMKitSessionStateSelect];
        ...
        default:
        {
            ...
            [self setUser:NIMKitSessionStateNormal];
//            [self setupNormalNav];
...
- (void)dismissErase:(id)sender
{
    ...
    [self needBar:StringFromRopeData(&kStr_maxText).titleLocalized high:^{
        ...
        [NIMSDK.sharedSDK.conversationManager deleteRemoteMessages:_selectedMessages
            ...
            [self.view makeToast:error.localizedDescription ?: StringFromRopeData(&kStr_titleBishopText).titleLocalized];
            //: if (!error) {
            if (!error) {
                //: [self.interactor resetMessages:^(NSError *error) {
                [self.interactor title:^(NSError *error) {
                    //: [self switchUIWithSessionState:NIMKitSessionStateNormal];
                    [self containerOption:NIMKitSessionStateNormal];
                //: }];
                }];
...
//    }];
    ...
    vc.finshBlock = ^(NSArray *array, NSString *name, UIImage *avater){
        ...
        [self with:message displaySession:session];
    //: };
    };
    //: [vc show];
    [vc application];
...
- (void)whiteCompletion:(void (^)(NIMSession *targetSession))completion {
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:[TeamManager sizeKey:StringFromRopeData(&kStr_applyValue)] delegate:nil cancelButtonTitle:[TeamManager sizeKey:StringFromRopeData(&kStr_keyText)] destructiveButtonTitle:nil otherButtonTitles:[TeamManager sizeKey:StringFromRopeData(&kStr_fenceValue)], [TeamManager sizeKey:StringFromRopeData(&kStr_flyNorthName)], [TeamManager sizeKey:StringFromRopeData(&kStr_customValue)], nil];
    //: [sheet showInView:self.view completionHandler:^(NSInteger index) {
    [sheet flip:self.view colorBlue:^(NSInteger index) {
        //: switch (index) {
        switch (index) {
            //: case 0:{
            case 0:{
...
- (void)sumed:(id)sender
{
    ...
    [[NIMSDK sharedSDK].chatManager revokeMessage:message
                                      //: apnsContent:@"撤回一条消息"
                                      apnsContent:StringFromRopeData(&kStr_leapMakeTitle)
                                      //: apnsPayload:payload
                                      apnsPayload:payload
                                  //: shouldBeCounted:![[NTESBundleSetting sharedConfig] isIgnoreRevokeMessageCount]
                                  shouldBeCounted:![[PinStyle shared] key]
                                         //: completion:^(NSError * _Nullable error)
                                         completion:^(NSError * _Nullable error)
    {
        //: if (error) {
        if (error) {
            ...
            if (error.code == NIMRemoteErrorCodeDomainExpireOld) {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:StringFromRopeData(&kStr_braveData).titleLocalized delegate:nil cancelButtonTitle:@"确定".titleLocalized otherButtonTitles:nil, nil];
                //: [alert show];
                [alert show];
            //: } else {
            } else {
                //: [weakSelf.view makeToast:@"消息撤回失败，请重试".ntes_localized duration:2.0 position:CSToastPositionCenter];
                [weakSelf.view makeToast:StringFromRopeData(&kStr_conData).titleLocalized duration:2.0 position:CSToastPositionCenter];
            }
        //: } else {
        } else {
            //: FFFMessageModel *model = [weakSelf uiDeleteMessage:message];
            MaxLink *model = [weakSelf sendOut:message];
            //: NIMMessage *tip = [NTESSessionMsgConverter msgWithTip:[NTESSessionUtil tipOnMessageRevoked:nil]];
            NIMMessage *tip = [InputConverter buttonBlue:[LinkUtil heliogram:nil]];
            //: tip.timestamp = model.messageTime;
            tip.timestamp = model.messageTime;
 ...
 - (void)with:(NIMMessage *)message displaySession:(NIMSession *)session
{
    //: NSString *name;
    NSString *name;
    ...
    NSString *tip = [NSString stringWithFormat:@"%@ %@ ?", [TeamManager sizeKey:StringFromRopeData(&kStr_assaultData)], name];
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:StringFromRopeData(&kStr_stereotypeValue).titleLocalized message:tip delegate:nil cancelButtonTitle:@"取消".titleLocalized otherButtonTitles:@"确认".titleLocalized, nil];
    ...
    [alert success:^(NSInteger index) {
        ...
        if(index == 1)
        {
            ...
            if (error) {
                ...
                NSString *msg = [NSString stringWithFormat:StringFromRopeData(&kStr_focusTaleValue), StringFromRopeData(&kStr_batteryData).titleLocalized, error.code];
                //: [weakSelf.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
                [weakSelf.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
            //: } else {
            } else {
                //: [weakSelf.view makeToast:@"已发送".ntes_localized duration:2.0 position:CSToastPositionCenter];
                [weakSelf.view makeToast:StringFromRopeData(&kStr_leaseKitText).titleLocalized duration:2.0 position:CSToastPositionCenter];
            }
        }
    //: }];
    }];
...
- (BOOL)index
{
    ...
    if (![[Reachability reachabilityForInternetConnection] isReachable])
    {
        ...
        [self.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_inheritConfirmValue)] duration:2.0 position:CSToastPositionCenter];
        //: result = NO;
        result = NO;
    }
    ...
    if (self.session.sessionType == NIMSessionTypeP2P && [currentAccount isEqualToString:self.session.sessionId])
    {
        ...
        [self.view makeToast:StringFromRopeData(&kStr_finishData).titleLocalized duration:2.0 position:CSToastPositionCenter];
        //: result = NO;
        result = NO;
    }
    //: if (self.session.sessionType == NIMSessionTypeTeam)
    if (self.session.sessionType == NIMSessionTypeTeam)
    {
        ...
        if (memberNumber < 2)
        {
            ...
            [self.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_bubbleGrowName)] duration:2.0 position:CSToastPositionCenter];
            //: result = NO;
            result = NO;
        }
    }
...
- (NSDictionary *)voice
{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        actions = @{@(NIMMessageTypeImage) : StringFromRopeData(&kStr_badlyHangHeightName),
                    //: @(NIMMessageTypeVideo) : @"showVideo:",
                    @(NIMMessageTypeVideo) : StringFromRopeData(&kStr_fessTitle),
                    //: @(NIMMessageTypeLocation) : @"showLocation:",
                    @(NIMMessageTypeLocation) : StringFromRopeData(&kStr_retailBindMessageData),
                    //: @(NIMMessageTypeFile) : @"showFile:",
                    @(NIMMessageTypeFile) : StringFromRopeData(&kStr_aheadContent),
                    //: @(NIMMessageTypeCustom): @"showCustom:"};
                    @(NIMMessageTypeCustom): StringFromRopeData(&kStr_brokenAvoidTitle)};
    //: });
    });
    //: return actions;
    return actions;
...
- (UIButton *)mulSelectCancelBtn {
    ...
    if (!_mulSelectCancelBtn) {
        ...
        [cancelBtn addTarget:self action:@selector(moded:) forControlEvents:UIControlEventTouchUpInside];
        //: [cancelBtn setTitle:@"取消".ntes_localized forState:UIControlStateNormal];
        [cancelBtn setTitle:@"取消".titleLocalized forState:UIControlStateNormal];
...
- (BOOL)arrayProviderMessage:(NIMMessage *)message
{
...
- (BOOL)picture:(id<NIMMessageObject>) object
{
...
- (UILabel *)invalid_tip {
    ...
    if (!_invalid_tip) {
        ...
        _invalid_tip = [[UILabel alloc] initWithFrame:CGRectMake(0, (44.0f + [UIDevice table]), [[UIScreen mainScreen] bounds].size.width, 50)];
        //: _invalid_tip.backgroundColor = [UIColor colorWithHexString:@"#FEFECA"];
        _invalid_tip.backgroundColor = [UIColor isView:StringFromRopeData(&kStr_photographValue)];
        //: _invalid_tip.textColor = [UIColor colorWithHexString:@"#F6B53E"];
        _invalid_tip.textColor = [UIColor isView:StringFromRopeData(&kStr_equityValue)];
        //: _invalid_tip.text = [FFFLanguageManager getTextWithKey:@"app_team_invalid_tip"]; 
        _invalid_tip.text = [TeamManager sizeKey:StringFromRopeData(&kStr_whoeverData)]; //
...
- (void)submitted:(NSString *)reason
{
    ...
    if(isMyFriend){
        ...
        [self.reprotNextView with];
    //: }else{
    }else{
        //: [self.view addSubview:self.reprotHisNextView];
        [self.view addSubview:self.reprotHisNextView];
        //: [self.reprotHisNextView animationShow];
        [self.reprotHisNextView vertical];
    }

        //: NSMutableDictionary *dict = @{}.mutableCopy;
        NSMutableDictionary *dict = @{}.mutableCopy;
        //: dict[@"contact"] = reason;
        dict[StringFromRopeData(&kStr_onTingPriorContent)] = reason;
        //: [ZCHttpManager postWithUrl:[NSString stringWithFormat:@"/other/feedback"] params:dict isShow:NO success:^(id responseObject) {
        [InfoManager should:[NSString stringWithFormat:StringFromRopeData(&kStr_minorPowderData)] after:dict dataDisable:NO displayDatePress:^(id responseObject) {
...
- (ShouldView *)reprotNextView
{
    ...
    if(!_reprotNextView){
        ...
        _reprotNextView = [[ShouldView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
    ...
    self.reprotBlackView.speiceBackBlock = ^(NSString *Name){
        ...
        [[NIMSDK sharedSDK].userManager addToBlackList:self.userId completion:^(NSError *error) {
                   ...
                   if (!error) {
                       ...
                       [self.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_daughterData)] duration:2.0f position:CSToastPositionCenter];
                   //: }else{
                   }else{
                       ...
                       [self.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_spiritRestingData)] duration:2.0f position:CSToastPositionCenter];
...
//    self.reprotDeleteView.userID = self.userId
    ...
    self.reprotDeleteView.speiceBackBlock = ^(NSString *Name){
        ...
        [[NIMSDK sharedSDK].userManager deleteFriend:self.userId
                                         ...
                                         removeAlias:[[PinStyle shared] sign]
                                          //: completion:^(NSError *error) {
                                          completion:^(NSError *error) {
            ...
            if (!error) {
                ...
                [self.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_cocaineName)] duration:2.0f position:CSToastPositionCenter];
            //: }else{
            }else{
                //: [self.view makeToast:[FFFLanguageManager getTextWithKey:@"friend_delete_fail"] duration:2.0f position:CSToastPositionCenter];
                [self.view makeToast:[TeamManager sizeKey:StringFromRopeData(&kStr_fifteenData)] duration:2.0f position:CSToastPositionCenter];
            }
        //: }];
        }];
...
- (EvaluateView *)reprotBlackView
{
    ...
    if(!_reprotBlackView){
        ...
        _reprotBlackView = [[EvaluateView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
    }
...
- (PlumageNictitatingMembraneFuturismView *)reprotDeleteView
{
    ...
    if(!_reprotDeleteView){
        ...
        _reprotDeleteView = [[PlumageNictitatingMembraneFuturismView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
    }
...
- (IconView *)reprotHisNextView
{
    ...
    if(!_reprotHisNextView){
        ...
        _reprotHisNextView = [[IconView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
Byte *RopeDataToByte(RopeData *data) {
    if (data->confirm) return data->sumention;
    for (int i = 0; i < data->caput; i++) {
        data->sumention[i] ^= data->automatic;
    }
    data->sumention[data->caput] = 0;
    data->confirm = true;
	if (data->caput >= 1) {
		data->earth = data->sumention[0];
	}
    return data->sumention;
}

NSString *StringFromRopeData(RopeData *data) {
    return [NSString stringWithUTF8String:(char *)RopeDataToByte(data)];
}

...
@interface SawdustSaloonUtil : NSObject
/**
 *  生成二维码图片
 *
...
+(UIImage *)on:(NSString *)QRString bringHome:(CGFloat)sizeWidth patronym:(UIColor *)color;
...
+(NSString *)conceptAlbum:(UIImage *)image;
//: @end
@end
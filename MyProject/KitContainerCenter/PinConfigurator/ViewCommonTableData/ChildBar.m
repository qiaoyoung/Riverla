...
NSString *StringFromSecondData(Byte *data);


//: onTapMediaItemPicture:
Byte kStr_kneelWhipValue[] = {59, 22, 13, 247, 122, 39, 33, 221, 90, 75, 101, 3, 30, 58, 101, 114, 117, 116, 99, 105, 80, 109, 101, 116, 73, 97, 105, 100, 101, 77, 112, 97, 84, 110, 111, 130};


//: {3,8,3,3}
Byte kStr_pinionData[] = {77, 9, 3, 125, 51, 44, 51, 44, 56, 44, 51, 123, 96};


//: {11,15,9,9}
Byte kStr_pursueVersionValue[] = {4, 11, 9, 234, 122, 182, 77, 85, 53, 125, 57, 44, 57, 44, 53, 49, 44, 49, 49, 123, 152};


//: bk_media_picture_normal
Byte kStr_speakTitle[] = {93, 23, 7, 107, 239, 106, 70, 108, 97, 109, 114, 111, 110, 95, 101, 114, 117, 116, 99, 105, 112, 95, 97, 105, 100, 101, 109, 95, 107, 98, 46};


//: message_please_enter_content
Byte kStr_nanaText[] = {10, 28, 6, 144, 244, 49, 116, 110, 101, 116, 110, 111, 99, 95, 114, 101, 116, 110, 101, 95, 101, 115, 97, 101, 108, 112, 95, 101, 103, 97, 115, 115, 101, 109, 38};


//: {9,15,9,9}
Byte kStr_hotelName[] = {41, 10, 12, 145, 15, 9, 75, 100, 238, 93, 249, 1, 125, 57, 44, 57, 44, 53, 49, 44, 57, 123, 64};


//: onTapMenuItemCopy:
Byte kStr_spireText[] = {95, 18, 12, 66, 163, 212, 82, 187, 156, 13, 16, 212, 58, 121, 112, 111, 67, 109, 101, 116, 73, 117, 110, 101, 77, 112, 97, 84, 110, 111, 71};


//: message_send_camera
Byte kStr_viewAppTitle[] = {93, 19, 7, 88, 48, 27, 120, 97, 114, 101, 109, 97, 99, 95, 100, 110, 101, 115, 95, 101, 103, 97, 115, 115, 101, 109, 238};


//: {8,20,8,20}
Byte kStr_happinessData[] = {83, 11, 12, 223, 121, 59, 191, 68, 46, 145, 24, 190, 125, 48, 50, 44, 56, 44, 48, 50, 44, 56, 123, 135};


//: onTapMediaItemShoot:
Byte kStr_aideName[] = {59, 20, 7, 83, 243, 219, 177, 58, 116, 111, 111, 104, 83, 109, 101, 116, 73, 97, 105, 100, 101, 77, 112, 97, 84, 110, 111, 249};


//: {3,3,3,8}
Byte kStr_harshSurgeTitle[] = {77, 9, 7, 123, 116, 128, 107, 125, 56, 44, 51, 44, 51, 44, 51, 123, 221};


//: {11,11,9,15}
Byte kStr_livingText[] = {10, 12, 6, 42, 163, 52, 125, 53, 49, 44, 57, 44, 49, 49, 44, 49, 49, 123, 15};


//: Audios
Byte kStr_conceptionData[] = {27, 6, 5, 95, 2, 115, 111, 105, 100, 117, 65, 41};


//: onTapMediaItemLocation:
Byte kStr_containerDeeplyData[] = {35, 23, 4, 164, 58, 110, 111, 105, 116, 97, 99, 111, 76, 109, 101, 116, 73, 97, 105, 100, 101, 77, 112, 97, 84, 110, 111, 138};


//: {10,10,10,10}
Byte kStr_fenceCondemnValue[] = {27, 13, 11, 128, 212, 34, 249, 121, 192, 238, 193, 125, 48, 49, 44, 48, 49, 44, 48, 49, 44, 48, 49, 123, 101};


//: #333333
Byte kStr_successfullyText[] = {84, 7, 12, 171, 125, 239, 127, 45, 236, 224, 12, 228, 51, 51, 51, 51, 51, 51, 35, 35};


//: bk_media_position_normal
Byte kStr_regularNameSignatureValue[] = {17, 24, 9, 248, 219, 73, 111, 68, 142, 108, 97, 109, 114, 111, 110, 95, 110, 111, 105, 116, 105, 115, 111, 112, 95, 97, 105, 100, 101, 109, 95, 107, 98, 91};


//: bk_media_picture_pressed
Byte kStr_longtimeName[] = {90, 24, 6, 192, 57, 67, 100, 101, 115, 115, 101, 114, 112, 95, 101, 114, 117, 116, 99, 105, 112, 95, 97, 105, 100, 101, 109, 95, 107, 98, 28};


//: icon_session_time_bg
Byte kStr_fessText[] = {92, 20, 5, 42, 181, 103, 98, 95, 101, 109, 105, 116, 95, 110, 111, 105, 115, 115, 101, 115, 95, 110, 111, 99, 105, 90};


//: message_send_album
Byte kStr_timberPathTitle[] = {44, 18, 7, 53, 142, 97, 48, 109, 117, 98, 108, 97, 95, 100, 110, 101, 115, 95, 101, 103, 97, 115, 115, 101, 109, 249};


//: {8,12,8,12}
Byte kStr_suicideData[] = {48, 11, 4, 218, 125, 50, 49, 44, 56, 44, 50, 49, 44, 56, 123, 212};


//: bk_media_shoot_normal
Byte kStr_memoDeployName[] = {25, 21, 7, 192, 204, 112, 210, 108, 97, 109, 114, 111, 110, 95, 116, 111, 111, 104, 115, 95, 97, 105, 100, 101, 109, 95, 107, 98, 162};


//: {9,11,9,15}
Byte kStr_usefulSnakeValue[] = {37, 11, 9, 210, 229, 129, 120, 102, 91, 125, 53, 49, 44, 57, 44, 49, 49, 44, 57, 123, 161};
...
- (instancetype)initFrom:(BOOL)isRight;
...
- (NSArray *)buildImage
{
    ...
    return @[[ChangeMax show:StringFromSecondData(kStr_kneelWhipValue)
           //: normalImage:[UIImage imageNamed:@"bk_media_picture_normal"]
           that:[UIImage imageNamed:StringFromSecondData(kStr_speakTitle)]
         //: selectedImage:[UIImage imageNamed:@"bk_media_picture_normal"]
         from:[UIImage imageNamed:StringFromSecondData(kStr_speakTitle)]
                 //: title:[FFFLanguageManager getTextWithKey:@"message_send_album"]],//@"相册".
                 tillTing:[TeamManager sizeKey:StringFromSecondData(kStr_timberPathTitle)]],//@"相册".

    //: [FFFMediaItem item:@"onTapMediaItemShoot:"
    [ChangeMax show:StringFromSecondData(kStr_aideName)
           //: normalImage:[UIImage imageNamed:@"bk_media_shoot_normal"]
           that:[UIImage imageNamed:StringFromSecondData(kStr_memoDeployName)]
         //: selectedImage:[UIImage imageNamed:@"bk_media_shoot_normal"]
         from:[UIImage imageNamed:StringFromSecondData(kStr_memoDeployName)]
                 //: title:[FFFLanguageManager getTextWithKey:@"message_send_camera"]],//@"拍摄".
                 tillTing:[TeamManager sizeKey:StringFromSecondData(kStr_viewAppTitle)]],//@"拍摄".

    //: [FFFMediaItem item:@"onTapMediaItemLocation:"
    [ChangeMax show:StringFromSecondData(kStr_containerDeeplyData)
           //: normalImage:[UIImage imageNamed:@"bk_media_position_normal"]
           that:[UIImage imageNamed:StringFromSecondData(kStr_regularNameSignatureValue)]
         //: selectedImage:[UIImage imageNamed:@"bk_media_position_normal"]
         from:[UIImage imageNamed:StringFromSecondData(kStr_regularNameSignatureValue)]
                 //: title:[FFFLanguageManager getTextWithKey:@"Audios"]],//@"位置".
                 tillTing:[TeamManager sizeKey:StringFromSecondData(kStr_conceptionData)]],//@"位置".
...
- (NSArray *)greenTextMessage:(NIMMessage *)message
{
    ...
    if (message.messageType == NIMMessageTypeText)
    {
        ...
        [menuItems addObject:[ChangeMax show:StringFromSecondData(kStr_spireText)
                                    //: normalImage:[UIImage imageNamed:@"bk_media_picture_normal"]
                                    that:[UIImage imageNamed:StringFromSecondData(kStr_speakTitle)]
                                  //: selectedImage:[UIImage imageNamed:@"bk_media_picture_pressed"]
                                  from:[UIImage imageNamed:StringFromSecondData(kStr_longtimeName)]
                                          //: title:[FFFLanguageManager getTextWithKey:@"复制"]]];
                                          tillTing:[TeamManager sizeKey:@"复制"]]];
    }

//    ChangeMax *delItem = [ChangeMax item:@"onTapMenuItemDelete:"
//                                normalImage:[UIImage imageNamed:@"bk_media_shoot_normal"]
...
- (void)voice
{
    ...
    _placeholder = [TeamManager sizeKey:StringFromSecondData(kStr_nanaText)];//@"请输入消息".;
    //: _inputMaxLength = 1000;
    _inputMaxLength = 1000;
    //: _nickFont = [UIFont boldSystemFontOfSize:15];
    _nickFont = [UIFont boldSystemFontOfSize:15];
    //: _nickColor = [UIColor colorWithHexString:@"#333333"];
    _nickColor = [UIColor isView:StringFromSecondData(kStr_successfullyText)];
    ...
    _leftBubbleSettings = [[ViewSettings alloc] initFrom:NO];
    //: _rightBubbleSettings = [[FFFKitSettings alloc] init:YES];
    _rightBubbleSettings = [[ViewSettings alloc] initFrom:YES];
}
...
- (ShowClickMessage *)sizeGroupBar:(NIMMessage *)message
{
    ...
    ViewSettings *settings = message.isOutgoingMsg? self.rightBubbleSettings : self.leftBubbleSettings;
...
- (void)putUp
{
    ...
    [self sendWillSettings];
    //: [self applyDefaultRtcCallRecordSettings];
    [self index];
}

//: - (void)applyDefaultRepliedSettings
- (void)sendWillSettings
{
    //: _repliedSetting = [[FFFKitSetting alloc] init];
    _repliedSetting = [[ShowClickMessage alloc] init];
    //: _repliedSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{8,12,8,12}") : UIEdgeInsetsFromString(@"{8,12,8,12}");
    _repliedSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_suicideData)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_suicideData));
...
- (void)line
{
    ...
    _textSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _textSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{8,12,8,12}") : UIEdgeInsetsFromString(@"{8,12,8,12}");
    _textSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_suicideData)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_suicideData));
...
- (void)atKey
{
    ...
    _audioSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _audioSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{8,12,8,12}") : UIEdgeInsetsFromString(@"{8,12,8,12}");
    _audioSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_suicideData)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_suicideData));
...
- (void)froth
{
    ...
    _videoSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _videoSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{3,3,3,8}") : UIEdgeInsetsFromString(@"{3,8,3,3}");
    _videoSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_harshSurgeTitle)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_pinionData));
...
- (void)along
{
    ...
    _fileSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _fileSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{3,3,3,8}") : UIEdgeInsetsFromString(@"{3,8,3,3}");
    _fileSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_harshSurgeTitle)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_pinionData));
...
- (void)textMargin
{
    ...
    _imageSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _imageSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{3,3,3,8}") : UIEdgeInsetsFromString(@"{3,8,3,3}");
    _imageSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_harshSurgeTitle)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_pinionData));
...
- (void)misuse
{
    ...
    _locationSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _locationSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{3,3,3,8}") : UIEdgeInsetsFromString(@"{3,8,3,3}");
    _locationSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_harshSurgeTitle)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_pinionData));
...
- (void)touchBase
{
    ...
    _tipSetting = [[ShowClickMessage alloc] initOf:_isRight];
    ...
    UIImage *backgroundImage = [[UIImage imageNamed:StringFromSecondData(kStr_fessText)] resizableImageWithCapInsets:UIEdgeInsetsFromString(StringFromSecondData(kStr_happinessData)) resizingMode:UIImageResizingModeStretch];;
...
- (void)index
{
    ...
    _rtcCallRecordSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _rtcCallRecordSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{9,11,9,15}") : UIEdgeInsetsFromString(@"{9,15,9,9}");
    _rtcCallRecordSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_usefulSnakeValue)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_hotelName));
...
- (void)isTotalerval
{
    ...
    _unsupportSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _unsupportSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{10,10,10,10}") : UIEdgeInsetsFromString(@"{10,10,10,10}");
    _unsupportSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_fenceCondemnValue)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_fenceCondemnValue));
...
- (void)view
{
    ...
    _teamNotificationSetting = [[ShowClickMessage alloc] initOf:_isRight];
...
- (void)smart
{
    ...
    _superTeamNotificationSetting = [[ShowClickMessage alloc] initOf:_isRight];
...
- (void)thoughtImage
{
    ...
    _chatroomNotificationSetting = [[ShowClickMessage alloc] initOf:_isRight];
...
- (void)valueBubble
{
    ...
    _netcallNotificationSetting = [[ShowClickMessage alloc] initOf:_isRight];
    //: _netcallNotificationSetting.contentInsets = _isRight? UIEdgeInsetsFromString(@"{11,11,9,15}") : UIEdgeInsetsFromString(@"{11,15,9,9}");
    _netcallNotificationSetting.contentInsets = _isRight? UIEdgeInsetsFromString(StringFromSecondData(kStr_livingText)) : UIEdgeInsetsFromString(StringFromSecondData(kStr_pursueVersionValue));
...
Byte * SecondDataToCache(Byte *data) {
    int bindLast = data[0];
    int vas = data[1];
    int every = data[2];
    if (!bindLast) return data + every;
    for (int i = 0; i < vas / 2; i++) {
        int begin = every + i;
        int end = every + vas - i - 1;
...
NSString *StringFromSecondData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)SecondDataToCache(data)];
}  

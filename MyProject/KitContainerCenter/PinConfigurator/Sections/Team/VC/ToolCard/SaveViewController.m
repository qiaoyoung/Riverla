...
NSString *StringFromGoodHeData(Byte *data);


//: content
Byte kStr_refugeeFenceTitle[] = {4, 7, 11, 40, 99, 7, 120, 19, 158, 122, 11, 116, 110, 101, 116, 110, 111, 99, 175};


//: team_create_helper_create_failed
Byte kStr_agoTitle[] = {44, 32, 11, 54, 13, 118, 158, 201, 43, 9, 206, 100, 101, 108, 105, 97, 102, 95, 101, 116, 97, 101, 114, 99, 95, 114, 101, 112, 108, 101, 104, 95, 101, 116, 97, 101, 114, 99, 95, 109, 97, 101, 116, 208};


//: title
Byte kStr_earnData[] = {15, 5, 6, 124, 48, 253, 101, 108, 116, 105, 116, 69};


//: icon_add_w
Byte kStr_fabName[] = {85, 10, 4, 81, 119, 95, 100, 100, 97, 95, 110, 111, 99, 105, 230};


//: time
Byte kStr_auctionEmbarrassedContent[] = {29, 4, 6, 157, 151, 225, 101, 109, 105, 116, 237};


//: delete
Byte kStr_candyContent[] = {95, 6, 6, 147, 208, 90, 101, 116, 101, 108, 101, 100, 158};


//: clear_notice
Byte kStr_differValue[] = {65, 12, 3, 101, 99, 105, 116, 111, 110, 95, 114, 97, 101, 108, 99, 36};


//: activity_group_info_group_toast
Byte kStr_chewName[] = {85, 31, 10, 204, 104, 49, 111, 59, 121, 131, 116, 115, 97, 111, 116, 95, 112, 117, 111, 114, 103, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 95, 121, 116, 105, 118, 105, 116, 99, 97, 8};


//: #999999
Byte kStr_thankValue[] = {45, 7, 3, 57, 57, 57, 57, 57, 57, 35, 188};


//: Create_group_announcement
Byte kStr_butterTitle[] = {2, 25, 3, 116, 110, 101, 109, 101, 99, 110, 117, 111, 110, 110, 97, 95, 112, 117, 111, 114, 103, 95, 101, 116, 97, 101, 114, 67, 133};


//: ic_none_announcement
Byte kStr_convictionData[] = {42, 20, 3, 116, 110, 101, 109, 101, 99, 110, 117, 111, 110, 110, 97, 95, 101, 110, 111, 110, 95, 99, 105, 122};


//: back_arrow_bl
Byte kStr_cookTunaName[] = {44, 13, 8, 26, 79, 1, 240, 251, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 235};


//: creator
Byte kStr_conTitle[] = {19, 7, 4, 130, 114, 111, 116, 97, 101, 114, 99, 138};


//: sure_to_clear
Byte kStr_suicideText[] = {27, 13, 3, 114, 97, 101, 108, 99, 95, 111, 116, 95, 101, 114, 117, 115, 147};


//: No_group_announcement
Byte kStr_chocolateName[] = {98, 21, 6, 126, 218, 21, 116, 110, 101, 109, 101, 99, 110, 117, 111, 110, 110, 97, 95, 112, 117, 111, 114, 103, 95, 111, 78, 216};


//: Clean_success
Byte kStr_besidesContent[] = {73, 13, 10, 146, 60, 215, 68, 140, 101, 117, 115, 115, 101, 99, 99, 117, 115, 95, 110, 97, 101, 108, 67, 222};


//: add_noticess
Byte kStr_foodText[] = {91, 12, 3, 115, 115, 101, 99, 105, 116, 111, 110, 95, 100, 100, 97, 81};


//: #F6F7FA
Byte kStr_findingSillData[] = {29, 7, 3, 65, 70, 55, 70, 54, 70, 35, 252};


//: team_create_helper_create_success
Byte kStr_snakeData[] = {89, 33, 9, 181, 95, 133, 125, 127, 32, 115, 115, 101, 99, 99, 117, 115, 95, 101, 116, 97, 101, 114, 99, 95, 114, 101, 112, 108, 101, 104, 95, 101, 116, 97, 101, 114, 99, 95, 109, 97, 101, 116, 174};


//: #FF483D
Byte kStr_heritageText[] = {78, 7, 3, 68, 51, 56, 52, 70, 70, 35, 98};


//: #B391FF
Byte kStr_photographName[] = {93, 7, 9, 129, 88, 21, 176, 220, 87, 70, 70, 49, 57, 51, 66, 35, 221};


//: user_profile_avtivity_edit
Byte kStr_softConsumeText[] = {19, 26, 7, 6, 101, 123, 199, 116, 105, 100, 101, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 101, 108, 105, 102, 111, 114, 112, 95, 114, 101, 115, 117, 106};
...
@interface SaveViewController () <UITableViewDelegate,
...
@property (nonatomic,strong) HouseAt *option;
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor isView:StringFromGoodHeData(kStr_findingSillData)];
    ...
    [backButton setImage:[UIImage imageNamed:StringFromGoodHeData(kStr_cookTunaName)] forState:(UIControlStateNormal)];
    ...
    labtitle.text = [TeamManager sizeKey:StringFromGoodHeData(kStr_chewName)];//群公告
...
- (void)setOption:(HouseAt *)option {
    //: _option = option;
    _option = option;
    //: [self updateAnnouncementsWithContent:option.announcement];
    [self announcementsModifyStreetSmartText:option.announcement];
}

//: - (void)updateAnnouncementsWithContent:(NSString *)content {
- (void)announcementsModifyStreetSmartText:(NSString *)content {
    //: if (content) {
    if (content) {
...
- (void)lengths:(id)sender {
    ...
    PinViewController *vc = [[PinViewController alloc] initWithNibName:nil bundle:nil];
    //: vc.delegate = self;
    vc.delegate = self;
...
- (void)disabling:(id)sender {
    ...
    vc.defaultTitle = [announcement objectForKey:StringFromGoodHeData(kStr_earnData)] ?: @"";
    //: vc.defaultContent = [announcement objectForKey:@"content"] ?: @"";
    vc.defaultContent = [announcement objectForKey:StringFromGoodHeData(kStr_refugeeFenceTitle)] ?: @"";
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)refreshing:(id)sender {
    ...
    [self.groupAlartView at:[TeamManager sizeKey:StringFromGoodHeData(kStr_suicideText)]];
...
//    self.option.team.announcement = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
    ...
    [[NIMSDK sharedSDK].teamManager updateTeamAnnouncement:@"" teamId:wself.option.team.teamId completion:^(NSError *error) {
        ...
        if(!error && wself) {
            ...
            [wself.view makeToast:[TeamManager sizeKey:StringFromGoodHeData(kStr_besidesContent)]];// @"清理成功"
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *content = [announcement objectForKey:StringFromGoodHeData(kStr_refugeeFenceTitle)];

    //: return [FFFTeamAnnouncementListCell cellHeight:content];
    return [ProclamationViewCell title:content];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ProclamationViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ProclamationViewCell"];
    //: if (!cell) {
    if (!cell) {
        ...
        cell = [[ProclamationViewCell alloc] initWithStyle:(UITableViewCellStyleValue1) reuseIdentifier:@"ProclamationViewCell"];
    }
    //: [cell refreshData:announcement nick:_option.nick];
    [cell file:announcement removeStorage:_option.nick];
//
//    ProclamationViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ProclamationViewCell"];
//    [cell refreshData:announcement nick:_option.nick];
    //: return cell;
...
- (void)announcementColor:(NSString *)title content:(NSString *)content {
    ...
    NSDictionary *announcement = @{StringFromGoodHeData(kStr_earnData): title ?: @"",
                                   //: @"content": content ?: @"",
                                   StringFromGoodHeData(kStr_refugeeFenceTitle): content ?: @"",
                                   //: @"creator": [[NIMSDK sharedSDK].loginManager currentAccount],
                                   StringFromGoodHeData(kStr_conTitle): [[NIMSDK sharedSDK].loginManager currentAccount],
                                   //: @"time": @((NSInteger)[NSDate date].timeIntervalSince1970)};
                                   StringFromGoodHeData(kStr_auctionEmbarrassedContent): @((NSInteger)[NSDate date].timeIntervalSince1970)};
    ...
    if ([_delegate respondsToSelector:@selector(frame:off:)]) {
        //: __weak typeof(self) wself = self;
        __weak typeof(self) wself = self;
        //: [_delegate didUpdateAnnouncement:ret completion:^(NSError *error) {
        [_delegate frame:ret off:^(NSError *error) {
            //: [FFFKitProgressHUD dismiss];
            [DiscoverEffectView view];
            //: if(!error) {
            if(!error) {
                //: [wself.view makeToast:[FFFLanguageManager getTextWithKey:@"team_create_helper_create_success"]];
                [wself.view makeToast:[TeamManager sizeKey:StringFromGoodHeData(kStr_snakeData)]];
                //: [wself updateAnnouncementsWithContent:ret];
                [wself announcementsModifyStreetSmartText:ret];
                //: [wself.tableView reloadData];
                [wself.tableView reloadData];
            //: } else {
            } else {
                //: [wself.view makeToast:[FFFLanguageManager getTextWithKey:@"team_create_helper_create_failed"]];
                [wself.view makeToast:[TeamManager sizeKey:StringFromGoodHeData(kStr_agoTitle)]];
            }
        //: }];
        }];
    }
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(15, (44.0f + [UIDevice table])+15, [[UIScreen mainScreen] bounds].size.width-30, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice table])-15-64-(({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom)) style:UITableViewStylePlain];
...
- (UIView *)defView{
    ...
    if(!_defView){
        ...
        _defView = [[UIView alloc]initWithFrame:CGRectMake(0, (44.0f + [UIDevice table]), [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice table]))];
        //: _defView.hidden = YES;
        _defView.hidden = YES;
        ...
        defImg.image = [UIImage imageNamed:StringFromGoodHeData(kStr_convictionData)];
        ...
        emptyTipLabel.textColor = [UIColor isView:StringFromGoodHeData(kStr_thankValue)];
        ...
        emptyTipLabel.text = [TeamManager sizeKey:StringFromGoodHeData(kStr_chocolateName)];
        ...
        if(_option.canCreateAnnouncement) {
            ...
            emptyButton.frame = CGRectMake(15, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice table])-44-(({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom), [[UIScreen mainScreen] bounds].size.width-30, 44);
            ...
            [emptyButton setTitle:[TeamManager sizeKey:StringFromGoodHeData(kStr_butterTitle)] forState:UIControlStateNormal];
            //: [emptyButton setImage:[UIImage imageNamed:@"icon_add_w"] forState:UIControlStateNormal];
            [emptyButton setImage:[UIImage imageNamed:StringFromGoodHeData(kStr_fabName)] forState:UIControlStateNormal];
            //: [emptyButton addTarget:self action:@selector(onCreateAnnouncement:) forControlEvents:UIControlEventTouchUpInside];
            [emptyButton addTarget:self action:@selector(lengths:) forControlEvents:UIControlEventTouchUpInside];
            //: [_defView addSubview:emptyButton];
            [_defView addSubview:emptyButton];
            //: emptyButton.backgroundColor = [UIColor colorWithHexString:@"#B391FF"];
            emptyButton.backgroundColor = [UIColor isView:StringFromGoodHeData(kStr_photographName)];
            ...
            [emptyButton barBackground:(MKButtonEdgeInsetsStyleLeft) by:10];
        }
...
//        _box.layer.shadowRadius = 12;
        ...
        [closeBtn addTarget:self action:@selector(disabling:) forControlEvents:UIControlEventTouchUpInside];
       //: [closeBtn setImage:[UIImage imageNamed:@"add_noticess"] forState:UIControlStateNormal];
       [closeBtn setImage:[UIImage imageNamed:StringFromGoodHeData(kStr_foodText)] forState:UIControlStateNormal];
        //: closeBtn.backgroundColor = [UIColor colorWithHexString:@"#B391FF"];
        closeBtn.backgroundColor = [UIColor isView:StringFromGoodHeData(kStr_photographName)];
        ...
        [closeBtn setTitle:[TeamManager sizeKey:StringFromGoodHeData(kStr_softConsumeText)] forState:UIControlStateNormal];
        //: [closeBtn layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleLeft) imageTitleSpace:10];
        [closeBtn barBackground:(MKButtonEdgeInsetsStyleLeft) by:10];
        ...
        [sureBtn addTarget:self action:@selector(refreshing:) forControlEvents:UIControlEventTouchUpInside];
        //: [sureBtn setImage:[UIImage imageNamed:@"clear_notice"] forState:UIControlStateNormal];
        [sureBtn setImage:[UIImage imageNamed:StringFromGoodHeData(kStr_differValue)] forState:UIControlStateNormal];
        //: sureBtn.backgroundColor = [UIColor colorWithHexString:@"#FF483D"];
        sureBtn.backgroundColor = [UIColor isView:StringFromGoodHeData(kStr_heritageText)];
        ...
        [sureBtn setTitle:[TeamManager sizeKey:StringFromGoodHeData(kStr_candyContent)] forState:UIControlStateNormal];
        //: [sureBtn layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleLeft) imageTitleSpace:10];
        [sureBtn barBackground:(MKButtonEdgeInsetsStyleLeft) by:10];
...
@implementation HouseAt
//: @end
@end

Byte * GoodHeDataToCache(Byte *data) {
    int fileBalloon = data[0];
    int leaAllowOxygen = data[1];
    int perfectCheat = data[2];
    if (!fileBalloon) return data + perfectCheat;
    for (int i = 0; i < leaAllowOxygen / 2; i++) {
        int begin = perfectCheat + i;
        int end = perfectCheat + leaAllowOxygen - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[perfectCheat + leaAllowOxygen] = 0;
    return data + perfectCheat;
}

NSString *StringFromGoodHeData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)GoodHeDataToCache(data)];
}  

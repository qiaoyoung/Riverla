...
@interface BarOriginViewController : UIViewController<ListingInsert,CourseOfActionDelegate,RubricTing,NIMChatManagerDelegate,NIMConversationManagerDelegate,NIMChatExtendManagerDelegate>

//: @property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) UITableView *tableView;

//: @property (nonatomic, strong) FFFInputView *sessionInputView;
@property (nonatomic, strong) CellTingView *sessionInputView;

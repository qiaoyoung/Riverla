...
extern __attribute__((visibility ("default"))) NSString *const let_buttonValue;/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const let_controlVersionData;/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const let_viaValue;/** 即时聊天*/

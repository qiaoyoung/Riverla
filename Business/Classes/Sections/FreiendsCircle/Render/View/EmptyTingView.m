...
- (void)setTinkleProgress:(CGFloat)progress {
...
- (CAShapeLayer *)backgroundLayer {
    ...
    if (!_backgroundLayer) {
        ...
        _backgroundLayer.strokeColor = [UIColor value:0x111226].CGColor;
...
- (CAShapeLayer *)progressLayer {
    ...
    if (!_progressLayer) {
        ...
        _progressLayer.strokeColor = [UIColor value:0x5EC7FE].CGColor;

...
- (FUSlider *)filterSlider {
    if (!_filterSlider) {
        _filterSlider = [[FUSlider alloc] initWithFrame:CGRectMake(20, 16, SCREEN_WIDTH-40, 30)];
...
- (void)setSelected:(BOOL)selected {
    ...
    self.imageView.layer.borderColor = selected ? ThemeColor.CGColor : [UIColor clearColor].CGColor;
    self.textLabel.textColor = selected ? ThemeColor : kTextColor_2c3042;
}

...
- (void)fellow:(AVCaptureSessionPreset)preset untilLibrary:(nullable void (^)(void))handler;
...
- (void)getStarted:(BOOL)front array:(nullable void (^)(void))handler;

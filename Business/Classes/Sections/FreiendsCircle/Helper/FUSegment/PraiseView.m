...
static NSString * const let_pageText = @"FUSegmentedCellIdentifier";

//: @interface FUSegmentedControl ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
@interface PraiseView ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    return [self initWithStartSend:frame loadTing:nil];
}

//: - (instancetype)initWithFrame:(CGRect)frame items:(NSArray<NSString *> *)items {
- (instancetype)initWithStartSend:(CGRect)frame loadTing:(NSArray<NSString *> *)items {
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BuildViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:let_pageText forIndexPath:indexPath];
...
- (BOOL)collectionView:(UICollectionView *)collectionView shouldSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(lats:)]) {
        //: return [self.delegate segmentedControlShouldSelectItemAtIndex:indexPath.item];
        return [self.delegate lats:indexPath.item];
    }
    //: return YES;
    return YES;
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(segmented:)]) {
        //: [self.delegate segmentedControlDidSelectAtIndex:indexPath.item];
        [self.delegate segmented:indexPath.item];
    }
}
...
- (UICollectionView *)segmentedCollection {
    ...
    if (!_segmentedCollection) {
        ...
        [_segmentedCollection registerClass:[BuildViewCell class] forCellWithReuseIdentifier:let_pageText];
    }

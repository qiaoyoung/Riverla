...
@implementation InfoChangePerson
    ...
    if (self)
    {
        ...
        if ([contact isKeyAvailable:CNContactPhoneNumbersKey])
        {
            ...
            for (CNLabeledValue *labeledValue in contact.phoneNumbers)
            {
                ...
                if ([ArtifactColor demonstrateRecord:labeledValue]) {
                    //: NIMContactPhone *phoneModel = [[NIMContactPhone alloc] initWithLabeledValue:labeledValue];
                    ArtifactColor *phoneModel = [[ArtifactColor alloc] initWithRecentValue:labeledValue];
...
- (instancetype)initWithRecentValue:(CNLabeledValue *)labeledValue {
    ...
    if (self)
    {
        ...
        self.phone = [NSString coverLibrary:phoneNumber];
...
+ (BOOL)demonstrateRecord:(CNLabeledValue *)labeledValue {
    ...
    NSString *userful = [NSString coverLibrary:phoneNumber];

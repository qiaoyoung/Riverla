...
NSString *StringFromLastData(Byte *data);


//: data
Byte kStr_willTitle[] = {93, 4, 43, 10, 12, 144, 10, 37, 145, 243, 143, 140, 159, 140, 190};


//: #2C3042
Byte kStr_bubbleValue[] = {91, 7, 79, 4, 114, 129, 146, 130, 127, 131, 129, 88};


//: #EEEEEE
Byte kStr_displayLimitShowData[] = {43, 7, 46, 8, 213, 178, 27, 177, 81, 115, 115, 115, 115, 115, 115, 150};


//: owner
Byte kStr_makeValue[] = {70, 5, 54, 8, 235, 243, 120, 165, 165, 173, 164, 155, 168, 218};


//: tag_activity_set
Byte kStr_ofValue[] = {69, 16, 12, 5, 53, 128, 109, 115, 107, 109, 111, 128, 117, 130, 117, 128, 133, 107, 127, 113, 128, 19};


//: type
Byte kStr_spaceStopText[] = {33, 4, 95, 7, 95, 113, 81, 211, 216, 207, 196, 6};


//: #B391FF
Byte kStr_redName[] = {59, 7, 80, 13, 174, 188, 116, 64, 18, 25, 78, 80, 48, 115, 146, 131, 137, 129, 150, 150, 58};


//: /group/
Byte kStr_frameData[] = {50, 7, 12, 5, 74, 59, 115, 126, 123, 129, 124, 59, 69};


//: contact_add_friend
Byte kStr_imageData[] = {83, 18, 95, 4, 194, 206, 205, 211, 192, 194, 211, 190, 192, 195, 195, 190, 197, 209, 200, 196, 205, 195, 83};


//: #5D5F66
Byte kStr_tapChildData[] = {16, 7, 78, 11, 218, 22, 94, 75, 183, 15, 37, 113, 131, 146, 131, 148, 132, 132, 150};


//: #F7D2F3
Byte kStr_modelContent[] = {47, 7, 93, 8, 138, 98, 187, 186, 128, 163, 148, 161, 143, 163, 144, 186};


//: #999999
Byte kStr_imageTitle[] = {47, 7, 73, 4, 108, 130, 130, 130, 130, 130, 130, 171};


//: code
Byte kStr_blueData[] = {43, 4, 13, 5, 152, 112, 124, 113, 114, 242};


//: add_friend_activity_add_friend
Byte kStr_kitText[] = {49, 30, 72, 6, 7, 253, 169, 172, 172, 167, 174, 186, 177, 173, 182, 172, 167, 169, 171, 188, 177, 190, 177, 188, 193, 167, 169, 172, 172, 167, 174, 186, 177, 173, 182, 172, 10};


//: E3F4AA
Byte kStr_tapName[] = {45, 6, 74, 9, 190, 142, 175, 172, 237, 143, 125, 144, 126, 139, 139, 247};


//: contact_fragment_friend
Byte kStr_spaceBarText[] = {25, 23, 30, 7, 214, 160, 122, 129, 141, 140, 146, 127, 129, 146, 125, 132, 144, 127, 133, 139, 131, 140, 146, 125, 132, 144, 135, 131, 140, 130, 43};


//: jpg
Byte kStr_spaceData[] = {96, 3, 57, 7, 227, 31, 151, 163, 169, 160, 241};


//: #F6F6F6
Byte kStr_checkData[] = {60, 7, 76, 14, 33, 157, 183, 19, 70, 89, 11, 211, 234, 214, 111, 146, 130, 146, 130, 146, 130, 207};


//: invite_you_group
Byte kStr_viewValue[] = {32, 16, 34, 6, 172, 131, 139, 144, 152, 139, 150, 135, 129, 155, 145, 151, 129, 137, 148, 145, 151, 146, 197};


//: activity_create_group_name_create_group
Byte kStr_ofData[] = {73, 39, 42, 4, 139, 141, 158, 147, 160, 147, 158, 163, 137, 141, 156, 143, 139, 158, 143, 137, 145, 156, 153, 159, 154, 137, 152, 139, 151, 143, 137, 141, 156, 143, 139, 158, 143, 137, 145, 156, 153, 159, 154, 143};


//: group_info_activity_without
Byte kStr_onName[] = {86, 27, 65, 9, 41, 245, 170, 49, 213, 168, 179, 176, 182, 177, 160, 170, 175, 167, 176, 160, 162, 164, 181, 170, 183, 170, 181, 186, 160, 184, 170, 181, 169, 176, 182, 181, 18};


//: name
Byte kStr_pressValue[] = {30, 4, 31, 6, 147, 58, 141, 128, 140, 132, 199};


//: team_create_helper_create_failed
Byte kStr_withValue[] = {77, 32, 59, 8, 170, 121, 23, 22, 175, 160, 156, 168, 154, 158, 173, 160, 156, 175, 160, 154, 163, 160, 167, 171, 160, 173, 154, 158, 173, 160, 156, 175, 160, 154, 161, 156, 164, 167, 160, 159, 223};


//: #CCECFC
Byte kStr_lastTitle[] = {99, 7, 60, 10, 200, 85, 11, 240, 175, 248, 95, 127, 127, 129, 127, 130, 127, 145};


//: notification
Byte kStr_kitTitle[] = {74, 12, 52, 11, 75, 61, 80, 101, 58, 83, 117, 162, 163, 168, 157, 154, 157, 151, 149, 168, 157, 163, 162, 242};


//: user_id
Byte kStr_ofWindowName[] = {83, 7, 57, 4, 174, 172, 158, 171, 152, 162, 157, 54};


//: tname
Byte kStr_languageTitle[] = {51, 5, 7, 12, 182, 22, 213, 50, 172, 195, 156, 228, 123, 117, 104, 116, 108, 163};


//: ids
Byte kStr_addShouldInfoContent[] = {31, 3, 79, 9, 60, 122, 138, 241, 79, 184, 179, 194, 16};


//: contact_group
Byte kStr_colorDisplayTitle[] = {86, 13, 76, 6, 220, 144, 175, 187, 186, 192, 173, 175, 192, 171, 179, 190, 187, 193, 188, 47};


//: contact_notice
Byte kStr_enableName[] = {92, 14, 17, 13, 206, 56, 36, 61, 112, 130, 125, 237, 207, 116, 128, 127, 133, 114, 116, 133, 112, 127, 128, 133, 122, 116, 118, 165};


//: contact_tag_fragment_friend
Byte kStr_toInfoName[] = {2, 27, 9, 14, 23, 2, 228, 11, 181, 246, 139, 104, 251, 185, 108, 120, 119, 125, 106, 108, 125, 104, 125, 106, 112, 104, 111, 123, 106, 112, 118, 110, 119, 125, 104, 111, 123, 114, 110, 119, 109, 39};


//: /team/create
Byte kStr_toData[] = {79, 12, 62, 4, 109, 178, 163, 159, 171, 109, 161, 176, 163, 159, 178, 163, 192};


//: ic_none_ContactList
Byte kStr_makeTitle[] = {59, 19, 58, 6, 166, 32, 163, 157, 153, 168, 169, 168, 159, 153, 125, 169, 168, 174, 155, 157, 174, 134, 163, 173, 174, 252};


//: setting_privacy_camera
Byte kStr_messageName[] = {33, 22, 67, 10, 104, 100, 1, 209, 89, 145, 182, 168, 183, 183, 172, 177, 170, 162, 179, 181, 172, 185, 164, 166, 188, 162, 166, 164, 176, 168, 181, 164, 51};


//: tid
Byte kStr_securityTitle[] = {89, 3, 35, 5, 145, 151, 140, 135, 63};


//: contact_fragment_group
Byte kStr_tingText[] = {63, 22, 15, 12, 80, 182, 188, 214, 117, 171, 58, 47, 114, 126, 125, 131, 112, 114, 131, 110, 117, 129, 112, 118, 124, 116, 125, 131, 110, 118, 129, 126, 132, 127, 125};


//: warm_prompt
Byte kStr_nameLimitText[] = {20, 11, 86, 4, 205, 183, 200, 195, 181, 198, 200, 197, 195, 198, 202, 203};


//: user_info_avtivity_upload_avatar_failed
Byte kStr_languageData[] = {23, 39, 51, 5, 149, 168, 166, 152, 165, 146, 156, 161, 153, 162, 146, 148, 169, 167, 156, 169, 156, 167, 172, 146, 168, 163, 159, 162, 148, 151, 146, 148, 169, 148, 167, 148, 165, 146, 153, 148, 156, 159, 152, 151, 27};


//: contact_tag_fragment_cancel
Byte kStr_stopName[] = {66, 27, 23, 13, 4, 122, 79, 147, 232, 162, 215, 220, 27, 122, 134, 133, 139, 120, 122, 139, 118, 139, 120, 126, 118, 125, 137, 120, 126, 132, 124, 133, 139, 118, 122, 120, 133, 122, 124, 131, 31};
...
LanguageCell> {
    ...
    CradleDataCollection *_contacts;
}
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.advancedTeamArray = [self item];
...
- (void)viewDidLoad {
    ...
    if ([self.tableView respondsToSelector:@selector(setSectionIndexColor:)]) {
        ...
        self.tableView.sectionIndexColor = [UIColor isView:StringFromLastData(kStr_bubbleValue)]; // 索引文字颜色
...
- (UIView *)defView{
    ...
    if(!_defView){
        ...
        _defView = [[UIView alloc]initWithFrame:CGRectMake(0, [UIDevice table]+140, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-[UIDevice table]-140-(49.0f))];
...
//        _defView.hidden = YES;
        ...
        defImg.image = [UIImage imageNamed:StringFromLastData(kStr_makeTitle)];
        ...
        emptyTipLabel.textColor = [UIColor isView:StringFromLastData(kStr_imageTitle)];
        ...
        emptyTipLabel.text = [TeamManager sizeKey:StringFromLastData(kStr_onName)];
...
-(void)rawData{
    ...
    [InfoManager enable:[NSString stringWithFormat:StringFromLastData(kStr_frameData)] sub:nil record:NO tapGetFailed:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict speedy:StringFromLastData(kStr_blueData)];
        ...
        if (code.integerValue == 0) {
            ...
            for (NIMUser *user in friendList) {
                ...
                NSDictionary *dict = [NSDictionary dictionaryWithObject:user.userId forKey:StringFromLastData(kStr_ofWindowName)];
            ...
            [myfriend setObject:[TeamManager sizeKey:StringFromLastData(kStr_toInfoName)] forKey:StringFromLastData(kStr_pressValue)];
            //: [myfriend setObject:friendIds forKey:@"ids"];
            [myfriend setObject:friendIds forKey:StringFromLastData(kStr_addShouldInfoContent)];
            ...
            NSArray *data = [resultDict parent:StringFromLastData(kStr_willTitle)];
...
- (void)colorInfo
{
    ...
    UIView *navView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [UIDevice table]+132)];
    ...
    UIView *topview = [[UIView alloc]initWithFrame:CGRectMake(15, [UIDevice table]+8, [[UIScreen mainScreen] bounds].size.width-30, 48)];
    //: topview.backgroundColor = [UIColor colorWithHexString:@"#F6F6F6"];
    topview.backgroundColor = [UIColor isView:StringFromLastData(kStr_checkData)];
    ...
    _btnfriend.backgroundColor = [UIColor isView:StringFromLastData(kStr_redName)];
    ...
    [_btnfriend setTitle:[TeamManager sizeKey:StringFromLastData(kStr_spaceBarText)] forState:UIControlStateNormal];
    ...
    [_btngroup setTitleColor:[UIColor isView:StringFromLastData(kStr_tapChildData)] forState:UIControlStateNormal];
    //: [_btngroup setTitle:[FFFLanguageManager getTextWithKey:@"contact_fragment_group"] forState:UIControlStateNormal];
    [_btngroup setTitle:[TeamManager sizeKey:StringFromLastData(kStr_tingText)] forState:UIControlStateNormal];
    ...
    lineview.backgroundColor = [UIColor isView:StringFromLastData(kStr_displayLimitShowData)];
...
- (void)sessionDate
{
    ...
    SystemViewController *vc = [[SystemViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)doingDistance{
    ...
    _contacts = [[CradleDataCollection alloc] init];
}
...
-(void)changeTeam:(NSString *)teamID storage:(NSString *)teamName saveTop:(NSString *)type{
    //: NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"owner"] = currentUserId;
    dict[StringFromLastData(kStr_makeValue)] = currentUserId;
    //: dict[@"type"] = type;
    dict[StringFromLastData(kStr_spaceStopText)] = type;
    //: dict[@"tname"] = teamName;
    dict[StringFromLastData(kStr_languageTitle)] = teamName;
    //: dict[@"tid"] = teamID;
    dict[StringFromLastData(kStr_securityTitle)] = teamID;

}

//: - (void)searchAction:(id)sender {
- (void)formatTitle:(id)sender {
    //: NTESContactSearchViewController *vc = [[NTESContactSearchViewController alloc] init];
    ContainerRecentTableViewController *vc = [[ContainerRecentTableViewController alloc] init];
    //: vc.delegate = self;
    vc.delegate = self;
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_sliderIndex <= 0) {
        ...
        if ([contactItem respondsToSelector:@selector(findObject)] && [contactItem findObject].length) {
            //: SEL sel = NSSelectorFromString([contactItem selName]);
            SEL sel = NSSelectorFromString([contactItem findObject]);
    ...
    //: }else{
        ...
        NIMSession *session = [self littleness:team];
        //: if (session) {
        if (session) {
            //: NTESSessionViewController *vc = [[NTESSessionViewController alloc] initWithSession:session];
            SelectChildViewController *vc = [[SelectChildViewController alloc] initWithScale:session];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
//    id<CornerTeam> contactItem = (id<CornerTeam>)[_contacts memberOfIndex:indexPath];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    if (_sliderIndex <= 0) {
        ...
        return [_contacts prolusionComment:section];
    //: }else{
    }else{
        //: return 1;
        return 1;
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (_sliderIndex == 0) {
           ...
           label.text = [_contacts parameter:section];
           //: label.font = [UIFont systemFontOfSize:16];
           label.font = [UIFont systemFontOfSize:16];
           //: label.textColor = [UIColor colorWithHexString:@"#2C3042"];
           label.textColor = [UIColor isView:StringFromLastData(kStr_bubbleValue)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_sliderIndex <= 0) {
        ...
        id contactItem = [_contacts magnitudeervalOf:indexPath];
        //: [cell refreshUser:contactItem];
        [cell color:contactItem];
    //: }else{
    }else{
...
- (NSString*)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{
    ...
    if (_sliderIndex <= 0) {
        ...
        return [_contacts parameter:section];
    //: }else{
    }else{
        //: return @"";
        return @"";
...
- (void)to:(ContactSelectFinishBlock) block{
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, [UIDevice table]+64, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-[UIDevice table]-64-(49.0f)) style:UITableViewStyleGrouped];
...
-(void)searchedText{
    ...
    CellViewController *vc = [[CellViewController alloc] initWithNibName:nil bundle:nil];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
...
-(void)backgroundTitle{
    ...
    [self to:^(NSArray *uids, NSString *name, UIImage *avater) {
        @
        ...
        [self track:avater parentQuery:^(NSString *urlString) {
            ...
            option.postscript = [TeamManager sizeKey:StringFromLastData(kStr_viewValue)];
//            [SVProgressHUD show];
...
//                [SVProgressHUD dismiss];
                ...
                if (!error) {
                    ...
                    [self changeTeam:teamId storage:option.name saveTop:@"1"];
                    //: [self newGroupSyncRequest:option.name teamID:teamId];
                    [self index:option.name item:teamId];
                //: }else{
                }else{
                    ...
                    [self.view makeToast:[TeamManager sizeKey:StringFromLastData(kStr_withValue)] duration:2.0 position:CSToastPositionCenter];
                }
            //: }];
            }];
        //: }];
...
- (void)track:(UIImage *)image parentQuery:(void(^)(NSString *urlString ))complete {
    ...
    NSString *fileName = [WithHelper value:StringFromLastData(kStr_spaceData)];
    ...
    if (success) {
        ...
        //: } completion:^(NSString * _Nullable urlString, NSError * _Nullable error) {
            ...
            //: }else{
                ...
                [wself.view makeToast:[TeamManager sizeKey:StringFromLastData(kStr_languageData)]
                             //: duration:2
                             duration:2
    ...
    //: }else{
        ...
        [self.view makeToast:[TeamManager sizeKey:StringFromLastData(kStr_languageData)]
                    //: duration:2
                    duration:2
                    //: position:CSToastPositionCenter];
                    position:CSToastPositionCenter];
...
-(void)index:(NSString *)groupName item:(NSString *)teamId{
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"name"] = groupName;
    dict[StringFromLastData(kStr_pressValue)] = groupName;
    //: dict[@"id"] = teamId;
    dict[@"id"] = teamId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/team/create"] params:dict isShow:NO success:^(id responseObject) {
    [InfoManager enable:[NSString stringWithFormat:StringFromLastData(kStr_toData)] sub:dict record:NO tapGetFailed:^(id responseObject) {
...
-(void)fromsed:(UIButton *)sender
{
    ...
    //: }else if (sender == self.btngroup){
        ...
        _btngroup.backgroundColor = [UIColor isView:StringFromLastData(kStr_redName)];
        ...
        [_btnfriend setTitleColor:[UIColor isView:StringFromLastData(kStr_tapChildData)] forState:UIControlStateNormal];
...
//        }
        ...
        UIAlertController *alertControl = [UIAlertController alertControllerWithTitle:[TeamManager sizeKey:StringFromLastData(kStr_nameLimitText)] message:[TeamManager sizeKey:StringFromLastData(kStr_messageName)] preferredStyle:UIAlertControllerStyleAlert];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[TeamManager sizeKey:StringFromLastData(kStr_stopName)] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        //: }])];
        }])];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[TeamManager sizeKey:StringFromLastData(kStr_ofValue)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            //: NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            //: if( [[UIApplication sharedApplication] canOpenURL:url]) {
            if( [[UIApplication sharedApplication] canOpenURL:url]) {
...
-(void)plumb{
    ...
    [wself to:^(NSArray *uids, NSString *groupName, UIImage *avater) {
        //: NSArray *members = [@[currentUserId] arrayByAddingObjectsFromArray:uids];
        NSArray *members = [@[currentUserId] arrayByAddingObjectsFromArray:uids];
        //: NIMCreateTeamOption *option = [[NIMCreateTeamOption alloc] init];
        NIMCreateTeamOption *option = [[NIMCreateTeamOption alloc] init];
        ...
        [[NIMSDK sharedSDK].teamManager createTeam:option users:members completion:^(NSError *error, NSString *teamId, NSArray<NSString *> * _Nullable failedUserIds) {
            ...
            if (!error) {
                ...
                [wself index:option.name item:teamId];
            //: }else{
            }else{
                ...
                [wself.view makeToast:[TeamManager sizeKey:StringFromLastData(kStr_withValue)] duration:2.0 position:CSToastPositionCenter];
            }
        //: }];
        }];
    //: }];
...
- (UIView *)friendheaderView
{
    ...
    if (!_friendheaderView) {
        ...
        editView.backgroundColor = [UIColor isView:StringFromLastData(kStr_modelContent)];
        ...
        UITapGestureRecognizer *singleTap1 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(sessionDate)];
        ...
        editimg.image = [UIImage imageNamed:StringFromLastData(kStr_enableName)];
        ...
        labedit.textColor = [UIColor isView:StringFromLastData(kStr_bubbleValue)];
        //: labedit.text = [FFFLanguageManager getTextWithKey:@"notification"];
        labedit.text = [TeamManager sizeKey:StringFromLastData(kStr_kitTitle)];
        ...
        langView.backgroundColor = [UIColor isView:StringFromLastData(kStr_tapName)];
        ...
        UITapGestureRecognizer *singleTap2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(searchedText)];
        ...
        langimg.image = [UIImage imageNamed:StringFromLastData(kStr_imageData)];
        ...
        lablang.textColor = [UIColor isView:StringFromLastData(kStr_bubbleValue)];
        //: lablang.text = [FFFLanguageManager getTextWithKey:@"add_friend_activity_add_friend"];
        lablang.text = [TeamManager sizeKey:StringFromLastData(kStr_kitText)];
...
- (UIView *)groupheaderView
{
    ...
    if (!_groupheaderView) {
        ...
        langView.backgroundColor = [UIColor isView:StringFromLastData(kStr_lastTitle)];
        //: langView.layer.cornerRadius = 12;
        langView.layer.cornerRadius = 12;
        ...
        UITapGestureRecognizer *singleTap2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(backgroundTitle)];
        //: [langView addGestureRecognizer:singleTap2];
        [langView addGestureRecognizer:singleTap2];
        //: UIImageView *langimg = [[UIImageView alloc]initWithFrame:CGRectMake(width2-165, 0, 165, 52)];
        UIImageView *langimg = [[UIImageView alloc]initWithFrame:CGRectMake(width2-165, 0, 165, 52)];
        //: langimg.image = [UIImage imageNamed:@"contact_group"];
        langimg.image = [UIImage imageNamed:StringFromLastData(kStr_colorDisplayTitle)];
        //: [langView addSubview:langimg];
        [langView addSubview:langimg];
        //: UILabel *lablang = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, width2-30, 52)];
        UILabel *lablang = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, width2-30, 52)];
        ...
        lablang.text = [TeamManager sizeKey:StringFromLastData(kStr_ofData)];
        //: [langView addSubview:lablang];
        [langView addSubview:lablang];
    }
...
Byte * LastDataToCache(Byte *data) {
    int should = data[0];
    int point = data[1];
    Byte key = data[2];
    int image = data[3];
    if (!should) return data + image;
    for (int i = image; i < image + point; i++) {
...
NSString *StringFromLastData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)LastDataToCache(data)];
}

...
NSString *StringFromGreenData(Byte *data);


//: #8A8E98
Byte kStr_likeData[] = {8, 7, 13, 58, 187, 19, 9, 202, 21, 68, 44, 88, 11, 56, 57, 69, 56, 65, 56, 35, 185};


//: data
Byte kStr_likeValue[] = {1, 4, 5, 157, 95, 97, 116, 97, 100, 9};


//: icon_me_arrow
Byte kStr_basicallyName[] = {53, 13, 10, 156, 234, 21, 193, 127, 55, 200, 119, 111, 114, 114, 97, 95, 101, 109, 95, 110, 111, 99, 105, 109};


//: 移出本群
Byte kStr_againText[] = {37, 12, 5, 213, 127, 164, 190, 231, 172, 156, 230, 186, 135, 229, 187, 167, 231, 24};


//: #F6F7FA
Byte kStr_uponData[] = {28, 7, 11, 156, 252, 27, 8, 186, 77, 88, 88, 65, 70, 55, 70, 54, 70, 35, 102};


//: personcart_profile_bg
Byte kStr_shamViewPowderName[] = {62, 21, 9, 158, 170, 201, 50, 42, 187, 103, 98, 95, 101, 108, 105, 102, 111, 114, 112, 95, 116, 114, 97, 99, 110, 111, 115, 114, 101, 112, 202};


//: activity_group_member_info2_inviter
Byte kStr_planHarvestName[] = {77, 35, 3, 114, 101, 116, 105, 118, 110, 105, 95, 50, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 95, 121, 116, 105, 118, 105, 116, 99, 97, 81};


//: #ECECEC
Byte kStr_expectationShouldValue[] = {96, 7, 13, 51, 67, 171, 1, 230, 28, 212, 143, 96, 197, 67, 69, 67, 69, 67, 69, 35, 188};


//: /user/detail
Byte kStr_contentEcologicalValue[] = {3, 12, 6, 16, 205, 126, 108, 105, 97, 116, 101, 100, 47, 114, 101, 115, 117, 47, 105};


//: code
Byte kStr_cheatFaintChapterData[] = {76, 4, 3, 101, 100, 111, 99, 72};


//: personCard_bg
Byte kStr_meteRelativelyName[] = {91, 13, 5, 58, 211, 103, 98, 95, 100, 114, 97, 67, 110, 111, 115, 114, 101, 112, 176};


//: group_member_info_activity_mute_msg
Byte kStr_possessionUserShouldData[] = {11, 35, 11, 224, 32, 138, 48, 132, 7, 247, 4, 103, 115, 109, 95, 101, 116, 117, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 228};


//: ic_sex_woman
Byte kStr_afraidValue[] = {89, 12, 8, 237, 255, 67, 62, 97, 110, 97, 109, 111, 119, 95, 120, 101, 115, 95, 99, 105, 198};


//: #2C3042
Byte kStr_sheOptionContent[] = {60, 7, 3, 50, 52, 48, 51, 67, 50, 35, 87};


//: #ffffff
Byte kStr_someoneTitle[] = {94, 7, 7, 227, 19, 232, 136, 102, 102, 102, 102, 102, 102, 35, 157};


//: activity_group_member_info2_shenfen
Byte kStr_consumerData[] = {96, 35, 13, 120, 74, 228, 247, 37, 168, 2, 191, 180, 179, 110, 101, 102, 110, 101, 104, 115, 95, 50, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 95, 121, 116, 105, 118, 105, 116, 99, 97, 9};


//: #EEEEEE
Byte kStr_mannerName[] = {7, 7, 10, 135, 247, 40, 158, 230, 212, 150, 69, 69, 69, 69, 69, 69, 35, 51};


//: ic_identity_authentication
Byte kStr_specialTitle[] = {54, 26, 10, 113, 246, 222, 42, 127, 76, 183, 110, 111, 105, 116, 97, 99, 105, 116, 110, 101, 104, 116, 117, 97, 95, 121, 116, 105, 116, 110, 101, 100, 105, 95, 99, 105, 55};


//: ic_sex_man
Byte kStr_homelandText[] = {2, 10, 13, 8, 146, 213, 103, 163, 40, 120, 17, 40, 126, 110, 97, 109, 95, 120, 101, 115, 95, 99, 105, 172};


//: #FF483D
Byte kStr_monthlyName[] = {34, 7, 9, 74, 224, 51, 63, 172, 34, 68, 51, 56, 52, 70, 70, 35, 185};


//: account
Byte kStr_gradualTitle[] = {36, 7, 5, 158, 95, 116, 110, 117, 111, 99, 99, 97, 110};


//: back_arrow_bl
Byte kStr_dependingKitTitle[] = {43, 13, 7, 7, 194, 103, 199, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 203};


//: head_default
Byte kStr_authorizeTitle[] = {91, 12, 11, 200, 225, 47, 49, 119, 61, 105, 56, 116, 108, 117, 97, 102, 101, 100, 95, 100, 97, 101, 104, 226};


//: ic_invite
Byte kStr_standingTitle[] = {73, 9, 8, 61, 125, 28, 129, 113, 101, 116, 105, 118, 110, 105, 95, 99, 105, 163};


//: ic_card_edit
Byte kStr_earthName[] = {88, 12, 3, 116, 105, 100, 101, 95, 100, 114, 97, 99, 95, 99, 105, 91};


//: modify_activity_modify_success
Byte kStr_plungeValue[] = {16, 30, 3, 115, 115, 101, 99, 99, 117, 115, 95, 121, 102, 105, 100, 111, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 121, 102, 105, 100, 111, 109, 110};


//: #B391FF
Byte kStr_weakenChildValue[] = {35, 7, 4, 56, 70, 70, 49, 57, 51, 66, 35, 77};


//: user_id
Byte kStr_lungLikeMeteContent[] = {60, 7, 10, 4, 209, 34, 175, 170, 62, 101, 100, 105, 95, 114, 101, 115, 117, 46};


//: ic_group_lists
Byte kStr_dateStareName[] = {11, 14, 11, 151, 248, 220, 122, 251, 8, 36, 25, 115, 116, 115, 105, 108, 95, 112, 117, 111, 114, 103, 95, 99, 105, 94};


//: group_info_activity_op_failed
Byte kStr_expectationName[] = {56, 29, 4, 13, 100, 101, 108, 105, 97, 102, 95, 112, 111, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 96};


//: 本地不存在
Byte kStr_entryRefugeeText[] = {74, 15, 6, 26, 71, 20, 168, 156, 229, 152, 173, 229, 141, 184, 228, 176, 156, 229, 172, 156, 230, 207};


//: message_remark_name
Byte kStr_lightningContent[] = {79, 19, 11, 98, 5, 158, 76, 30, 117, 175, 41, 101, 109, 97, 110, 95, 107, 114, 97, 109, 101, 114, 95, 101, 103, 97, 115, 115, 101, 109, 195};
...
@interface LittleLeagueTeamViewController ()<NIMUserManagerDelegate>
...
@implementation LittleLeagueTeamViewController
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor isView:StringFromGreenData(kStr_uponData)];
...
//    [self refresh];
    ...
    dict[StringFromGreenData(kStr_lungLikeMeteContent)] = self.memberId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [InfoManager enable:[NSString stringWithFormat:StringFromGreenData(kStr_contentEcologicalValue)] sub:dict record:NO tapGetFailed:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict speedy:StringFromGreenData(kStr_cheatFaintChapterData)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict straddle:StringFromGreenData(kStr_likeValue)];
            //: self.userAcount = [data newStringValueForKey:@"account"];
            self.userAcount = [data speedy:StringFromGreenData(kStr_gradualTitle)];
...
- (void)tutorials:(UISwitch *)switcher
{
    ...
    [[NIMSDK sharedSDK].teamManager updateMuteState:mute
        ...
        if (!error) {
            ...
            msg = [TeamManager sizeKey:StringFromGreenData(kStr_plungeValue)];
        //: }else{
        }else{
            //: msg = [FFFLanguageManager getTextWithKey:@"group_info_activity_op_failed"];
            msg = [TeamManager sizeKey:StringFromGreenData(kStr_expectationName)];
            //: switcher.on = !mute;
            switcher.on = !mute;
        }
...
- (UIView *)userView
{
    ...
    if(!_userView){
        ...
        Bg.image = [UIImage imageNamed:StringFromGreenData(kStr_meteRelativelyName)];
        ...
        UIImageView *userBg = [[UIImageView alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-345)/2, [UIDevice table]+44+20, 345, 140)];
        //: userBg.image = [UIImage imageNamed:@"personcart_profile_bg"];
        userBg.image = [UIImage imageNamed:StringFromGreenData(kStr_shamViewPowderName)];
        ...
        [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromGreenData(kStr_authorizeTitle)]];
        ...
        if (self.user.userInfo.gender == NIMUserGenderMale) {
            ...
            sexImg.image = [UIImage imageNamed:StringFromGreenData(kStr_homelandText)];
        //: }else if (self.user.userInfo.gender == NIMUserGenderFemale){
        }else if (self.user.userInfo.gender == NIMUserGenderFemale){
            //: sexImg.image = [UIImage imageNamed:@"ic_sex_woman"];
            sexImg.image = [UIImage imageNamed:StringFromGreenData(kStr_afraidValue)];
        }
...
//        self.accountId.backgroundColor = RGB_COLOR_String(@"#FDF4C9");
        ...
        self.accountId.textColor = [UIColor isView:StringFromGreenData(kStr_sheOptionContent)];
        ...
        [self.closeBtn setImage:[UIImage imageNamed:StringFromGreenData(kStr_dependingKitTitle)] forState:(UIControlStateNormal)];
...
- (UIView *)personView
{
    ...
    if(!_personView){
        ...
        UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(applicationNick)];
        ...
        pic1.image = [UIImage imageNamed:StringFromGreenData(kStr_earthName)];
        ...
        self.labTitleRemark.textColor = [UIColor isView:StringFromGreenData(kStr_sheOptionContent)];
        //: self.labTitleRemark.text = [FFFLanguageManager getTextWithKey:@"message_remark_name"];
        self.labTitleRemark.text = [TeamManager sizeKey:StringFromGreenData(kStr_lightningContent)];
        ...
        self.labRemark.textColor = [UIColor isView:StringFromGreenData(kStr_likeData)];
        ...
        arrow.image = [UIImage imageNamed:StringFromGreenData(kStr_basicallyName)];
        ...
        line1.backgroundColor = [UIColor isView:StringFromGreenData(kStr_expectationShouldValue)];
        ...
        icon2.image = [UIImage imageNamed:StringFromGreenData(kStr_specialTitle)];
        ...
        lab2.textColor = [UIColor isView:StringFromGreenData(kStr_sheOptionContent)];
        //: lab2.text = [FFFLanguageManager getTextWithKey:@"activity_group_member_info2_shenfen"];
        lab2.text = [TeamManager sizeKey:StringFromGreenData(kStr_consumerData)];
        ...
        sublab2.textColor = [UIColor isView:StringFromGreenData(kStr_weakenChildValue)];
        //: sublab2.text = [FFFTeamHelper memberTypeText:self.member.type];
        sublab2.text = [ScaleHelper member:self.member.type];
        ...
        arrow2.image = [UIImage imageNamed:StringFromGreenData(kStr_basicallyName)];
        ...
        line2.backgroundColor = [UIColor isView:StringFromGreenData(kStr_expectationShouldValue)];
        ...
        icon3.image = [UIImage imageNamed:StringFromGreenData(kStr_standingTitle)];
        ...
        lab3.textColor = [UIColor isView:StringFromGreenData(kStr_sheOptionContent)];
        //: lab3.text = [FFFLanguageManager getTextWithKey:@"activity_group_member_info2_inviter"];
        lab3.text = [TeamManager sizeKey:StringFromGreenData(kStr_planHarvestName)];
        ...
        sublab3.textColor = [UIColor isView:StringFromGreenData(kStr_weakenChildValue)];
        //: sublab3.text = _member.inviterAccid ? (_member.inviterAccid.length ? _member.inviterAccid : _member.userId) : @"本地不存在".nim_localized;
        sublab3.text = _member.inviterAccid ? (_member.inviterAccid.length ? _member.inviterAccid : _member.userId) : StringFromGreenData(kStr_entryRefugeeText).positionMenu;
        ...
        arrow3.image = [UIImage imageNamed:StringFromGreenData(kStr_basicallyName)];
        ...
        line3.backgroundColor = [UIColor isView:StringFromGreenData(kStr_expectationShouldValue)];
        ...
        icon4.image = [UIImage imageNamed:StringFromGreenData(kStr_dateStareName)];
        ...
        lab4.textColor = [UIColor isView:StringFromGreenData(kStr_sheOptionContent)];
        //: lab4.text = [FFFLanguageManager getTextWithKey:@"group_member_info_activity_mute_msg"];
        lab4.text = [TeamManager sizeKey:StringFromGreenData(kStr_possessionUserShouldData)];
        ...
        [pushSwitch setOnTintColor: [UIColor isView:StringFromGreenData(kStr_weakenChildValue)]];
        //: [pushSwitch addTarget:self action:@selector(updateMute:) forControlEvents:UIControlEventValueChanged];
        [pushSwitch addTarget:self action:@selector(tutorials:) forControlEvents:UIControlEventValueChanged];
        ...
        if(canEdit){
            ...
            [self.btnDelete setTitleColor:[UIColor isView:StringFromGreenData(kStr_monthlyName)] forState:UIControlStateNormal];
            //: [self.btnDelete setTitle:@"移出本群".nim_localized forState:UIControlStateNormal];
            [self.btnDelete setTitle:StringFromGreenData(kStr_againText).positionMenu forState:UIControlStateNormal];
            //: [self.btnDelete addTarget:self action:@selector(removeMember) forControlEvents:UIControlEventTouchUpInside];
            [self.btnDelete addTarget:self action:@selector(loadManager) forControlEvents:UIControlEventTouchUpInside];
            //: self.btnDelete.backgroundColor = [UIColor colorWithHexString:@"#ffffff"];
            self.btnDelete.backgroundColor = [UIColor isView:StringFromGreenData(kStr_someoneTitle)];
            //: self.btnDelete.layer.borderWidth = 1;
            self.btnDelete.layer.borderWidth = 1;
            //: self.btnDelete.layer.borderColor = [UIColor colorWithHexString:@"#EEEEEE"].CGColor;
            self.btnDelete.layer.borderColor = [UIColor isView:StringFromGreenData(kStr_mannerName)].CGColor;
...
Byte * GreenDataToCache(Byte *data) {
    int avoidOpen = data[0];
    int sheWeed = data[1];
    int productiveness = data[2];
    if (!avoidOpen) return data + productiveness;
    for (int i = 0; i < sheWeed / 2; i++) {
        int begin = productiveness + i;
        int end = productiveness + sheWeed - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[productiveness + sheWeed] = 0;
    return data + productiveness;
}

NSString *StringFromGreenData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)GreenDataToCache(data)];
}  

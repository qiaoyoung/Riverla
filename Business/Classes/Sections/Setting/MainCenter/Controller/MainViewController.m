...
NSString *StringFromPowderData(Byte *data);


//: Slovenija
Byte kStr_inquiryTitle[] = {62, 9, 3, 97, 106, 105, 110, 101, 118, 111, 108, 83, 104};


//: hant
Byte kStr_direName[] = {72, 4, 6, 82, 14, 154, 116, 110, 97, 104, 108};


//: edit_profile
Byte kStr_bluePowderValue[] = {75, 12, 7, 38, 86, 251, 83, 101, 108, 105, 102, 111, 114, 112, 95, 116, 105, 100, 101, 60};


//: Poland
Byte kStr_alleyTitle[] = {93, 6, 4, 83, 100, 110, 97, 108, 111, 80, 32};


//: user_edit_lang
Byte kStr_screenTitle[] = {6, 14, 5, 155, 128, 103, 110, 97, 108, 95, 116, 105, 100, 101, 95, 114, 101, 115, 117, 75};


//: enable
Byte kStr_toFileTitle[] = {68, 6, 11, 105, 84, 218, 113, 121, 143, 23, 170, 101, 108, 98, 97, 110, 101, 222};


//: user_ic_1
Byte kStr_birdValue[] = {14, 9, 3, 49, 95, 99, 105, 95, 114, 101, 115, 117, 204};


//: safe_setting_activity_title
Byte kStr_theoryData[] = {27, 27, 8, 233, 3, 68, 151, 245, 101, 108, 116, 105, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 103, 110, 105, 116, 116, 101, 115, 95, 101, 102, 97, 115, 175};


//: Finland
Byte kStr_shadowInfoReloadValue[] = {26, 7, 8, 163, 213, 100, 49, 121, 100, 110, 97, 108, 110, 105, 70, 86};


//: CFBundleShortVersionString
Byte kStr_greenFedTitle[] = {44, 26, 13, 67, 79, 16, 198, 155, 247, 1, 171, 88, 30, 103, 110, 105, 114, 116, 83, 110, 111, 105, 115, 114, 101, 86, 116, 114, 111, 104, 83, 101, 108, 100, 110, 117, 66, 70, 67, 19};


//: user_ic_5
Byte kStr_onText[] = {72, 9, 12, 132, 244, 241, 51, 24, 31, 75, 138, 216, 53, 95, 99, 105, 95, 114, 101, 115, 117, 218};


//: #B391FF
Byte kStr_roadValue[] = {30, 7, 5, 187, 107, 70, 70, 49, 57, 51, 66, 35, 109};


//: user_edit_profile
Byte kStr_knifeWeightData[] = {45, 17, 12, 142, 195, 180, 146, 98, 29, 214, 144, 196, 101, 108, 105, 102, 111, 114, 112, 95, 116, 105, 100, 101, 95, 114, 101, 115, 117, 122};


//: #F7D2F3
Byte kStr_oilData[] = {55, 7, 7, 172, 10, 143, 206, 51, 70, 50, 68, 55, 70, 35, 203};


//: activity_comment_setting_ys
Byte kStr_direChapValue[] = {70, 27, 10, 98, 148, 19, 247, 111, 241, 112, 115, 121, 95, 103, 110, 105, 116, 116, 101, 115, 95, 116, 110, 101, 109, 109, 111, 99, 95, 121, 116, 105, 118, 105, 116, 99, 97, 140};


//: Español
Byte kStr_meteValue[] = {35, 8, 11, 245, 28, 42, 38, 23, 91, 68, 86, 108, 111, 177, 195, 97, 112, 115, 69, 214};


//: italiano
Byte kStr_dependingValue[] = {58, 8, 11, 44, 226, 54, 40, 141, 16, 129, 134, 111, 110, 97, 105, 108, 97, 116, 105, 142};


//: France
Byte kStr_alleyText[] = {44, 6, 3, 101, 99, 110, 97, 114, 70, 27};


//: Türkçe
Byte kStr_direRefreshGladTitle[] = {71, 8, 13, 103, 3, 134, 252, 90, 247, 255, 25, 151, 234, 101, 167, 195, 107, 114, 188, 195, 84, 82};


//: Latvia
Byte kStr_approximateName[] = {58, 6, 12, 255, 21, 112, 168, 236, 121, 164, 193, 122, 97, 105, 118, 116, 97, 76, 202};


//: user_ic_3
Byte kStr_leadingValue[] = {9, 9, 5, 248, 238, 51, 95, 99, 105, 95, 114, 101, 115, 117, 82};


//: contact_tag_fragment_sure
Byte kStr_tonightText[] = {61, 25, 7, 211, 28, 23, 214, 101, 114, 117, 115, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 198};


//: Netherlands
Byte kStr_obviouslyData[] = {24, 11, 10, 43, 27, 57, 148, 8, 68, 124, 115, 100, 110, 97, 108, 114, 101, 104, 116, 101, 78, 26};


//: Em alemão
Byte kStr_nameContent[] = {8, 10, 9, 225, 62, 21, 176, 204, 117, 111, 163, 195, 109, 101, 108, 97, 32, 109, 69, 210};


//: feedback_activity_title
Byte kStr_livingContent[] = {28, 23, 5, 165, 207, 101, 108, 116, 105, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 107, 99, 97, 98, 100, 101, 101, 102, 56};


//: Hungary
Byte kStr_tunaValue[] = {4, 7, 12, 99, 116, 191, 248, 252, 27, 117, 237, 37, 121, 114, 97, 103, 110, 117, 72, 138};


//: NTESNotificationLogout
Byte kStr_surgeName[] = {8, 22, 6, 208, 90, 26, 116, 117, 111, 103, 111, 76, 110, 111, 105, 116, 97, 99, 105, 102, 105, 116, 111, 78, 83, 69, 84, 78, 94};


//: English
Byte kStr_tapContent[] = {47, 7, 4, 104, 104, 115, 105, 108, 103, 110, 69, 230};


//: #2C3042
Byte kStr_destructionData[] = {74, 7, 9, 18, 44, 81, 128, 203, 192, 50, 52, 48, 51, 67, 50, 35, 232};


//: user_qr_icon
Byte kStr_kitEnableValue[] = {19, 12, 7, 51, 115, 67, 15, 110, 111, 99, 105, 95, 114, 113, 95, 114, 101, 115, 117, 177};


//: Bulgaria
Byte kStr_optName[] = {75, 8, 13, 218, 254, 237, 9, 175, 242, 123, 122, 229, 25, 97, 105, 114, 97, 103, 108, 117, 66, 61};


//: qrcode_activity_title
Byte kStr_linkTextData[] = {66, 21, 7, 142, 178, 25, 231, 101, 108, 116, 105, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 101, 100, 111, 99, 114, 113, 155};


//: user_ic_4
Byte kStr_userGreenMyText[] = {74, 9, 4, 2, 52, 95, 99, 105, 95, 114, 101, 115, 117, 75};


//: #ffffff
Byte kStr_weightFieldForData[] = {18, 7, 6, 206, 143, 167, 102, 102, 102, 102, 102, 102, 35, 39};


//: #CCECFC
Byte kStr_absolutelyText[] = {29, 7, 6, 193, 214, 11, 67, 70, 67, 69, 67, 67, 35, 21};


//: common_bg
Byte kStr_sagData[] = {86, 9, 7, 178, 189, 123, 150, 103, 98, 95, 110, 111, 109, 109, 111, 99, 72};


//: Czech Republic
Byte kStr_powderKnifeSurgeContent[] = {18, 14, 9, 53, 213, 115, 71, 174, 154, 99, 105, 108, 98, 117, 112, 101, 82, 32, 104, 99, 101, 122, 67, 68};


//: icon_select_confirm
Byte kStr_birdText[] = {28, 19, 4, 51, 109, 114, 105, 102, 110, 111, 99, 95, 116, 99, 101, 108, 101, 115, 95, 110, 111, 99, 105, 106};


//: receiver_model
Byte kStr_enableRefugeeData[] = {88, 14, 13, 87, 236, 99, 12, 111, 160, 26, 69, 196, 183, 108, 101, 100, 111, 109, 95, 114, 101, 118, 105, 101, 99, 101, 114, 122};


//: my_log
Byte kStr_addTheorySentenceName[] = {27, 6, 11, 73, 252, 136, 182, 157, 130, 159, 73, 103, 111, 108, 95, 121, 109, 26};


//: Croatia
Byte kStr_barTitleContent[] = {81, 7, 7, 176, 194, 9, 240, 97, 105, 116, 97, 111, 114, 67, 229};


//: Kiswahili
Byte kStr_sheData[] = {15, 9, 3, 105, 108, 105, 104, 97, 119, 115, 105, 75, 78};


//: Greece
Byte kStr_routineData[] = {62, 6, 6, 47, 154, 16, 101, 99, 101, 101, 114, 71, 58};


//: Estonia
Byte kStr_bedroomInfoData[] = {50, 7, 13, 21, 178, 135, 148, 254, 211, 193, 194, 109, 9, 97, 105, 110, 111, 116, 115, 69, 223};


//: #999999
Byte kStr_entryName[] = {84, 7, 9, 92, 93, 190, 177, 182, 138, 57, 57, 57, 57, 57, 57, 35, 17};


//: Denmark
Byte kStr_discusData[] = {71, 7, 12, 77, 228, 128, 13, 234, 78, 244, 211, 157, 107, 114, 97, 109, 110, 101, 68, 36};


//: spa
Byte kStr_oilContent[] = {94, 3, 11, 194, 64, 128, 216, 247, 54, 63, 86, 97, 112, 115, 196};


//: Sverige
Byte kStr_colorfulValue[] = {14, 7, 4, 61, 101, 103, 105, 114, 101, 118, 83, 139};


//: Ireland
Byte kStr_sheHazardValue[] = {99, 7, 7, 69, 87, 97, 89, 100, 110, 97, 108, 101, 114, 73, 243};


//: btn_right
Byte kStr_checkName[] = {6, 9, 12, 146, 31, 113, 131, 244, 229, 71, 239, 222, 116, 104, 103, 105, 114, 95, 110, 116, 98, 162};


//: system_change_language_title
Byte kStr_checkSheValue[] = {22, 28, 6, 163, 49, 168, 101, 108, 116, 105, 116, 95, 101, 103, 97, 117, 103, 110, 97, 108, 95, 101, 103, 110, 97, 104, 99, 95, 109, 101, 116, 115, 121, 115, 27};


//: Malta
Byte kStr_optionDependingValue[] = {80, 5, 9, 21, 67, 187, 48, 66, 241, 97, 116, 108, 97, 77, 199};


//: user_ic_2
Byte kStr_cellKitValue[] = {70, 9, 7, 99, 242, 13, 186, 50, 95, 99, 105, 95, 114, 101, 115, 117, 234};


//: Lithuania
Byte kStr_electricContent[] = {44, 9, 3, 97, 105, 110, 97, 117, 104, 116, 105, 76, 150};


//: user_my_log
Byte kStr_moreoverContent[] = {4, 11, 10, 152, 241, 183, 201, 26, 235, 224, 103, 111, 108, 95, 121, 109, 95, 114, 101, 115, 117, 110};


//: fragment_my_version
Byte kStr_indicateData[] = {29, 19, 8, 137, 29, 247, 132, 227, 110, 111, 105, 115, 114, 101, 118, 95, 121, 109, 95, 116, 110, 101, 109, 103, 97, 114, 102, 42};


//: 5D5F66
Byte kStr_materText[] = {4, 6, 4, 161, 54, 54, 70, 53, 68, 53, 105};


//: Portugal
Byte kStr_roadPinOpponentTitle[] = {46, 8, 10, 61, 81, 20, 75, 207, 184, 39, 108, 97, 103, 117, 116, 114, 111, 80, 2};


//: 中文繁体
Byte kStr_stationName[] = {59, 12, 5, 151, 109, 147, 189, 228, 129, 185, 231, 135, 150, 230, 173, 184, 228, 235};


//: Slovakia
Byte kStr_knifeValue[] = {85, 8, 9, 231, 28, 173, 163, 134, 94, 97, 105, 107, 97, 118, 111, 108, 83, 93};


//: icon_close
Byte kStr_speakText[] = {88, 10, 11, 231, 87, 249, 96, 31, 215, 13, 82, 101, 115, 111, 108, 99, 95, 110, 111, 99, 105, 173};


//: contact_tag_fragment_cancel
Byte kStr_inquiryContent[] = {95, 27, 7, 247, 143, 55, 172, 108, 101, 99, 110, 97, 99, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 139};


//: Việt nam
Byte kStr_oakText[] = {34, 10, 13, 22, 123, 237, 205, 46, 157, 68, 129, 113, 232, 109, 97, 110, 32, 116, 135, 187, 225, 105, 86, 191};


//: activity_comment_setting_exit
Byte kStr_leadingOptionValue[] = {56, 29, 10, 247, 72, 63, 228, 178, 218, 58, 116, 105, 120, 101, 95, 103, 110, 105, 116, 116, 101, 115, 95, 116, 110, 101, 109, 109, 111, 99, 95, 121, 116, 105, 118, 105, 116, 99, 97, 40};


//: Romania
Byte kStr_developingValue[] = {21, 7, 13, 34, 123, 97, 47, 127, 168, 159, 193, 168, 80, 97, 105, 110, 97, 109, 111, 82, 81};


//: Luxembourg
Byte kStr_taleText[] = {19, 10, 8, 254, 60, 145, 138, 130, 103, 114, 117, 111, 98, 109, 101, 120, 117, 76, 252};
...
#import "QuantityryViewController.h"//个人资料
//: #import "NTESUserQRCodeViewController.h" //我的二维码
#import "ChanceViewController.h" //我的二维码
//: #import "NTESSafetySetingController.h"   //安全设置
#import "MViewController.h"   //安全设置
//: #import "NTESFeedbackViewController.h" //意见反馈
#import "LanguageViewController.h" //意见反馈
...
@interface MainViewController ()<NIMUserManagerDelegate>
...
- (void)viewDidLoad {
    ...
    bg.image = [UIImage imageNamed:StringFromPowderData(kStr_sagData)];
    ...
    self.language = [self link:[BlondeDefaults phone].language];
}
...
- (void)size
{
    ...
    self.accountLabel.text = [NSString stringWithFormat:@"%@",emptyString([BlondeDefaults phone].accountName)];
...
- (NSString *)link:(NSString *)langType {
    ...
    if ([langType containsString:@"en"]) {
        ...
        resourceType = StringFromPowderData(kStr_tapContent);
    ...
    //: }else if ([langType containsString:@"vi"]){
        ...
        resourceType = StringFromPowderData(kStr_oakText);
    ...
    }else if ([langType containsString:StringFromPowderData(kStr_oilContent)]){
        //: resourceType = @"Español";
        resourceType = StringFromPowderData(kStr_meteValue);
    //: }else if ([langType containsString:@"pt"]){
    }else if ([langType containsString:@"pt"]){
        //: resourceType = @"Portugal";
        resourceType = StringFromPowderData(kStr_roadPinOpponentTitle);
    ...
    //: }else if ([langType containsString:@"it"]){
        ...
        resourceType = StringFromPowderData(kStr_dependingValue);
    ...
    //: }else if ([langType containsString:@"tr"]){
        ...
        //: resourceType = @"Türkçe";
        resourceType = StringFromPowderData(kStr_direRefreshGladTitle);
    //: }else if ([langType containsString:@"ug"]){
    }else if ([langType containsString:@"ug"]){
        //: resourceType = @"Kiswahili";
        resourceType = StringFromPowderData(kStr_sheData);
    //: }else if ([langType containsString:@"de"]){
    }else if ([langType containsString:@"de"]){
        //: resourceType = @"Em alemão";
        resourceType = StringFromPowderData(kStr_nameContent);
    ...
    //: }else if ([langType containsString:@"fr"]){
        ...
        //: resourceType = @"France";
        resourceType = StringFromPowderData(kStr_alleyText);
    //: }else if ([langType containsString:@"hant"]){
    }else if ([langType containsString:StringFromPowderData(kStr_direName)]){
        //: resourceType = @"中文繁体";
        resourceType = StringFromPowderData(kStr_stationName);
    //: }else if ([langType containsString:@"sv"]){
    }else if ([langType containsString:@"sv"]){
        //: resourceType = @"Sverige";
        resourceType = StringFromPowderData(kStr_colorfulValue);
    //: }else if ([langType containsString:@"sl"]){
    }else if ([langType containsString:@"sl"]){
        //: resourceType = @"Slovenija";
        resourceType = StringFromPowderData(kStr_inquiryTitle);
    //: }else if ([langType containsString:@"sk"]){
    }else if ([langType containsString:@"sk"]){
        //: resourceType = @"Slovakia";
        resourceType = StringFromPowderData(kStr_knifeValue);
    //: }else if ([langType containsString:@"ro"]){
    }else if ([langType containsString:@"ro"]){
        //: resourceType = @"Romania";
        resourceType = StringFromPowderData(kStr_developingValue);
    //: }else if ([langType containsString:@"pl"]){
    }else if ([langType containsString:@"pl"]){
        //: resourceType = @"Poland";
        resourceType = StringFromPowderData(kStr_alleyTitle);
    //: }else if ([langType containsString:@"nl"]){
    }else if ([langType containsString:@"nl"]){
        //: resourceType = @"Netherlands";
        resourceType = StringFromPowderData(kStr_obviouslyData);
    //: }else if ([langType containsString:@"mt"]){
    }else if ([langType containsString:@"mt"]){
        //: resourceType = @"Malta";
        resourceType = StringFromPowderData(kStr_optionDependingValue);
    //: }else if ([langType containsString:@"lb"]){
    }else if ([langType containsString:@"lb"]){
        //: resourceType = @"Luxembourg";
        resourceType = StringFromPowderData(kStr_taleText);
    //: }else if ([langType containsString:@"lt"]){
    }else if ([langType containsString:@"lt"]){
        //: resourceType = @"Lithuania";
        resourceType = StringFromPowderData(kStr_electricContent);
    //: }else if ([langType containsString:@"lv"]){
    }else if ([langType containsString:@"lv"]){
        //: resourceType = @"Latvia";
        resourceType = StringFromPowderData(kStr_approximateName);
    //: }else if ([langType containsString:@"bg"]){
    }else if ([langType containsString:@"bg"]){
        //: resourceType = @"Bulgaria";
        resourceType = StringFromPowderData(kStr_optName);
    //: }else if ([langType containsString:@"hr"]){
    }else if ([langType containsString:@"hr"]){
        //: resourceType = @"Croatia";
        resourceType = StringFromPowderData(kStr_barTitleContent);
    //: }else if ([langType containsString:@"cs"]){
    }else if ([langType containsString:@"cs"]){
        //: resourceType = @"Czech Republic";
        resourceType = StringFromPowderData(kStr_powderKnifeSurgeContent);
    //: }else if ([langType containsString:@"da"]){
    }else if ([langType containsString:@"da"]){
        //: resourceType = @"Denmark";
        resourceType = StringFromPowderData(kStr_discusData);
    //: }else if ([langType containsString:@"et"]){
    }else if ([langType containsString:@"et"]){
        //: resourceType = @"Estonia";
        resourceType = StringFromPowderData(kStr_bedroomInfoData);
    //: }else if ([langType containsString:@"fi"]){
    }else if ([langType containsString:@"fi"]){
        //: resourceType = @"Finland";
        resourceType = StringFromPowderData(kStr_shadowInfoReloadValue);
    //: }else if ([langType containsString:@"el"]){
    }else if ([langType containsString:@"el"]){
        //: resourceType = @"Greece";
        resourceType = StringFromPowderData(kStr_routineData);
    //: }else if ([langType containsString:@"hu"]){
    }else if ([langType containsString:@"hu"]){
        //: resourceType = @"Hungary";
        resourceType = StringFromPowderData(kStr_tunaValue);
    //: }else if ([langType containsString:@"ga"]){
    }else if ([langType containsString:@"ga"]){
        //: resourceType = @"Ireland";
        resourceType = StringFromPowderData(kStr_sheHazardValue);
    }
...
- (void)initInput{
    ...
    _headerImage = [[UIImageView alloc] initWithFrame:CGRectMake(20,(44.0f + [UIDevice table]), 64, 64)];
    ...
    self.titleLabel.frame = CGRectMake(_headerImage.right+10, (44.0f + [UIDevice table])+7, 150, 25);
    ...
    qrBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-53-15, (44.0f + [UIDevice table])+2, 53, 60);
    ...
    [qrBtn setImage:[UIImage imageNamed:StringFromPowderData(kStr_kitEnableValue)] forState:(UIControlStateNormal)];
    //: [qrBtn addTarget:self action:@selector(handlebtnQr) forControlEvents:UIControlEventTouchUpInside];
    [qrBtn addTarget:self action:@selector(imageAt) forControlEvents:UIControlEventTouchUpInside];
    ...
    [qrBtn setTitleColor:[UIColor isView:StringFromPowderData(kStr_roadValue)] forState:UIControlStateNormal];
    //: [qrBtn setTitle:[FFFLanguageManager getTextWithKey:@"qrcode_activity_title"] forState:UIControlStateNormal];
    [qrBtn setTitle:[TeamManager sizeKey:StringFromPowderData(kStr_linkTextData)] forState:UIControlStateNormal];
    //: [qrBtn layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleTop) imageTitleSpace:10];
    [qrBtn barBackground:(MKButtonEdgeInsetsStyleTop) by:10];
    ...
    UIView *contentView = [[UIView alloc]initWithFrame:CGRectMake(0, (44.0f + [UIDevice table])+100, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice table])-(49.0f))];
    //: contentView.backgroundColor = [UIColor colorWithHexString:@"#ffffff"];
    contentView.backgroundColor = [UIColor isView:StringFromPowderData(kStr_weightFieldForData)];
    ...
    editView.backgroundColor = [UIColor isView:StringFromPowderData(kStr_oilData)];
    ...
    UITapGestureRecognizer *singleTap1 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(upInfo)];
    ...
    editimg.image = [UIImage imageNamed:StringFromPowderData(kStr_knifeWeightData)];
    ...
    labedit.textColor = [UIColor isView:StringFromPowderData(kStr_destructionData)];
    //: labedit.text = [FFFLanguageManager getTextWithKey:@"edit_profile"];
    labedit.text = [TeamManager sizeKey:StringFromPowderData(kStr_bluePowderValue)];
    ...
    langView.backgroundColor = [UIColor isView:StringFromPowderData(kStr_absolutelyText)];
    ...
    UITapGestureRecognizer *singleTap2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(parameterHeight)];
    ...
    langimg.image = [UIImage imageNamed:StringFromPowderData(kStr_screenTitle)];
    ...
    _lablang.textColor = [UIColor isView:StringFromPowderData(kStr_destructionData)];
    //: _lablang.text = @"English";
    _lablang.text = StringFromPowderData(kStr_tapContent);
    ...
    UIImageView *image11 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromPowderData(kStr_birdValue)]];
    ...
    label11.text = [TeamManager sizeKey:StringFromPowderData(kStr_enableRefugeeData)];
    ...
    switch11.onTintColor = [UIColor isView:StringFromPowderData(kStr_roadValue)];
    //: [switch11 addTarget:self action:@selector(switchWith:) forControlEvents:UIControlEventValueChanged];
    [switch11 addTarget:self action:@selector(styled:) forControlEvents:UIControlEventValueChanged];
    ...
    UITapGestureRecognizer *singleTap8 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(userIndex)];
    ...
    UIImageView *imagelog = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromPowderData(kStr_moreoverContent)]];
    ...
    labellog.text = [TeamManager sizeKey:StringFromPowderData(kStr_addTheorySentenceName)];
    ...
    arrowrightlog.image = [UIImage imageNamed:StringFromPowderData(kStr_checkName)];
    ...
    UITapGestureRecognizer *singleTap7 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(mySeting)];
    //: [box6 addGestureRecognizer:singleTap7];
    [box6 addGestureRecognizer:singleTap7];

    //: UIImageView *image23 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"user_ic_2"]];
    UIImageView *image23 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromPowderData(kStr_cellKitValue)]];
    ...
    label23.text = [TeamManager sizeKey:StringFromPowderData(kStr_theoryData)];
    ...
    arrowright6.image = [UIImage imageNamed:StringFromPowderData(kStr_checkName)];
    ...
    UIImageView *image14 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromPowderData(kStr_leadingValue)]];
    ...
    label14.text = [TeamManager sizeKey:StringFromPowderData(kStr_direChapValue)];//@"用户协议和隐私协议";
    ...
    arrowright2.image = [UIImage imageNamed:StringFromPowderData(kStr_checkName)];
    ...
    UITapGestureRecognizer *singleTap4 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(totalText)];
    ...
    UITapGestureRecognizer *singleTap6 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(latAccount)];
    //: [box5 addGestureRecognizer:singleTap6];
    [box5 addGestureRecognizer:singleTap6];

    //: UIImageView *image22 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"user_ic_4"]];
    UIImageView *image22 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromPowderData(kStr_userGreenMyText)]];
    ...
    label22.text = [TeamManager sizeKey:StringFromPowderData(kStr_livingContent)];
    ...
    arrowright5.image = [UIImage imageNamed:StringFromPowderData(kStr_checkName)];
    ...
    UIImageView *image31 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromPowderData(kStr_onText)]];
    ...
    NSString *fragment_my_version = [TeamManager sizeKey:StringFromPowderData(kStr_indicateData)];
    //: NSDictionary *infoDic = [[NSBundle mainBundle] infoDictionary];
    NSDictionary *infoDic = [[NSBundle mainBundle] infoDictionary];
    //: NSString *appVersion = [infoDic objectForKey:@"CFBundleShortVersionString"];
    NSString *appVersion = [infoDic objectForKey:StringFromPowderData(kStr_greenFedTitle)];// 获取App的版本号
    ...
    [loginButton setTitleColor:[UIColor isView:StringFromPowderData(kStr_materText)] forState:UIControlStateNormal];
    //: [loginButton setTitle:[FFFLanguageManager getTextWithKey:@"activity_comment_setting_exit"] forState:UIControlStateNormal];
    [loginButton setTitle:[TeamManager sizeKey:StringFromPowderData(kStr_leadingOptionValue)] forState:UIControlStateNormal];
    //: [loginButton addTarget:self action:@selector(logoutCurrentAccount) forControlEvents:UIControlEventTouchUpInside];
    [loginButton addTarget:self action:@selector(logoutFromAccount) forControlEvents:UIControlEventTouchUpInside];
...
-(void)upInfo{
    ...
    QuantityryViewController *vc = [[QuantityryViewController alloc] init];
...
- (void)userIndex
{
    ...
    FaceFungusViewController *vc = [[FaceFungusViewController alloc] init];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}

//: -(void)switchWith:(UISwitch *)switchView{
-(void)styled:(UISwitch *)switchView{
    ...
    if (switchView.on) {
        ...
        [dict setObject:@"1" forKey:StringFromPowderData(kStr_toFileTitle)];
    ...
    //: }else{
        ...
        [dict setObject:@"0" forKey:StringFromPowderData(kStr_toFileTitle)];
...
-(void)comment{
    ...
    NSString *alertStr = [TeamManager sizeKey:StringFromPowderData(kStr_checkSheValue)];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:[TeamManager sizeKey:StringFromPowderData(kStr_tonightText)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        //: exit(0);
        exit(0);
    //: }]];
    }]];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:[TeamManager sizeKey:StringFromPowderData(kStr_inquiryContent)] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
...
-(void)totalText{
    ...
    vc.webTitle = [TeamManager sizeKey:StringFromPowderData(kStr_direChapValue)];//@"隐私协议";
    ...
    [[[NIMSDK sharedSDK] loginManager] logout:^(NSError *error)
     {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:StringFromPowderData(kStr_surgeName) object:nil];
    //: }];
    }];
...
- (UILabel *)accountLabel{
    ...
    if (!_accountLabel) {
        ...
        _accountLabel.textColor = [UIColor isView:StringFromPowderData(kStr_entryName)];
    }
...
- (UIButton *)closeBtn {
    ...
    if (!_closeBtn) {
        ...
        [_closeBtn setImage:[UIImage imageNamed:StringFromPowderData(kStr_speakText)] forState:UIControlStateNormal];
    }
    //: return _closeBtn;
    return _closeBtn;
}
...
- (UIButton *)sureBtn {
    ...
    if (!_sureBtn) {
        ...
        [_sureBtn setImage:[UIImage imageNamed:StringFromPowderData(kStr_birdText)] forState:UIControlStateNormal];
...
Byte * PowderDataToCache(Byte *data) {
    int shoveTitle = data[0];
    int spaceScare = data[1];
    int carmine = data[2];
    if (!shoveTitle) return data + carmine;
    for (int i = 0; i < spaceScare / 2; i++) {
        int begin = carmine + i;
        int end = carmine + spaceScare - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[carmine + spaceScare] = 0;
    return data + carmine;
}

NSString *StringFromPowderData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)PowderDataToCache(data)];
}  

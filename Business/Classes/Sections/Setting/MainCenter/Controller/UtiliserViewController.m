...
NSString *StringFromSingeKeyData(SingeKeyData *data);


//: back_arrow_bl
SingeKeyData kStr_makeupValue = (SingeKeyData){155, (Byte []){249, 250, 248, 240, 196, 250, 233, 233, 244, 236, 196, 249, 247, 28}, 13, false};


//: user_id
SingeKeyData kStr_complexValue = (SingeKeyData){165, (Byte []){208, 214, 192, 215, 250, 204, 193, 63}, 7, false};


//: /user/edit
SingeKeyData kStr_shutContent = (SingeKeyData){200, (Byte []){231, 189, 187, 173, 186, 231, 173, 172, 161, 188, 165}, 10, false};


//: my_user_info_activity_title
SingeKeyData kStr_solelyFilmValue = (SingeKeyData){42, (Byte []){71, 83, 117, 95, 89, 79, 88, 117, 67, 68, 76, 69, 117, 75, 73, 94, 67, 92, 67, 94, 83, 117, 94, 67, 94, 70, 79, 24}, 27, false};


//: spa
SingeKeyData kStr_limitedText = (SingeKeyData){234, (Byte []){153, 154, 139, 38}, 3, false};


//: zh-Hant
SingeKeyData kStr_dumpTitle = (SingeKeyData){79, (Byte []){53, 39, 98, 7, 46, 33, 59, 15}, 7, false};


//: account_account
SingeKeyData kStr_shrinkAtTitle = (SingeKeyData){122, (Byte []){27, 25, 25, 21, 15, 20, 14, 37, 27, 25, 25, 21, 15, 20, 14, 115}, 15, false};


//: ko-KP
SingeKeyData kStr_eticTitle = (SingeKeyData){64, (Byte []){43, 47, 109, 11, 16, 104}, 5, false};


//: photo_account_def
SingeKeyData kStr_succeedValeValue = (SingeKeyData){73, (Byte []){57, 33, 38, 61, 38, 22, 40, 42, 42, 38, 60, 39, 61, 22, 45, 44, 47, 50}, 17, false};


//: user_info_avtivity_upload_avatar_failed
SingeKeyData kStr_terroristName = (SingeKeyData){95, (Byte []){42, 44, 58, 45, 0, 54, 49, 57, 48, 0, 62, 41, 43, 54, 41, 54, 43, 38, 0, 42, 47, 51, 48, 62, 59, 0, 62, 41, 62, 43, 62, 45, 0, 57, 62, 54, 51, 58, 59, 60}, 39, false};


//: friend_info_activity_xu
SingeKeyData kStr_brutalText = (SingeKeyData){234, (Byte []){140, 152, 131, 143, 132, 142, 181, 131, 132, 140, 133, 181, 139, 137, 158, 131, 156, 131, 158, 147, 181, 146, 159, 161}, 23, false};


//: account
SingeKeyData kStr_terroristTitle = (SingeKeyData){76, (Byte []){45, 47, 47, 35, 57, 34, 56, 29}, 7, false};


//: icon_photo
SingeKeyData kStr_budgeDeemValue = (SingeKeyData){127, (Byte []){22, 28, 16, 17, 32, 15, 23, 16, 11, 16, 61}, 10, false};


//: #5D5F66
SingeKeyData kStr_solelyName = (SingeKeyData){157, (Byte []){190, 168, 217, 168, 219, 171, 171, 245}, 7, false};


//: /user/detail
SingeKeyData kStr_forgeData = (SingeKeyData){241, (Byte []){222, 132, 130, 148, 131, 222, 149, 148, 133, 144, 152, 157, 147}, 12, false};


//: friend_info_activity_nv
SingeKeyData kStr_tenderValue = (SingeKeyData){60, (Byte []){90, 78, 85, 89, 82, 88, 99, 85, 82, 90, 83, 99, 93, 95, 72, 85, 74, 85, 72, 69, 99, 82, 74, 239}, 23, false};


//: activity_my_user_info_nick
SingeKeyData kStr_keyMobileTitle = (SingeKeyData){12, (Byte []){109, 111, 120, 101, 122, 101, 120, 117, 83, 97, 117, 83, 121, 127, 105, 126, 83, 101, 98, 106, 99, 83, 98, 101, 111, 103, 75}, 26, false};


//: icon_options_grdefault
SingeKeyData kStr_imageTriggerAttackValue = (SingeKeyData){34, (Byte []){75, 65, 77, 76, 125, 77, 82, 86, 75, 77, 76, 81, 125, 69, 80, 70, 71, 68, 67, 87, 78, 86, 133}, 22, false};


//: user_profile_avtivity_account
SingeKeyData kStr_previousText = (SingeKeyData){241, (Byte []){132, 130, 148, 131, 174, 129, 131, 158, 151, 152, 157, 148, 174, 144, 135, 133, 152, 135, 152, 133, 136, 174, 144, 146, 146, 158, 132, 159, 133, 134}, 29, false};


//: code
SingeKeyData kStr_solelyTitle = (SingeKeyData){102, (Byte []){5, 9, 2, 3, 136}, 4, false};


//: icon_me_arrow
SingeKeyData kStr_identificationData = (SingeKeyData){182, (Byte []){223, 213, 217, 216, 233, 219, 211, 233, 215, 196, 196, 217, 193, 215}, 13, false};


//: contact_tag_fragment_cancel
SingeKeyData kStr_spectrumData = (SingeKeyData){40, (Byte []){75, 71, 70, 92, 73, 75, 92, 119, 92, 73, 79, 119, 78, 90, 73, 79, 69, 77, 70, 92, 119, 75, 73, 70, 75, 77, 68, 62}, 27, false};


//: tag_activity_set
SingeKeyData kStr_tamName = (SingeKeyData){126, (Byte []){10, 31, 25, 33, 31, 29, 10, 23, 8, 23, 10, 7, 33, 13, 27, 10, 136}, 16, false};


//: jpg
SingeKeyData kStr_standingText = (SingeKeyData){169, (Byte []){195, 217, 206, 96}, 3, false};


//: setting_privacy_camera
SingeKeyData kStr_populationData = (SingeKeyData){5, (Byte []){118, 96, 113, 113, 108, 107, 98, 90, 117, 119, 108, 115, 100, 102, 124, 90, 102, 100, 104, 96, 119, 100, 27}, 22, false};


//: zh-Hans
SingeKeyData kStr_angelContent = (SingeKeyData){191, (Byte []){197, 215, 146, 247, 222, 209, 204, 44}, 7, false};


//: gender
SingeKeyData kStr_singeTitle = (SingeKeyData){51, (Byte []){84, 86, 93, 87, 86, 65, 143}, 6, false};


//: data
SingeKeyData kStr_infoNameShouldValue = (SingeKeyData){184, (Byte []){220, 217, 204, 217, 76}, 4, false};


//: accout_nickname
SingeKeyData kStr_pinText = (SingeKeyData){153, (Byte []){248, 250, 250, 246, 236, 237, 198, 247, 240, 250, 242, 247, 248, 244, 252, 180}, 15, false};


//: group_info_activity_update_failed
SingeKeyData kStr_mandateZoneName = (SingeKeyData){10, (Byte []){109, 120, 101, 127, 122, 85, 99, 100, 108, 101, 85, 107, 105, 126, 99, 124, 99, 126, 115, 85, 127, 122, 110, 107, 126, 111, 85, 108, 107, 99, 102, 111, 110, 143}, 33, false};


//: userinfo_bg
SingeKeyData kStr_stairData = (SingeKeyData){241, (Byte []){132, 130, 148, 131, 152, 159, 151, 158, 174, 147, 150, 182}, 11, false};


//: icon_copy
SingeKeyData kStr_atBubbleStatusValue = (SingeKeyData){165, (Byte []){204, 198, 202, 203, 250, 198, 202, 213, 220, 104}, 9, false};


//: warm_prompt
SingeKeyData kStr_convertData = (SingeKeyData){61, (Byte []){74, 92, 79, 80, 98, 77, 79, 82, 80, 77, 73, 173}, 11, false};


//: activity_friend_info_sex
SingeKeyData kStr_singeData = (SingeKeyData){140, (Byte []){237, 239, 248, 229, 250, 229, 248, 245, 211, 234, 254, 229, 233, 226, 232, 211, 229, 226, 234, 227, 211, 255, 233, 244, 79}, 24, false};


//: hant
SingeKeyData kStr_agedDoingValue = (SingeKeyData){193, (Byte []){169, 160, 175, 181, 175}, 4, false};


//: setting_privacy
SingeKeyData kStr_parkSolelyDumpText = (SingeKeyData){185, (Byte []){202, 220, 205, 205, 208, 215, 222, 230, 201, 203, 208, 207, 216, 218, 192, 7}, 15, false};


//: friend_info_activity_nan
SingeKeyData kStr_deemValue = (SingeKeyData){178, (Byte []){212, 192, 219, 215, 220, 214, 237, 219, 220, 212, 221, 237, 211, 209, 198, 219, 196, 219, 198, 203, 237, 220, 211, 220, 206}, 24, false};


//: account_gender
SingeKeyData kStr_murderValue = (SingeKeyData){161, (Byte []){192, 194, 194, 206, 212, 207, 213, 254, 198, 196, 207, 197, 196, 211, 102}, 14, false};

// __DEBUG__
// __CLOSE_PRINT__
//
//  UtiliserViewController.m
//  Riverla
//
...
#import "UtiliserViewController.h"
...
@interface UtiliserViewController ()<NIMUserManagerDelegate,TZImagePickerControllerDelegate,HeadingSum,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@property (nonatomic, strong) PointView *sexView;
//: @property (nonatomic, strong) KEKESetNickNameView *changeNickNameView;
@property (nonatomic, strong) TingView *changeNickNameView;
...
@implementation UtiliserViewController
...
//    self.view.backgroundColor = RGB_COLOR_String(@"#F6F7FA");
    ...
    bg.image = [UIImage imageNamed:StringFromSingeKeyData(&kStr_stairData)];
    ...
    [backButton setImage:[UIImage imageNamed:StringFromSingeKeyData(&kStr_makeupValue)] forState:(UIControlStateNormal)];
    ...
    labtitle.text = [ItemManager sessionInformation:StringFromSingeKeyData(&kStr_solelyFilmValue)];
...
- (void)qualifyView
{
    ...
    UIView *avaterView = [[UIView alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-140)/2, (44.0f + [UIDevice clear])+15, 140, 140)];
    ...
    self.imgHeader.image = [UIImage imageNamed:StringFromSingeKeyData(&kStr_succeedValeValue)];
...
//    self.btnPhoto.backgroundColor = [UIColor whiteColor];
    ...
    [self.btnPhoto setImage:[UIImage imageNamed:StringFromSingeKeyData(&kStr_budgeDeemValue)] forState:(UIControlStateNormal)];
    //: [self.btnPhoto addTarget:self action:@selector(handleThePhoto) forControlEvents:UIControlEventTouchUpInside];
    [self.btnPhoto addTarget:self action:@selector(anointTo) forControlEvents:UIControlEventTouchUpInside];
    ...
    accountImg.image = [UIImage imageNamed:StringFromSingeKeyData(&kStr_shrinkAtTitle)];
    ...
    self.labAccount.text = [ItemManager sessionInformation:StringFromSingeKeyData(&kStr_previousText)];
    ...
    self.account.textColor = [UIColor withMax:StringFromSingeKeyData(&kStr_solelyName)];
    ...
    [self.btnCopy setImage:[UIImage imageNamed:StringFromSingeKeyData(&kStr_atBubbleStatusValue)] forState:(UIControlStateNormal)];
    //: [self.btnCopy addTarget:self action:@selector(handleTheCopy) forControlEvents:UIControlEventTouchUpInside];
    [self.btnCopy addTarget:self action:@selector(beView) forControlEvents:UIControlEventTouchUpInside];
    ...
    UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(toBar)];
    ...
    nameImg.image = [UIImage imageNamed:StringFromSingeKeyData(&kStr_pinText)];
...
//    labtitle.textAlignment = NSTextAlignmentCenter;
    ...
    self.labNickname.text = [ItemManager sessionInformation:StringFromSingeKeyData(&kStr_keyMobileTitle)];
    ...
    self.nickName.textColor = [UIColor withMax:StringFromSingeKeyData(&kStr_solelyName)];
    ...
    arrow.image = [UIImage imageNamed:StringFromSingeKeyData(&kStr_identificationData)];
    ...
    UITapGestureRecognizer *sexGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(userEvent)];
    ...
    sexImg.image = [UIImage imageNamed:StringFromSingeKeyData(&kStr_murderValue)];
...
//    labtitle.textAlignment = NSTextAlignmentCenter;
    ...
    self.labSex.text = [ItemManager sessionInformation:StringFromSingeKeyData(&kStr_singeData)];
    ...
    self.sex.textColor = [UIColor withMax:StringFromSingeKeyData(&kStr_solelyName)];
    ...
    sexarrow.image = [UIImage imageNamed:StringFromSingeKeyData(&kStr_identificationData)];
...
- (void)districtManager {
    ...
    [self.imgHeader sd_setImageWithURL:[NSURL URLWithString:me.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromSingeKeyData(&kStr_imageTriggerAttackValue)]];
...
//    self.sign.text = me.userInfo.sign.length ? me.userInfo.sign : LangKey(@"未设置");
    ...
    self.sex.text = [self ambages:me.userInfo.gender];

    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"user_id"] = me.userId;
    dict[StringFromSingeKeyData(&kStr_complexValue)] = me.userId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromSingeKeyData(&kStr_forgeData)] tool:dict examine:NO titleResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict with:StringFromSingeKeyData(&kStr_solelyTitle)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict view:StringFromSingeKeyData(&kStr_infoNameShouldValue)];
            //: NSString *account = [data newStringValueForKey:@"account"];
            NSString *account = [data with:StringFromSingeKeyData(&kStr_terroristTitle)];
...
- (void)toBar
{
    ...
    [ self.changeNickNameView with: self.nickName.text];
    //: [self.changeNickNameView animationShow];
    [self.changeNickNameView color];
}
//: - (void)handleTheSign
- (void)streetwise
{
    //: NTESSignSettingViewController *vc = [[NTESSignSettingViewController alloc] initWithNibName:nil bundle:nil];
    StartViewController *vc = [[StartViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)userEvent
{
    ...
    [self.sexView will: self.selectedGender];
...
- (void)app{
    ...
    dict[StringFromSingeKeyData(&kStr_singeTitle)] = @(self.selectedGender);
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/edit"] params:dict isShow:YES success:^(id responseObject) {
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromSingeKeyData(&kStr_shutContent)] tool:dict examine:YES titleResponseSuccess:^(id responseObject) {

        //: [wself.sexView animationClose];
        [wself.sexView textLanguage];
    //: } failed:^(id responseObject, NSError *error) {
    } exhibitClick:^(id responseObject, NSError *error) {
    ...
    self.sex.text = [self ambages:self.selectedGender];

}

//: - (NSString *)genderString:(NSInteger )gender{
- (NSString *)ambages:(NSInteger )gender{
    //: NSString *genderStr = @"";
    NSString *genderStr = @"";
    //: switch (gender) {
    switch (gender) {
        ...
        case 1:
            ...
            genderStr = [ItemManager sessionInformation:StringFromSingeKeyData(&kStr_deemValue)];
            //: break;
            break;
        //: case 2:
        case 2:
            //: genderStr = [FFFLanguageManager getTextWithKey:@"friend_info_activity_nv"];
            genderStr = [ItemManager sessionInformation:StringFromSingeKeyData(&kStr_tenderValue)];
            //: break;
            break;
        //: case 0:
        case 0:
            //: genderStr = [FFFLanguageManager getTextWithKey:@"friend_info_activity_xu"];
            genderStr = [ItemManager sessionInformation:StringFromSingeKeyData(&kStr_brutalText)];
        //: default:
        default:
            //: break;
            break;
...
- (void)beView
{
    ...
    [self.view makeToast:[ItemManager sessionInformation:@"复制"]
                     //: duration:2
                     duration:2
...
//        }
        ...
        UIAlertController *alertControl = [UIAlertController alertControllerWithTitle:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_convertData)] message:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_populationData)] preferredStyle:UIAlertControllerStyleAlert];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_spectrumData)] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        //: }])];
        }])];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_tamName)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            //: NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            //: if( [[UIApplication sharedApplication] canOpenURL:url]) {
            if( [[UIApplication sharedApplication] canOpenURL:url]) {
...
//        }
        ...
        UIAlertController *alertControl = [UIAlertController alertControllerWithTitle:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_convertData)] message:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_parkSolelyDumpText)] preferredStyle:UIAlertControllerStyleAlert];
        //: [alertControl addAction:([UIAlertAction actionWithTitle:[FFFLanguageManager getTextWithKey:@"contact_tag_fragment_cancel"] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        [alertControl addAction:([UIAlertAction actionWithTitle:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_spectrumData)] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        //: }])];
        }])];
...
- (void)formatTouch:(PHAsset *)asset {
...
//    imagePickerVc.naviBgColor = [KEKESkinColorManager shareInstance].skinColor;
    ...
    //: }else if ([langType containsString:@"ko"]){
        ...
        //: preferredlang = @"ko-KP";
        preferredlang = StringFromSingeKeyData(&kStr_eticTitle);
    //: }else if ([langType containsString:@"spa"]){
    }else if ([langType containsString:StringFromSingeKeyData(&kStr_limitedText)]){
        //: preferredlang = @"es";
        preferredlang = @"es";
    ...
    //: }else if ([langType containsString:@"zh"]){
        ...
        preferredlang = StringFromSingeKeyData(&kStr_angelContent);
    ...
    }else if ([langType containsString:StringFromSingeKeyData(&kStr_agedDoingValue)]){
        //: preferredlang = @"zh-Hant";
        preferredlang = StringFromSingeKeyData(&kStr_dumpTitle);
    //: }else{
    }else{
        //: preferredlang = @"en";
        preferredlang = @"en";
...
#pragma mark - 到这里为止
    ...
    [imagePickerVc setDidFinishPickingPhotosHandle:^(NSArray<UIImage *> *photos, NSArray *assets, BOOL isSelectOriginalPhoto) {
        ...
        if (photos.count > 0 && assets.count > 0) {
            ...
            [self master:photos.firstObject];
        }
    //: }];
    }];
...
- (void)images:(NSInteger )tag
{
    ...
    if(tag == 101){
        ...
        [self theImpression:UIImagePickerControllerSourceTypeCamera];
    //: }else if (tag == 102){
    }else if (tag == 102){
        //: [self showImagePicker:UIImagePickerControllerSourceTypePhotoLibrary];
        [self theImpression:UIImagePickerControllerSourceTypePhotoLibrary];
    }
}
//: - (void)showImagePicker:(UIImagePickerControllerSourceType)type{
- (void)theImpression:(UIImagePickerControllerSourceType)type{
...
- (void)master:(UIImage *)image{
    ...
    NSString *fileName = [MessageSearchedHelper random:StringFromSingeKeyData(&kStr_standingText)];
                ...
                [[NIMSDK sharedSDK].userManager updateMyUserInfo:@{@(NIMUserInfoUpdateTagAvatar):urlString} completion:^(NSError *error) {
                    ...
                    if (!error) {
                        ...
                        [sdManager.imageCache storeImage:imageForAvatarUpload
                                              ...
                                              completion:nil];
                        //: [wself refresh];
                        [wself districtManager];
                    //: }else{
                    }else{
                        //: [wself.view makeToast:[FFFLanguageManager getTextWithKey:@"user_info_avtivity_upload_avatar_failed"]
                        [wself.view makeToast:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_terroristName)]
                                     //: duration:2
                                     duration:2
                                     //: position:CSToastPositionCenter];
                                     position:CSToastPositionCenter];
    ...
    //: }else{
        ...
        [self.view makeToast:[ItemManager sessionInformation:StringFromSingeKeyData(&kStr_mandateZoneName)]
                    //: duration:2
                    duration:2
                    //: position:CSToastPositionCenter];
                    position:CSToastPositionCenter];
...
- (TingView *)changeNickNameView
{
    ...
    if(!_changeNickNameView){
        ...
        _changeNickNameView = [[TingView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
- (PointView *)sexView
{
    ...
    if(!_sexView){
        ...
        _sexView = [[PointView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
//        _sexView.hidden = YES;
    }
    //: return _sexView;
    return _sexView;
...
NSString *StringFromSingeKeyData(SingeKeyData *data) {
    return [NSString stringWithUTF8String:(char *)SingeKeyDataToByte(data)];
}

...
//: AlbumAddBtn
Byte kStr_reverseBirdData[] = {6, 11, 4, 128, 110, 116, 66, 100, 100, 65, 109, 117, 98, 108, 65, 231};


//: back_arrow_b
Byte kStr_similarityTitle[] = {89, 12, 5, 134, 184, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 56};


//: report_activity_title
Byte kStr_hamValue[] = {47, 21, 6, 100, 27, 135, 101, 108, 116, 105, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 114, 111, 112, 101, 114, 247};


//: icon_checkbox_selected
Byte kStr_viewKnifeTitle[] = {43, 22, 6, 63, 27, 131, 100, 101, 116, 99, 101, 108, 101, 115, 95, 120, 111, 98, 107, 99, 101, 104, 99, 95, 110, 111, 99, 105, 241};


//: image%lu
Byte kStr_addFileValue[] = {74, 8, 9, 198, 137, 126, 172, 91, 167, 117, 108, 37, 101, 103, 97, 109, 105, 27};


//: #612CF9
Byte kStr_indicateMaxData[] = {97, 7, 5, 231, 82, 57, 70, 67, 50, 49, 54, 35, 173};


//: #875FFA
Byte kStr_gangTitle[] = {97, 7, 4, 140, 65, 70, 70, 53, 55, 56, 35, 230};


//: common_bg
Byte kStr_birdData[] = {7, 9, 9, 139, 117, 238, 140, 17, 187, 103, 98, 95, 110, 111, 109, 109, 111, 99, 92};


//: public.image
Byte kStr_brandTitle[] = {23, 12, 5, 80, 96, 101, 103, 97, 109, 105, 46, 99, 105, 108, 98, 117, 112, 5};


//: code
Byte kStr_pinText[] = {39, 4, 4, 166, 101, 100, 111, 99, 183};


//: msg
Byte kStr_maxDiscusTonightText[] = {11, 3, 5, 135, 193, 103, 115, 109, 242};


//: #999999
Byte kStr_surgeDiscusContent[] = {75, 7, 4, 103, 57, 57, 57, 57, 57, 57, 35, 125};


//: %lu/400
Byte kStr_fedLimitValue[] = {51, 7, 13, 255, 125, 60, 26, 44, 143, 70, 175, 193, 196, 48, 48, 52, 47, 117, 108, 37, 138};


//: contact
Byte kStr_offeringMemberName[] = {78, 7, 13, 210, 208, 15, 182, 128, 48, 161, 28, 41, 193, 116, 99, 97, 116, 110, 111, 99, 121};


//: /other/feedback
Byte kStr_taTitle[] = {16, 15, 7, 217, 11, 165, 252, 107, 99, 97, 98, 100, 101, 101, 102, 47, 114, 101, 104, 116, 111, 47, 75};


//: group_info_activity_op_failed
Byte kStr_offeringDoingLinkData[] = {87, 29, 4, 116, 100, 101, 108, 105, 97, 102, 95, 112, 111, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 245};


//: #A148FF
Byte kStr_refugeeDisplayData[] = {52, 7, 6, 207, 247, 86, 70, 70, 56, 52, 49, 65, 35, 185};


//: report_info
Byte kStr_absolutelyContent[] = {41, 11, 12, 126, 168, 61, 122, 231, 220, 177, 68, 186, 111, 102, 110, 105, 95, 116, 114, 111, 112, 101, 114, 95};
...
//    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"common_bg"]];
    ...
    bg.image = [UIImage imageNamed:StringFromNameData(kStr_birdData)];
...
//    [self.view addSubview:bg];
    ...
    [backButton setImage:[UIImage imageNamed:StringFromNameData(kStr_similarityTitle)] forState:(UIControlStateNormal)];
    ...
    labtitle.text = [TeamManager sizeKey:StringFromNameData(kStr_hamValue)];
    ...
    [submitButton setImage:[UIImage imageNamed:StringFromNameData(kStr_viewKnifeTitle)] forState:(UIControlStateNormal)];
...
//    self.navigationItem.rightBarButtonItem.enabled = NO;
    ...
    _textView = [[UITextView alloc] initWithFrame:CGRectMake(15, (44.0f + [UIDevice table])+15, [[UIScreen mainScreen] bounds].size.width-30, 200)];
    //: _textView.placeholder = [FFFLanguageManager getTextWithKey:@"report_info"];
    _textView.placeholder = [TeamManager sizeKey:StringFromNameData(kStr_absolutelyContent)];//@"请输入您的举报信息";
    ...
    self.numLabel.text = [NSString stringWithFormat:StringFromNameData(kStr_fedLimitValue),(unsigned long)_textView.text.length];
    //: self.numLabel.frame = CGRectMake(15, (44.0f + [UIDevice vg_statusBarHeight])+200+30, [[UIScreen mainScreen] bounds].size.width-30, 20);
    self.numLabel.frame = CGRectMake(15, (44.0f + [UIDevice table])+200+30, [[UIScreen mainScreen] bounds].size.width-30, 20);
...
//    }
    ...
    self.numLabel.text = [NSString stringWithFormat:StringFromNameData(kStr_fedLimitValue),textView.text.length];
}
...
-(void)modeClick{
    ...
    dict[StringFromNameData(kStr_offeringMemberName)] = _textView.text;
    ...
    if (_selectedPhotos.count > 0) {
        ...
        [_selectedPhotos enumerateObjectsUsingBlock:^(UIImage *image , NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            [nameArray addObject:[NSString stringWithFormat:StringFromNameData(kStr_addFileValue),(unsigned long)(idx+1)]];
        //: }];
        }];
    }
    //: [SVProgressHUD show];
    ...
    [InfoManager paintTheLilyShould:[NSString stringWithFormat:StringFromNameData(kStr_taTitle)] tapHappening:dict soul:array specification_strong:nameArray modePath:^(NSProgress *progress) {
    ...
    //: } success:^(id responseObject) {
        ...
        NSString *code = [resultDict speedy:StringFromNameData(kStr_pinText)];
        //: NSString *msg = [resultDict newStringValueForKey:@"msg"];
        NSString *msg = [resultDict speedy:StringFromNameData(kStr_maxDiscusTonightText)];
    ...
    //: } failed:^(id responseObject, NSError *error) {
        ...
        [SVProgressHUD rangeMessage:[TeamManager sizeKey:StringFromNameData(kStr_offeringDoingLinkData)]];
    //: }];
    }];
...
- (UILabel *)numLabel{
    ...
    if (!_numLabel) {
        ...
        _numLabel.textColor = [UIColor isView:StringFromNameData(kStr_surgeDiscusContent)];
    }
    //: return _numLabel;
    return _numLabel;
}
...
- (UIImagePickerController *)imagePickerVc {
    ...
    if (_imagePickerVc == nil) {
        ...
        _imagePickerVc.navigationBar.barTintColor = [UIColor colorWithPatternImage:[MessageTitleHelper edit:[UIColor isView:StringFromNameData(kStr_gangTitle)] magnitudeerval:[UIColor isView:StringFromNameData(kStr_indicateMaxData)] view:SNLinearGradientDirectionLevel]];
        //: _imagePickerVc.navigationBar.tintColor = [UIColor colorWithHexString:@"#A148FF"];
        _imagePickerVc.navigationBar.tintColor = [UIColor isView:StringFromNameData(kStr_refugeeDisplayData)];
    }
...
- (void)viewDidLayoutSubviews {
    ...
    self.collectionView.frame = CGRectMake(0, self.textView.quickOf + self.textView.height, self.view.tz_width, self.view.tz_height - self.textView.height);
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.item == _selectedPhotos.count) {
        ...
        cell.imageView.image = [UIImage imageNamed:StringFromNameData(kStr_reverseBirdData)];
...
- (void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    if ([type isEqualToString:StringFromNameData(kStr_brandTitle)]) {
        ...
        [[TZImageManager manager] savePhotoWithImage:image meta:meta location:nil completion:^(PHAsset *asset, NSError *error){
            ...
            //: } else {
                ...
                [self show:assetModel.asset position:image];
            }
        //: }];
        }];
    }
...
- (void)show:(PHAsset *)asset position:(UIImage *)image {
...
Byte * NameDataToCache(Byte *data) {
    int barGoing = data[0];
    int collection = data[1];
    int departmentTheory = data[2];
    if (!barGoing) return data + departmentTheory;
    for (int i = 0; i < collection / 2; i++) {
        int begin = departmentTheory + i;
        int end = departmentTheory + collection - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[departmentTheory + collection] = 0;
    return data + departmentTheory;
}

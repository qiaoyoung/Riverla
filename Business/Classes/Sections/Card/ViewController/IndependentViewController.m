...
NSString *StringFromHonkyTonkData(Byte *data);


//: isfrend
Byte kStr_fieldData[] = {86, 7, 12, 139, 101, 151, 105, 109, 125, 47, 137, 133, 100, 110, 101, 114, 102, 115, 105, 93};


//: user_profile_avtivity_remove_friend_tip
Byte kStr_modelTitle[] = {35, 39, 7, 216, 170, 73, 175, 112, 105, 116, 95, 100, 110, 101, 105, 114, 102, 95, 101, 118, 111, 109, 101, 114, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 101, 108, 105, 102, 111, 114, 112, 95, 114, 101, 115, 117, 112};


//: contact_tag_fragment_sure
Byte kStr_showTitle[] = {65, 25, 12, 99, 117, 23, 108, 112, 115, 8, 100, 97, 101, 114, 117, 115, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 79};


//: contact_tag_fragment_cancel
Byte kStr_myKitValue[] = {36, 27, 10, 168, 100, 5, 12, 75, 161, 11, 108, 101, 99, 110, 97, 99, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 26};


//: icon_me_arrow
Byte kStr_pinVideoName[] = {99, 13, 12, 117, 116, 4, 198, 131, 15, 50, 43, 153, 119, 111, 114, 114, 97, 95, 101, 109, 95, 110, 111, 99, 105, 207};


//: friend_delete_fail
Byte kStr_messageTitle[] = {85, 18, 3, 108, 105, 97, 102, 95, 101, 116, 101, 108, 101, 100, 95, 100, 110, 101, 105, 114, 102, 164};


//: head_default
Byte kStr_questionPartMessageValue[] = {23, 12, 8, 100, 73, 142, 129, 189, 116, 108, 117, 97, 102, 101, 100, 95, 100, 97, 101, 104, 14};


//: #ECECEC
Byte kStr_contentLastName[] = {75, 7, 4, 4, 67, 69, 67, 69, 67, 69, 35, 97};


//: /other/feedback
Byte kStr_contentTitle[] = {35, 15, 10, 134, 104, 31, 254, 197, 200, 158, 107, 99, 97, 98, 100, 101, 101, 102, 47, 114, 101, 104, 116, 111, 47, 188};


//: back_arrow_bl
Byte kStr_textTingWithData[] = {4, 13, 6, 136, 158, 233, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 148};


//: group_info_activity_op_failed
Byte kStr_appTitle[] = {19, 29, 6, 212, 74, 27, 100, 101, 108, 105, 97, 102, 95, 112, 111, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 24};


//: type
Byte kStr_itemStopAddName[] = {91, 4, 6, 245, 230, 77, 101, 112, 121, 116, 149};


//: message_info_activity_message_info
Byte kStr_memberContent[] = {77, 34, 8, 59, 62, 187, 167, 125, 111, 102, 110, 105, 95, 101, 103, 97, 115, 115, 101, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 101, 103, 97, 115, 115, 101, 109, 216};


//: /group/addgroupuser
Byte kStr_shouldContent[] = {22, 19, 7, 225, 252, 222, 179, 114, 101, 115, 117, 112, 117, 111, 114, 103, 100, 100, 97, 47, 112, 117, 111, 114, 103, 47, 94};


//: contact
Byte kStr_viewText[] = {99, 7, 8, 144, 201, 55, 161, 13, 116, 99, 97, 116, 110, 111, 99, 128};


//: name
Byte kStr_textWithValue[] = {29, 4, 12, 247, 151, 199, 110, 64, 175, 203, 225, 181, 101, 109, 97, 110, 203};


//: add_friend_add_fail
Byte kStr_showGreenKitName[] = {37, 19, 6, 150, 82, 129, 108, 105, 97, 102, 95, 100, 100, 97, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 134};


//: friend_ids
Byte kStr_cellText[] = {38, 10, 8, 10, 248, 135, 162, 133, 115, 100, 105, 95, 100, 110, 101, 105, 114, 102, 30};


//: account
Byte kStr_replacementTitle[] = {32, 7, 11, 142, 188, 71, 136, 99, 142, 154, 10, 116, 110, 117, 111, 99, 99, 97, 5};


//: ic_card_black
Byte kStr_greenViewTitle[] = {59, 13, 10, 5, 6, 239, 33, 99, 36, 83, 107, 99, 97, 108, 98, 95, 100, 114, 97, 99, 95, 99, 105, 93};


//: ic_card_report
Byte kStr_messageContent[] = {12, 14, 6, 7, 23, 81, 116, 114, 111, 112, 101, 114, 95, 100, 114, 97, 99, 95, 99, 105, 162};


//: add_friend_request_fail
Byte kStr_colorData[] = {84, 23, 7, 82, 249, 123, 252, 108, 105, 97, 102, 95, 116, 115, 101, 117, 113, 101, 114, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 8};


//: user_info_avtivity_upload_avatar_failed
Byte kStr_colorDatePinName[] = {3, 39, 12, 183, 140, 237, 222, 10, 191, 62, 33, 38, 100, 101, 108, 105, 97, 102, 95, 114, 97, 116, 97, 118, 97, 95, 100, 97, 111, 108, 112, 117, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 111, 102, 110, 105, 95, 114, 101, 115, 117, 229};


//: #2C3042
Byte kStr_pressWithName[] = {41, 7, 7, 60, 29, 26, 238, 50, 52, 48, 51, 67, 50, 35, 239};


//: team_create_helper_create_failed
Byte kStr_redQuestionName[] = {89, 32, 3, 100, 101, 108, 105, 97, 102, 95, 101, 116, 97, 101, 114, 99, 95, 114, 101, 112, 108, 101, 104, 95, 101, 116, 97, 101, 114, 99, 95, 109, 97, 101, 116, 78};


//: request_successful
Byte kStr_makeBlueValue[] = {78, 18, 7, 187, 92, 179, 63, 108, 117, 102, 115, 115, 101, 99, 99, 117, 115, 95, 116, 115, 101, 117, 113, 101, 114, 208};


//: Group_chat
Byte kStr_linkItemTitle[] = {79, 10, 5, 47, 24, 116, 97, 104, 99, 95, 112, 117, 111, 114, 71, 242};


//: friend_circle_adapter_delete
Byte kStr_greenVideoCellTitle[] = {29, 28, 6, 252, 169, 83, 101, 116, 101, 108, 101, 100, 95, 114, 101, 116, 112, 97, 100, 97, 95, 101, 108, 99, 114, 105, 99, 95, 100, 110, 101, 105, 114, 102, 165};


//: invite_you_group
Byte kStr_messageTapValue[] = {19, 16, 7, 92, 237, 30, 125, 112, 117, 111, 114, 103, 95, 117, 111, 121, 95, 101, 116, 105, 118, 110, 105, 57};


//: ic_card_notice
Byte kStr_redLastShowValue[] = {49, 14, 10, 38, 136, 78, 22, 36, 4, 131, 101, 99, 105, 116, 111, 110, 95, 100, 114, 97, 99, 95, 99, 105, 214};


//: mobile
Byte kStr_modelValue[] = {89, 6, 3, 101, 108, 105, 98, 111, 109, 142};


//: contact_tag_fragment_add_success
Byte kStr_nameData[] = {92, 32, 13, 63, 17, 228, 228, 7, 227, 149, 121, 166, 171, 115, 115, 101, 99, 99, 117, 115, 95, 100, 100, 97, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 94};


//: data
Byte kStr_messagePartData[] = {4, 4, 8, 91, 174, 245, 190, 69, 97, 116, 97, 100, 21};


//: /group/getgroups
Byte kStr_partData[] = {22, 16, 13, 172, 236, 71, 95, 220, 110, 73, 193, 249, 57, 115, 112, 117, 111, 114, 103, 116, 101, 103, 47, 112, 117, 111, 114, 103, 47, 136};


//: message_info_activity_msg_notice
Byte kStr_messageValue[] = {17, 32, 9, 140, 238, 18, 35, 40, 180, 101, 99, 105, 116, 111, 110, 95, 103, 115, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 101, 103, 97, 115, 115, 101, 109, 99};


//: func_viewholder_black
Byte kStr_redText[] = {54, 21, 12, 164, 189, 43, 29, 71, 125, 220, 166, 123, 107, 99, 97, 108, 98, 95, 114, 101, 100, 108, 111, 104, 119, 101, 105, 118, 95, 99, 110, 117, 102, 207};


//: gotoBlacklist
Byte kStr_shouldMyValue[] = {91, 13, 5, 173, 94, 116, 115, 105, 108, 107, 99, 97, 108, 66, 111, 116, 111, 103, 208};


//: personcart_profile_bg
Byte kStr_contentFrameData[] = {24, 21, 3, 103, 98, 95, 101, 108, 105, 102, 111, 114, 112, 95, 116, 114, 97, 99, 110, 111, 115, 114, 101, 112, 188};


//: #8A8E98
Byte kStr_withInfoContent[] = {10, 7, 4, 115, 56, 57, 69, 56, 65, 56, 35, 5};


//: #FF483D
Byte kStr_fileAppData[] = {38, 7, 11, 231, 26, 1, 210, 228, 10, 145, 185, 68, 51, 56, 52, 70, 70, 35, 123};


//: add_friend_activity_add_friend
Byte kStr_successReplacementData[] = {72, 30, 6, 233, 151, 142, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 81};


//: black_list_activity_add_black_failed
Byte kStr_titleData[] = {12, 36, 5, 191, 79, 100, 101, 108, 105, 97, 102, 95, 107, 99, 97, 108, 98, 95, 100, 100, 97, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 115, 105, 108, 95, 107, 99, 97, 108, 98, 79};


//: #EEEEEE
Byte kStr_withPartContent[] = {52, 7, 12, 72, 124, 242, 93, 122, 242, 59, 56, 241, 69, 69, 69, 69, 69, 69, 35, 116};


//: group_chat_avatar_activity_add_black_success
Byte kStr_willName[] = {94, 44, 11, 173, 231, 138, 114, 181, 123, 163, 142, 115, 115, 101, 99, 99, 117, 115, 95, 107, 99, 97, 108, 98, 95, 100, 100, 97, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 114, 97, 116, 97, 118, 97, 95, 116, 97, 104, 99, 95, 112, 117, 111, 114, 103, 45};


//: #B391FF
Byte kStr_imageEnableValue[] = {57, 7, 6, 199, 27, 140, 70, 70, 49, 57, 51, 66, 35, 23};


//: report_activity_title
Byte kStr_dateData[] = {86, 21, 9, 32, 250, 33, 106, 37, 66, 101, 108, 116, 105, 116, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 114, 111, 112, 101, 114, 149};


//: contact_tag_fragment_delete_success
Byte kStr_cellBubbleText[] = {89, 35, 10, 216, 102, 36, 15, 188, 238, 129, 115, 115, 101, 99, 99, 117, 115, 95, 101, 116, 101, 108, 101, 100, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 117};


//: ic_sex_woman
Byte kStr_pinData[] = {11, 12, 3, 110, 97, 109, 111, 119, 95, 120, 101, 115, 95, 99, 105, 67};


//: register_avtivity_account
Byte kStr_barShouldKitValue[] = {2, 25, 9, 10, 46, 62, 113, 74, 221, 116, 110, 117, 111, 99, 99, 97, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 114, 101, 116, 115, 105, 103, 101, 114, 238};


//: black_list_activity_remove_black
Byte kStr_maxTitle[] = {32, 32, 13, 183, 24, 68, 235, 4, 85, 2, 244, 154, 50, 107, 99, 97, 108, 98, 95, 101, 118, 111, 109, 101, 114, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 115, 105, 108, 95, 107, 99, 97, 108, 98, 86};


//: jpg
Byte kStr_nameText[] = {21, 3, 13, 185, 100, 81, 39, 195, 255, 7, 26, 25, 142, 103, 112, 106, 99};


//: code
Byte kStr_colorVideoBarTitle[] = {78, 4, 8, 188, 245, 75, 134, 166, 101, 100, 111, 99, 227};


//: #FDF4C9
Byte kStr_spaceText[] = {22, 7, 10, 111, 123, 74, 125, 26, 100, 7, 57, 67, 52, 70, 68, 70, 35, 249};


//: message_remark_name
Byte kStr_addValue[] = {61, 19, 13, 111, 40, 232, 150, 173, 235, 58, 70, 157, 60, 101, 109, 97, 110, 95, 107, 114, 97, 109, 101, 114, 95, 101, 103, 97, 115, 115, 101, 109, 53};


//: canAddFriend
Byte kStr_modelBarFieldTitle[] = {25, 12, 8, 67, 194, 220, 218, 11, 100, 110, 101, 105, 114, 70, 100, 100, 65, 110, 97, 99, 11};


//: #ffffff
Byte kStr_contentText[] = {78, 7, 12, 246, 148, 199, 242, 197, 231, 217, 222, 230, 102, 102, 102, 102, 102, 102, 35, 116};


//: /user/detail
Byte kStr_securityName[] = {50, 12, 6, 150, 123, 23, 108, 105, 97, 116, 101, 100, 47, 114, 101, 115, 117, 47, 80};


//: user_id
Byte kStr_tingCellName[] = {12, 7, 4, 168, 100, 105, 95, 114, 101, 115, 117, 99};


//: personCard_bg
Byte kStr_shouldDoingTitle[] = {57, 13, 9, 187, 114, 47, 240, 13, 196, 103, 98, 95, 100, 114, 97, 67, 110, 111, 115, 114, 101, 112, 219};


//: item_data
Byte kStr_cellContent[] = {54, 9, 3, 97, 116, 97, 100, 95, 109, 101, 116, 105, 14};


//: black_list_activity_remove_black_failed
Byte kStr_memberName[] = {34, 39, 7, 120, 51, 43, 58, 100, 101, 108, 105, 97, 102, 95, 107, 99, 97, 108, 98, 95, 101, 118, 111, 109, 101, 114, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 115, 105, 108, 95, 107, 99, 97, 108, 98, 155};


//: his_qr
Byte kStr_linkTitle[] = {85, 6, 10, 176, 225, 242, 71, 172, 156, 203, 114, 113, 95, 115, 105, 104, 217};


//: ic_card_edit
Byte kStr_screenOfValue[] = {98, 12, 5, 48, 79, 116, 105, 100, 101, 95, 100, 114, 97, 99, 95, 99, 105, 87};


//: avatar
Byte kStr_viewBubbleName[] = {96, 6, 10, 81, 80, 241, 211, 148, 186, 250, 114, 97, 116, 97, 118, 97, 169};


//: ic_sex_man
Byte kStr_shadowGreenData[] = {39, 10, 7, 40, 192, 160, 189, 110, 97, 109, 95, 120, 101, 115, 95, 99, 105, 112};


//: 未设置
Byte kStr_colorTapTingData[] = {82, 9, 5, 177, 113, 174, 189, 231, 190, 174, 232, 170, 156, 230, 37};


//: user_profile_avtivity_remove_friend
Byte kStr_cellTitle[] = {84, 35, 3, 100, 110, 101, 105, 114, 102, 95, 101, 118, 111, 109, 101, 114, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 101, 108, 105, 102, 111, 114, 112, 95, 114, 101, 115, 117, 187};


//: group_id
Byte kStr_infoTitleValue[] = {31, 8, 13, 88, 171, 61, 101, 47, 188, 74, 79, 255, 246, 100, 105, 95, 112, 117, 111, 114, 103, 231};


//: #F6F7FA
Byte kStr_appTapName[] = {56, 7, 8, 225, 237, 47, 40, 20, 65, 70, 55, 70, 54, 70, 35, 126};


//: please_contact_your_administrator
Byte kStr_partName[] = {13, 33, 13, 3, 9, 163, 164, 72, 118, 236, 166, 98, 30, 114, 111, 116, 97, 114, 116, 115, 105, 110, 105, 109, 100, 97, 95, 114, 117, 111, 121, 95, 116, 99, 97, 116, 110, 111, 99, 95, 101, 115, 97, 101, 108, 112, 151};
...
@interface IndependentViewController ()<NIMUserManagerDelegate,MarginDoing,RelateContainer,InformItem>
...
@property (nonatomic, strong) LanguageView *reprotView;
//: @property (nonatomic, strong) FFFRemarksView *changeRemarksView;
@property (nonatomic, strong) ShowChangeView *changeRemarksView;
...
//    [self setUpNav];
    ...
    self.view.backgroundColor = [UIColor isView:StringFromHonkyTonkData(kStr_appTapName)];
    ...
    dict[StringFromHonkyTonkData(kStr_tingCellName)] = self.userId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [InfoManager enable:[NSString stringWithFormat:StringFromHonkyTonkData(kStr_securityName)] sub:dict record:NO tapGetFailed:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict speedy:StringFromHonkyTonkData(kStr_colorVideoBarTitle)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict straddle:StringFromHonkyTonkData(kStr_messagePartData)];
            //: self.userAcount = [data newStringValueForKey:@"account"];
            self.userAcount = [data speedy:StringFromHonkyTonkData(kStr_replacementTitle)];
            //: NSString *avatar = [data newStringValueForKey:@"avatar"];
            NSString *avatar = [data speedy:StringFromHonkyTonkData(kStr_viewBubbleName)];

            //: NSString *str = [NSString stringWithFormat:@"%@:%@",[FFFLanguageManager getTextWithKey:@"register_avtivity_account"],self.userAcount];
            NSString *str = [NSString stringWithFormat:@"%@:%@",[TeamManager sizeKey:StringFromHonkyTonkData(kStr_barShouldKitValue)],self.userAcount];
         ...
         autoreleasepool{} __weak __typeof__(self) __weak_self__ = self;
            ...
            [[NIMSDK sharedSDK].userManager fetchUserInfos:@[self.userId] completion:^(NSArray<NIMUser *> * _Nullable users, NSError * _Nullable error) {
                ...
                if (users.count) {
                    ...
                    [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromHonkyTonkData(kStr_questionPartMessageValue)]];
                    ...
                    if (self.user.userInfo.gender == NIMUserGenderMale) {
                        ...
                        _sexImg.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_shadowGreenData)];
                    //: }else if (self.user.userInfo.gender == NIMUserGenderFemale){
                    }else if (self.user.userInfo.gender == NIMUserGenderFemale){
                        //: _sexImg.image = [UIImage imageNamed:@"ic_sex_woman"];
                        _sexImg.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_pinData)];
                    }
                    ...
                    self.labRemark.text = self.user.alias.length ? self.user.alias : [TeamManager sizeKey:StringFromHonkyTonkData(kStr_colorTapTingData)];
                    //: self.labSign.text = self.user.userInfo.sign.length ? self.user.userInfo.sign : [FFFLanguageManager getTextWithKey:@"未设置"];
                    self.labSign.text = self.user.userInfo.sign.length ? self.user.userInfo.sign : [TeamManager sizeKey:StringFromHonkyTonkData(kStr_colorTapTingData)];
...
//    [SVProgressHUD show];
    ...
    [InfoManager enable:[NSString stringWithFormat:StringFromHonkyTonkData(kStr_partData)] sub:nil record:NO tapGetFailed:^(id responseObject) {
...
//        [SVProgressHUD dismissWithCompletion:^{
            ...
            if (code.integerValue == 0) {
                ...
                NSArray *dataArray = [resultDict parent:StringFromHonkyTonkData(kStr_messagePartData)];
                //: NSDictionary *dataDict = [NSDictionary dictionaryWithObject:dataArray forKey:@"item_data"];
                NSDictionary *dataDict = [NSDictionary dictionaryWithObject:dataArray forKey:StringFromHonkyTonkData(kStr_cellContent)];
                //: HMDataPicker *dataPick = [[HMDataPicker alloc] initWithDelegate:self dataDict:dataDict selectedDict:nil jsonNode:@"name"];
                PickerView *dataPick = [[PickerView alloc] initWithNode:self with:dataDict node:nil streetSmart:StringFromHonkyTonkData(kStr_textWithValue)];
                //: dataPick.tag = 500;
                dataPick.tag = 500;
                //: [dataPick show];
                [dataPick sendSelected];
            }
//        }];
    //: } failed:^(id responseObject, NSError *error) {
    } failedSmartOccurrentSelectShowGet:^(id responseObject, NSError *error) {
//        [SVProgressHUD dismiss];
        ...
        [self.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_colorData)]
                    //: duration:2.0
                    duration:2.0
...
-(void)value:(id)sender{
    ...
    if (switcher.on) {
        ...
        dict[StringFromHonkyTonkData(kStr_modelValue)] = self.userId;
        //: dict[@"type"] = @"1";
        dict[StringFromHonkyTonkData(kStr_itemStopAddName)] = @"1";//拉入黑名单
        //: [wself refresh];
        [wself success];
    ...
    //: }else{
        ...
        dict[StringFromHonkyTonkData(kStr_modelValue)] = self.userId;
        //: dict[@"type"] = @"0";
        dict[StringFromHonkyTonkData(kStr_itemStopAddName)] = @"0";//解除黑名单
        //: [wself refresh];
        [wself success];
...
//            [SVProgressHUD dismiss];
            ...
            if (!error) {
                ...
                [wself.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_willName)] duration:2.0f position:CSToastPositionCenter];
            //: }else{
            }else{
                ...
                [wself.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_titleData)] duration:2.0f position:CSToastPositionCenter];
                //: [wself refresh];
                [wself success];
            }
        //: }];
...
//            [SVProgressHUD dismiss];
            ...
            if (!error) {
                ...
                [wself.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_maxTitle)] duration:2.0f position:CSToastPositionCenter];
            //: }else{
            }else{
                ...
                [wself.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_memberName)] duration:2.0f position:CSToastPositionCenter];
                //: [wself refresh];
                [wself success];
            }
        //: }];
...
//        [SVProgressHUD dismiss];
        ...
        if (error) {
            ...
            [wself.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_appTitle)] duration:2.0f position:CSToastPositionCenter];
            //: [wself refresh];
            [wself success];
        }
    //: }];
...
- (void)showOf
{
    ...
    [self uncoloured:^(NSArray *uids, NSString *name, UIImage *avater) {
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
                        ;
...
//        [SVProgressHUD show];
        ...
        [self index:avater allOrNoneBackground:^(NSString *urlString) {
            ...
            option.postscript = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_messageTapValue)];
//            [SVProgressHUD show];
...
//                [SVProgressHUD dismiss];
                ...
                //: }else{
                    ...
                    [self.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_redQuestionName)] duration:2.0 position:CSToastPositionCenter];
                }
            //: }];
            }];
...
- (void)uncoloured:(ContactSelectFinishBlock) block{
...
- (void)index:(UIImage *)image allOrNoneBackground:(void(^)(NSString *urlString ))complete {
    ...
    UIImage *imageForAvatarUpload = [image remove:CGSizeMake(375, 375)];
    //: NSString *fileName = [FFFKitFileLocationHelper genFilenameWithExt:@"jpg"];
    NSString *fileName = [WithHelper value:StringFromHonkyTonkData(kStr_nameText)];
    //: NSString *filePath = [[FFFKitFileLocationHelper getAppDocumentPath] stringByAppendingPathComponent:fileName];
    NSString *filePath = [[WithHelper dismissCustom] stringByAppendingPathComponent:fileName];
    ...
    if (success) {
        ...
        //: } completion:^(NSString * _Nullable urlString, NSError * _Nullable error) {
            ...
            //: }else{
                ...
                [wself.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_colorDatePinName)]
                             //: duration:2
                             duration:2
                             //: position:CSToastPositionCenter];
                             position:CSToastPositionCenter];
    ...
    //: }else{
        ...
        [self.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_colorDatePinName)]
                    //: duration:2
                    duration:2
                    //: position:CSToastPositionCenter];
                    position:CSToastPositionCenter];
...
-(void)searchedText{
    ...
    if (_teamSetingConfig != nil) {
        ...
        NSString *canAddFriend = [_teamSetingConfig speedy:StringFromHonkyTonkData(kStr_modelBarFieldTitle)];
        ...
        if (canAddFriend.integerValue <= 0) {
            ...
            [SVProgressHUD rangeMessage:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_partName)]];
            //: return;
            return;
        }
    }
...
-(void)constantBy{
    ...
    NSString *contact_tag_fragment_add_success = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_nameData)];//@"添加成功"
    //: NSString *request_successful = [FFFLanguageManager getTextWithKey:@"request_successful"];
    NSString *request_successful = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_makeBlueValue)];//@"请求成功"
    //: NSString *add_friend_add_fail = [FFFLanguageManager getTextWithKey:@"add_friend_add_fail"];
    NSString *add_friend_add_fail = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_showGreenKitName)];//@"添加失败"
    //: NSString *add_friend_request_fail = [FFFLanguageManager getTextWithKey:@"add_friend_request_fail"];
    NSString *add_friend_request_fail = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_colorData)];//@"请求失败"
...
-(void)show{
    ...
    dict[StringFromHonkyTonkData(kStr_infoTitleValue)] = [_groupDict speedy:@"id"];
    //: dict[@"friend_ids"] = self.user.userId;
    dict[StringFromHonkyTonkData(kStr_cellText)] = self.user.userId;
    //: dict[@"isfrend"] = isMyFriend?@"1":@"0";
    dict[StringFromHonkyTonkData(kStr_fieldData)] = isMyFriend?@"1":@"0";

    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/group/addgroupuser"] params:dict isShow:YES success:^(id responseObject) {
    [InfoManager enable:[NSString stringWithFormat:StringFromHonkyTonkData(kStr_shouldContent)] sub:dict record:YES tapGetFailed:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSLog(@"-----%@",resultDict);
    //: } failed:^(id responseObject, NSError *error) {
...
- (void)sizeTo{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_cellTitle)] message:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_modelTitle)] delegate:nil cancelButtonTitle:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_myKitValue)] otherButtonTitles:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_showTitle)], nil];
...
//                [SVProgressHUD dismiss];
                ...
                if (!error) {
                    ...
                    [wself.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_cellBubbleText)] duration:2.0f position:CSToastPositionCenter];
                    //: [wself refresh];
                    [wself success];
                ...
                //: }else{
                    ...
                    [wself.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_messageTitle)] duration:2.0f position:CSToastPositionCenter];
                }
            //: }];
            }];
        }
...
- (void)yearLength{
    ...
    [ self.changeRemarksView tingOld: self.user];
    //: [self.changeRemarksView animationShow];
    [self.changeRemarksView data];
}
...
//        _userView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"personCard_bg"]];
        ...
        Bg.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_shouldDoingTitle)];
        ...
        UIImageView *userBg = [[UIImageView alloc]initWithFrame:CGRectMake(15, [UIDevice table]+44+20, [[UIScreen mainScreen] bounds].size.width-30, 140)];
        //: userBg.image = [UIImage imageNamed:@"personcart_profile_bg"];
        userBg.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_contentFrameData)];
        ...
        QrBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-30-36, [UIDevice table]+44+35, 36, 36);
//        QrBtn.backgroundColor = [UIColor whiteColor];
        //: [QrBtn setImage:[UIImage imageNamed:@"his_qr"] forState:UIControlStateNormal];
        [QrBtn setImage:[UIImage imageNamed:StringFromHonkyTonkData(kStr_linkTitle)] forState:UIControlStateNormal];
        //: [QrBtn addTarget:self action:@selector(handleQrbtn) forControlEvents:UIControlEventTouchUpInside];
        [QrBtn addTarget:self action:@selector(mediaPlace) forControlEvents:UIControlEventTouchUpInside];
        ...
        self.accountheadImg = [[UIImageView alloc] initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-100)/2, [UIDevice table]+20, 88, 88)];
        //: [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:@"head_default"]];
        [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromHonkyTonkData(kStr_questionPartMessageValue)]];
        ...
        _accountView.backgroundColor = [UIColor isView:StringFromHonkyTonkData(kStr_spaceText)];
...
//        self.accountId.backgroundColor = RGB_COLOR_String(@"#FDF4C9");
        ...
        self.accountId.textColor = [UIColor isView:StringFromHonkyTonkData(kStr_pressWithName)];
        ...
        if(isMyFriend){
            ...
            _messageBtn.backgroundColor = [UIColor isView:StringFromHonkyTonkData(kStr_imageEnableValue)];
            //: [_messageBtn addTarget:self action:@selector(btnchat) forControlEvents:UIControlEventTouchUpInside];
            [_messageBtn addTarget:self action:@selector(highSelected) forControlEvents:UIControlEventTouchUpInside];
            ...
            [_messageBtn setTitleColor:[UIColor isView:StringFromHonkyTonkData(kStr_contentText)] forState:UIControlStateNormal];
            //: [_messageBtn setTitle:[FFFLanguageManager getTextWithKey:@"message_info_activity_message_info"] forState:UIControlStateNormal];
            [_messageBtn setTitle:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_memberContent)] forState:UIControlStateNormal];
            ...
            _groupBtn.backgroundColor = [UIColor isView:StringFromHonkyTonkData(kStr_imageEnableValue)];
            //: [_groupBtn addTarget:self action:@selector(btnGroupchat) forControlEvents:UIControlEventTouchUpInside];
            [_groupBtn addTarget:self action:@selector(showOf) forControlEvents:UIControlEventTouchUpInside];
            ...
            [_groupBtn setTitleColor:[UIColor isView:StringFromHonkyTonkData(kStr_contentText)] forState:UIControlStateNormal];
            //: [_groupBtn setTitle:[FFFLanguageManager getTextWithKey:@"Group_chat"] forState:UIControlStateNormal];
            [_groupBtn setTitle:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_linkItemTitle)] forState:UIControlStateNormal];
        ...
        [self.closeBtn setImage:[UIImage imageNamed:StringFromHonkyTonkData(kStr_textTingWithData)] forState:(UIControlStateNormal)];
...
- (UIView *)personView
{
    ...
    if(!_personView){
        ...
        pic3.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_redLastShowValue)];
        ...
        self.labTitlenotice.text = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_messageValue)];
        ...
        [self.switchNotice addTarget:self action:@selector(messaging:) forControlEvents:UIControlEventValueChanged];
        //: self.switchNotice.onTintColor = [UIColor colorWithHexString:@"#B391FF"];
        self.switchNotice.onTintColor = [UIColor isView:StringFromHonkyTonkData(kStr_imageEnableValue)];
        ...
        line3.backgroundColor = [UIColor isView:StringFromHonkyTonkData(kStr_contentLastName)];
        ...
        pic4.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_greenViewTitle)];
        ...
        self.labTitleBlack.text = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_redText)];
        ...
        [blackBtn addTarget:self action:@selector(filterInList) forControlEvents:UIControlEventTouchUpInside];
        ...
        [blackBtn setTitleColor:[UIColor isView:StringFromHonkyTonkData(kStr_imageEnableValue)] forState:UIControlStateNormal];
        //: [blackBtn setTitle:[FFFLanguageManager getTextWithKey:@"gotoBlacklist"] forState:UIControlStateNormal];
        [blackBtn setTitle:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_shouldMyValue)] forState:UIControlStateNormal];
        ...
        [self.switchBlack addTarget:self action:@selector(distanceBy:) forControlEvents:UIControlEventValueChanged];
        //: self.switchBlack.onTintColor = [UIColor colorWithHexString:@"#B391FF"];
        self.switchBlack.onTintColor = [UIColor isView:StringFromHonkyTonkData(kStr_imageEnableValue)];
...
//        [shareCartView addSubview:arrow5];
        ...
        UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(yearLength)];
        ...
        pic1.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_screenOfValue)];
        ...
        self.labTitleRemark.text = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_addValue)];
        ...
        self.labRemark.textColor = [UIColor isView:StringFromHonkyTonkData(kStr_withInfoContent)];
        ...
        arrow.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_pinVideoName)];
        ...
        line1.backgroundColor = [UIColor isView:StringFromHonkyTonkData(kStr_contentLastName)];
...
//        [signView addSubview:line2];
        ...
        UITapGestureRecognizer *reporttapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(itemGreen)];
        ...
        picreport.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_messageContent)];
        ...
        self.labTitleResport.text = [TeamManager sizeKey:StringFromHonkyTonkData(kStr_dateData)];
        ...
        arrowreport.image = [UIImage imageNamed:StringFromHonkyTonkData(kStr_pinVideoName)];
        ...
        [self.btnAdd setTitleColor:[UIColor isView:StringFromHonkyTonkData(kStr_fileAppData)] forState:UIControlStateNormal];
        //: [self.btnAdd setTitle:[FFFLanguageManager getTextWithKey:@"add_friend_activity_add_friend"] forState:UIControlStateNormal];
        [self.btnAdd setTitle:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_successReplacementData)] forState:UIControlStateNormal];
        //: [self.btnAdd addTarget:self action:@selector(addFriend) forControlEvents:UIControlEventTouchUpInside];
        [self.btnAdd addTarget:self action:@selector(searchedText) forControlEvents:UIControlEventTouchUpInside];
        //: self.btnAdd.backgroundColor = [UIColor colorWithHexString:@"#ffffff"];
        self.btnAdd.backgroundColor = [UIColor isView:StringFromHonkyTonkData(kStr_contentText)];
        //: self.btnAdd.layer.borderWidth = 1;
        self.btnAdd.layer.borderWidth = 1;
        //: self.btnAdd.layer.borderColor = [UIColor colorWithHexString:@"#EEEEEE"].CGColor;
        self.btnAdd.layer.borderColor = [UIColor isView:StringFromHonkyTonkData(kStr_withPartContent)].CGColor;
        ...
        [self.btnDelete setTitleColor:[UIColor isView:StringFromHonkyTonkData(kStr_fileAppData)] forState:UIControlStateNormal];
        //: [self.btnDelete setTitle:[FFFLanguageManager getTextWithKey:@"friend_circle_adapter_delete"] forState:UIControlStateNormal];
        [self.btnDelete setTitle:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_greenVideoCellTitle)] forState:UIControlStateNormal];
        //: [self.btnDelete addTarget:self action:@selector(deleteFriend) forControlEvents:UIControlEventTouchUpInside];
        [self.btnDelete addTarget:self action:@selector(sizeTo) forControlEvents:UIControlEventTouchUpInside];
        //: self.btnDelete.backgroundColor = [UIColor colorWithHexString:@"#ffffff"];
        self.btnDelete.backgroundColor = [UIColor isView:StringFromHonkyTonkData(kStr_contentText)];
        //: self.btnDelete.layer.borderWidth = 1;
        self.btnDelete.layer.borderWidth = 1;
        //: self.btnDelete.layer.borderColor = [UIColor colorWithHexString:@"#EEEEEE"].CGColor;
        self.btnDelete.layer.borderColor = [UIColor isView:StringFromHonkyTonkData(kStr_withPartContent)].CGColor;
...
- (ShowChangeView *)changeRemarksView
{
    ...
    if(!_changeRemarksView){
        ...
        _changeRemarksView = [[ShowChangeView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
- (ChildInfoView *)loadingView
{
    ...
    if(!_loadingView){
        ...
        _loadingView = [[ChildInfoView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
    }
    //: return _loadingView;
    return _loadingView;
}
//: - (ZMONReportUserView *)reprotView
- (LanguageView *)reprotView
{
    //: if(!_reprotView){
    if(!_reprotView){
        ...
        _reprotView = [[LanguageView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
-(void)atomicSum85:(NSString *)reason
{
    ...
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"contact"] = reason?:@"";
    dict[StringFromHonkyTonkData(kStr_viewText)] = reason?:@"";
    //: [ZCHttpManager postWithUrl:[NSString stringWithFormat:@"/other/feedback"] params:dict isShow:NO success:^(id responseObject) {
    [InfoManager should:[NSString stringWithFormat:StringFromHonkyTonkData(kStr_contentTitle)] after:dict dataDisable:NO displayDatePress:^(id responseObject) {
    //: } failed:^(id responseObject, NSError *error) {
    ...
    self.reprotBlackView.speiceBackBlock = ^(NSString *Name){
        ...
        [[NIMSDK sharedSDK].userManager addToBlackList:self.userId completion:^(NSError *error) {
                   ...
                   if (!error) {
                       ...
                       [self.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_willName)] duration:2.0f position:CSToastPositionCenter];
                   //: }else{
                   }else{
                       ...
                       [self.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_titleData)] duration:2.0f position:CSToastPositionCenter];
    ...
    self.reprotDeleteView.speiceBackBlock = ^(NSString *Name){
        ...
        [[NIMSDK sharedSDK].userManager deleteFriend:self.userId
            ...
            if (!error) {
                ...
                [self.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_cellBubbleText)] duration:2.0f position:CSToastPositionCenter];
            //: }else{
            }else{
                //: [self.view makeToast:[FFFLanguageManager getTextWithKey:@"friend_delete_fail"] duration:2.0f position:CSToastPositionCenter];
                [self.view makeToast:[TeamManager sizeKey:StringFromHonkyTonkData(kStr_messageTitle)] duration:2.0f position:CSToastPositionCenter];
            }
        //: }];
        }];
...
Byte * HonkyTonkDataToCache(Byte *data) {
    int accumulation = data[0];
    int withBlue = data[1];
    int tingTap = data[2];
    if (!accumulation) return data + tingTap;
    for (int i = 0; i < withBlue / 2; i++) {
        int begin = tingTap + i;
        int end = tingTap + withBlue - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[tingTap + withBlue] = 0;
    return data + tingTap;
}

NSString *StringFromHonkyTonkData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)HonkyTonkDataToCache(data)];
}  

...
NSString *StringFromMediaStyleData(Byte *data);        


//: type
Byte kStr_formatCanName[] = {1, 4, 47, 9, 138, 239, 1, 120, 212, 69, 74, 65, 54, 155};


//: user_profile_avtivity_remove_friend
Byte kStr_sessionViewValue[] = {7, 35, 70, 14, 197, 7, 190, 90, 94, 125, 53, 73, 78, 77, 47, 45, 31, 44, 25, 42, 44, 41, 32, 35, 38, 31, 25, 27, 48, 46, 35, 48, 35, 46, 51, 25, 44, 31, 39, 41, 48, 31, 25, 32, 44, 35, 31, 40, 30, 217};


//: data
Byte kStr_onText[] = {36, 4, 40, 13, 67, 209, 198, 129, 157, 241, 30, 132, 2, 60, 57, 76, 57, 142};


//: add_friend_activity_add_friend
Byte kStr_changeShowName[] = {86, 30, 62, 7, 192, 66, 185, 35, 38, 38, 33, 40, 52, 43, 39, 48, 38, 33, 35, 37, 54, 43, 56, 43, 54, 59, 33, 35, 38, 38, 33, 40, 52, 43, 39, 48, 38, 240};


//: /group/addgroupuser
Byte kStr_messageStatusData[] = {48, 19, 75, 14, 132, 32, 76, 5, 217, 187, 36, 47, 177, 28, 228, 28, 39, 36, 42, 37, 228, 22, 25, 25, 28, 39, 36, 42, 37, 42, 40, 26, 39, 14};


//: user_profile_avtivity_remove_friend_tip
Byte kStr_pinBubbleName[] = {90, 39, 64, 6, 138, 243, 53, 51, 37, 50, 31, 48, 50, 47, 38, 41, 44, 37, 31, 33, 54, 52, 41, 54, 41, 52, 57, 31, 50, 37, 45, 47, 54, 37, 31, 38, 50, 41, 37, 46, 36, 31, 52, 41, 48, 122};


//: friend_circle_adapter_delete
Byte kStr_showTitle[] = {30, 28, 58, 9, 11, 67, 118, 237, 208, 44, 56, 47, 43, 52, 42, 37, 41, 47, 56, 41, 50, 43, 37, 39, 42, 39, 54, 58, 43, 56, 37, 42, 43, 50, 43, 58, 43, 59};


//: isfrend
Byte kStr_selectedRecordText[] = {24, 7, 70, 14, 209, 143, 221, 101, 126, 149, 11, 35, 248, 166, 35, 45, 32, 44, 31, 40, 30, 129};


//: code
Byte kStr_scaleItemName[] = {84, 4, 13, 13, 168, 152, 104, 149, 127, 80, 84, 199, 145, 86, 98, 87, 88, 119};


//: group_info_activity_op_failed
Byte kStr_textValue[] = {7, 29, 61, 11, 202, 8, 173, 102, 96, 105, 108, 42, 53, 50, 56, 51, 34, 44, 49, 41, 50, 34, 36, 38, 55, 44, 57, 44, 55, 60, 34, 50, 51, 34, 41, 36, 44, 47, 40, 39, 3};


//: back_arrow_bl
Byte kStr_keyText[] = {34, 13, 21, 5, 27, 77, 76, 78, 86, 74, 76, 93, 93, 90, 98, 74, 77, 87, 145};


//: black_list_activity_add_black_failed
Byte kStr_canText[] = {79, 36, 30, 13, 56, 63, 127, 198, 235, 131, 152, 75, 60, 68, 78, 67, 69, 77, 65, 78, 75, 85, 86, 65, 67, 69, 86, 75, 88, 75, 86, 91, 65, 67, 70, 70, 65, 68, 78, 67, 69, 77, 65, 72, 67, 75, 78, 71, 70, 210};


//: /user/detail
Byte kStr_bubbleData[] = {20, 12, 24, 10, 131, 241, 98, 52, 72, 221, 23, 93, 91, 77, 90, 23, 76, 77, 92, 73, 81, 84, 5};


//: add_friend_request_fail
Byte kStr_providerTitle[] = {91, 23, 45, 14, 235, 246, 74, 147, 100, 22, 11, 93, 254, 18, 52, 55, 55, 50, 57, 69, 60, 56, 65, 55, 50, 69, 56, 68, 72, 56, 70, 71, 50, 57, 52, 60, 63, 34};


//: add_friend_add_fail
Byte kStr_atValue[] = {33, 19, 60, 6, 67, 212, 37, 40, 40, 35, 42, 54, 45, 41, 50, 40, 35, 37, 40, 40, 35, 42, 37, 45, 48, 181};


//: #FF483D
Byte kStr_infoItemTitle[] = {6, 7, 8, 13, 57, 122, 138, 40, 62, 83, 62, 145, 122, 27, 62, 62, 44, 48, 43, 60, 161};


//: contact_tag_fragment_add_success
Byte kStr_atNameSessionContent[] = {31, 32, 1, 6, 197, 181, 98, 110, 109, 115, 96, 98, 115, 94, 115, 96, 102, 94, 101, 113, 96, 102, 108, 100, 109, 115, 94, 96, 99, 99, 94, 114, 116, 98, 98, 100, 114, 114, 62};


//: black_list_activity_remove_black_failed
Byte kStr_messageCellContent[] = {44, 39, 6, 9, 135, 72, 104, 244, 177, 92, 102, 91, 93, 101, 89, 102, 99, 109, 110, 89, 91, 93, 110, 99, 112, 99, 110, 115, 89, 108, 95, 103, 105, 112, 95, 89, 92, 102, 91, 93, 101, 89, 96, 91, 99, 102, 95, 94, 36};


//: message_info_activity_msg_notice
Byte kStr_areaValue[] = {43, 32, 41, 12, 149, 160, 155, 30, 114, 221, 90, 177, 68, 60, 74, 74, 56, 62, 60, 54, 64, 69, 61, 70, 54, 56, 58, 75, 64, 77, 64, 75, 80, 54, 68, 74, 62, 54, 69, 70, 75, 64, 58, 60, 188};


//: icon_me_arrow
Byte kStr_insertData[] = {35, 13, 65, 8, 104, 33, 162, 34, 40, 34, 46, 45, 30, 44, 36, 30, 32, 49, 49, 46, 54, 230};


//: contact
Byte kStr_withViewName[] = {96, 7, 35, 9, 136, 68, 152, 190, 4, 64, 76, 75, 81, 62, 64, 81, 101};


//: jpg
Byte kStr_captureFileData[] = {40, 3, 9, 6, 73, 31, 97, 103, 94, 78};


//: team_create_helper_create_failed
Byte kStr_addFileTitle[] = {14, 32, 39, 11, 145, 133, 221, 90, 176, 40, 22, 77, 62, 58, 70, 56, 60, 75, 62, 58, 77, 62, 56, 65, 62, 69, 73, 62, 75, 56, 60, 75, 62, 58, 77, 62, 56, 63, 58, 66, 69, 62, 61, 225};


//: gotoBlacklist
Byte kStr_directionSessionText[] = {6, 13, 52, 10, 228, 37, 106, 233, 189, 232, 51, 59, 64, 59, 14, 56, 45, 47, 55, 56, 53, 63, 64, 222};


//: friend_delete_fail
Byte kStr_contentAreaData[] = {98, 18, 34, 13, 205, 155, 61, 84, 170, 154, 144, 64, 100, 68, 80, 71, 67, 76, 66, 61, 66, 67, 74, 67, 82, 67, 61, 68, 63, 71, 74, 108};


//: #FDF4C9
Byte kStr_messageViewData[] = {27, 7, 65, 6, 120, 56, 226, 5, 3, 5, 243, 2, 248, 105};


//: user_id
Byte kStr_bubbleMessageTingName[] = {99, 7, 7, 5, 142, 110, 108, 94, 107, 88, 98, 93, 97};


//: contact_tag_fragment_sure
Byte kStr_bubbleText[] = {11, 25, 6, 12, 14, 151, 247, 202, 126, 60, 9, 123, 93, 105, 104, 110, 91, 93, 110, 89, 110, 91, 97, 89, 96, 108, 91, 97, 103, 95, 104, 110, 89, 109, 111, 108, 95, 158};


//: head_default
Byte kStr_showName[] = {65, 12, 41, 4, 63, 60, 56, 59, 54, 59, 60, 61, 56, 76, 67, 75, 193};


//: message_remark_name
Byte kStr_itemCaptureBlueValue[] = {3, 19, 96, 10, 26, 162, 151, 199, 179, 178, 13, 5, 19, 19, 1, 7, 5, 255, 18, 5, 13, 1, 18, 11, 255, 14, 1, 13, 5, 150};


//: please_contact_your_administrator
Byte kStr_areaViewOnData[] = {92, 33, 75, 7, 231, 169, 108, 37, 33, 26, 22, 40, 26, 20, 24, 36, 35, 41, 22, 24, 41, 20, 46, 36, 42, 39, 20, 22, 25, 34, 30, 35, 30, 40, 41, 39, 22, 41, 36, 39, 46};


//: register_avtivity_account
Byte kStr_remoteValue[] = {94, 25, 84, 11, 39, 109, 162, 157, 66, 153, 159, 30, 17, 19, 21, 31, 32, 17, 30, 11, 13, 34, 32, 21, 34, 21, 32, 37, 11, 13, 15, 15, 27, 33, 26, 32, 217};


//: ic_card_notice
Byte kStr_colorPathData[] = {92, 14, 6, 7, 193, 32, 237, 99, 93, 89, 93, 91, 108, 94, 89, 104, 105, 110, 99, 93, 95, 16};


//: ic_card_black
Byte kStr_textTitle[] = {79, 13, 62, 13, 23, 40, 9, 156, 201, 109, 67, 21, 28, 43, 37, 33, 37, 35, 52, 38, 33, 36, 46, 35, 37, 45, 24};


//: personCard_bg
Byte kStr_insertNameContent[] = {72, 13, 71, 8, 12, 199, 136, 75, 41, 30, 43, 44, 40, 39, 252, 26, 43, 29, 24, 27, 32, 79};


//: account
Byte kStr_timeStatusViewData[] = {16, 7, 17, 7, 246, 150, 97, 80, 82, 82, 94, 100, 93, 99, 50};


//: name
Byte kStr_layerText[] = {85, 4, 45, 7, 238, 61, 178, 65, 52, 64, 56, 114};


//: contact_tag_fragment_cancel
Byte kStr_indexMyName[] = {12, 27, 39, 6, 236, 53, 60, 72, 71, 77, 58, 60, 77, 56, 77, 58, 64, 56, 63, 75, 58, 64, 70, 62, 71, 77, 56, 60, 58, 71, 60, 62, 69, 236};


//: Group_chat
Byte kStr_timeItemData[] = {8, 10, 2, 6, 75, 54, 69, 112, 109, 115, 110, 93, 97, 102, 95, 114, 219};


//: mobile
Byte kStr_videoMessageName[] = {86, 6, 67, 10, 51, 246, 227, 238, 163, 211, 42, 44, 31, 38, 41, 34, 65};


//: ic_card_edit
Byte kStr_styleName[] = {33, 12, 6, 12, 40, 174, 17, 240, 61, 207, 87, 230, 99, 93, 89, 93, 91, 108, 94, 89, 95, 94, 99, 110, 57};


//: /group/getgroups
Byte kStr_atData[] = {7, 16, 11, 13, 203, 138, 87, 82, 248, 113, 152, 191, 251, 36, 92, 103, 100, 106, 101, 36, 92, 90, 105, 92, 103, 100, 106, 101, 104, 89};


//: #F6F7FA
Byte kStr_enableRowValue[] = {93, 7, 74, 6, 102, 164, 217, 252, 236, 252, 237, 252, 247, 252};


//: #EEEEEE
Byte kStr_pathSessionValue[] = {67, 7, 69, 6, 135, 90, 222, 0, 0, 0, 0, 0, 0, 26};


//: /other/feedback
Byte kStr_tableTitle[] = {94, 15, 64, 13, 125, 26, 38, 150, 83, 164, 10, 3, 50, 239, 47, 52, 40, 37, 50, 239, 38, 37, 37, 36, 34, 33, 35, 43, 125};


//: user_info_avtivity_upload_avatar_failed
Byte kStr_shouldChangeName[] = {42, 39, 16, 11, 67, 13, 168, 79, 129, 252, 242, 101, 99, 85, 98, 79, 89, 94, 86, 95, 79, 81, 102, 100, 89, 102, 89, 100, 105, 79, 101, 96, 92, 95, 81, 84, 79, 81, 102, 81, 100, 81, 98, 79, 86, 81, 89, 92, 85, 84, 11};


//: his_qr
Byte kStr_messageTitleName[] = {45, 6, 93, 8, 233, 1, 43, 51, 11, 12, 22, 2, 20, 21, 36};


//: #ECECEC
Byte kStr_recordTableData[] = {2, 7, 14, 10, 44, 221, 52, 121, 241, 96, 21, 55, 53, 55, 53, 55, 53, 68};


//: request_successful
Byte kStr_highlightValue[] = {75, 18, 79, 8, 201, 255, 142, 58, 35, 22, 34, 38, 22, 36, 37, 16, 36, 38, 20, 20, 22, 36, 36, 23, 38, 29, 115};


//: #2C3042
Byte kStr_shouldDisableTitle[] = {3, 7, 89, 12, 207, 9, 74, 50, 8, 68, 223, 33, 202, 217, 234, 218, 215, 219, 217, 23};


//: ic_sex_woman
Byte kStr_contentCanValue[] = {96, 12, 84, 7, 171, 129, 52, 21, 15, 11, 31, 17, 36, 11, 35, 27, 25, 13, 26, 14};


//: #B391FF
Byte kStr_statusData[] = {24, 7, 55, 14, 178, 50, 158, 223, 78, 96, 141, 190, 117, 145, 236, 11, 252, 2, 250, 15, 15, 124};


//: canAddFriend
Byte kStr_myTitle[] = {49, 12, 68, 5, 177, 31, 29, 42, 253, 32, 32, 2, 46, 37, 33, 42, 32, 4};


//: group_chat_avatar_activity_add_black_success
Byte kStr_scaleTitle[] = {68, 44, 2, 14, 140, 51, 163, 214, 220, 231, 111, 153, 79, 115, 101, 112, 109, 115, 110, 93, 97, 102, 95, 114, 93, 95, 116, 95, 114, 95, 112, 93, 95, 97, 114, 103, 116, 103, 114, 119, 93, 95, 98, 98, 93, 96, 106, 95, 97, 105, 93, 113, 115, 97, 97, 99, 113, 113, 15};


//: contact_tag_fragment_delete_success
Byte kStr_sizeValue[] = {84, 35, 18, 14, 72, 52, 186, 213, 154, 160, 194, 219, 162, 254, 81, 93, 92, 98, 79, 81, 98, 77, 98, 79, 85, 77, 84, 96, 79, 85, 91, 83, 92, 98, 77, 82, 83, 90, 83, 98, 83, 77, 97, 99, 81, 81, 83, 97, 97, 208};


//: avatar
Byte kStr_keyData[] = {68, 6, 29, 5, 203, 68, 89, 68, 87, 68, 85, 64};


//: friend_ids
Byte kStr_scaleContent[] = {80, 10, 60, 5, 56, 42, 54, 45, 41, 50, 40, 35, 45, 40, 55, 251};


//: #ffffff
Byte kStr_videoDisableData[] = {2, 7, 28, 11, 53, 146, 44, 66, 244, 66, 159, 7, 74, 74, 74, 74, 74, 74, 238};


//: #8A8E98
Byte kStr_textBottomDirectionTitle[] = {88, 7, 37, 8, 140, 247, 210, 249, 254, 19, 28, 19, 32, 20, 19, 177};


//: message_info_activity_message_info
Byte kStr_onAreaData[] = {41, 34, 60, 8, 42, 253, 31, 202, 49, 41, 55, 55, 37, 43, 41, 35, 45, 50, 42, 51, 35, 37, 39, 56, 45, 58, 45, 56, 61, 35, 49, 41, 55, 55, 37, 43, 41, 35, 45, 50, 42, 51, 62};


//: report_activity_title
Byte kStr_timeStatusTitle[] = {23, 21, 41, 9, 251, 238, 45, 56, 106, 73, 60, 71, 70, 73, 75, 54, 56, 58, 75, 64, 77, 64, 75, 80, 54, 75, 64, 75, 67, 60, 156};


//: item_data
Byte kStr_titleMessageText[] = {3, 9, 73, 11, 37, 68, 27, 21, 81, 68, 63, 32, 43, 28, 36, 22, 27, 24, 43, 24, 200};


//: personcart_profile_bg
Byte kStr_pinName[] = {95, 21, 13, 12, 80, 91, 129, 54, 219, 179, 227, 153, 99, 88, 101, 102, 98, 97, 86, 84, 101, 103, 82, 99, 101, 98, 89, 92, 95, 88, 82, 85, 90, 238};


//: func_viewholder_black
Byte kStr_showData[] = {27, 21, 57, 8, 27, 112, 145, 91, 45, 60, 53, 42, 38, 61, 48, 44, 62, 47, 54, 51, 43, 44, 57, 38, 41, 51, 40, 42, 50, 156};


//: black_list_activity_remove_black
Byte kStr_infoChangeData[] = {25, 32, 45, 5, 101, 53, 63, 52, 54, 62, 50, 63, 60, 70, 71, 50, 52, 54, 71, 60, 73, 60, 71, 76, 50, 69, 56, 64, 66, 73, 56, 50, 53, 63, 52, 54, 62, 103};


//: ic_card_report
Byte kStr_areaShouldTitle[] = {64, 14, 95, 8, 98, 212, 73, 232, 10, 4, 0, 4, 2, 19, 5, 0, 19, 6, 17, 16, 19, 21, 58};


//: ic_sex_man
Byte kStr_contentKeyData[] = {81, 10, 27, 12, 189, 12, 238, 198, 67, 134, 177, 77, 78, 72, 68, 88, 74, 93, 68, 82, 70, 83, 79};


//: group_id
Byte kStr_mediaHideTitle[] = {31, 8, 12, 4, 91, 102, 99, 105, 100, 83, 93, 88, 57};


//: 未设置
Byte kStr_bottomTitle[] = {10, 9, 85, 10, 129, 138, 71, 31, 231, 141, 145, 71, 85, 147, 89, 105, 146, 104, 89, 28};


//: invite_you_group
Byte kStr_fileEnableValue[] = {23, 16, 77, 11, 79, 229, 91, 83, 148, 162, 61, 28, 33, 41, 28, 39, 24, 18, 44, 34, 40, 18, 26, 37, 34, 40, 35, 93};
...
@interface ColorViewController ()<NIMUserManagerDelegate,ImageDelegate,ActionStatus,DisableReplyDelegate>
...
@property (nonatomic, strong) PositionView *reprotView;
//: @property (nonatomic, strong) FFFRemarksView *changeRemarksView;
@property (nonatomic, strong) ColorView *changeRemarksView;
...
//    [self setUpNav];
    ...
    self.view.backgroundColor = [UIColor withMax:StringFromMediaStyleData(kStr_enableRowValue)];
    ...
    dict[StringFromMediaStyleData(kStr_bubbleMessageTingName)] = self.userId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromMediaStyleData(kStr_bubbleData)] tool:dict examine:NO titleResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict with:StringFromMediaStyleData(kStr_scaleItemName)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict view:StringFromMediaStyleData(kStr_onText)];
            //: self.userAcount = [data newStringValueForKey:@"account"];
            self.userAcount = [data with:StringFromMediaStyleData(kStr_timeStatusViewData)];
            //: NSString *avatar = [data newStringValueForKey:@"avatar"];
            NSString *avatar = [data with:StringFromMediaStyleData(kStr_keyData)];

            //: NSString *str = [NSString stringWithFormat:@"%@:%@",[FFFLanguageManager getTextWithKey:@"register_avtivity_account"],self.userAcount];
            NSString *str = [NSString stringWithFormat:@"%@:%@",[ItemManager sessionInformation:StringFromMediaStyleData(kStr_remoteValue)],self.userAcount];
         ...
         autoreleasepool{} __weak __typeof__(self) __weak_self__ = self;
            ...
            [[NIMSDK sharedSDK].userManager fetchUserInfos:@[self.userId] completion:^(NSArray<NIMUser *> * _Nullable users, NSError * _Nullable error) {
                ...
                if (users.count) {
                    ...
                    [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromMediaStyleData(kStr_showName)]];
                    ...
                    if (self.user.userInfo.gender == NIMUserGenderMale) {
                        ...
                        _sexImg.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_contentKeyData)];
                    //: }else if (self.user.userInfo.gender == NIMUserGenderFemale){
                    }else if (self.user.userInfo.gender == NIMUserGenderFemale){
                        //: _sexImg.image = [UIImage imageNamed:@"ic_sex_woman"];
                        _sexImg.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_contentCanValue)];
                    }
                    ...
                    self.labRemark.text = self.user.alias.length ? self.user.alias : [ItemManager sessionInformation:StringFromMediaStyleData(kStr_bottomTitle)];
                    //: self.labSign.text = self.user.userInfo.sign.length ? self.user.userInfo.sign : [FFFLanguageManager getTextWithKey:@"未设置"];
                    self.labSign.text = self.user.userInfo.sign.length ? self.user.userInfo.sign : [ItemManager sessionInformation:StringFromMediaStyleData(kStr_bottomTitle)];
...
//    [SVProgressHUD show];
    ...
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromMediaStyleData(kStr_atData)] tool:nil examine:NO titleResponseSuccess:^(id responseObject) {
...
//        [SVProgressHUD dismissWithCompletion:^{
            ...
            if (code.integerValue == 0) {
                ...
                NSArray *dataArray = [resultDict checked:StringFromMediaStyleData(kStr_onText)];
                //: NSDictionary *dataDict = [NSDictionary dictionaryWithObject:dataArray forKey:@"item_data"];
                NSDictionary *dataDict = [NSDictionary dictionaryWithObject:dataArray forKey:StringFromMediaStyleData(kStr_titleMessageText)];
                //: HMDataPicker *dataPick = [[HMDataPicker alloc] initWithDelegate:self dataDict:dataDict selectedDict:nil jsonNode:@"name"];
                PickerView *dataPick = [[PickerView alloc] initWithOfNode:self delayContainer:dataDict representation:nil notProgress:StringFromMediaStyleData(kStr_layerText)];
                //: dataPick.tag = 500;
                dataPick.tag = 500;
                //: [dataPick show];
                [dataPick end];
...
//        [SVProgressHUD dismiss];
        ...
        [self.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_providerTitle)]
                    //: duration:2.0
                    duration:2.0
...
-(void)findChanged:(id)sender{
    ...
    if (switcher.on) {
        ...
        dict[StringFromMediaStyleData(kStr_videoMessageName)] = self.userId;
        //: dict[@"type"] = @"1";
        dict[StringFromMediaStyleData(kStr_formatCanName)] = @"1";//拉入黑名单
        //: [wself refresh];
        [wself session];
    ...
    //: }else{
        ...
        dict[StringFromMediaStyleData(kStr_videoMessageName)] = self.userId;
        //: dict[@"type"] = @"0";
        dict[StringFromMediaStyleData(kStr_formatCanName)] = @"0";//解除黑名单
        //: [wself refresh];
        [wself session];
...
//            [SVProgressHUD dismiss];
            ...
            if (!error) {
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_scaleTitle)] duration:2.0f position:CSToastPositionCenter];
            //: }else{
            }else{
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_canText)] duration:2.0f position:CSToastPositionCenter];
                //: [wself refresh];
                [wself session];
            }
        //: }];
...
//            [SVProgressHUD dismiss];
            ...
            if (!error) {
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_infoChangeData)] duration:2.0f position:CSToastPositionCenter];
            //: }else{
            }else{
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_messageCellContent)] duration:2.0f position:CSToastPositionCenter];
                //: [wself refresh];
                [wself session];
            }
        //: }];
...
//        [SVProgressHUD dismiss];
        ...
        if (error) {
            ...
            [wself.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_textValue)] duration:2.0f position:CSToastPositionCenter];
            //: [wself refresh];
            [wself session];
        }
    //: }];
...
//        [SVProgressHUD show];
        ...
        [self vertical:avater close:^(NSString *urlString) {
            ...
            option.postscript = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_fileEnableValue)];
//            [SVProgressHUD show];
...
//                [SVProgressHUD dismiss];
                ...
                //: }else{
                    ...
                    [self.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_addFileTitle)] duration:2.0 position:CSToastPositionCenter];
                }
            //: }];
            }];
...
- (void)vertical:(UIImage *)image close:(void(^)(NSString *urlString ))complete {
    ...
    NSString *fileName = [ShowHelper timeName:StringFromMediaStyleData(kStr_captureFileData)];
    //: NSString *filePath = [[FFFKitFileLocationHelper getAppDocumentPath] stringByAppendingPathComponent:fileName];
    NSString *filePath = [[ShowHelper text] stringByAppendingPathComponent:fileName];
    ...
    if (success) {
        ...
        //: } completion:^(NSString * _Nullable urlString, NSError * _Nullable error) {
            ...
            //: }else{
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_shouldChangeName)]
                             //: duration:2
                             duration:2
                             //: position:CSToastPositionCenter];
                             position:CSToastPositionCenter];
    ...
    //: }else{
        ...
        [self.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_shouldChangeName)]
                    //: duration:2
                    duration:2
                    //: position:CSToastPositionCenter];
                    position:CSToastPositionCenter];
...
-(void)endOf{
    ...
    if (_teamSetingConfig != nil) {
        ...
        NSString *canAddFriend = [_teamSetingConfig with:StringFromMediaStyleData(kStr_myTitle)];
        ...
        if (canAddFriend.integerValue <= 0) {
            ...
            [SVProgressHUD format:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_areaViewOnData)]];
            //: return;
            return;
        }
    }
...
-(void)arrayHolder{
    ...
    NSString *contact_tag_fragment_add_success = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_atNameSessionContent)];//@"添加成功"
    //: NSString *request_successful = [FFFLanguageManager getTextWithKey:@"request_successful"];
    NSString *request_successful = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_highlightValue)];//@"请求成功"
    //: NSString *add_friend_add_fail = [FFFLanguageManager getTextWithKey:@"add_friend_add_fail"];
    NSString *add_friend_add_fail = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_atValue)];//@"添加失败"
    //: NSString *add_friend_request_fail = [FFFLanguageManager getTextWithKey:@"add_friend_request_fail"];
    NSString *add_friend_request_fail = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_providerTitle)];//@"请求失败"
...
-(void)to{
    ...
    dict[StringFromMediaStyleData(kStr_mediaHideTitle)] = [_groupDict with:@"id"];
    //: dict[@"friend_ids"] = self.user.userId;
    dict[StringFromMediaStyleData(kStr_scaleContent)] = self.user.userId;
    //: dict[@"isfrend"] = isMyFriend?@"1":@"0";
    dict[StringFromMediaStyleData(kStr_selectedRecordText)] = isMyFriend?@"1":@"0";

    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/group/addgroupuser"] params:dict isShow:YES success:^(id responseObject) {
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromMediaStyleData(kStr_messageStatusData)] tool:dict examine:YES titleResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSLog(@"-----%@",resultDict);
    //: } failed:^(id responseObject, NSError *error) {
...
- (void)enableFor{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_sessionViewValue)] message:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_pinBubbleName)] delegate:nil cancelButtonTitle:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_indexMyName)] otherButtonTitles:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_bubbleText)], nil];
...
//                [SVProgressHUD dismiss];
                ...
                if (!error) {
                    ...
                    [wself.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_sizeValue)] duration:2.0f position:CSToastPositionCenter];
                    //: [wself refresh];
                    [wself session];
                ...
                //: }else{
                    ...
                    [wself.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_contentAreaData)] duration:2.0f position:CSToastPositionCenter];
                }
            //: }];
            }];
        }
...
- (void)barSize{
    ...
    [ self.changeRemarksView performance: self.user];
    //: [self.changeRemarksView animationShow];
    [self.changeRemarksView singingVoice];
}
...
- (void)dateAction {
    ...
    [self.reprotView longMode];
//    VeilViewController *vc = [[VeilViewController alloc]init];
//    [self.navigationController pushViewController:vc animated:YES];
}
...
//        _userView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"personCard_bg"]];
        ...
        Bg.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_insertNameContent)];
        ...
        UIImageView *userBg = [[UIImageView alloc]initWithFrame:CGRectMake(15, [UIDevice clear]+44+20, [[UIScreen mainScreen] bounds].size.width-30, 140)];
        //: userBg.image = [UIImage imageNamed:@"personcart_profile_bg"];
        userBg.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_pinName)];
        ...
        QrBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-30-36, [UIDevice clear]+44+35, 36, 36);
//        QrBtn.backgroundColor = [UIColor whiteColor];
        //: [QrBtn setImage:[UIImage imageNamed:@"his_qr"] forState:UIControlStateNormal];
        [QrBtn setImage:[UIImage imageNamed:StringFromMediaStyleData(kStr_messageTitleName)] forState:UIControlStateNormal];
        //: [QrBtn addTarget:self action:@selector(handleQrbtn) forControlEvents:UIControlEventTouchUpInside];
        [QrBtn addTarget:self action:@selector(containerSpace) forControlEvents:UIControlEventTouchUpInside];
        ...
        self.accountheadImg = [[UIImageView alloc] initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-100)/2, [UIDevice clear]+20, 88, 88)];
        //: [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:@"head_default"]];
        [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromMediaStyleData(kStr_showName)]];
        ...
        _accountView.backgroundColor = [UIColor withMax:StringFromMediaStyleData(kStr_messageViewData)];
...
//        self.accountId.backgroundColor = RGB_COLOR_String(@"#FDF4C9");
        ...
        self.accountId.textColor = [UIColor withMax:StringFromMediaStyleData(kStr_shouldDisableTitle)];
        ...
        if(isMyFriend){
            ...
            _messageBtn.frame = CGRectMake(15, userBg.bottom+10, width, 44);
            //: _messageBtn.backgroundColor = [UIColor colorWithHexString:@"#B391FF"];
            _messageBtn.backgroundColor = [UIColor withMax:StringFromMediaStyleData(kStr_statusData)];
            //: [_messageBtn addTarget:self action:@selector(btnchat) forControlEvents:UIControlEventTouchUpInside];
            [_messageBtn addTarget:self action:@selector(doWill) forControlEvents:UIControlEventTouchUpInside];
            ...
            [_messageBtn setTitleColor:[UIColor withMax:StringFromMediaStyleData(kStr_videoDisableData)] forState:UIControlStateNormal];
            //: [_messageBtn setTitle:[FFFLanguageManager getTextWithKey:@"message_info_activity_message_info"] forState:UIControlStateNormal];
            [_messageBtn setTitle:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_onAreaData)] forState:UIControlStateNormal];
            ...
            _groupBtn.frame = CGRectMake(30+width, userBg.bottom+10, width, 44);
            //: _groupBtn.backgroundColor = [UIColor colorWithHexString:@"#B391FF"];
            _groupBtn.backgroundColor = [UIColor withMax:StringFromMediaStyleData(kStr_statusData)];
            //: [_groupBtn addTarget:self action:@selector(btnGroupchat) forControlEvents:UIControlEventTouchUpInside];
            [_groupBtn addTarget:self action:@selector(clearMonth) forControlEvents:UIControlEventTouchUpInside];
            ...
            [_groupBtn setTitleColor:[UIColor withMax:StringFromMediaStyleData(kStr_videoDisableData)] forState:UIControlStateNormal];
            //: [_groupBtn setTitle:[FFFLanguageManager getTextWithKey:@"Group_chat"] forState:UIControlStateNormal];
            [_groupBtn setTitle:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_timeItemData)] forState:UIControlStateNormal];
        ...
        [self.closeBtn setImage:[UIImage imageNamed:StringFromMediaStyleData(kStr_keyText)] forState:(UIControlStateNormal)];
...
- (UIView *)personView
{
    ...
    if(!_personView){
        ...
        pic3.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_colorPathData)];
        ...
        self.labTitlenotice.text = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_areaValue)];
        ...
        [self.switchNotice addTarget:self action:@selector(handled:) forControlEvents:UIControlEventValueChanged];
        //: self.switchNotice.onTintColor = [UIColor colorWithHexString:@"#B391FF"];
        self.switchNotice.onTintColor = [UIColor withMax:StringFromMediaStyleData(kStr_statusData)];
        ...
        line3.backgroundColor = [UIColor withMax:StringFromMediaStyleData(kStr_recordTableData)];
        ...
        pic4.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_textTitle)];
        ...
        self.labTitleBlack.text = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_showData)];
        ...
        [blackBtn addTarget:self action:@selector(lineRecent) forControlEvents:UIControlEventTouchUpInside];
        //: blackBtn.titleLabel.font = [UIFont systemFontOfSize:12];
        blackBtn.titleLabel.font = [UIFont systemFontOfSize:12];
        //: [blackBtn setTitleColor:[UIColor colorWithHexString:@"#B391FF"] forState:UIControlStateNormal];
        [blackBtn setTitleColor:[UIColor withMax:StringFromMediaStyleData(kStr_statusData)] forState:UIControlStateNormal];
        //: [blackBtn setTitle:[FFFLanguageManager getTextWithKey:@"gotoBlacklist"] forState:UIControlStateNormal];
        [blackBtn setTitle:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_directionSessionText)] forState:UIControlStateNormal];
        ...
        [self.switchBlack addTarget:self action:@selector(characteristicRootOfASquareMatrixTeam:) forControlEvents:UIControlEventValueChanged];
        //: self.switchBlack.onTintColor = [UIColor colorWithHexString:@"#B391FF"];
        self.switchBlack.onTintColor = [UIColor withMax:StringFromMediaStyleData(kStr_statusData)];
...
//        [shareCartView addSubview:arrow5];
        ...
        UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(barSize)];
        ...
        pic1.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_styleName)];
        ...
        self.labTitleRemark.text = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_itemCaptureBlueValue)];
        ...
        self.labRemark.textColor = [UIColor withMax:StringFromMediaStyleData(kStr_textBottomDirectionTitle)];
        ...
        arrow.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_insertData)];
        ...
        line1.backgroundColor = [UIColor withMax:StringFromMediaStyleData(kStr_recordTableData)];
...
//        [signView addSubview:line2];
        ...
        UITapGestureRecognizer *reporttapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(dateAction)];
        ...
        picreport.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_areaShouldTitle)];
        ...
        self.labTitleResport.text = [ItemManager sessionInformation:StringFromMediaStyleData(kStr_timeStatusTitle)];
        ...
        arrowreport.image = [UIImage imageNamed:StringFromMediaStyleData(kStr_insertData)];
        ...
        [self.btnAdd setTitleColor:[UIColor withMax:StringFromMediaStyleData(kStr_infoItemTitle)] forState:UIControlStateNormal];
        //: [self.btnAdd setTitle:[FFFLanguageManager getTextWithKey:@"add_friend_activity_add_friend"] forState:UIControlStateNormal];
        [self.btnAdd setTitle:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_changeShowName)] forState:UIControlStateNormal];
        //: [self.btnAdd addTarget:self action:@selector(addFriend) forControlEvents:UIControlEventTouchUpInside];
        [self.btnAdd addTarget:self action:@selector(endOf) forControlEvents:UIControlEventTouchUpInside];
        //: self.btnAdd.backgroundColor = [UIColor colorWithHexString:@"#ffffff"];
        self.btnAdd.backgroundColor = [UIColor withMax:StringFromMediaStyleData(kStr_videoDisableData)];
        //: self.btnAdd.layer.borderWidth = 1;
        self.btnAdd.layer.borderWidth = 1;
        //: self.btnAdd.layer.borderColor = [UIColor colorWithHexString:@"#EEEEEE"].CGColor;
        self.btnAdd.layer.borderColor = [UIColor withMax:StringFromMediaStyleData(kStr_pathSessionValue)].CGColor;
        ...
        [self.btnDelete setTitleColor:[UIColor withMax:StringFromMediaStyleData(kStr_infoItemTitle)] forState:UIControlStateNormal];
        //: [self.btnDelete setTitle:[FFFLanguageManager getTextWithKey:@"friend_circle_adapter_delete"] forState:UIControlStateNormal];
        [self.btnDelete setTitle:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_showTitle)] forState:UIControlStateNormal];
        //: [self.btnDelete addTarget:self action:@selector(deleteFriend) forControlEvents:UIControlEventTouchUpInside];
        [self.btnDelete addTarget:self action:@selector(enableFor) forControlEvents:UIControlEventTouchUpInside];
        //: self.btnDelete.backgroundColor = [UIColor colorWithHexString:@"#ffffff"];
        self.btnDelete.backgroundColor = [UIColor withMax:StringFromMediaStyleData(kStr_videoDisableData)];
        //: self.btnDelete.layer.borderWidth = 1;
        self.btnDelete.layer.borderWidth = 1;
        //: self.btnDelete.layer.borderColor = [UIColor colorWithHexString:@"#EEEEEE"].CGColor;
        self.btnDelete.layer.borderColor = [UIColor withMax:StringFromMediaStyleData(kStr_pathSessionValue)].CGColor;
...
- (ColorView *)changeRemarksView
{
    ...
    if(!_changeRemarksView){
        ...
        _changeRemarksView = [[ColorView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
- (PositionView *)reprotView
{
    ...
    if(!_reprotView){
        ...
        _reprotView = [[PositionView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
-(void)passOnView:(NSString *)reason
{
    ...
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"contact"] = reason?:@"";
    dict[StringFromMediaStyleData(kStr_withViewName)] = reason?:@"";
    //: [ZCHttpManager postWithUrl:[NSString stringWithFormat:@"/other/feedback"] params:dict isShow:NO success:^(id responseObject) {
    [PhotoManager militaryInstallationMenuMedia:[NSString stringWithFormat:StringFromMediaStyleData(kStr_tableTitle)] event:dict current:NO titleFailed:^(id responseObject) {
    //: } failed:^(id responseObject, NSError *error) {
    ...
    self.reprotBlackView.speiceBackBlock = ^(NSString *Name){
        ...
        [[NIMSDK sharedSDK].userManager addToBlackList:self.userId completion:^(NSError *error) {
                   ...
                   if (!error) {
                       ...
                       [self.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_scaleTitle)] duration:2.0f position:CSToastPositionCenter];
                   //: }else{
                   }else{
                       ...
                       [self.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_canText)] duration:2.0f position:CSToastPositionCenter];
    ...
    self.reprotDeleteView.speiceBackBlock = ^(NSString *Name){
        ...
        [[NIMSDK sharedSDK].userManager deleteFriend:self.userId
            ...
            if (!error) {
                ...
                [self.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_sizeValue)] duration:2.0f position:CSToastPositionCenter];
            //: }else{
            }else{
                //: [self.view makeToast:[FFFLanguageManager getTextWithKey:@"friend_delete_fail"] duration:2.0f position:CSToastPositionCenter];
                [self.view makeToast:[ItemManager sessionInformation:StringFromMediaStyleData(kStr_contentAreaData)] duration:2.0f position:CSToastPositionCenter];
            }
        //: }];
        }];
...
Byte * MediaStyleDataToCache(Byte *data) {
    int enableMy = data[0];
    int timeWith = data[1];
    Byte collectionView = data[2];
    int videoSelected = data[3];
    if (!enableMy) return data + videoSelected;
    for (int i = videoSelected; i < videoSelected + timeWith; i++) {
        int value = data[i] + collectionView;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[videoSelected + timeWith] = 0;
    return data + videoSelected;
}

NSString *StringFromMediaStyleData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)MediaStyleDataToCache(data)];
}

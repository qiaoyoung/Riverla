...
@interface MarginOfErrorViewController ()

//: @property (nonatomic,strong) NSString *userId;
@property (nonatomic,strong) NSString *userId;

//: @property (nonatomic,strong) NTESColorButton *chatButton;
@property (nonatomic,strong) NameView *chatButton;

//: @end
@end

//: @implementation NTESRobotCardViewController
@implementation MarginOfErrorViewController
...
- (void)viewDidLoad {
    ...
    self.chatButton = [[NameView alloc] initWithFrame:CGRectZero];
...
//: - (void)chat:(id)sender
- (void)natalDayData:(id)sender
{
    //: NIMSession *session = [NIMSession session:self.userId type:NIMSessionTypeP2P];
    NIMSession *session = [NIMSession session:self.userId type:NIMSessionTypeP2P];
    //: NTESSessionViewController *vc = [[NTESSessionViewController alloc] initWithSession:session];
    RadiogramViewController *vc = [[RadiogramViewController alloc] initWithSession:session];

...
#import "UIView+StopAdditions.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: NSString * const kViewUserInfo = @"kAlertViewUserInfo";
NSString * const kLet_clientContent = @"kAlertViewUserInfo";



//: @implementation UIView (KIAdditions)
@implementation UIView (StopAdditions)
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(kLet_clientContent), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(kLet_clientContent));
}
...
- (void)poping:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)find {
    ...
    return (UIViewController *)[self ofStart:self];
}
...
- (UIView *)holder:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView holder:superViewClass];
    }

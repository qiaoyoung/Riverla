...
// __CLOSE_PRINT__
//
//  UINavigationBar+CoronaSwizzling.m
//  NIM
//
...
#import "UINavigationBar+CoronaSwizzling.h"
...
@implementation UINavigationBar (CoronaSwizzling)
...
+ (void)load{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        swizzling_exchangeMethod([UINavigationBar class] ,@selector(keyImage), @selector(colorList));
    //: });
    });
}

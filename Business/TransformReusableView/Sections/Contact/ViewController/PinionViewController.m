...
NSString *StringFromViewCellData(Byte *data);        


//: setting_privacy_camera
Byte kStr_videoName[] = {8, 22, 76, 4, 39, 25, 40, 40, 29, 34, 27, 19, 36, 38, 29, 42, 21, 23, 45, 19, 23, 21, 33, 25, 38, 21, 159};


//: contact_fragment_group
Byte kStr_disableData[] = {57, 22, 9, 6, 86, 22, 90, 102, 101, 107, 88, 90, 107, 86, 93, 105, 88, 94, 100, 92, 101, 107, 86, 94, 105, 102, 108, 103, 24};


//: team_create_helper_create_failed
Byte kStr_onContent[] = {89, 32, 78, 12, 41, 231, 172, 175, 48, 156, 212, 113, 38, 23, 19, 31, 17, 21, 36, 23, 19, 38, 23, 17, 26, 23, 30, 34, 23, 36, 17, 21, 36, 23, 19, 38, 23, 17, 24, 19, 27, 30, 23, 22, 244};


//: user_info_avtivity_upload_avatar_failed
Byte kStr_viewTitle[] = {93, 39, 37, 13, 75, 130, 81, 142, 130, 75, 90, 159, 183, 80, 78, 64, 77, 58, 68, 73, 65, 74, 58, 60, 81, 79, 68, 81, 68, 79, 84, 58, 80, 75, 71, 74, 60, 63, 58, 60, 81, 60, 79, 60, 77, 58, 65, 60, 68, 71, 64, 63, 243};


//: ic_none_ContactList
Byte kStr_showFileForData[] = {63, 19, 51, 10, 246, 229, 189, 243, 179, 130, 54, 48, 44, 59, 60, 59, 50, 44, 16, 60, 59, 65, 46, 48, 65, 25, 54, 64, 65, 31};


//: /group/
Byte kStr_viewData[] = {9, 7, 82, 7, 169, 166, 155, 221, 21, 32, 29, 35, 30, 221, 17};


//: user_id
Byte kStr_myData[] = {55, 7, 26, 13, 3, 78, 108, 27, 195, 228, 145, 52, 124, 91, 89, 75, 88, 69, 79, 74, 133};


//: jpg
Byte kStr_bubbleContentData[] = {50, 3, 49, 12, 96, 88, 211, 224, 163, 134, 221, 154, 57, 63, 54, 180};


//: #999999
Byte kStr_contentOnData[] = {62, 7, 30, 14, 73, 58, 169, 139, 208, 237, 137, 117, 64, 76, 5, 27, 27, 27, 27, 27, 27, 116};


//: contact_group
Byte kStr_shouldValue[] = {85, 13, 25, 6, 20, 215, 74, 86, 85, 91, 72, 74, 91, 70, 78, 89, 86, 92, 87, 112};


//: add_friend_activity_add_friend
Byte kStr_atName[] = {83, 30, 6, 11, 14, 246, 229, 37, 123, 213, 153, 91, 94, 94, 89, 96, 108, 99, 95, 104, 94, 89, 91, 93, 110, 99, 112, 99, 110, 115, 89, 91, 94, 94, 89, 96, 108, 99, 95, 104, 94, 69};


//: group_info_activity_without
Byte kStr_collectionDisableData[] = {21, 27, 34, 13, 248, 145, 189, 73, 93, 148, 54, 178, 90, 69, 80, 77, 83, 78, 61, 71, 76, 68, 77, 61, 63, 65, 82, 71, 84, 71, 82, 87, 61, 85, 71, 82, 70, 77, 83, 82, 122};


//: invite_you_group
Byte kStr_cellText[] = {23, 16, 37, 10, 210, 129, 152, 168, 254, 155, 68, 73, 81, 68, 79, 64, 58, 84, 74, 80, 58, 66, 77, 74, 80, 75, 27};


//: owner
Byte kStr_showChangeValue[] = {82, 5, 63, 4, 48, 56, 47, 38, 51, 161};


//: contact_fragment_friend
Byte kStr_imageText[] = {89, 23, 53, 11, 90, 208, 166, 244, 83, 66, 161, 46, 58, 57, 63, 44, 46, 63, 42, 49, 61, 44, 50, 56, 48, 57, 63, 42, 49, 61, 52, 48, 57, 47, 127};


//: warm_prompt
Byte kStr_directionTitle[] = {66, 11, 61, 14, 71, 246, 239, 64, 57, 101, 151, 129, 115, 26, 58, 36, 53, 48, 34, 51, 53, 50, 48, 51, 55, 108};


//: #2C3042
Byte kStr_textColorName[] = {68, 7, 37, 6, 220, 54, 254, 13, 30, 14, 11, 15, 13, 122};


//: #B391FF
Byte kStr_timeData[] = {28, 7, 2, 5, 119, 33, 64, 49, 55, 47, 68, 68, 197};


//: ids
Byte kStr_colorText[] = {34, 3, 59, 12, 37, 31, 219, 28, 164, 93, 31, 206, 46, 41, 56, 3};


//: contact_notice
Byte kStr_rowTitle[] = {12, 14, 4, 5, 164, 95, 107, 106, 112, 93, 95, 112, 91, 106, 107, 112, 101, 95, 97, 221};


//: /team/create
Byte kStr_withName[] = {74, 12, 55, 12, 132, 160, 34, 193, 49, 70, 209, 95, 248, 61, 46, 42, 54, 248, 44, 59, 46, 42, 61, 46, 160};


//: E3F4AA
Byte kStr_captureTitle[] = {80, 6, 8, 6, 245, 250, 61, 43, 62, 44, 57, 57, 21};


//: #F7D2F3
Byte kStr_mobileData[] = {40, 7, 4, 4, 31, 66, 51, 64, 46, 66, 47, 157};


//: #5D5F66
Byte kStr_shouldText[] = {8, 7, 17, 12, 202, 112, 6, 214, 187, 239, 63, 236, 18, 36, 51, 36, 53, 37, 37, 47};


//: data
Byte kStr_withContent[] = {26, 4, 5, 12, 132, 92, 239, 214, 163, 234, 111, 169, 95, 92, 111, 92, 93};


//: type
Byte kStr_highlightData[] = {91, 4, 51, 14, 120, 100, 136, 65, 170, 93, 234, 179, 179, 193, 65, 70, 61, 50, 116};


//: code
Byte kStr_withValue[] = {83, 4, 2, 12, 70, 241, 118, 136, 147, 66, 139, 149, 97, 109, 98, 99, 184};


//: tag_activity_set
Byte kStr_messageFormatName[] = {20, 16, 85, 10, 74, 157, 83, 145, 16, 122, 31, 12, 18, 10, 12, 14, 31, 20, 33, 20, 31, 36, 10, 30, 16, 31, 227};


//: contact_add_friend
Byte kStr_scaleValue[] = {28, 18, 20, 6, 19, 207, 79, 91, 90, 96, 77, 79, 96, 75, 77, 80, 80, 75, 82, 94, 85, 81, 90, 80, 158};


//: tname
Byte kStr_statusName[] = {69, 5, 51, 9, 203, 42, 160, 3, 149, 65, 59, 46, 58, 50, 95};


//: contact_tag_fragment_friend
Byte kStr_enableData[] = {31, 27, 98, 7, 175, 51, 112, 1, 13, 12, 18, 255, 1, 18, 253, 18, 255, 5, 253, 4, 16, 255, 5, 11, 3, 12, 18, 253, 4, 16, 7, 3, 12, 2, 106};


//: notification
Byte kStr_mediaValue[] = {41, 12, 88, 8, 243, 102, 71, 218, 22, 23, 28, 17, 14, 17, 11, 9, 28, 17, 23, 22, 98};


//: contact_tag_fragment_cancel
Byte kStr_fileTimeValue[] = {89, 27, 16, 4, 83, 95, 94, 100, 81, 83, 100, 79, 100, 81, 87, 79, 86, 98, 81, 87, 93, 85, 94, 100, 79, 83, 81, 94, 83, 85, 92, 204};


//: name
Byte kStr_shouldMessageValue[] = {52, 4, 6, 6, 53, 79, 104, 91, 103, 95, 21};


//: activity_create_group_name_create_group
Byte kStr_sessionValue[] = {91, 39, 35, 14, 68, 48, 162, 161, 132, 207, 135, 218, 63, 30, 62, 64, 81, 70, 83, 70, 81, 86, 60, 64, 79, 66, 62, 81, 66, 60, 68, 79, 76, 82, 77, 60, 75, 62, 74, 66, 60, 64, 79, 66, 62, 81, 66, 60, 68, 79, 76, 82, 77, 90};


//: #CCECFC
Byte kStr_tableInfoValue[] = {42, 7, 53, 4, 238, 14, 14, 16, 14, 17, 14, 97};


//: #EEEEEE
Byte kStr_messageValue[] = {42, 7, 63, 14, 78, 104, 168, 253, 96, 251, 229, 153, 154, 65, 228, 6, 6, 6, 6, 6, 6, 8};


//: #F6F6F6
Byte kStr_objectData[] = {39, 7, 44, 8, 54, 144, 168, 235, 247, 26, 10, 26, 10, 26, 10, 122};


//: tid
Byte kStr_viewCaptureContent[] = {91, 3, 56, 8, 208, 75, 13, 162, 60, 49, 44, 63};

// __DEBUG__
// __CLOSE_PRINT__
//
//  PinionViewController.m
//  NIM
//
...
ToneSize> {
    ...
    CounternationalismDataCollection *_contacts;
}
...
@implementation PinionViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.advancedTeamArray = [self teamsItem];
...
- (void)viewDidLoad {
    ...
    if ([self.tableView respondsToSelector:@selector(setSectionIndexColor:)]) {
        ...
        self.tableView.sectionIndexColor = [UIColor withMax:StringFromViewCellData(kStr_textColorName)]; // 索引文字颜色
...
- (UIView *)defView{
    ...
    if(!_defView){
        ...
        _defView = [[UIView alloc]initWithFrame:CGRectMake(0, [UIDevice clear]+140, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-[UIDevice clear]-140-(49.0f))];
...
//        _defView.hidden = YES;
        ...
        defImg.image = [UIImage imageNamed:StringFromViewCellData(kStr_showFileForData)];
        ...
        emptyTipLabel.textColor = [UIColor withMax:StringFromViewCellData(kStr_contentOnData)];
        ...
        emptyTipLabel.text = [ItemManager sessionInformation:StringFromViewCellData(kStr_collectionDisableData)];
...
-(void)activity{
    ...
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromViewCellData(kStr_viewData)] tool:nil examine:NO titleResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict with:StringFromViewCellData(kStr_withValue)];
        ...
        if (code.integerValue == 0) {
            ...
            for (NIMUser *user in friendList) {
                ...
                NSDictionary *dict = [NSDictionary dictionaryWithObject:user.userId forKey:StringFromViewCellData(kStr_myData)];
            ...
            [myfriend setObject:[ItemManager sessionInformation:StringFromViewCellData(kStr_enableData)] forKey:StringFromViewCellData(kStr_shouldMessageValue)];
            //: [myfriend setObject:friendIds forKey:@"ids"];
            [myfriend setObject:friendIds forKey:StringFromViewCellData(kStr_colorText)];
            ...
            NSArray *data = [resultDict checked:StringFromViewCellData(kStr_withContent)];
...
- (void)middleAndItem
{
    ...
    UIView *navView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [UIDevice clear]+132)];
    ...
    UIView *topview = [[UIView alloc]initWithFrame:CGRectMake(15, [UIDevice clear]+8, [[UIScreen mainScreen] bounds].size.width-30, 48)];
    //: topview.backgroundColor = [UIColor colorWithHexString:@"#F6F6F6"];
    topview.backgroundColor = [UIColor withMax:StringFromViewCellData(kStr_objectData)];
    ...
    _btnfriend.backgroundColor = [UIColor withMax:StringFromViewCellData(kStr_timeData)];
    ...
    [_btnfriend setTitle:[ItemManager sessionInformation:StringFromViewCellData(kStr_imageText)] forState:UIControlStateNormal];
    ...
    [_btngroup setTitleColor:[UIColor withMax:StringFromViewCellData(kStr_shouldText)] forState:UIControlStateNormal];
    //: [_btngroup setTitle:[FFFLanguageManager getTextWithKey:@"contact_fragment_group"] forState:UIControlStateNormal];
    [_btngroup setTitle:[ItemManager sessionInformation:StringFromViewCellData(kStr_disableData)] forState:UIControlStateNormal];
    ...
    lineview.backgroundColor = [UIColor withMax:StringFromViewCellData(kStr_messageValue)];
...
- (void)noticeRight
{
    ...
    FrameViewController *vc = [[FrameViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)sendTab{
    ...
    _contacts = [[CounternationalismDataCollection alloc] init];
}

//普通群组
//: - (NSMutableArray *)normalDidFetchTeams{
- (NSMutableArray *)robot{
...
-(void)styleName:(NSString *)teamID change:(NSString *)teamName image:(NSString *)type{
    //: NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"owner"] = currentUserId;
    dict[StringFromViewCellData(kStr_showChangeValue)] = currentUserId;
    //: dict[@"type"] = type;
    dict[StringFromViewCellData(kStr_highlightData)] = type;
    //: dict[@"tname"] = teamName;
    dict[StringFromViewCellData(kStr_statusName)] = teamName;
    //: dict[@"tid"] = teamID;
    dict[StringFromViewCellData(kStr_viewCaptureContent)] = teamID;

}

//: - (void)searchAction:(id)sender {
- (void)frameAction:(id)sender {
    //: NTESContactSearchViewController *vc = [[NTESContactSearchViewController alloc] init];
    ManhuntTableViewController *vc = [[ManhuntTableViewController alloc] init];
    //: vc.delegate = self;
    vc.delegate = self;
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_sliderIndex <= 0) {
        ...
        if ([contactItem respondsToSelector:@selector(sendBackground)] && [contactItem sendBackground].length) {
            //: SEL sel = NSSelectorFromString([contactItem selName]);
            SEL sel = NSSelectorFromString([contactItem sendBackground]);
    ...
    //: }else{
        ...
        NIMSession *session = [self afterWith:team];
        //: if (session) {
        if (session) {
            //: NTESSessionViewController *vc = [[NTESSessionViewController alloc] initWithSession:session];
            RadiogramViewController *vc = [[RadiogramViewController alloc] initWithFind:session];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
//    id<ImageItem> contactItem = (id<ImageItem>)[_contacts memberOfIndex:indexPath];
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (_sliderIndex == 0) {
           ...
           label.text = [_contacts measure:section];
           //: label.font = [UIFont systemFontOfSize:16];
           label.font = [UIFont systemFontOfSize:16];
           //: label.textColor = [UIColor colorWithHexString:@"#2C3042"];
           label.textColor = [UIColor withMax:StringFromViewCellData(kStr_textColorName)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_sliderIndex <= 0) {
        ...
        id contactItem = [_contacts index:indexPath];
        //: [cell refreshUser:contactItem];
        [cell asDomainImage:contactItem];
    //: }else{
    }else{
...
- (NSString*)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{
    ...
    if (_sliderIndex <= 0) {
        ...
        return [_contacts measure:section];
    //: }else{
    }else{
        //: return @"";
        return @"";
...
- (void)byDoing:(ContactSelectFinishBlock) block{
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, [UIDevice clear]+64, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-[UIDevice clear]-64-(49.0f)) style:UITableViewStyleGrouped];
...
-(void)endOf{
    ...
    LightViewController *vc = [[LightViewController alloc] initWithNibName:nil bundle:nil];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
...
-(void)viewUp{
    ...
    [self byDoing:^(NSArray *uids, NSString *name, UIImage *avater) {
        @
        ...
        [self messageDetail:avater view:^(NSString *urlString) {
            ...
            option.postscript = [ItemManager sessionInformation:StringFromViewCellData(kStr_cellText)];
//            [SVProgressHUD show];
...
//                [SVProgressHUD dismiss];
                ...
                if (!error) {
                    ...
                    [self styleName:teamId change:option.name image:@"1"];
                    //: [self newGroupSyncRequest:option.name teamID:teamId];
                    [self name:option.name valueLength:teamId];
                //: }else{
                }else{
                    ...
                    [self.view makeToast:[ItemManager sessionInformation:StringFromViewCellData(kStr_onContent)] duration:2.0 position:CSToastPositionCenter];
                }
            //: }];
            }];
        //: }];
...
- (void)messageDetail:(UIImage *)image view:(void(^)(NSString *urlString ))complete {
    ...
    NSString *fileName = [ShowHelper timeName:StringFromViewCellData(kStr_bubbleContentData)];
    ...
    if (success) {
        ...
        //: } completion:^(NSString * _Nullable urlString, NSError * _Nullable error) {
            ...
            //: }else{
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromViewCellData(kStr_viewTitle)]
                             //: duration:2
                             duration:2
    ...
    //: }else{
        ...
        [self.view makeToast:[ItemManager sessionInformation:StringFromViewCellData(kStr_viewTitle)]
                    //: duration:2
                    duration:2
                    //: position:CSToastPositionCenter];
                    position:CSToastPositionCenter];
...
-(void)name:(NSString *)groupName valueLength:(NSString *)teamId{
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"name"] = groupName;
    dict[StringFromViewCellData(kStr_shouldMessageValue)] = groupName;
    //: dict[@"id"] = teamId;
    dict[@"id"] = teamId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/team/create"] params:dict isShow:NO success:^(id responseObject) {
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromViewCellData(kStr_withName)] tool:dict examine:NO titleResponseSuccess:^(id responseObject) {
...
-(void)colorIndex{
    ...
    AfterViewController *vc = [[AfterViewController alloc] init];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}
...
-(void)showwed:(UIButton *)sender
{
    ...
    //: }else if (sender == self.btngroup){
        ...
        _btngroup.backgroundColor = [UIColor withMax:StringFromViewCellData(kStr_timeData)];
        ...
        [_btnfriend setTitleColor:[UIColor withMax:StringFromViewCellData(kStr_shouldText)] forState:UIControlStateNormal];
...
//        }
        ...
        UIAlertController *alertControl = [UIAlertController alertControllerWithTitle:[ItemManager sessionInformation:StringFromViewCellData(kStr_directionTitle)] message:[ItemManager sessionInformation:StringFromViewCellData(kStr_videoName)] preferredStyle:UIAlertControllerStyleAlert];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[ItemManager sessionInformation:StringFromViewCellData(kStr_fileTimeValue)] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        //: }])];
        }])];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[ItemManager sessionInformation:StringFromViewCellData(kStr_messageFormatName)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            //: NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            //: if( [[UIApplication sharedApplication] canOpenURL:url]) {
            if( [[UIApplication sharedApplication] canOpenURL:url]) {
...
-(void)need{
    ...
    [wself byDoing:^(NSArray *uids, NSString *groupName, UIImage *avater) {
        //: NSArray *members = [@[currentUserId] arrayByAddingObjectsFromArray:uids];
        NSArray *members = [@[currentUserId] arrayByAddingObjectsFromArray:uids];
        //: NIMCreateTeamOption *option = [[NIMCreateTeamOption alloc] init];
        NIMCreateTeamOption *option = [[NIMCreateTeamOption alloc] init];
        ...
        [[NIMSDK sharedSDK].teamManager createTeam:option users:members completion:^(NSError *error, NSString *teamId, NSArray<NSString *> * _Nullable failedUserIds) {
            ...
            if (!error) {
                ...
                [wself name:option.name valueLength:teamId];
            //: }else{
            }else{
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromViewCellData(kStr_onContent)] duration:2.0 position:CSToastPositionCenter];
            }
        //: }];
        }];
    //: }];
...
- (UIView *)friendheaderView
{
    ...
    if (!_friendheaderView) {
        ...
        editView.backgroundColor = [UIColor withMax:StringFromViewCellData(kStr_mobileData)];
        ...
        UITapGestureRecognizer *singleTap1 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(noticeRight)];
        ...
        editimg.image = [UIImage imageNamed:StringFromViewCellData(kStr_rowTitle)];
        ...
        labedit.textColor = [UIColor withMax:StringFromViewCellData(kStr_textColorName)];
        //: labedit.text = [FFFLanguageManager getTextWithKey:@"notification"];
        labedit.text = [ItemManager sessionInformation:StringFromViewCellData(kStr_mediaValue)];
        ...
        langView.backgroundColor = [UIColor withMax:StringFromViewCellData(kStr_captureTitle)];
        ...
        UITapGestureRecognizer *singleTap2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(endOf)];
        ...
        langimg.image = [UIImage imageNamed:StringFromViewCellData(kStr_scaleValue)];
        ...
        lablang.textColor = [UIColor withMax:StringFromViewCellData(kStr_textColorName)];
        //: lablang.text = [FFFLanguageManager getTextWithKey:@"add_friend_activity_add_friend"];
        lablang.text = [ItemManager sessionInformation:StringFromViewCellData(kStr_atName)];
...
- (UIView *)groupheaderView
{
    ...
    if (!_groupheaderView) {
        ...
        langView.backgroundColor = [UIColor withMax:StringFromViewCellData(kStr_tableInfoValue)];
        //: langView.layer.cornerRadius = 12;
        langView.layer.cornerRadius = 12;
        ...
        UITapGestureRecognizer *singleTap2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(viewUp)];
        //: [langView addGestureRecognizer:singleTap2];
        [langView addGestureRecognizer:singleTap2];
        //: UIImageView *langimg = [[UIImageView alloc]initWithFrame:CGRectMake(width2-165, 0, 165, 52)];
        UIImageView *langimg = [[UIImageView alloc]initWithFrame:CGRectMake(width2-165, 0, 165, 52)];
        //: langimg.image = [UIImage imageNamed:@"contact_group"];
        langimg.image = [UIImage imageNamed:StringFromViewCellData(kStr_shouldValue)];
        //: [langView addSubview:langimg];
        [langView addSubview:langimg];
        //: UILabel *lablang = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, width2-30, 52)];
        UILabel *lablang = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, width2-30, 52)];
        ...
        lablang.text = [ItemManager sessionInformation:StringFromViewCellData(kStr_sessionValue)];
        //: [langView addSubview:lablang];
        [langView addSubview:lablang];
    }
...
Byte * ViewCellDataToCache(Byte *data) {
    int alter = data[0];
    int areaTing = data[1];
    Byte capture = data[2];
    int media = data[3];
    if (!alter) return data + media;
    for (int i = media; i < media + areaTing; i++) {
        int value = data[i] + capture;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[media + areaTing] = 0;
    return data + media;
}

NSString *StringFromViewCellData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)ViewCellDataToCache(data)];
}

...
NSString *StringFromGalaTacticData(Byte *data);


//: personcart_profile_bg
Byte kStr_runnerContent[] = {79, 21, 13, 46, 180, 111, 73, 190, 35, 9, 177, 220, 37, 103, 98, 95, 101, 108, 105, 102, 111, 114, 112, 95, 116, 114, 97, 99, 110, 111, 115, 114, 101, 112, 164};


//: back_arrow_bl
Byte kStr_smellTitle[] = {70, 13, 5, 137, 182, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 219};


//: #B391FF
Byte kStr_regimeName[] = {43, 7, 10, 95, 154, 231, 55, 124, 210, 109, 70, 70, 49, 57, 51, 66, 35, 167};


//: head_default
Byte kStr_pastorMessageStandingName[] = {5, 12, 10, 125, 170, 113, 85, 55, 204, 30, 116, 108, 117, 97, 102, 101, 100, 95, 100, 97, 101, 104, 17};


//: ic_sex_woman
Byte kStr_pastorName[] = {85, 12, 6, 88, 61, 249, 110, 97, 109, 111, 119, 95, 120, 101, 115, 95, 99, 105, 201};


//: #2C3042
Byte kStr_nagName[] = {58, 7, 7, 204, 144, 219, 148, 50, 52, 48, 51, 67, 50, 35, 53};


//: 本地不存在
Byte kStr_parkContent[] = {4, 15, 3, 168, 156, 229, 152, 173, 229, 141, 184, 228, 176, 156, 229, 172, 156, 230, 38};


//: #FF483D
Byte kStr_recordChangeText[] = {37, 7, 9, 239, 155, 170, 234, 82, 204, 68, 51, 56, 52, 70, 70, 35, 9};


//: code
Byte kStr_includingTitle[] = {22, 4, 11, 254, 141, 46, 213, 202, 149, 228, 1, 101, 100, 111, 99, 174};


//: ic_invite
Byte kStr_patientName[] = {17, 9, 11, 163, 62, 15, 70, 74, 83, 236, 96, 101, 116, 105, 118, 110, 105, 95, 99, 105, 93};


//: group_member_info_activity_mute_msg
Byte kStr_cakeContent[] = {60, 35, 11, 110, 31, 70, 215, 75, 78, 233, 133, 103, 115, 109, 95, 101, 116, 117, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 243};


//: /user/detail
Byte kStr_museTingValue[] = {84, 12, 4, 30, 108, 105, 97, 116, 101, 100, 47, 114, 101, 115, 117, 47, 83};


//: #ffffff
Byte kStr_showPoleData[] = {66, 7, 8, 8, 168, 99, 53, 221, 102, 102, 102, 102, 102, 102, 35, 171};


//: personCard_bg
Byte kStr_presidentContent[] = {70, 13, 13, 204, 190, 22, 201, 188, 250, 162, 90, 218, 192, 103, 98, 95, 100, 114, 97, 67, 110, 111, 115, 114, 101, 112, 148};


//: activity_group_member_info2_inviter
Byte kStr_happilyStatusName[] = {59, 35, 4, 218, 114, 101, 116, 105, 118, 110, 105, 95, 50, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 95, 121, 116, 105, 118, 105, 116, 99, 97, 191};


//: group_info_activity_op_failed
Byte kStr_factionTitle[] = {12, 29, 11, 205, 98, 39, 108, 185, 165, 31, 25, 100, 101, 108, 105, 97, 102, 95, 112, 111, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 154};


//: account
Byte kStr_askItemData[] = {89, 7, 3, 116, 110, 117, 111, 99, 99, 97, 143};


//: #ECECEC
Byte kStr_pastorContent[] = {59, 7, 9, 83, 244, 210, 160, 215, 201, 67, 69, 67, 69, 67, 69, 35, 34};


//: icon_me_arrow
Byte kStr_beatKeyAddText[] = {48, 13, 3, 119, 111, 114, 114, 97, 95, 101, 109, 95, 110, 111, 99, 105, 90};


//: ic_identity_authentication
Byte kStr_seventhStyleData[] = {26, 26, 13, 237, 78, 89, 209, 157, 167, 14, 182, 58, 192, 110, 111, 105, 116, 97, 99, 105, 116, 110, 101, 104, 116, 117, 97, 95, 121, 116, 105, 116, 110, 101, 100, 105, 95, 99, 105, 121};


//: #EEEEEE
Byte kStr_peakCryAgueData[] = {57, 7, 6, 171, 36, 149, 69, 69, 69, 69, 69, 69, 35, 247};


//: #F6F7FA
Byte kStr_imageAreaTitle[] = {60, 7, 13, 151, 82, 156, 59, 236, 3, 164, 128, 201, 214, 65, 70, 55, 70, 54, 70, 35, 236};


//: ic_sex_man
Byte kStr_nagAgedData[] = {78, 10, 13, 252, 14, 207, 80, 27, 73, 31, 159, 111, 197, 110, 97, 109, 95, 120, 101, 115, 95, 99, 105, 221};


//: #8A8E98
Byte kStr_tenderChangeNervousValue[] = {60, 7, 8, 102, 105, 243, 193, 189, 56, 57, 69, 56, 65, 56, 35, 89};


//: modify_activity_modify_success
Byte kStr_itWantName[] = {59, 30, 3, 115, 115, 101, 99, 99, 117, 115, 95, 121, 102, 105, 100, 111, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 121, 102, 105, 100, 111, 109, 126};


//: activity_group_member_info2_shenfen
Byte kStr_supporterPoleSingeData[] = {53, 35, 9, 173, 7, 144, 190, 24, 165, 110, 101, 102, 110, 101, 104, 115, 95, 50, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 95, 121, 116, 105, 118, 105, 116, 99, 97, 164};


//: 移出本群
Byte kStr_videoViewData[] = {33, 12, 11, 111, 254, 156, 164, 197, 175, 180, 228, 164, 190, 231, 172, 156, 230, 186, 135, 229, 187, 167, 231, 8};


//: user_id
Byte kStr_surgeryBubbleName[] = {46, 7, 6, 97, 224, 57, 100, 105, 95, 114, 101, 115, 117, 25};


//: message_remark_name
Byte kStr_prominentAttackData[] = {7, 19, 4, 60, 101, 109, 97, 110, 95, 107, 114, 97, 109, 101, 114, 95, 101, 103, 97, 115, 115, 101, 109, 110};


//: data
Byte kStr_stairProminentValue[] = {19, 4, 6, 142, 234, 118, 97, 116, 97, 100, 173};


//: ic_group_lists
Byte kStr_correlationData[] = {59, 14, 7, 139, 127, 132, 33, 115, 116, 115, 105, 108, 95, 112, 117, 111, 114, 103, 95, 99, 105, 167};


//: ic_card_edit
Byte kStr_triggerName[] = {15, 12, 7, 248, 61, 243, 241, 116, 105, 100, 101, 95, 100, 114, 97, 99, 95, 99, 105, 161};
...
@interface SupportViewController ()<NIMUserManagerDelegate>
...
@property (nonatomic,weak) id <FitSource> dataSource;
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor withMax:StringFromGalaTacticData(kStr_imageAreaTitle)];
...
//    [self refresh];
    ...
    dict[StringFromGalaTacticData(kStr_surgeryBubbleName)] = self.memberId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromGalaTacticData(kStr_museTingValue)] tool:dict examine:NO titleResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict with:StringFromGalaTacticData(kStr_includingTitle)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict view:StringFromGalaTacticData(kStr_stairProminentValue)];
            //: self.userAcount = [data newStringValueForKey:@"account"];
            self.userAcount = [data with:StringFromGalaTacticData(kStr_askItemData)];
...
- (void)changeWith:(UISwitch *)switcher
{
    ...
    [[NIMSDK sharedSDK].teamManager updateMuteState:mute
        ...
        if (!error) {
            ...
            msg = [ItemManager sessionInformation:StringFromGalaTacticData(kStr_itWantName)];
        //: }else{
        }else{
            //: msg = [FFFLanguageManager getTextWithKey:@"group_info_activity_op_failed"];
            msg = [ItemManager sessionInformation:StringFromGalaTacticData(kStr_factionTitle)];
            //: switcher.on = !mute;
            switcher.on = !mute;
        }
...
- (UIView *)userView
{
    ...
    if(!_userView){
        ...
        Bg.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_presidentContent)];
        ...
        UIImageView *userBg = [[UIImageView alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-345)/2, [UIDevice clear]+44+20, 345, 140)];
        //: userBg.image = [UIImage imageNamed:@"personcart_profile_bg"];
        userBg.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_runnerContent)];
        ...
        [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromGalaTacticData(kStr_pastorMessageStandingName)]];
        ...
        if (self.user.userInfo.gender == NIMUserGenderMale) {
            ...
            sexImg.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_nagAgedData)];
        //: }else if (self.user.userInfo.gender == NIMUserGenderFemale){
        }else if (self.user.userInfo.gender == NIMUserGenderFemale){
            //: sexImg.image = [UIImage imageNamed:@"ic_sex_woman"];
            sexImg.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_pastorName)];
        }
...
//        self.accountId.backgroundColor = RGB_COLOR_String(@"#FDF4C9");
        ...
        self.accountId.textColor = [UIColor withMax:StringFromGalaTacticData(kStr_nagName)];
        ...
        [self.closeBtn setImage:[UIImage imageNamed:StringFromGalaTacticData(kStr_smellTitle)] forState:(UIControlStateNormal)];
...
- (UIView *)personView
{
    ...
    if(!_personView){
        ...
        UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(sureNick)];
        ...
        pic1.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_triggerName)];
        ...
        self.labTitleRemark.textColor = [UIColor withMax:StringFromGalaTacticData(kStr_nagName)];
        //: self.labTitleRemark.text = [FFFLanguageManager getTextWithKey:@"message_remark_name"];
        self.labTitleRemark.text = [ItemManager sessionInformation:StringFromGalaTacticData(kStr_prominentAttackData)];
        ...
        self.labRemark.textColor = [UIColor withMax:StringFromGalaTacticData(kStr_tenderChangeNervousValue)];
        ...
        arrow.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_beatKeyAddText)];
        ...
        line1.backgroundColor = [UIColor withMax:StringFromGalaTacticData(kStr_pastorContent)];
        ...
        icon2.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_seventhStyleData)];
        ...
        lab2.textColor = [UIColor withMax:StringFromGalaTacticData(kStr_nagName)];
        //: lab2.text = [FFFLanguageManager getTextWithKey:@"activity_group_member_info2_shenfen"];
        lab2.text = [ItemManager sessionInformation:StringFromGalaTacticData(kStr_supporterPoleSingeData)];
        ...
        sublab2.font = [UIFont systemFontOfSize:12];
        //: sublab2.textColor = [UIColor colorWithHexString:@"#B391FF"];
        sublab2.textColor = [UIColor withMax:StringFromGalaTacticData(kStr_regimeName)];
        //: sublab2.text = [FFFTeamHelper memberTypeText:self.member.type];
        sublab2.text = [RandomHelper itemWith:self.member.type];
        ...
        arrow2.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_beatKeyAddText)];
        ...
        line2.backgroundColor = [UIColor withMax:StringFromGalaTacticData(kStr_pastorContent)];
        ...
        icon3.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_patientName)];
        ...
        lab3.textColor = [UIColor withMax:StringFromGalaTacticData(kStr_nagName)];
        //: lab3.text = [FFFLanguageManager getTextWithKey:@"activity_group_member_info2_inviter"];
        lab3.text = [ItemManager sessionInformation:StringFromGalaTacticData(kStr_happilyStatusName)];
        ...
        sublab3.font = [UIFont systemFontOfSize:12];
        //: sublab3.textColor = [UIColor colorWithHexString:@"#B391FF"];
        sublab3.textColor = [UIColor withMax:StringFromGalaTacticData(kStr_regimeName)];
        //: sublab3.text = _member.inviterAccid ? (_member.inviterAccid.length ? _member.inviterAccid : _member.userId) : @"本地不存在".nim_localized;
        sublab3.text = _member.inviterAccid ? (_member.inviterAccid.length ? _member.inviterAccid : _member.userId) : StringFromGalaTacticData(kStr_parkContent).textKey;
        ...
        arrow3.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_beatKeyAddText)];
        ...
        line3.backgroundColor = [UIColor withMax:StringFromGalaTacticData(kStr_pastorContent)];
        ...
        icon4.image = [UIImage imageNamed:StringFromGalaTacticData(kStr_correlationData)];
        ...
        lab4.textColor = [UIColor withMax:StringFromGalaTacticData(kStr_nagName)];
        //: lab4.text = [FFFLanguageManager getTextWithKey:@"group_member_info_activity_mute_msg"];
        lab4.text = [ItemManager sessionInformation:StringFromGalaTacticData(kStr_cakeContent)];
        ...
        UISwitch *pushSwitch = [[UISwitch alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width-60-51, 10, 51, 30)];
        //: [pushSwitch setOnTintColor: [UIColor colorWithHexString:@"#B391FF"]];
        [pushSwitch setOnTintColor: [UIColor withMax:StringFromGalaTacticData(kStr_regimeName)]];
        //: [pushSwitch addTarget:self action:@selector(updateMute:) forControlEvents:UIControlEventValueChanged];
        [pushSwitch addTarget:self action:@selector(changeWith:) forControlEvents:UIControlEventValueChanged];
        ...
        if(canEdit){
            ...
            [self.btnDelete setTitleColor:[UIColor withMax:StringFromGalaTacticData(kStr_recordChangeText)] forState:UIControlStateNormal];
            //: [self.btnDelete setTitle:@"移出本群".nim_localized forState:UIControlStateNormal];
            [self.btnDelete setTitle:StringFromGalaTacticData(kStr_videoViewData).textKey forState:UIControlStateNormal];
            //: [self.btnDelete addTarget:self action:@selector(removeMember) forControlEvents:UIControlEventTouchUpInside];
            [self.btnDelete addTarget:self action:@selector(indicatorSegment) forControlEvents:UIControlEventTouchUpInside];
            //: self.btnDelete.backgroundColor = [UIColor colorWithHexString:@"#ffffff"];
            self.btnDelete.backgroundColor = [UIColor withMax:StringFromGalaTacticData(kStr_showPoleData)];
            //: self.btnDelete.layer.borderWidth = 1;
            self.btnDelete.layer.borderWidth = 1;
            //: self.btnDelete.layer.borderColor = [UIColor colorWithHexString:@"#EEEEEE"].CGColor;
            self.btnDelete.layer.borderColor = [UIColor withMax:StringFromGalaTacticData(kStr_peakCryAgueData)].CGColor;
...
Byte * GalaTacticDataToCache(Byte *data) {
    int equate = data[0];
    int birdSEyeView = data[1];
    int angel = data[2];
    if (!equate) return data + angel;
    for (int i = 0; i < birdSEyeView / 2; i++) {
        int begin = angel + i;
        int end = angel + birdSEyeView - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[angel + birdSEyeView] = 0;
    return data + angel;
}

NSString *StringFromGalaTacticData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)GalaTacticDataToCache(data)];
}  

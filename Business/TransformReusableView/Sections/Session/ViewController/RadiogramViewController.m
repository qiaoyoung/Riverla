...
//: 消息撤回失败，请重试
Byte kStr_showFranchiseData[] = {33, 30, 44, 6, 23, 122, 186, 138, 92, 186, 85, 131, 186, 102, 120, 185, 111, 114, 185, 120, 133, 188, 136, 121, 195, 144, 96, 188, 131, 139, 189, 91, 97, 188, 131, 105, 115};


//: ispush
Byte kStr_dateName[] = {67, 6, 22, 14, 213, 255, 166, 195, 166, 117, 56, 52, 212, 194, 83, 93, 90, 95, 93, 82, 207};


//: showCustom:
Byte kStr_cellTingContent[] = {79, 11, 51, 9, 205, 198, 213, 60, 15, 64, 53, 60, 68, 16, 66, 64, 65, 60, 58, 7, 145};


//: friend_delete_fail
Byte kStr_entitleData[] = {91, 18, 37, 6, 194, 126, 65, 77, 68, 64, 73, 63, 58, 63, 64, 71, 64, 79, 64, 58, 65, 60, 68, 71, 175};


//: 被禁言
Byte kStr_frameText[] = {57, 9, 45, 4, 187, 117, 126, 186, 121, 84, 187, 123, 83, 12};


//: nonce
Byte kStr_sharedSizeData[] = {13, 5, 96, 12, 28, 247, 163, 154, 150, 172, 108, 169, 14, 15, 14, 3, 5, 71};


//: app_avchat_not_start_with_less_member
Byte kStr_delicateName[] = {81, 37, 33, 7, 103, 97, 206, 64, 79, 79, 62, 64, 85, 66, 71, 64, 83, 62, 77, 78, 83, 62, 82, 83, 64, 81, 83, 62, 86, 72, 83, 71, 62, 75, 68, 82, 82, 62, 76, 68, 76, 65, 68, 81, 200};


//: 撤回一条消息
Byte kStr_heroData[] = {48, 18, 36, 12, 26, 103, 139, 224, 205, 140, 137, 58, 194, 110, 128, 193, 119, 122, 192, 148, 92, 194, 121, 125, 194, 146, 100, 194, 93, 139, 21};


//: contact_tag_fragment_cancel
Byte kStr_windowTodayData[] = {54, 27, 81, 12, 70, 189, 2, 183, 193, 239, 84, 134, 18, 30, 29, 35, 16, 18, 35, 14, 35, 16, 22, 14, 21, 33, 16, 22, 28, 20, 29, 35, 14, 18, 16, 29, 18, 20, 27, 222};


//: friend_verify_avtivity_net_error
Byte kStr_casualtyData[] = {48, 32, 95, 13, 24, 132, 168, 16, 243, 126, 115, 65, 122, 7, 19, 10, 6, 15, 5, 0, 23, 6, 19, 10, 7, 26, 0, 2, 23, 21, 10, 23, 10, 21, 26, 0, 15, 6, 21, 0, 6, 19, 19, 16, 19, 35};


//: curTime
Byte kStr_endControlTitle[] = {91, 7, 76, 13, 132, 26, 212, 98, 8, 93, 64, 5, 183, 23, 41, 38, 8, 29, 33, 25, 136};


//: type
Byte kStr_userNameData[] = {78, 4, 61, 7, 46, 35, 115, 55, 60, 51, 40, 238};


//: showImage:
Byte kStr_drivewayNimReloadName[] = {34, 10, 6, 5, 236, 109, 98, 105, 113, 67, 103, 91, 97, 95, 52, 91};


//: 请输入附言
Byte kStr_apologyValue[] = {8, 15, 32, 6, 82, 228, 200, 143, 151, 200, 158, 115, 197, 101, 133, 201, 121, 100, 200, 136, 96, 58};


//: 确定删除？
Byte kStr_statusDishBlueValue[] = {75, 15, 75, 9, 129, 201, 132, 227, 93, 156, 86, 99, 154, 99, 79, 154, 61, 85, 158, 78, 89, 164, 113, 84, 10};


//: YYYY-MM-dd HH:mm:ss
Byte kStr_referTingConfirmTitle[] = {92, 19, 80, 9, 152, 41, 20, 80, 11, 9, 9, 9, 9, 221, 253, 253, 221, 20, 20, 208, 248, 248, 234, 29, 29, 234, 35, 35, 252};


//: watch_multiretweet_activity_person
Byte kStr_withLengthData[] = {30, 34, 43, 8, 174, 34, 210, 37, 76, 54, 73, 56, 61, 52, 66, 74, 65, 73, 62, 71, 58, 73, 76, 58, 58, 73, 52, 54, 56, 73, 62, 75, 62, 73, 78, 52, 69, 58, 71, 72, 68, 67, 174};


//: apns-collapse-id
Byte kStr_ernText[] = {54, 16, 90, 4, 7, 22, 20, 25, 211, 9, 21, 18, 18, 7, 22, 25, 11, 211, 15, 10, 83};


//: watch_multiretweet_activity_confirm_forwarded_to
Byte kStr_keyFindValue[] = {51, 48, 21, 11, 211, 82, 154, 162, 160, 80, 220, 98, 76, 95, 78, 83, 74, 88, 96, 87, 95, 84, 93, 80, 95, 98, 80, 80, 95, 74, 76, 78, 95, 84, 97, 84, 95, 100, 74, 78, 90, 89, 81, 84, 93, 88, 74, 81, 90, 93, 98, 76, 93, 79, 80, 79, 74, 95, 90, 160};


//: 取消标记失败
Byte kStr_toData[] = {19, 18, 84, 9, 39, 137, 85, 44, 244, 145, 59, 66, 146, 98, 52, 146, 76, 51, 148, 90, 92, 145, 80, 93, 148, 96, 81, 162};


//: hant
Byte kStr_keyBarValue[] = {22, 4, 45, 7, 236, 39, 130, 59, 52, 65, 71, 226};


//: desc
Byte kStr_willEvolutionaryValue[] = {4, 4, 29, 5, 214, 71, 72, 86, 70, 189};


//: Asia/Shanghai
Byte kStr_endKeyValue[] = {6, 13, 32, 11, 48, 235, 19, 113, 119, 165, 63, 33, 83, 73, 65, 15, 51, 72, 65, 78, 71, 72, 65, 73, 190};


//: message_super_team
Byte kStr_tingFlueValue[] = {17, 18, 88, 7, 169, 167, 167, 21, 13, 27, 27, 9, 15, 13, 7, 27, 29, 24, 13, 26, 7, 28, 13, 9, 21, 224};


//: invalid event
Byte kStr_missileText[] = {71, 13, 43, 9, 136, 52, 14, 49, 142, 62, 67, 75, 54, 65, 62, 57, 245, 58, 75, 58, 67, 73, 86};


//: 不允许文字
Byte kStr_optionFindName[] = {16, 15, 59, 4, 169, 125, 82, 170, 74, 70, 173, 115, 125, 171, 91, 76, 170, 114, 92, 154};


//: accid
Byte kStr_atText[] = {79, 5, 55, 5, 118, 42, 44, 44, 50, 45, 226};


//: 发言频次
Byte kStr_quickBarValue[] = {55, 12, 26, 9, 43, 29, 80, 102, 176, 203, 117, 119, 206, 142, 102, 207, 136, 119, 204, 146, 135, 197};


//: apple+%@
Byte kStr_messageDisabledData[] = {19, 8, 19, 12, 238, 245, 6, 43, 137, 97, 240, 136, 78, 93, 93, 89, 82, 24, 18, 45, 165};


//: /team/getStatusSendText
Byte kStr_titleCountName[] = {36, 23, 4, 9, 228, 240, 57, 181, 20, 43, 112, 97, 93, 105, 43, 99, 97, 112, 79, 112, 93, 112, 113, 111, 79, 97, 106, 96, 80, 97, 116, 112, 86};


//: KEKENotificationLanguageChanged
Byte kStr_userContent[] = {7, 31, 23, 9, 29, 139, 152, 130, 252, 52, 46, 52, 46, 55, 88, 93, 82, 79, 82, 76, 74, 93, 82, 88, 87, 53, 74, 87, 80, 94, 74, 80, 78, 44, 81, 74, 87, 80, 78, 77, 177};


//: showFile:
Byte kStr_tingFrameName[] = {75, 9, 29, 8, 190, 16, 3, 201, 86, 75, 82, 90, 41, 76, 79, 72, 29, 111};


//: contact_tag_fragment_sure
Byte kStr_barStackReloadValue[] = {59, 25, 17, 11, 85, 32, 103, 57, 5, 156, 147, 82, 94, 93, 99, 80, 82, 99, 78, 99, 80, 86, 78, 85, 97, 80, 86, 92, 84, 93, 99, 78, 98, 100, 97, 84, 238};


//: 被拉黑
Byte kStr_ingredientText[] = {37, 9, 5, 12, 12, 58, 58, 187, 116, 100, 242, 157, 227, 157, 166, 225, 134, 132, 228, 182, 140, 1};


//: #F6B53E
Byte kStr_flueData[] = {14, 7, 26, 8, 39, 10, 113, 189, 9, 44, 28, 40, 27, 25, 43, 187};


//: contact
Byte kStr_representSelectData[] = {25, 7, 77, 12, 144, 182, 77, 120, 149, 120, 234, 136, 22, 34, 33, 39, 20, 22, 39, 131};


//: code
Byte kStr_dateData[] = {33, 4, 66, 6, 41, 183, 33, 45, 34, 35, 41};


//: 消息已发送，但对方拒收
Byte kStr_drivewayData[] = {6, 33, 43, 5, 68, 187, 139, 93, 187, 86, 132, 186, 140, 135, 186, 100, 102, 190, 85, 86, 196, 145, 97, 185, 146, 91, 186, 132, 142, 187, 107, 142, 187, 96, 103, 187, 105, 139, 137};


//: text
Byte kStr_valueImageName[] = {30, 4, 67, 4, 49, 34, 53, 49, 62};


//: user_profile_avtivity_user_info_update_failed
Byte kStr_normalDelicateText[] = {69, 45, 12, 8, 215, 182, 174, 112, 105, 103, 89, 102, 83, 100, 102, 99, 90, 93, 96, 89, 83, 85, 106, 104, 93, 106, 93, 104, 109, 83, 105, 103, 89, 102, 83, 93, 98, 90, 99, 83, 105, 100, 88, 85, 104, 89, 83, 90, 85, 93, 96, 89, 88, 212};


//: 01B0FD
Byte kStr_requestSearchedValue[] = {11, 6, 46, 6, 214, 139, 2, 3, 20, 2, 24, 22, 121};


//: 撤回附言
Byte kStr_cousinName[] = {49, 12, 2, 5, 156, 228, 144, 162, 227, 153, 156, 231, 151, 130, 230, 166, 126, 33};


//: http
Byte kStr_burningValue[] = {77, 4, 96, 11, 82, 42, 212, 147, 196, 227, 165, 8, 20, 20, 16, 145};


//: /other/feedback
Byte kStr_referText[] = {42, 15, 86, 4, 217, 25, 30, 18, 15, 28, 217, 16, 15, 15, 14, 12, 11, 13, 21, 125};


//: sessionname
Byte kStr_endData[] = {19, 11, 22, 13, 100, 158, 12, 19, 239, 102, 254, 211, 41, 93, 79, 93, 93, 83, 89, 88, 88, 75, 87, 79, 129};


//: /other/getNimCheckSum
Byte kStr_emptyText[] = {99, 21, 83, 14, 40, 174, 119, 193, 233, 138, 154, 219, 27, 93, 220, 28, 33, 21, 18, 31, 220, 20, 18, 33, 251, 22, 26, 240, 21, 18, 16, 24, 0, 34, 26, 169};


//: 本地反垃圾失败
Byte kStr_onRefreshContent[] = {19, 21, 6, 10, 7, 136, 87, 35, 136, 30, 224, 150, 166, 223, 150, 170, 223, 137, 135, 223, 152, 125, 223, 150, 184, 223, 158, 171, 226, 174, 159, 93};


//: 添加失败
Byte kStr_sizeWillValue[] = {18, 12, 68, 13, 11, 22, 121, 186, 255, 58, 157, 203, 32, 162, 115, 119, 161, 70, 92, 161, 96, 109, 164, 112, 97, 239};


//: http://api-sg.yunxinapi.com/nimserver/translator/textMsg.action
Byte kStr_brigData[] = {97, 63, 37, 14, 199, 239, 232, 118, 58, 192, 100, 51, 195, 153, 67, 79, 79, 75, 21, 10, 10, 60, 75, 68, 8, 78, 66, 9, 84, 80, 73, 83, 68, 73, 60, 75, 68, 9, 62, 74, 72, 10, 73, 68, 72, 78, 64, 77, 81, 64, 77, 10, 79, 77, 60, 73, 78, 71, 60, 79, 74, 77, 10, 79, 64, 83, 79, 40, 78, 66, 9, 60, 62, 79, 68, 74, 73, 51};


//: 选择会话类型
Byte kStr_controlValue[] = {45, 18, 33, 10, 2, 253, 209, 190, 84, 43, 200, 95, 104, 197, 106, 136, 195, 155, 121, 199, 142, 124, 198, 144, 154, 196, 125, 106, 218};


//: 申请成功，等待验证
Byte kStr_sizeDateTitle[] = {7, 27, 62, 4, 169, 86, 117, 170, 113, 121, 168, 74, 82, 167, 76, 97, 177, 126, 78, 169, 111, 75, 167, 128, 71, 171, 108, 78, 170, 113, 67, 209};


//: 发送时间超过2分钟的消息不能被撤回
Byte kStr_findText[] = {27, 49, 45, 14, 185, 26, 202, 182, 118, 207, 91, 185, 41, 5, 184, 98, 100, 188, 83, 84, 185, 106, 137, 188, 106, 135, 187, 137, 88, 187, 146, 90, 5, 184, 91, 89, 188, 101, 114, 186, 109, 87, 185, 137, 91, 185, 84, 130, 183, 139, 96, 187, 86, 144, 187, 117, 126, 185, 101, 119, 184, 110, 113, 239};


//: postscript
Byte kStr_toPaintValue[] = {82, 10, 38, 10, 19, 73, 123, 79, 228, 87, 74, 73, 77, 78, 77, 61, 76, 67, 74, 78, 158};


//: 不能和自己通话哦
Byte kStr_viewRecentForData[] = {60, 24, 89, 8, 105, 129, 231, 144, 139, 95, 52, 143, 42, 100, 140, 57, 51, 143, 46, 81, 140, 94, 88, 144, 39, 65, 143, 86, 68, 140, 58, 77, 56};


//: 已发送
Byte kStr_languageButtonTitle[] = {57, 9, 72, 11, 232, 178, 11, 228, 68, 106, 138, 157, 111, 106, 157, 71, 73, 161, 56, 57, 159};


//: %@.code:%zd
Byte kStr_soleTornTitle[] = {14, 11, 66, 9, 167, 18, 244, 139, 230, 227, 254, 236, 33, 45, 34, 35, 248, 227, 56, 34, 209};


//: message_helper_apply_to_group
Byte kStr_soleData[] = {24, 29, 26, 6, 227, 26, 83, 75, 89, 89, 71, 77, 75, 69, 78, 75, 82, 86, 75, 88, 69, 71, 86, 86, 82, 95, 69, 90, 85, 69, 77, 88, 85, 91, 86, 69};


//: luyintaiduan
Byte kStr_messageDateData[] = {5, 12, 37, 6, 120, 1, 71, 80, 84, 68, 73, 79, 60, 68, 63, 80, 60, 73, 165};


//: 收藏失败
Byte kStr_stackBarShowTitle[] = {46, 12, 55, 9, 246, 136, 159, 166, 181, 175, 93, 127, 177, 96, 88, 174, 109, 122, 177, 125, 110, 218};


//: contact_tag_fragment_delete_success
Byte kStr_heToxicValue[] = {82, 35, 59, 10, 253, 144, 80, 189, 104, 217, 40, 52, 51, 57, 38, 40, 57, 36, 57, 38, 44, 36, 43, 55, 38, 44, 50, 42, 51, 57, 36, 41, 42, 49, 42, 57, 42, 36, 56, 58, 40, 40, 42, 56, 56, 40};


//: teamgonggao_content_
Byte kStr_quickDisabledData[] = {56, 20, 21, 13, 221, 83, 162, 85, 36, 134, 34, 53, 81, 95, 80, 76, 88, 82, 90, 89, 82, 82, 76, 90, 74, 78, 90, 89, 95, 80, 89, 95, 74, 190};


//: content
Byte kStr_disabledTitle[] = {56, 7, 36, 8, 112, 19, 21, 103, 63, 75, 74, 80, 65, 74, 80, 84};


//: luyinshibai
Byte kStr_normalTitle[] = {65, 11, 53, 9, 74, 33, 87, 99, 172, 55, 64, 68, 52, 57, 62, 51, 52, 45, 44, 52, 51};


//: 您已被禁言
Byte kStr_viewEnableText[] = {28, 15, 38, 5, 216, 192, 92, 130, 191, 145, 140, 194, 124, 133, 193, 128, 91, 194, 130, 90, 210};


//: 扩展字段
Byte kStr_oxygenValue[] = {72, 12, 97, 11, 131, 175, 242, 19, 226, 220, 88, 133, 40, 72, 132, 80, 52, 132, 76, 54, 133, 77, 84, 166};


//: teamgonggao_
Byte kStr_normalEndTitle[] = {1, 12, 25, 4, 91, 76, 72, 84, 78, 86, 85, 78, 78, 72, 86, 70, 15};


//: /team/getTeamSetting
Byte kStr_imageSearchValue[] = {62, 20, 65, 4, 238, 51, 36, 32, 44, 238, 38, 36, 51, 19, 36, 32, 44, 18, 36, 51, 51, 40, 45, 38, 233};


//: 收藏成功
Byte kStr_normalOptionText[] = {99, 12, 33, 6, 162, 14, 197, 115, 149, 199, 118, 110, 197, 103, 111, 196, 105, 126, 182};


//: 发送时间超过2分钟的消息，不能被撤回
Byte kStr_blueTornValue[] = {28, 52, 28, 6, 224, 139, 201, 115, 117, 205, 100, 101, 202, 123, 154, 205, 123, 152, 204, 154, 105, 204, 163, 107, 22, 201, 108, 106, 205, 118, 131, 203, 126, 104, 202, 154, 108, 202, 101, 147, 211, 160, 112, 200, 156, 113, 204, 103, 161, 204, 134, 143, 202, 118, 136, 201, 127, 130, 23};


//: 群申请失败
Byte kStr_hungerText[] = {34, 15, 21, 5, 145, 210, 169, 143, 210, 127, 158, 211, 154, 162, 208, 143, 156, 211, 159, 144, 140};


//: activity_friend_verify_info
Byte kStr_casualtyEndErnName[] = {89, 27, 88, 12, 163, 223, 22, 63, 86, 140, 54, 213, 9, 11, 28, 17, 30, 17, 28, 33, 7, 14, 26, 17, 13, 22, 12, 7, 30, 13, 26, 17, 14, 33, 7, 17, 22, 14, 23, 62};


//: app_team_invalid_tip
Byte kStr_whenSubmitTitle[] = {33, 20, 56, 10, 127, 90, 117, 104, 22, 145, 41, 56, 56, 39, 60, 45, 41, 53, 39, 49, 54, 62, 41, 52, 49, 44, 39, 60, 49, 56, 96};


//: teamgonggao_title_
Byte kStr_countLanguageValue[] = {19, 18, 85, 14, 210, 62, 134, 30, 15, 103, 130, 56, 244, 67, 31, 16, 12, 24, 18, 26, 25, 18, 18, 12, 26, 10, 31, 20, 31, 23, 16, 10, 74};


//: #FEFECA
Byte kStr_requestName[] = {48, 7, 53, 11, 17, 251, 7, 238, 170, 165, 224, 238, 17, 16, 17, 16, 14, 12, 132};


//: group_chat_avatar_activity_add_black_success
Byte kStr_suspectTitle[] = {4, 44, 92, 10, 104, 233, 55, 90, 15, 67, 11, 22, 19, 25, 20, 3, 7, 12, 5, 24, 3, 5, 26, 5, 24, 5, 22, 3, 5, 7, 24, 13, 26, 13, 24, 29, 3, 5, 8, 8, 3, 6, 16, 5, 7, 15, 3, 23, 25, 7, 7, 9, 23, 23, 56};


//: personCardId
Byte kStr_novelName[] = {57, 12, 98, 8, 166, 224, 191, 143, 14, 3, 16, 17, 13, 12, 225, 255, 16, 2, 231, 2, 165};


//: 消息合并转发失败
Byte kStr_heroName[] = {44, 24, 5, 7, 132, 147, 167, 225, 177, 131, 225, 124, 170, 224, 139, 131, 224, 180, 177, 227, 184, 167, 224, 138, 140, 224, 159, 172, 227, 175, 160, 246};


//: msg
Byte kStr_drivewayValue[] = {66, 3, 35, 14, 70, 29, 73, 118, 40, 187, 216, 222, 242, 97, 74, 80, 68, 21};


//: 正在输入
Byte kStr_requestData[] = {28, 12, 9, 13, 229, 199, 105, 74, 199, 65, 22, 171, 212, 221, 164, 154, 220, 147, 159, 223, 181, 138, 220, 124, 156, 179};


//: 确认转发
Byte kStr_franchiseTitle[] = {82, 12, 44, 6, 158, 145, 187, 117, 130, 188, 130, 120, 188, 145, 128, 185, 99, 101, 160};


//: title
Byte kStr_titleFrameValue[] = {16, 5, 5, 12, 231, 87, 234, 131, 122, 75, 185, 243, 111, 100, 111, 103, 96, 255};


//: my_computer
Byte kStr_endControlName[] = {28, 11, 56, 4, 53, 65, 39, 43, 55, 53, 56, 61, 60, 45, 58, 1};


//: zh-CHT
Byte kStr_cellContentName[] = {32, 6, 4, 9, 164, 85, 105, 228, 105, 118, 100, 41, 63, 68, 80, 65};


//: 反垃圾消息
Byte kStr_quickTitle[] = {20, 15, 9, 12, 89, 2, 211, 216, 132, 58, 75, 196, 220, 134, 132, 220, 149, 122, 220, 147, 181, 221, 173, 127, 221, 120, 166, 51};


//: data
Byte kStr_lengthValue[] = {36, 4, 81, 4, 19, 16, 35, 16, 193};


//: ** 该消息被屏蔽 **
Byte kStr_topGroupTitle[] = {75, 24, 95, 10, 147, 108, 89, 253, 21, 144, 203, 203, 193, 137, 80, 70, 135, 87, 41, 135, 34, 80, 137, 67, 76, 134, 82, 48, 137, 53, 94, 193, 203, 203, 78};


//: username
Byte kStr_recentTitleName[] = {73, 8, 41, 5, 252, 76, 74, 60, 73, 69, 56, 68, 60, 225};


//: NTESMessageRefusedTag
Byte kStr_apologyName[] = {92, 21, 66, 6, 230, 253, 12, 18, 3, 17, 11, 35, 49, 49, 31, 37, 35, 16, 35, 36, 51, 49, 35, 34, 18, 31, 37, 243};


//: contact_fragment_group
Byte kStr_recentData[] = {13, 22, 29, 4, 70, 82, 81, 87, 68, 70, 87, 66, 73, 85, 68, 74, 80, 72, 81, 87, 66, 74, 85, 82, 88, 83, 105};


//: showVideo:
Byte kStr_fleshTitle[] = {43, 10, 81, 6, 168, 68, 34, 23, 30, 38, 5, 24, 19, 20, 30, 233, 209};


//: NTESMessageTranslate
Byte kStr_requestKeyNimValue[] = {48, 20, 20, 6, 182, 210, 58, 64, 49, 63, 57, 81, 95, 95, 77, 83, 81, 64, 94, 77, 90, 95, 88, 77, 96, 81, 234};


//: 转发失败
Byte kStr_equalName[] = {97, 12, 40, 6, 233, 181, 192, 149, 132, 189, 103, 105, 189, 124, 137, 192, 140, 125, 180};


//: canSendText
Byte kStr_indexEmptyName[] = {67, 11, 57, 6, 81, 173, 42, 40, 53, 26, 44, 53, 43, 27, 44, 63, 59, 47};


//: showLocation:
Byte kStr_noteData[] = {46, 13, 87, 9, 95, 95, 12, 183, 33, 28, 17, 24, 32, 245, 24, 12, 10, 29, 18, 24, 23, 227, 202};


//: black_list_activity_add_black_failed
Byte kStr_voiceRequestValue[] = {89, 36, 14, 9, 193, 122, 88, 124, 131, 84, 94, 83, 85, 93, 81, 94, 91, 101, 102, 81, 83, 85, 102, 91, 104, 91, 102, 107, 81, 83, 86, 86, 81, 84, 94, 83, 85, 93, 81, 88, 83, 91, 94, 87, 86, 154};


//: zh-CHS
Byte kStr_countText[] = {32, 6, 23, 13, 240, 122, 237, 246, 251, 105, 67, 216, 211, 99, 81, 22, 44, 49, 60, 117};


//: translation
Byte kStr_naturallyValue[] = {86, 11, 34, 13, 233, 116, 167, 70, 173, 186, 194, 102, 171, 82, 80, 63, 76, 81, 74, 63, 82, 71, 77, 76, 247};


//: SELF MATCHES %@
Byte kStr_userFindBlueName[] = {58, 15, 70, 10, 101, 144, 224, 49, 188, 220, 13, 255, 6, 0, 218, 7, 251, 14, 253, 2, 255, 13, 218, 223, 250, 185};


//: 删除成功
Byte kStr_blueToxicData[] = {27, 12, 34, 11, 71, 255, 63, 163, 51, 45, 129, 195, 102, 126, 199, 119, 130, 196, 102, 110, 195, 104, 125, 96};


//: canMemberInfo
Byte kStr_normalButtonName[] = {48, 13, 96, 10, 143, 100, 49, 198, 67, 86, 3, 1, 14, 237, 5, 13, 2, 5, 18, 233, 14, 6, 15, 205};


//: checksum
Byte kStr_mustCurrentName[] = {91, 8, 11, 9, 87, 112, 104, 250, 195, 88, 93, 90, 88, 96, 104, 106, 98, 180};


//: 发言频次过快，请%ld秒后重试
Byte kStr_fileSizeDeviceName[] = {75, 39, 77, 6, 32, 231, 152, 66, 68, 155, 91, 51, 156, 85, 68, 153, 95, 84, 155, 114, 58, 152, 114, 94, 162, 111, 63, 155, 98, 106, 216, 31, 23, 154, 90, 69, 152, 67, 65, 156, 58, 64, 155, 98, 72, 55};


//: recid
Byte kStr_messageTingKeyValue[] = {32, 5, 32, 10, 225, 67, 128, 101, 138, 79, 82, 69, 67, 73, 68, 187};
...
#import "PhotoManager+TitleAddtionals.h"
...
NSString *kLet_messageTitle = @"kNTESDemoRevokeMessageFromMeNotication";
// 定义后台允许的最大时间（1小时）
//: static const NSTimeInterval kMaxBackgroundTime = 60*60;
static const NSTimeInterval kLet_viewData = 60*60;

//: @interface NTESSessionViewController ()
@interface RadiogramViewController ()
...
@property (nonatomic,strong) KeySender *notificaionSender;
//: @property (nonatomic,strong) NTESSessionConfig *sessionConfig;
@property (nonatomic,strong) PointConfig *sessionConfig;
//: @property (nonatomic,strong) UIImagePickerController *imagePicker;
@property (nonatomic,strong) UIImagePickerController *imagePicker;
//: @property (nonatomic,strong) UIView *currentSingleSnapView;
@property (nonatomic,strong) UIView *currentSingleSnapView;
//@property (nonatomic,strong)    IndexView *fpsLabel;
...
@property (nonatomic,strong) MarginView *mulSelectedSureBar;
...
@property (nonatomic,strong) PointAction *mergeForwardSession;
...
@property (nonatomic, strong) TitleView *reprotNextView;
//: @property (nonatomic, strong) ZMONReportBlackView *reprotBlackView;
@property (nonatomic, strong) TextView *reprotBlackView;
//: @property (nonatomic, strong) ZMONReportDeleteView *reprotDeleteView;
@property (nonatomic, strong) ChangeShapeView *reprotDeleteView;
//: @property (nonatomic, strong) NSString *userId;
@property (nonatomic, strong) NSString *userId;
//: @property (nonatomic, strong) ZMONReportHisView *reprotHisNextView;
@property (nonatomic, strong) RecentView *reprotHisNextView;
    ...
    dispatch_after(dispatch_time((0ull), (int64_t)(0.25 * 1000000000ull)), dispatch_get_main_queue(), ^{
        ...
        if (team && team.announcement && team.announcement.length > 0) {
            ...
            if (datas.count <= 0){
                ...
                [[MissiveButton phenomenon] titleParadigm];
                //: return;
                return;
            }

            //: NSString *title = [datas lastObject][@"title"];
            NSString *title = [datas lastObject][StringFromFrequentlyData(kStr_titleFrameValue)];
            //: NSString *content = [datas lastObject][@"content"];
            NSString *content = [datas lastObject][StringFromFrequentlyData(kStr_disabledTitle)];
            ...
            if (title.length > 0 || content.length > 0){
                ...
                [[MissiveButton phenomenon] redGenerateBlock:self.view image:message disable:^{
                    @
                    ...
                    MessageOption *option = [[MessageOption alloc] init];
                    ...
                    BroadViewController *vc = [[BroadViewController alloc] initWithAt:option];
...
- (void)showChecked:(NSNotification *)notification
{
        // 记录进入后台的时间
...
- (void)actionValue:(NSNotification *)notification
{
    // 检查后台停留时间是否超过阈值
       ...
       if (self.backgroundEnterTime) {
           ...
           if (backgroundTime >= kLet_viewData) {
...
- (void)viewDidLoad {
    ...
    _notificaionSender = [[KeySender alloc] init];
//    [self setupNormalNav];
...
//    if ([[SayImage sharedConfig] showFps])
//    {
//        self.fpsLabel = [[IndexView alloc] initWithFrame:CGRectZero];
...
//    }
    ...
    if (self.session.sessionType == NIMSessionTypeP2P && !self.disableOnlineState)
    {
        ...
        [[ImageColor sharedUserAdministratorName] trackDoing:self.session.sessionId];
    ...
    [ArrayUtil distance:self.session extra:NTESRecentSessionMarkTypeAt];

    //批量转发
    //: _mergeForwardSession = [[NTESMergeForwardSession alloc] init];
    _mergeForwardSession = [[PointAction alloc] init];
    //    [self setupSearchVC];

    //: [[NSNotificationCenter defaultCenter] addObserver:self
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             //: selector:@selector(onRevokeMessageFromMe:)
                                             selector:@selector(speedied:)
                                                 //: name:kNTESDemoRevokeMessageFromMeNotication
                                                 name:kLet_messageTitle
                                               //: object:nil];
                                               object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(showChecked:) name:UIApplicationDidEnterBackgroundNotification object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(actionValue:) name:UIApplicationWillEnterForegroundNotification object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(elected:) name:StringFromFrequentlyData(kStr_userContent) object:nil];
    ...
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromFrequentlyData(kStr_imageSearchValue)] tool:dict examine:NO titleResponseSuccess:^(id responseObject) {
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
        ...
        NSString *code = [resultDict with:StringFromFrequentlyData(kStr_dateData)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict view:StringFromFrequentlyData(kStr_lengthValue)];
...
//            NSString *frequency = [data newStringValueForKey:@"frequency"];
            ...
            NSString *canMemberInfovalue = [data with:StringFromFrequentlyData(kStr_normalButtonName)];
            //: NSString *ispushvalue = [data newStringValueForKey:@"ispush"];
            NSString *ispushvalue = [data with:StringFromFrequentlyData(kStr_dateName)];
...
//            }
    ...
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromFrequentlyData(kStr_titleCountName)] tool:dict examine:NO titleResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict with:StringFromFrequentlyData(kStr_dateData)];
        ...
        if (code.integerValue <= 0) {
            ...
            NSString *canSendText = [data team:StringFromFrequentlyData(kStr_indexEmptyName) doing:@"1"];
    ...
    NSString * flag = [[NSUserDefaults standardUserDefaults] valueForKey:[[NSString alloc]initWithFormat:@"%@%@",StringFromFrequentlyData(kStr_normalEndTitle),self.session.sessionId]];
    ...
    if([@"1" isEqualToString:flag]){
        ...
        [[NSUserDefaults standardUserDefaults] setValue:@"0" forKey:[[NSString alloc]initWithFormat:@"%@%@",StringFromFrequentlyData(kStr_normalEndTitle),self.session.sessionId]];
        //取出标题和内容
        ...
        NSString * title = [[NSUserDefaults standardUserDefaults] valueForKey:[[NSString alloc] initWithFormat:@"%@%@",StringFromFrequentlyData(kStr_countLanguageValue),self.session.sessionId]];
        ...
        NSString * content = [[NSUserDefaults standardUserDefaults] valueForKey:[[NSString alloc] initWithFormat:@"%@%@",StringFromFrequentlyData(kStr_quickDisabledData),self.session.sessionId]];
        ...
        if (title.length > 0 || content.length > 0){
            ...
            [GraduateTemp container].config
                ...
                .LeeAddAction(^(TempAction *action) {
                    ...
                    action.title = [ItemManager sessionInformation:StringFromFrequentlyData(kStr_barStackReloadValue)];
                    //: action.titleColor = [UIColor colorWithHexString:@"01B0FD"];
                    action.titleColor = [UIColor withMax:StringFromFrequentlyData(kStr_requestSearchedValue)];
    ...
    self.header = [[ShowView alloc] initWithFrame:CGRectMake(0, (44.0f + [UIDevice clear]), self.view.width, 0)];
    ...
    [self.header size:ListHeaderTypeNetStauts sign:@(step)];
}

//: - (void)languageChanged:(NSNotification *)noti {
- (void)elected:(NSNotification *)noti {
    //: [self refreshMessages];
    [self length];
...
- (void)dealloc
{
    ...
    if (self.session.sessionType == NIMSessionTypeP2P && !self.disableOnlineState)
    {
        ...
        [[ImageColor sharedUserAdministratorName] quickCircleState:self.session.sessionId];
    }
...
- (id<FrameConfig>)sessionConfig
{
    ...
    if (_sessionConfig == nil) {
        ...
        _sessionConfig = [[PointConfig alloc] init];
...
#pragma mark - CookieDelegate

//: - (void)NIMTeamCardVCDidSetTop:(BOOL)isTop {
- (void)clearing:(BOOL)isTop {
...
- (void)onRecvSubscribeEvents:(NSArray *)events
{
    ...
    for (NIMSubscribeEvent *event in events) {
        ...
        if ([event.from isEqualToString:self.session.sessionId]) {
            ...
            [self more:[ArrayUtil recording:self.session.sessionId key:YES]];
        }
    }
}
...
- (void)onReceiveCustomSystemNotification:(NIMCustomSystemNotification *)notification
{
    ...
    if (data) {
        ...
        if ([dict session:@"id"] == (1) && self.session.sessionType == NIMSessionTypeP2P && [notification.sender isEqualToString:self.session.sessionId])
        {
            //: [self refreshSessionTitle:[NSString stringWithFormat:@"%@...",@"正在输入".ntes_localized]];
            [self domain:[NSString stringWithFormat:@"%@...",StringFromFrequentlyData(kStr_requestData).aboveMagnitude]];
...
- (NSString *)disable
{
    ...
    if ([self.session.sessionId isEqualToString:[NIMSDK sharedSDK].loginManager.currentAccount]) {
        ...
        return [ItemManager sessionInformation:StringFromFrequentlyData(kStr_endControlName)];
    }
...
- (NSString *)picture
{
    ...
    if (self.session.sessionType == NIMSessionTypeP2P && ![self.session.sessionId isEqualToString:[NIMSDK sharedSDK].loginManager.currentAccount]) {
        ...
        return [ArrayUtil recording:self.session.sessionId key:YES];
    }
    //: return @"";
    return @"";
}
...
- (void)ofed:(id)sender
{
    ...
    [_notificaionSender menuView:self.session];
}
...
- (void)trademark:(NSString *)text searched:(NSArray *)atUsers{
    //: [super onSendText:text atUsers:atUsers];
    [super trademark:text searched:atUsers];
}

//正则过滤，字符串是否是纯数字
//: - (BOOL)filterInputShouldNumber:(NSString *)str
- (BOOL)cancel:(NSString *)str
{
   //: if (str.length == 0) {
   if (str.length == 0) {
        //: return NO;
    ...
    NSPredicate *pred = [NSPredicate predicateWithFormat:StringFromFrequentlyData(kStr_userFindBlueName),regex];
...
- (void)view:(NIMMessage *)message pop:(NSString *)type
{
    ...
    NSDictionary *dic = @{
        ...
        StringFromFrequentlyData(kStr_atText) : emptyString(userID),
        //: @"username" : nickName?:@"",
        StringFromFrequentlyData(kStr_recentTitleName) : nickName?:@"",
        //: @"content" : message.text?:@"",
        StringFromFrequentlyData(kStr_disabledTitle) : message.text?:@"",
        //: @"recid" : self.session.sessionId?:@"",
        StringFromFrequentlyData(kStr_messageTingKeyValue) : self.session.sessionId?:@"",
        //: @"type" : [NSString stringWithFormat:@"apple+%@",type],
        StringFromFrequentlyData(kStr_userNameData) : [NSString stringWithFormat:StringFromFrequentlyData(kStr_messageDisabledData),type],
        //: @"sessionname" : self.sessionTitle?:@"",
        StringFromFrequentlyData(kStr_endData) : self.disable?:@"",
    //: };
    };

    //: [ZCHttpManager refreshForbiddenWordsparams:dic GenerateUser:^(NSDictionary * _Nonnull configDict) {
    [PhotoManager input:dic generateStatusWearerSelectedInfo:^(NSDictionary * _Nonnull configDict) {
...
- (void)content:(NIMMessage *)message
{
    ...
    if (_intervalTime > 0 && _isSend == NO) {
        ...
        [self view:message pop:StringFromFrequentlyData(kStr_quickBarValue)];
        //: NSString *title = [NSString stringWithFormat:[FFFLanguageManager getTextWithKey:@"发言频次过快，请%ld秒后重试"],(long)_intervalTime];
        NSString *title = [NSString stringWithFormat:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_fileSizeDeviceName)],(long)_intervalTime];
        //: [SVProgressHUD showMessage:title];
        [SVProgressHUD format:title];
        //: return;
        return;
    }
    //: _isSend = NO;
    ...
    if (!_canSendText && message.messageType == NIMMessageTypeText && ![self cancel:message.text]) {
        //: [self hitClientAntispamWithMessage:message type:@"不允许文字"];
        [self view:message pop:StringFromFrequentlyData(kStr_optionFindName)];
    }

    //: if ([[NTESBundleSetting sharedConfig] enableLocalAnti] && message.messageType == NIMMessageTypeText)
    if ([[SayImage linkIn] bridle] && message.messageType == NIMMessageTypeText)
    {
        ...
        if (error)
        {
            ...
            [self.view makeToast:StringFromFrequentlyData(kStr_onRefreshContent).aboveMagnitude];
        }
        //: else
        else
        {
            ...
            switch (result.type) {
                ...
                case NIMAntiSpamResultLocalForbidden:
                    ...
                    [self.view makeToast:StringFromFrequentlyData(kStr_topGroupTitle).aboveMagnitude];
                    //: return;
                    return;
                ...
                case NIMAntiSpamResultServerForbidden:
                {
                    ...
                    [self view:message pop:StringFromFrequentlyData(kStr_quickTitle)];
                }
                    //: break;
                    break;
...
- (void)onTapMenuItemReply:(ImageRecent *)item
{
        ...
        menuMessage)
    {
        ...
        [self.sessionInputView size:@[[NSString stringWithFormat:@"%@", menuMessage.from]]];
    }
}
...
- (void)onTapMenuItemMark:(ImageRecent *)item
{
    ...
    params.uniqueId = message.messageId.past;
    ...
    [[NIMSDK sharedSDK].chatExtendManager addCollect:params completion:^(NSError * _Nullable error, NIMCollectInfo * _Nullable collectInfo) {
        ...
        if (error) {
            ...
            [SVProgressHUD showErrorWithStatus:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_stackBarShowTitle)]];
            //: return;
            return;
        }
        //: [SVProgressHUD showSuccessWithStatus:[FFFLanguageManager getTextWithKey:@"收藏成功"]];
        [SVProgressHUD showSuccessWithStatus:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_normalOptionText)]];
    //: }];
    }];
}
...
- (void)onTapMenuItemPin:(ImageRecent *)item
{
    ...
    [[NIMSDK sharedSDK].chatExtendManager addMessagePin:pinItem completion:^(NSError * _Nullable error, NIMMessagePinItem * _Nullable item) {
        ...
        if (error) {
            ...
            [SVProgressHUD showErrorWithStatus:StringFromFrequentlyData(kStr_sizeWillValue).aboveMagnitude];
            //: return;
            return;
        }
        //: [sself uiPinMessage:message];
        [sself trapCell:message];
    //: }];
    }];
}
...
- (void)onTapMenuItemUnpin:(ImageRecent *)item
{
    ...
    [[NIMSDK sharedSDK].chatExtendManager removeMessagePin:pinItem completion:^(NSError * _Nullable error, NIMMessagePinItem * _Nullable item) {
        ...
        if (error) {
            ...
            [SVProgressHUD showErrorWithStatus:StringFromFrequentlyData(kStr_toData).aboveMagnitude];
            //: return;
            return;
        }
...
- (void)onTapMenuItemRevoke:(ImageRecent *)item
{
    ...
    BOOL enableRevokePostscript = [[SayImage linkIn] postscriptStyle];
    //: if (enableRevokePostscript) {
    if (enableRevokePostscript) {
        //: [self doShowInputRevokePostscriptAlert:message];
        [self colorPath:message];
    //: } else {
    } else {
        //: [self doRevokeMessage:message postscript:nil];
        [self message:message practice:nil];
    }
}
///获取UTC时间戳
...
//    return timeSp;
    ...
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init] ;
        ...
        [formatter setDateFormat:StringFromFrequentlyData(kStr_referTingConfirmTitle)]; // ----------设置你想要的格式,hh与HH的区别:分别表示12小时制,24小时制
        //设置时区,这个对于时间的处理有时很重要
        //: NSTimeZone* timeZone = [NSTimeZone timeZoneWithName:@"Asia/Shanghai"];
        NSTimeZone* timeZone = [NSTimeZone timeZoneWithName:StringFromFrequentlyData(kStr_endKeyValue)];
...
- (void)onTapMenuItemTranslation:(ImageRecent *)item
{
    ...
    NSString *time = [self sound];
    //: NSMutableDictionary *param = @{}.mutableCopy;
    NSMutableDictionary *param = @{}.mutableCopy;
    //: param[@"curTime"] = time;
    param[StringFromFrequentlyData(kStr_endControlTitle)] = time;

    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/other/getNimCheckSum"] params:param isShow:NO success:^(id responseObject) {
    [PhotoManager towardExtra:[NSString stringWithFormat:StringFromFrequentlyData(kStr_emptyText)] tool:param examine:NO titleResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict with:StringFromFrequentlyData(kStr_dateData)];
        ...
        if (code.integerValue <= 0) {
            ...
            NSString *checksum = [data with:StringFromFrequentlyData(kStr_mustCurrentName)];
            //: NSString *nonce = [data newStringValueForKey:@"nonce"];
            NSString *nonce = [data with:StringFromFrequentlyData(kStr_sharedSizeData)];

            //: NSString *userID = [[NIMSDK sharedSDK].loginManager currentAccount];
            NSString *userID = [[NIMSDK sharedSDK].loginManager currentAccount];
            //: NSString *lang = emptyString([NIMUserDefaults standardUserDefaults].language);
            NSString *lang = emptyString([PhotoDefaults ting].language);
            //: if([lang isEqualToString:@"zh"]){
            if([lang isEqualToString:@"zh"]){
                //: lang = @"zh-CHS";
                lang = StringFromFrequentlyData(kStr_countText);
            //: }else if ([lang isEqualToString:@"hant"]){
            }else if ([lang isEqualToString:StringFromFrequentlyData(kStr_keyBarValue)]){
                //: lang = @"zh-CHT";
                lang = StringFromFrequentlyData(kStr_cellContentName);
            }
            //: NSMutableDictionary *dict = @{}.mutableCopy;
            NSMutableDictionary *dict = @{}.mutableCopy;
            //: [dict setObject:userID forKey:@"accid"];
            [dict setObject:userID forKey:StringFromFrequentlyData(kStr_atText)];
            //: [dict setObject:message.text forKey:@"text"];
            [dict setObject:message.text forKey:StringFromFrequentlyData(kStr_valueImageName)];
            ...
            [PhotoManager doing:StringFromFrequentlyData(kStr_brigData) gregorianCalendarMonthValue:checksum with:nonce tap:time makeUpFailed:dict sub:^(id responseObject) {
                ...
                if (code.integerValue == 200) {
                    ...
                    NSString *translation = [data with:StringFromFrequentlyData(kStr_naturallyValue)];

                    //: message.localExt = @{@"NTESMessageTranslate": translation };
                    message.localExt = @{StringFromFrequentlyData(kStr_requestKeyNimValue): translation };
                ...
                //: }else{
                    ...
                    NSString *desc = [resultDict with:StringFromFrequentlyData(kStr_willEvolutionaryValue)];
                    //: [SVProgressHUD showMessage:desc];
                    [SVProgressHUD format:desc];
                }


            //: } failed:^(id responseObject, NSError *error) {
            } titleResponseFailed:^(id responseObject, NSError *error) {
                //: [SVProgressHUD showMessage:error.domain];
                [SVProgressHUD format:error.domain];
            //: }];
            }];
...
- (void)theRadiogram:(NIMMessage *)message
{
    //: NSInteger row = [self.interactor findMessageIndex:message];
    NSInteger row = [self.interactor mark:message];
    //: if (row != -1) {
    if (row != -1) {
...
- (void)colorPath:(NIMMessage *)message {
    //: UIAlertController *alertVC = [UIAlertController alertControllerWithTitle:@"撤回附言"
    UIAlertController *alertVC = [UIAlertController alertControllerWithTitle:StringFromFrequentlyData(kStr_cousinName)
                                                                     //: message:nil
                                                                     message:nil
    ...
    [alertVC addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
        ...
        textField.placeholder = StringFromFrequentlyData(kStr_apologyValue);
    //: }];
    }];
    ...
    UIAlertAction *sure = [UIAlertAction actionWithTitle:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_barStackReloadValue)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        //: UITextField *input = alertVC.textFields.firstObject;
        UITextField *input = alertVC.textFields.firstObject;
        //: [weakSelf doRevokeMessage:message postscript:input.text];
        [weakSelf message:message practice:input.text];
    //: }];
    }];
...
- (void)message:(NIMMessage *)message practice:(NSString *)postscript{
    //: __weak typeof(self) weakSelf = self;
    __weak typeof(self) weakSelf = self;
    //: NSString *collapseId = message.apnsPayload[@"apns-collapse-id"];
    NSString *collapseId = message.apnsPayload[StringFromFrequentlyData(kStr_ernText)];
    //: NSDictionary *payload = @{
    NSDictionary *payload = @{
        //: @"apns-collapse-id": collapseId ? : @"",
        StringFromFrequentlyData(kStr_ernText): collapseId ? : @"",
    //: };
    };
    ...
    option.apnsContent = [ItemManager sessionInformation:StringFromFrequentlyData(kStr_heroData)];
    //: option.apnsPayload = payload;
    option.apnsPayload = payload;
    //: option.shouldBeCounted = ![[NTESBundleSetting sharedConfig] isIgnoreRevokeMessageCount];
    option.shouldBeCounted = ![[SayImage linkIn] input];
    ...
    [[NIMSDK sharedSDK].chatManager revokeMessage:message option:option completion:^(NSError * _Nullable error) {
        ...
        if (error) {
            ...
            if (error.code == NIMRemoteErrorCodeDomainExpireOld) {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_findText)] delegate:nil cancelButtonTitle:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_barStackReloadValue)] otherButtonTitles:nil, nil];
                //: [alert show];
                [alert show];
            //: } else {
            } else {
                ...
                [weakSelf.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_normalDelicateText)] duration:2.0 position:CSToastPositionCenter];
            }
        //: } else {
        } else {
            ...
            userInfo[StringFromFrequentlyData(kStr_drivewayValue)] = message;
            //: userInfo[@"postscript"] = postscript;
            userInfo[StringFromFrequentlyData(kStr_toPaintValue)] = postscript;
            //: [[NSNotificationCenter defaultCenter] postNotificationName:kNTESDemoRevokeMessageFromMeNotication
            [[NSNotificationCenter defaultCenter] postNotificationName:kLet_messageTitle
                                                                //: object:nil
                                                                object:nil
                                                              //: userInfo:userInfo];
                                                              userInfo:userInfo];
            ...
            NIMMessage *revocationMessage = [ActionConverter query:message];
            //: [weakSelf sendMessage:revocationMessage];
            [weakSelf content:revocationMessage];
        }
    //: }];
    }];
}
...
- (void)speedied:(NSNotification *)note {
    //: NIMMessage *message = note.userInfo[@"msg"];
    NIMMessage *message = note.userInfo[StringFromFrequentlyData(kStr_drivewayValue)];
    //: NSString *postscript = note.userInfo[@"postscript"];
    NSString *postscript = note.userInfo[StringFromFrequentlyData(kStr_toPaintValue)];
    //: if (message) {
    if (message) {
        //: FFFMessageModel *model = [self uiDeleteMessage:message];
        StochasticProcessTeam *model = [self viewMore:message];
        ...
        NIMMessage *tip = [ActionConverter voiceSize:[ArrayUtil secretTitle:postscript]
                                                 //: revokeAttach:_revokeAttach
                                                 library:_revokeAttach
...
- (void)onTapMenuItemDelete:(ImageRecent *)item
{
    ...
    BOOL deleteFromServer = [SayImage linkIn].addSegment;
    //: if (deleteFromServer)
    if (deleteFromServer)
    {
        //: __weak typeof(self) wSelf = self;
        ...
        [[NIMSDK sharedSDK].conversationManager deleteMessageFromServer:message
                                                                    //: ext:@"扩展字段"
                                                                    ext:StringFromFrequentlyData(kStr_oxygenValue)
    ...
    else
    {
        ...
        BOOL isDeleteFromDB = [SayImage linkIn].button;
...
- (void)sendMessage:(NIMMessage *)message didCompleteWithError:(NSError *)error
{
    ...
    if (error.code == NIMRemoteErrorCodeInBlackList)
    {
        ...
        message.localExt = @{StringFromFrequentlyData(kStr_apologyName):@(true)};
        ...
        NIMMessage *tip = [ActionConverter checkTip:StringFromFrequentlyData(kStr_drivewayData).aboveMagnitude];
        ...
        if (message.messageType == NIMMessageTypeText && _intervalTime<=0) {
            ...
            [self view:message pop:StringFromFrequentlyData(kStr_ingredientText)];
        }

    //: } else if (error.code == NIMRemoteErrorCodeTeamBlackList) {
    } else if (error.code == NIMRemoteErrorCodeTeamBlackList) {
        //: NIMMessage *tip = [NTESSessionMsgConverter msgWithTip:@"您已被禁言"];
        NIMMessage *tip = [ActionConverter checkTip:StringFromFrequentlyData(kStr_viewEnableText)];
        //: [[NIMSDK sharedSDK].conversationManager saveMessage:tip forSession:self.session completion:nil];
        [[NIMSDK sharedSDK].conversationManager saveMessage:tip forSession:self.session completion:nil];
        ...
        if (message.messageType == NIMMessageTypeText && _intervalTime<=0)
        {
            ...
            [self view:message pop:StringFromFrequentlyData(kStr_frameText)];
        }
...
- (void)heather:(NSError *)error
{
    ...
    [self.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_normalTitle)] duration:2 position:CSToastPositionCenter];
}
...
- (void)scaleBy
{
    ...
    [self.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_messageDateData)] duration:0.2f position:CSToastPositionCenter];
}
...
- (BOOL)totalled:(KitOperation *)event
{
    ...
    BOOL handled = [super totalled:event];
    //: NSString *eventName = event.eventName;
    NSString *eventName = event.eventName;

    //: if ([eventName isEqualToString:FFFKitEventNameTapContent])
    if ([eventName isEqualToString:kLet_valueContextName])
    {
        //: NIMMessage *message = event.messageModel.message;
        NIMMessage *message = event.messageModel.message;
        //: NSDictionary *actions = [self cellActions];
        NSDictionary *actions = [self smart];
    ...
    else if ([eventName isEqualToString:kLet_joinData])
    {
//        handled = YES;
//        StochasticProcessTeam *model = event.messageModel;
...
//            return handled;
//        }
//        AtViewController *vc = [[AtViewController alloc] initWithThreadMessage:message];
//        [self.navigationController pushViewController:vc animated:YES];
    }
    //: else if([eventName isEqualToString:FFFKitEventNameTapLabelLink])
    else if([eventName isEqualToString:kLet_channelValue])
    {
        //: NSString *link = event.data;
        NSString *link = event.data;
        //: [self openSafari:link];
        [self statusAcross:link];
        //: handled = YES;
        handled = YES;
    }
    ...
    if (!handled) {
        ...
        NSAssert(0, StringFromFrequentlyData(kStr_missileText));
    }
    //: return handled;
    return handled;
}
...
- (BOOL)fulled:(NIMMessage *)message{
    ...
    NSString *userId = [self text:message];
    //: NTESPersonalCardViewController *vc = [[NTESPersonalCardViewController alloc] initWithUserId:userId];
    ColorViewController *vc = [[ColorViewController alloc] initWithCell:userId];
...
- (BOOL)quicking:(NIMMessage *)message
{
        ...
        && ![userId isEqualToString:[NIMSDK sharedSDK].loginManager.currentAccount])
    {
        ...
        NSString *nick = [[Afterwards blue].provider put:userId button:option].showName;
        ...
        [self.sessionInputView.atCache digitizer:item];

        //: [self.sessionInputView.toolBar insertText:text];
        [self.sessionInputView.toolBar rubric:text];
    }
    //: return YES;
    return YES;
}
...
- (void)selected:(NIMMessage *)message
{
    ...
    AtViewController *vc = [[AtViewController alloc] initWithPlumbLine:message];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)showImage:(NIMMessage *)message
{
    ...
    LatchkeyName *item = [[LatchkeyName alloc] init];
    ...
    NIMSession *session = [self isMemberOfClass:[RadiogramViewController class]]? self.session : nil;


    //: ZMONGalleryImgViewController *vc = [[ZMONGalleryImgViewController alloc] init];
    DisableViewController *vc = [[DisableViewController alloc] init];
...
- (void)showVideo:(NIMMessage *)message
{
    ...
    RangeTeamViewController *playerViewController = [[RangeTeamViewController alloc] initWithCenter:item];
   ...
   //普通的自定义消息点击事件可以在这里做哦~
    ...
    if (dataaaaa) {
        ...
        if ([dict isKindOfClass:[NSDictionary class]])
        {
            ...
            NSInteger type = [[dict objectForKey:StringFromFrequentlyData(kStr_userNameData)] intValue];
            //: NSDictionary *datatyl = [dict objectForKey:@"data"];
            NSDictionary *datatyl = [dict objectForKey:StringFromFrequentlyData(kStr_lengthValue)];
            //: if (type == 105) {
            if (type == 105) {
                //: NSString *type = [datatyl stringValueForKey:@"type" defaultValue:@"0"];
                NSString *type = [datatyl team:StringFromFrequentlyData(kStr_userNameData) doing:@"0"];
                //: NSString *personCardId = [datatyl objectForKey:@"personCardId"];
                NSString *personCardId = [datatyl objectForKey:StringFromFrequentlyData(kStr_novelName)];
                //: if ([type boolValue]) {
                if ([type boolValue]) {
...
//                        UserOption *option = [[UserOption alloc] init];
//                        option.isTop = [NIMSDK.sharedSDK.chatExtendManager stickTopInfoForSession:self.session] != nil;
//                        BasketballTeamLightRandomViewController *vc = [[PointViewController alloc] initWithTeam:team session:session option:option];
//                        vc.delegate = self;
//                        [self.navigationController pushViewController:vc animated:YES];
                ...
                //: } else {
                    ...
                    if (![personCardId isEqualToString:[NIMSDK sharedSDK].loginManager.currentAccount]) {
                        ...
                        ColorViewController *vc = [[ColorViewController alloc] initWithCell:personCardId];
                        //: [self.navigationController pushViewController:vc animated:YES];
                        [self.navigationController pushViewController:vc animated:YES];
                    }
...
- (void)onWithoutTeam:(NIMTeam *)team {
    //: __weak typeof(self) wself = self;
    __weak typeof(self) wself = self;
    ...
    //: } else {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"" message:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_casualtyEndErnName)] delegate:nil cancelButtonTitle:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_barStackReloadValue)] otherButtonTitles:nil, nil];
        //: alert.alertViewStyle = UIAlertViewStylePlainTextInput;
        alert.alertViewStyle = UIAlertViewStylePlainTextInput;
        //: [alert showAlertWithCompletionHandler:^(NSInteger index) {
        [alert version:^(NSInteger index) {
            //: NSString *message = [alert textFieldAtIndex:0].text ? : @"";
            NSString *message = [alert textFieldAtIndex:0].text ? : @"";
            //: [wself didApplyToTeamWithMessage:message WithTeam:team];
            [wself image:message doFace:team];
        //: }];
        }];
    }
...
- (void)teamImage:(NSError *)error reuse:(NIMTeamApplyStatus)status queryArray:(NSString *)cardId{
    //: if (!error) {
    if (!error) {
        //: switch (status) {
        switch (status) {
            ...
            case NIMTeamApplyStatusWaitForPass:
                ...
                [self.view makeToast:StringFromFrequentlyData(kStr_sizeDateTitle).textKey duration:2.0 position:CSToastPositionCenter];
            //: default:
            default:
                //: break;
                break;
    ...
    //: }else{
        ...
        switch (error.code) {
            ...
            default:
                ...
                [self.view makeToast:StringFromFrequentlyData(kStr_hungerText).textKey duration:2.0 position:CSToastPositionCenter];
                //: break;
                break;
        }
    }
...
- (void)image:(NSString *)message doFace:(NIMTeam *)team {
    ...
    [GraduateTemp container].config
        ...
        .LeeAddTitle(^(UILabel *label) {
            ...
            NSString *msg = [NSString stringWithFormat:@"%@: %@",[ItemManager sessionInformation:StringFromFrequentlyData(kStr_soleData)],team.teamName];
            //: label.text = msg;
            label.text = msg;
            //: label.textColor = [UIColor grayColor];
            label.textColor = [UIColor grayColor];
        ...
        .LeeAddAction(^(TempAction *action) {
            ...
            action.title = [ItemManager sessionInformation:StringFromFrequentlyData(kStr_windowTodayData)];//@"取消"
        ...
        .LeeAddAction(^(TempAction *action) {
            ...
            action.type = LEEActionTypeDefault;
            //: action.title = [FFFLanguageManager getTextWithKey:@"contact_tag_fragment_sure"]; 
            action.title = [ItemManager sessionInformation:StringFromFrequentlyData(kStr_barStackReloadValue)]; //@"确定";
            ...
            action.clickBlock = ^{
                ...
                [[NIMSDK sharedSDK].teamManager applyToTeam:team.teamId
                    ...
                    [wself teamImage:error reuse:applyStatus queryArray:team.teamId];
                //: }];
                }];
            //: };
            };
...
- (void)statusAcross:(NSString *)link
{
    ...
    if (components)
    {
        ...
        if (!components.scheme)
        {
            ...
            components.scheme = StringFromFrequentlyData(kStr_burningValue);
        }
...
- (void)getInReply:(id)sender
{
    //: NTESPersonalCardViewController *vc = [[NTESPersonalCardViewController alloc] initWithUserId:self.session.sessionId];
    ColorViewController *vc = [[ColorViewController alloc] initWithCell:self.session.sessionId];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
...
- (void)model:(NSString *)title thanBlock:(void(^)(void))confirmBlock {
    ...
    UIAlertAction *sure = [UIAlertAction actionWithTitle:@"确定".aboveMagnitude style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        //: if (confirmBlock) {
        if (confirmBlock) {
            //: confirmBlock();
            confirmBlock();
    ...
    UIAlertAction *cancel = [UIAlertAction actionWithTitle:@"取消".aboveMagnitude
...
//    BasketballTeamLightRandomViewController *vc = nil;
//    UserOption *option = [[UserOption alloc] init];
//    option.isTop = [NIMSDK.sharedSDK.chatExtendManager stickTopInfoForSession:self.session] != nil;
//
//    if (self.session.sessionType == NIMSessionTypeTeam) {
...
//            vc = [[PointViewController alloc] initWithTeam:team
...
- (NSArray *)send:(NIMMessage *)message
{
    ...
    NSArray *defaultItems = [super send:message];
    //: if (defaultItems) {
    if (defaultItems) {
...
- (void)down:(NIMSession *)session {
    ...
    UndercoverOperationActivity *task = [_mergeForwardSession title:_selectedMessages name:nil taskForwardResult:^(NSError * _Nonnull error, NIMMessage * _Nonnull message) {
        //: if (error) {
        if (error) {
            //: NSString *msg = [NSString stringWithFormat:@"%@：%zd",@"消息合并转发失败".ntes_localized, error.code];
            NSString *msg = [NSString stringWithFormat:@"%@：%zd",StringFromFrequentlyData(kStr_heroName).aboveMagnitude, error.code];
            //: [weakSelf.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
            [weakSelf.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
        //: } else {
        } else {
            //: [weakSelf forwardMessage:message toSession:session];
            [weakSelf onSearch:message max:session];
        }
    //: }];
    }];
    //: [task resume];
...
- (void)beak:(NIMKitSessionState)state {
    //: switch (state) {
    switch (state) {
        ...
        case NIMKitSessionStateSelect:
        {
            ...
            [self setDateVoice:NIMKitSessionStateSelect];
        ...
        default:
        {
            ...
            [self setDateVoice:NIMKitSessionStateNormal];
//            [self setupNormalNav];
...
- (void)cleanOmit:(id)sender
{
    ...
    [self model:StringFromFrequentlyData(kStr_statusDishBlueValue).aboveMagnitude thanBlock:^{
        ...
        [NIMSDK.sharedSDK.conversationManager deleteRemoteMessages:_selectedMessages
            ...
            [self.view makeToast:error.localizedDescription ?: StringFromFrequentlyData(kStr_blueToxicData).aboveMagnitude];
            //: if (!error) {
            if (!error) {
                //: [self.interactor resetMessages:^(NSError *error) {
                [self.interactor successBottomMessages:^(NSError *error) {
                    //: [self switchUIWithSessionState:NIMKitSessionStateNormal];
                    [self beak:NIMKitSessionStateNormal];
                //: }];
                }];
...
//    }];
    ...
    vc.finshBlock = ^(NSArray *array, NSString *name, UIImage *avater){
        ...
        [self onSearch:message max:session];
    //: };
    };
    //: [vc show];
    [vc parent];
...
- (void)promotion:(void (^)(NIMSession *targetSession))completion {
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_controlValue)] delegate:nil cancelButtonTitle:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_windowTodayData)] destructiveButtonTitle:nil otherButtonTitles:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_withLengthData)], [ItemManager sessionInformation:StringFromFrequentlyData(kStr_recentData)], [ItemManager sessionInformation:StringFromFrequentlyData(kStr_tingFlueValue)], nil];
    //: [sheet showInView:self.view completionHandler:^(NSInteger index) {
    [sheet with:self.view stochastic:^(NSInteger index) {
        //: switch (index) {
        switch (index) {
            //: case 0:{
            case 0:{
...
- (void)revoked:(id)sender
{
    ...
    [[NIMSDK sharedSDK].chatManager revokeMessage:message
                                      //: apnsContent:@"撤回一条消息"
                                      apnsContent:StringFromFrequentlyData(kStr_heroData)
                                      //: apnsPayload:payload
                                      apnsPayload:payload
                                  //: shouldBeCounted:![[NTESBundleSetting sharedConfig] isIgnoreRevokeMessageCount]
                                  shouldBeCounted:![[SayImage linkIn] input]
                                         //: completion:^(NSError * _Nullable error)
                                         completion:^(NSError * _Nullable error)
    {
        //: if (error) {
        if (error) {
            ...
            if (error.code == NIMRemoteErrorCodeDomainExpireOld) {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:StringFromFrequentlyData(kStr_blueTornValue).aboveMagnitude delegate:nil cancelButtonTitle:@"确定".aboveMagnitude otherButtonTitles:nil, nil];
                //: [alert show];
                [alert show];
            //: } else {
            } else {
                //: [weakSelf.view makeToast:@"消息撤回失败，请重试".ntes_localized duration:2.0 position:CSToastPositionCenter];
                [weakSelf.view makeToast:StringFromFrequentlyData(kStr_showFranchiseData).aboveMagnitude duration:2.0 position:CSToastPositionCenter];
            }
        //: } else {
        } else {
            //: FFFMessageModel *model = [weakSelf uiDeleteMessage:message];
            StochasticProcessTeam *model = [weakSelf viewMore:message];
            //: NIMMessage *tip = [NTESSessionMsgConverter msgWithTip:[NTESSessionUtil tipOnMessageRevoked:nil]];
            NIMMessage *tip = [ActionConverter checkTip:[ArrayUtil cover:nil]];
            //: tip.timestamp = model.messageTime;
            tip.timestamp = model.messageTime;
 ...
 - (void)onSearch:(NIMMessage *)message max:(NIMSession *)session
{
    //: NSString *name;
    NSString *name;
    ...
    NSString *tip = [NSString stringWithFormat:@"%@ %@ ?", [ItemManager sessionInformation:StringFromFrequentlyData(kStr_keyFindValue)], name];
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:StringFromFrequentlyData(kStr_franchiseTitle).aboveMagnitude message:tip delegate:nil cancelButtonTitle:@"取消".aboveMagnitude otherButtonTitles:@"确认".aboveMagnitude, nil];
    ...
    [alert version:^(NSInteger index) {
        ...
        if(index == 1)
        {
            ...
            if (error) {
                ...
                NSString *msg = [NSString stringWithFormat:StringFromFrequentlyData(kStr_soleTornTitle), StringFromFrequentlyData(kStr_equalName).aboveMagnitude, error.code];
                //: [weakSelf.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
                [weakSelf.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
            //: } else {
            } else {
                //: [weakSelf.view makeToast:@"已发送".ntes_localized duration:2.0 position:CSToastPositionCenter];
                [weakSelf.view makeToast:StringFromFrequentlyData(kStr_languageButtonTitle).aboveMagnitude duration:2.0 position:CSToastPositionCenter];
            }
        }
    //: }];
    }];
...
- (BOOL)info
{
    ...
    if (![[Reachability reachabilityForInternetConnection] isReachable])
    {
        ...
        [self.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_casualtyData)] duration:2.0 position:CSToastPositionCenter];
        //: result = NO;
        result = NO;
    }
    ...
    if (self.session.sessionType == NIMSessionTypeP2P && [currentAccount isEqualToString:self.session.sessionId])
    {
        ...
        [self.view makeToast:StringFromFrequentlyData(kStr_viewRecentForData).aboveMagnitude duration:2.0 position:CSToastPositionCenter];
        //: result = NO;
        result = NO;
    }
    //: if (self.session.sessionType == NIMSessionTypeTeam)
    if (self.session.sessionType == NIMSessionTypeTeam)
    {
        ...
        if (memberNumber < 2)
        {
            ...
            [self.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_delicateName)] duration:2.0 position:CSToastPositionCenter];
            //: result = NO;
            result = NO;
        }
    }
...
- (NSDictionary *)smart
{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        actions = @{@(NIMMessageTypeImage) : StringFromFrequentlyData(kStr_drivewayNimReloadName),
                    //: @(NIMMessageTypeVideo) : @"showVideo:",
                    @(NIMMessageTypeVideo) : StringFromFrequentlyData(kStr_fleshTitle),
                    //: @(NIMMessageTypeLocation) : @"showLocation:",
                    @(NIMMessageTypeLocation) : StringFromFrequentlyData(kStr_noteData),
                    //: @(NIMMessageTypeFile) : @"showFile:",
                    @(NIMMessageTypeFile) : StringFromFrequentlyData(kStr_tingFrameName),
                    //: @(NIMMessageTypeCustom): @"showCustom:"};
                    @(NIMMessageTypeCustom): StringFromFrequentlyData(kStr_cellTingContent)};
    //: });
    });
    //: return actions;
    return actions;
...
- (UIButton *)mulSelectCancelBtn {
    ...
    if (!_mulSelectCancelBtn) {
        ...
        [cancelBtn addTarget:self action:@selector(showwed:) forControlEvents:UIControlEventTouchUpInside];
        //: [cancelBtn setTitle:@"取消".ntes_localized forState:UIControlStateNormal];
        [cancelBtn setTitle:@"取消".aboveMagnitude forState:UIControlStateNormal];
...
- (BOOL)picometre:(NIMMessage *)message
{
    ...
    if (message.session.sessionType == NIMSessionTypeChatroom ||
        ...
        [self lifestyleObject:messageObject])
    {
        //: return NO;
        return NO;
    }
...
- (BOOL)lifestyleObject:(id<NIMMessageObject>) object
{
    ...
    if ([object isKindOfClass:[NIMCustomObject class]])
    {
        ...
        if ([attachment isKindOfClass:[ButtonSupport class]])
        {
            //: return YES;
            return YES;
        }
...
- (UILabel *)invalid_tip {
    ...
    if (!_invalid_tip) {
        ...
        _invalid_tip = [[UILabel alloc] initWithFrame:CGRectMake(0, (44.0f + [UIDevice clear]), [[UIScreen mainScreen] bounds].size.width, 50)];
        //: _invalid_tip.backgroundColor = [UIColor colorWithHexString:@"#FEFECA"];
        _invalid_tip.backgroundColor = [UIColor withMax:StringFromFrequentlyData(kStr_requestName)];
        //: _invalid_tip.textColor = [UIColor colorWithHexString:@"#F6B53E"];
        _invalid_tip.textColor = [UIColor withMax:StringFromFrequentlyData(kStr_flueData)];
        //: _invalid_tip.text = [FFFLanguageManager getTextWithKey:@"app_team_invalid_tip"]; 
        _invalid_tip.text = [ItemManager sessionInformation:StringFromFrequentlyData(kStr_whenSubmitTitle)]; //
...
- (void)barAccount:(NSString *)reason
{
    ...
    if(isMyFriend){
        ...
        [self.reprotNextView recordingShow];
    //: }else{
    }else{
        //: [self.view addSubview:self.reprotHisNextView];
        [self.view addSubview:self.reprotHisNextView];
        //: [self.reprotHisNextView animationShow];
        [self.reprotHisNextView with];
    }

        //: NSMutableDictionary *dict = @{}.mutableCopy;
        NSMutableDictionary *dict = @{}.mutableCopy;
        //: dict[@"contact"] = reason;
        dict[StringFromFrequentlyData(kStr_representSelectData)] = reason;
        //: [ZCHttpManager postWithUrl:[NSString stringWithFormat:@"/other/feedback"] params:dict isShow:NO success:^(id responseObject) {
        [PhotoManager militaryInstallationMenuMedia:[NSString stringWithFormat:StringFromFrequentlyData(kStr_referText)] event:dict current:NO titleFailed:^(id responseObject) {
...
- (TitleView *)reprotNextView
{
    ...
    if(!_reprotNextView){
        ...
        _reprotNextView = [[TitleView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
//    self.reprotBlackView.userID = self.userId;
    ...
    [self.reprotBlackView examineed];
    @
     //: autoreleasepool{} __weak __typeof__(self) __weak_self__ = self;
     autoreleasepool{} __weak __typeof__(self) __weak_self__ = self;
    ...
    self.reprotBlackView.speiceBackBlock = ^(NSString *Name){
        ...
        [[NIMSDK sharedSDK].userManager addToBlackList:self.userId completion:^(NSError *error) {
                   ...
                   if (!error) {
                       ...
                       [self.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_suspectTitle)] duration:2.0f position:CSToastPositionCenter];
                   //: }else{
                   }else{
                       ...
                       [self.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_voiceRequestValue)] duration:2.0f position:CSToastPositionCenter];
...
//    self.reprotDeleteView.userID = self.userId
    ...
    [self.reprotDeleteView streetSmart];
    @
     //: autoreleasepool{} __weak __typeof__(self) __weak_self__ = self;
     autoreleasepool{} __weak __typeof__(self) __weak_self__ = self;
    ...
    self.reprotDeleteView.speiceBackBlock = ^(NSString *Name){
        ...
        [[NIMSDK sharedSDK].userManager deleteFriend:self.userId
                                         ...
                                         removeAlias:[[SayImage linkIn] bustEnableAlias]
                                          //: completion:^(NSError *error) {
                                          completion:^(NSError *error) {
            ...
            if (!error) {
                ...
                [self.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_heToxicValue)] duration:2.0f position:CSToastPositionCenter];
            //: }else{
            }else{
                //: [self.view makeToast:[FFFLanguageManager getTextWithKey:@"friend_delete_fail"] duration:2.0f position:CSToastPositionCenter];
                [self.view makeToast:[ItemManager sessionInformation:StringFromFrequentlyData(kStr_entitleData)] duration:2.0f position:CSToastPositionCenter];
            }
        //: }];
        }];
...
- (TextView *)reprotBlackView
{
    ...
    if(!_reprotBlackView){
        ...
        _reprotBlackView = [[TextView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
    }
...
- (ChangeShapeView *)reprotDeleteView
{
    ...
    if(!_reprotDeleteView){
        ...
        _reprotDeleteView = [[ChangeShapeView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
    }
...
- (RecentView *)reprotHisNextView
{
    ...
    if(!_reprotHisNextView){
        ...
        _reprotHisNextView = [[RecentView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
Byte * FrequentlyDataToCache(Byte *data) {
    int upToDate = data[0];
    int detoxicate = data[1];
    Byte hero = data[2];
    int imagineKey = data[3];
    if (!upToDate) return data + imagineKey;
    for (int i = imagineKey; i < imagineKey + detoxicate; i++) {
    ...
    data[0] = 0;
    data[imagineKey + detoxicate] = 0;
    return data + imagineKey;
}

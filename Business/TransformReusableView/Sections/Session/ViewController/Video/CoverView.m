...
- (void)user{
    ...
    self.thumb.center = [self empty:_value];
...
- (void)setBufferProgress:(CGFloat)bufferProgress{
    ...
    bufferProgress = [self elect:bufferProgress];
...
- (void)column:(UIImage *)thumbImage press:(UIControlState)state{

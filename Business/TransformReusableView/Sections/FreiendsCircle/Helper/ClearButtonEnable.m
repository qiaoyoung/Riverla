...
// __M_A_C_R_O__
//: #import "FUUtility.h"
#import "ClearButtonEnable.h"
//: #import <Photos/Photos.h>
#import <Photos/Photos.h>

//: @implementation FUUtility
@implementation ClearButtonEnable

//: + (void)requestPhotoLibraryAuthorization:(void (^)(PHAuthorizationStatus))handler {
+ (void)status:(void (^)(PHAuthorizationStatus))handler {
    //: if (@available(iOS 14, *)) {
    if (@available(iOS 14, *)) {
...
+ (void)length:(NSDictionary<NSString *,id> *)info heather:(void (^)(NSURL * _Nonnull))handler {

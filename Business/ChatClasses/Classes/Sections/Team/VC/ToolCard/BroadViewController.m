...
NSString *StringFromAssociablenessData(Byte *data);


//: Clean_success
Byte kStr_primAlsoName[] = {89, 13, 76, 9, 238, 18, 153, 26, 221, 143, 184, 177, 173, 186, 171, 191, 193, 175, 175, 177, 191, 191, 31};


//: creator
Byte kStr_ambassadorValue[] = {48, 7, 73, 5, 63, 172, 187, 174, 170, 189, 184, 187, 12};


//: #B391FF
Byte kStr_messageAmbassadorName[] = {55, 7, 70, 9, 38, 211, 173, 202, 242, 105, 136, 121, 127, 119, 140, 140, 41};


//: time
Byte kStr_cellIndexText[] = {27, 4, 94, 8, 112, 242, 176, 178, 210, 199, 203, 195, 192};


//: clear_notice
Byte kStr_requestIndexTitle[] = {83, 12, 53, 5, 154, 152, 161, 154, 150, 167, 148, 163, 164, 169, 158, 152, 154, 250};


//: back_arrow_bl
Byte kStr_atTitleValue[] = {19, 13, 25, 6, 198, 126, 123, 122, 124, 132, 120, 122, 139, 139, 136, 144, 120, 123, 133, 149};


//: activity_group_info_group_toast
Byte kStr_colorDestructTitle[] = {78, 31, 36, 13, 17, 42, 191, 247, 146, 77, 43, 115, 43, 133, 135, 152, 141, 154, 141, 152, 157, 131, 139, 150, 147, 153, 148, 131, 141, 146, 138, 147, 131, 139, 150, 147, 153, 148, 131, 152, 147, 133, 151, 152, 175};


//: delete
Byte kStr_keyRationTitle[] = {77, 6, 15, 12, 240, 237, 198, 52, 50, 26, 150, 149, 115, 116, 123, 116, 131, 116, 116};


//: icon_add_w
Byte kStr_recessionPromTitle[] = {59, 10, 51, 7, 27, 144, 100, 156, 150, 162, 161, 146, 148, 151, 151, 146, 170, 50};


//: user_profile_avtivity_edit
Byte kStr_universeName[] = {21, 26, 45, 7, 95, 246, 161, 162, 160, 146, 159, 140, 157, 159, 156, 147, 150, 153, 146, 140, 142, 163, 161, 150, 163, 150, 161, 166, 140, 146, 145, 150, 161, 43};


//: Create_group_announcement
Byte kStr_essentialName[] = {54, 25, 37, 11, 126, 213, 17, 189, 89, 85, 149, 104, 151, 138, 134, 153, 138, 132, 140, 151, 148, 154, 149, 132, 134, 147, 147, 148, 154, 147, 136, 138, 146, 138, 147, 153, 228};


//: title
Byte kStr_aircraftValue[] = {37, 5, 59, 11, 153, 232, 226, 219, 11, 228, 46, 175, 164, 175, 167, 160, 186};


//: ic_none_announcement
Byte kStr_userNoteName[] = {86, 20, 43, 4, 148, 142, 138, 153, 154, 153, 144, 138, 140, 153, 153, 154, 160, 153, 142, 144, 152, 144, 153, 159, 130};


//: team_create_helper_create_success
Byte kStr_retreatValue[] = {29, 33, 3, 4, 119, 104, 100, 112, 98, 102, 117, 104, 100, 119, 104, 98, 107, 104, 111, 115, 104, 117, 98, 102, 117, 104, 100, 119, 104, 98, 118, 120, 102, 102, 104, 118, 118, 75};


//: content
Byte kStr_comingData[] = {68, 7, 10, 14, 211, 184, 16, 6, 23, 73, 158, 205, 37, 126, 109, 121, 120, 126, 111, 120, 126, 227};


//: #FF483D
Byte kStr_oxygenTitle[] = {32, 7, 58, 8, 220, 88, 245, 181, 93, 128, 128, 110, 114, 109, 126, 24};


//: team_create_helper_create_failed
Byte kStr_balanceValue[] = {93, 32, 84, 13, 177, 196, 67, 13, 169, 87, 150, 229, 88, 200, 185, 181, 193, 179, 183, 198, 185, 181, 200, 185, 179, 188, 185, 192, 196, 185, 198, 179, 183, 198, 185, 181, 200, 185, 179, 186, 181, 189, 192, 185, 184, 79};


//: #F6F7FA
Byte kStr_retreatData[] = {39, 7, 97, 8, 53, 189, 146, 210, 132, 167, 151, 167, 152, 167, 162, 66};


//: #999999
Byte kStr_sharedToValue[] = {61, 7, 11, 9, 78, 145, 193, 167, 27, 46, 68, 68, 68, 68, 68, 68, 209};


//: No_group_announcement
Byte kStr_alsoToneTitle[] = {74, 21, 5, 10, 196, 112, 202, 144, 142, 200, 83, 116, 100, 108, 119, 116, 122, 117, 100, 102, 115, 115, 116, 122, 115, 104, 106, 114, 106, 115, 121, 16};


//: sure_to_clear
Byte kStr_steadReferName[] = {22, 13, 27, 11, 151, 235, 47, 226, 186, 110, 49, 142, 144, 141, 128, 122, 143, 138, 122, 126, 135, 128, 124, 141, 169};


//: add_noticess
Byte kStr_colorControlOutsideData[] = {50, 12, 4, 4, 101, 104, 104, 99, 114, 115, 120, 109, 103, 105, 119, 119, 175};
...
@interface BroadViewController () <UITableViewDelegate,
...
@property (nonatomic,strong) MessageOption *option;
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor withMax:StringFromAssociablenessData(kStr_retreatData)];
    ...
    [backButton setImage:[UIImage imageNamed:StringFromAssociablenessData(kStr_atTitleValue)] forState:(UIControlStateNormal)];
    ...
    labtitle.text = [ItemManager sessionInformation:StringFromAssociablenessData(kStr_colorDestructTitle)];//群公告
...
- (void)setOption:(MessageOption *)option {
    //: _option = option;
    _option = option;
    //: [self updateAnnouncementsWithContent:option.announcement];
    [self team:option.announcement];
}
...
- (void)ons:(id)sender {
    ...
    ConformToViewController *vc = [[ConformToViewController alloc] initWithNibName:nil bundle:nil];
    //: vc.delegate = self;
    vc.delegate = self;
...
- (void)immobilising:(id)sender {
    ...
    vc.defaultTitle = [announcement objectForKey:StringFromAssociablenessData(kStr_aircraftValue)] ?: @"";
    //: vc.defaultContent = [announcement objectForKey:@"content"] ?: @"";
    vc.defaultContent = [announcement objectForKey:StringFromAssociablenessData(kStr_comingData)] ?: @"";
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)controlled:(id)sender {
    ...
    [self.groupAlartView info:[ItemManager sessionInformation:StringFromAssociablenessData(kStr_steadReferName)]];
...
//    self.option.team.announcement = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
    ...
    [[NIMSDK sharedSDK].teamManager updateTeamAnnouncement:@"" teamId:wself.option.team.teamId completion:^(NSError *error) {
        ...
        if(!error && wself) {
            ...
            [wself.view makeToast:[ItemManager sessionInformation:StringFromAssociablenessData(kStr_primAlsoName)]];// @"清理成功"
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *content = [announcement objectForKey:StringFromAssociablenessData(kStr_comingData)];

    //: return [FFFTeamAnnouncementListCell cellHeight:content];
    return [ShowTableView image:content];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ShowTableView *cell = [tableView dequeueReusableCellWithIdentifier:@"ShowTableView"];
    //: if (!cell) {
    if (!cell) {
        ...
        cell = [[ShowTableView alloc] initWithStyle:(UITableViewCellStyleValue1) reuseIdentifier:@"ShowTableView"];
    }
    //: [cell refreshData:announcement nick:_option.nick];
    [cell min:announcement restoreOrNick:_option.nick];
//
//    ShowTableView *cell = [tableView dequeueReusableCellWithIdentifier:@"ShowTableView"];
//    [cell refreshData:announcement nick:_option.nick];
    //: return cell;
...
- (void)titleContent:(NSString *)title collection:(NSString *)content {
    ...
    NSDictionary *announcement = @{StringFromAssociablenessData(kStr_aircraftValue): title ?: @"",
                                   //: @"content": content ?: @"",
                                   StringFromAssociablenessData(kStr_comingData): content ?: @"",
                                   //: @"creator": [[NIMSDK sharedSDK].loginManager currentAccount],
                                   StringFromAssociablenessData(kStr_ambassadorValue): [[NIMSDK sharedSDK].loginManager currentAccount],
                                   //: @"time": @((NSInteger)[NSDate date].timeIntervalSince1970)};
                                   StringFromAssociablenessData(kStr_cellIndexText): @((NSInteger)[NSDate date].timeIntervalSince1970)};
    ...
    if ([_delegate respondsToSelector:@selector(lightColored:transform:)]) {
        //: __weak typeof(self) wself = self;
        __weak typeof(self) wself = self;
        //: [_delegate didUpdateAnnouncement:ret completion:^(NSError *error) {
        [_delegate lightColored:ret transform:^(NSError *error) {
            //: [FFFKitProgressHUD dismiss];
            [ExampleView coordinate];
            //: if(!error) {
            if(!error) {
                //: [wself.view makeToast:[FFFLanguageManager getTextWithKey:@"team_create_helper_create_success"]];
                [wself.view makeToast:[ItemManager sessionInformation:StringFromAssociablenessData(kStr_retreatValue)]];
            ...
            //: } else {
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromAssociablenessData(kStr_balanceValue)]];
            }
        //: }];
        }];
    }
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(15, (44.0f + [UIDevice clear])+15, [[UIScreen mainScreen] bounds].size.width-30, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice clear])-15-64-(({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom)) style:UITableViewStylePlain];
...
- (UIView *)defView{
    ...
    if(!_defView){
        ...
        _defView = [[UIView alloc]initWithFrame:CGRectMake(0, (44.0f + [UIDevice clear]), [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice clear]))];
        //: _defView.hidden = YES;
        _defView.hidden = YES;
        ...
        defImg.image = [UIImage imageNamed:StringFromAssociablenessData(kStr_userNoteName)];
        ...
        emptyTipLabel.textColor = [UIColor withMax:StringFromAssociablenessData(kStr_sharedToValue)];
        ...
        emptyTipLabel.text = [ItemManager sessionInformation:StringFromAssociablenessData(kStr_alsoToneTitle)];
        ...
        if(_option.canCreateAnnouncement) {
            ...
            emptyButton.frame = CGRectMake(15, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice clear])-44-(({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom), [[UIScreen mainScreen] bounds].size.width-30, 44);
            ...
            [emptyButton setTitle:[ItemManager sessionInformation:StringFromAssociablenessData(kStr_essentialName)] forState:UIControlStateNormal];
            //: [emptyButton setImage:[UIImage imageNamed:@"icon_add_w"] forState:UIControlStateNormal];
            [emptyButton setImage:[UIImage imageNamed:StringFromAssociablenessData(kStr_recessionPromTitle)] forState:UIControlStateNormal];
            //: [emptyButton addTarget:self action:@selector(onCreateAnnouncement:) forControlEvents:UIControlEventTouchUpInside];
            [emptyButton addTarget:self action:@selector(ons:) forControlEvents:UIControlEventTouchUpInside];
            //: [_defView addSubview:emptyButton];
            [_defView addSubview:emptyButton];
            //: emptyButton.backgroundColor = [UIColor colorWithHexString:@"#B391FF"];
            emptyButton.backgroundColor = [UIColor withMax:StringFromAssociablenessData(kStr_messageAmbassadorName)];
            ...
            [emptyButton value:(MKButtonEdgeInsetsStyleLeft) nameSelected:10];
        }
...
//        _box.layer.shadowRadius = 12;
        ...
        [closeBtn addTarget:self action:@selector(immobilising:) forControlEvents:UIControlEventTouchUpInside];
       //: [closeBtn setImage:[UIImage imageNamed:@"add_noticess"] forState:UIControlStateNormal];
       [closeBtn setImage:[UIImage imageNamed:StringFromAssociablenessData(kStr_colorControlOutsideData)] forState:UIControlStateNormal];
        //: closeBtn.backgroundColor = [UIColor colorWithHexString:@"#B391FF"];
        closeBtn.backgroundColor = [UIColor withMax:StringFromAssociablenessData(kStr_messageAmbassadorName)];
        ...
        [closeBtn setTitle:[ItemManager sessionInformation:StringFromAssociablenessData(kStr_universeName)] forState:UIControlStateNormal];
        //: [closeBtn layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleLeft) imageTitleSpace:10];
        [closeBtn value:(MKButtonEdgeInsetsStyleLeft) nameSelected:10];
        ...
        [sureBtn addTarget:self action:@selector(controlled:) forControlEvents:UIControlEventTouchUpInside];
        //: [sureBtn setImage:[UIImage imageNamed:@"clear_notice"] forState:UIControlStateNormal];
        [sureBtn setImage:[UIImage imageNamed:StringFromAssociablenessData(kStr_requestIndexTitle)] forState:UIControlStateNormal];
        //: sureBtn.backgroundColor = [UIColor colorWithHexString:@"#FF483D"];
        sureBtn.backgroundColor = [UIColor withMax:StringFromAssociablenessData(kStr_oxygenTitle)];
        ...
        [sureBtn setTitle:[ItemManager sessionInformation:StringFromAssociablenessData(kStr_keyRationTitle)] forState:UIControlStateNormal];
        //: [sureBtn layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleLeft) imageTitleSpace:10];
        [sureBtn value:(MKButtonEdgeInsetsStyleLeft) nameSelected:10];
...
Byte * AssociablenessDataToCache(Byte *data) {
    int receptionist = data[0];
    int follow = data[1];
    Byte deleteRequest = data[2];
    int barControl = data[3];
    if (!receptionist) return data + barControl;
    for (int i = barControl; i < barControl + follow; i++) {
        int value = data[i] - deleteRequest;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[barControl + follow] = 0;
    return data + barControl;
}

NSString *StringFromAssociablenessData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)AssociablenessDataToCache(data)];
}

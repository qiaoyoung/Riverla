...
@implementation FacialScrollView
...
- (instancetype)initWithFrame:(CGRect)frame textContainer:(NSTextContainer *)textContainer
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(lipogramNotification:) name:UITextViewTextDidChangeNotification object:self];
    }
    //: return self;
    return self;
}
...
- (void)lipogramNotification:(NSNotification *)notification
{
    //: [self updatePlaceholder];
    [self shortness];
}

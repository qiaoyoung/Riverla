...
@protocol UndersurfacePoint <NSObject>
...
@interface AtConfig : NSObject<UndersurfacePoint>
...
@interface RecentJoinerMessage : NSObject<UndersurfacePoint>
...
@interface EyeContactConfig : NSObject<UndersurfacePoint>

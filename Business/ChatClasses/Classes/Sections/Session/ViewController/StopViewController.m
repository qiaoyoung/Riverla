...
NSString *StringFromVertSizeData(Byte *data);


//: %@在群里@了你
Byte kStr_tingReferText[] = {92, 18, 59, 4, 96, 123, 32, 215, 227, 34, 249, 223, 36, 194, 199, 123, 31, 245, 193, 31, 248, 219, 41};


//: #00B01B
Byte kStr_atValueText[] = {38, 7, 12, 9, 211, 49, 90, 52, 31, 47, 60, 60, 78, 60, 61, 78, 29};


//: AUDIO
Byte kStr_screenName[] = {8, 5, 1, 9, 140, 146, 44, 97, 35, 66, 86, 69, 74, 80, 180};


//: temp_image_%@.jpg
Byte kStr_entitleText[] = {92, 17, 95, 10, 157, 5, 177, 228, 67, 194, 211, 196, 204, 207, 190, 200, 204, 192, 198, 196, 190, 132, 159, 141, 201, 207, 198, 191};


//: ic_block_no
Byte kStr_ayeEdictName[] = {58, 11, 31, 13, 69, 104, 237, 5, 127, 145, 87, 89, 129, 136, 130, 126, 129, 139, 142, 130, 138, 126, 141, 142, 146};


//: reply
Byte kStr_fileDrivewayName[] = {6, 5, 65, 9, 245, 182, 190, 246, 233, 179, 166, 177, 173, 186, 22};


//: IMAGE
Byte kStr_martGroupTitle[] = {13, 5, 37, 7, 16, 48, 80, 110, 114, 102, 108, 106, 93};


//: group_info_activity_op_failed
Byte kStr_theaterName[] = {35, 29, 38, 13, 27, 5, 105, 134, 144, 90, 73, 203, 41, 141, 152, 149, 155, 150, 133, 143, 148, 140, 149, 133, 135, 137, 154, 143, 156, 143, 154, 159, 133, 149, 150, 133, 140, 135, 143, 146, 139, 138, 115};


//: user_profile_avtivity_send
Byte kStr_comedyName[] = {2, 26, 11, 8, 149, 88, 53, 137, 128, 126, 112, 125, 106, 123, 125, 122, 113, 116, 119, 112, 106, 108, 129, 127, 116, 129, 116, 127, 132, 106, 126, 112, 121, 111, 226};


//: userName
Byte kStr_requestHourData[] = {34, 8, 99, 13, 116, 111, 73, 230, 32, 251, 76, 100, 101, 216, 214, 200, 213, 177, 196, 208, 200, 108};


//: message_send_album
Byte kStr_apologyOxygenValue[] = {63, 18, 12, 11, 39, 136, 50, 165, 144, 216, 173, 121, 113, 127, 127, 109, 115, 113, 107, 127, 113, 122, 112, 107, 109, 120, 110, 129, 121, 62};


//: content
Byte kStr_tributeInvolvementContent[] = {25, 7, 85, 9, 54, 194, 181, 46, 161, 184, 196, 195, 201, 186, 195, 201, 89};


//: icon_toolview_camera
Byte kStr_approveContent[] = {68, 20, 40, 11, 23, 125, 132, 89, 118, 14, 180, 145, 139, 151, 150, 135, 156, 151, 151, 148, 158, 145, 141, 159, 135, 139, 137, 149, 141, 154, 137, 51};


//: TEXT
Byte kStr_tingMumName[] = {8, 4, 69, 10, 28, 205, 210, 180, 3, 70, 153, 138, 157, 153, 216};


//: head_default_group
Byte kStr_dancingName[] = {95, 18, 15, 11, 122, 17, 179, 237, 253, 147, 110, 119, 116, 112, 115, 110, 115, 116, 117, 112, 132, 123, 131, 110, 118, 129, 126, 132, 127, 108};


//: #F6F7FA
Byte kStr_destructTitle[] = {43, 7, 33, 4, 68, 103, 87, 103, 88, 103, 98, 41};


//: messageid
Byte kStr_decreaseContent[] = {21, 9, 62, 6, 70, 245, 171, 163, 177, 177, 159, 165, 163, 167, 162, 217};


//: message_please_enter_content
Byte kStr_biasName[] = {88, 28, 56, 5, 186, 165, 157, 171, 171, 153, 159, 157, 151, 168, 164, 157, 153, 171, 157, 151, 157, 166, 172, 157, 170, 151, 155, 167, 166, 172, 157, 166, 172, 57};


//: icon_toolview_album
Byte kStr_colorFlueText[] = {20, 19, 52, 13, 142, 130, 238, 79, 72, 114, 53, 167, 162, 157, 151, 163, 162, 147, 168, 163, 163, 160, 170, 157, 153, 171, 147, 149, 160, 150, 169, 161, 227};


//: ic_block
Byte kStr_revelationColorTitle[] = {30, 8, 56, 10, 165, 58, 45, 222, 203, 169, 161, 155, 151, 154, 164, 167, 155, 163, 203};


//: temp_video_%@.mp4
Byte kStr_blindMootData[] = {73, 17, 6, 8, 205, 229, 143, 117, 122, 107, 115, 118, 101, 124, 111, 106, 107, 117, 101, 43, 70, 52, 115, 118, 58, 132};


//: icon_toolview_voice_normal
Byte kStr_dateKeyData[] = {62, 26, 97, 7, 109, 179, 120, 202, 196, 208, 207, 192, 213, 208, 208, 205, 215, 202, 198, 216, 192, 215, 208, 202, 196, 198, 192, 207, 208, 211, 206, 194, 205, 227};


//: VIDEO
Byte kStr_luteKeyData[] = {34, 5, 5, 14, 178, 190, 181, 118, 221, 105, 22, 218, 83, 16, 91, 78, 73, 74, 84, 47};


//: ic_more
Byte kStr_evolutionaryPinionData[] = {8, 7, 15, 8, 2, 24, 8, 63, 120, 114, 110, 124, 126, 129, 116, 75};


//: message_administrator_speak
Byte kStr_gasTitle[] = {22, 27, 54, 7, 33, 39, 77, 163, 155, 169, 169, 151, 157, 155, 149, 151, 154, 163, 159, 164, 159, 169, 170, 168, 151, 170, 165, 168, 149, 169, 166, 155, 151, 161, 57};


//: F6F7FA
Byte kStr_alsoHeroContent[] = {55, 6, 48, 11, 221, 31, 175, 85, 127, 106, 86, 118, 102, 118, 103, 118, 113, 98};


//: #B391FF
Byte kStr_publicityText[] = {7, 7, 6, 13, 165, 235, 244, 62, 252, 242, 105, 113, 84, 41, 72, 57, 63, 55, 76, 76, 222};


//: type
Byte kStr_suspectCorridorContent[] = {85, 4, 73, 7, 25, 183, 172, 189, 194, 185, 174, 5};


//: message_send_camera
Byte kStr_tingCellName[] = {62, 19, 69, 11, 218, 69, 68, 80, 201, 24, 56, 178, 170, 184, 184, 166, 172, 170, 164, 184, 170, 179, 169, 164, 168, 166, 178, 170, 183, 166, 81};


//: back_arrow_bl
Byte kStr_mythName[] = {8, 13, 39, 8, 136, 48, 241, 164, 137, 136, 138, 146, 134, 136, 153, 153, 150, 158, 134, 137, 147, 202};


//: 777777
Byte kStr_mustDishData[] = {45, 6, 61, 14, 98, 139, 57, 14, 174, 165, 221, 112, 26, 99, 116, 116, 116, 116, 116, 116, 73};
...
@interface StopViewController ()<NIMMediaManagerDelegate,InputTable,CookieDelegate,NIMConversationManagerDelegate,TitleMax,UIGestureRecognizerDelegate>
...
@property (nonatomic,strong) CommentMessage *configurator;
...
@property (nonatomic,strong) ToView *badgeView;
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor withMax:StringFromVertSizeData(kStr_alsoHeroContent)];
             ...
             if (team.inAllMuteMode) {
                 ...
                 if (team.allMuteMode == NIMTeamAllMuteModeMuteNormal || team.allMuteMode == NIMTeamAllMuteModeMuteAll) {
                     ...
                     if (member.isMuted) {
                         ...
                         [self setDisplayPlaceholder:YES];
                     }
                 }
             }
         }
...
- (void)messagesDeletedInSession:(NIMSession *)session{
    ...
    [self.interactor successBottomMessages:nil];
...
- (void)bubble
{
    ...
    _topview = [[UIView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, (44.0f + [UIDevice clear]))];
    //: _topview.backgroundColor = [UIColor colorWithHexString:@"#F6F7FA"];
    _topview.backgroundColor = [UIColor withMax:StringFromVertSizeData(kStr_destructTitle)];
    ...
    [backBtn setImage:[UIImage imageNamed:StringFromVertSizeData(kStr_mythName)] forState:UIControlStateNormal];
    ...
    _labtitle = [[UILabel alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-200)/2, [UIDevice clear], 200, 40)];
...
//    }
    ...
    if (self.session.sessionType == NIMSessionTypeTeam)
    {
        ...
        [enterTeamCard addTarget:self action:@selector(colorTeamCard:) forControlEvents:UIControlEventTouchUpInside];
        ...
        [enterTeamCard sd_setImageWithURL:[NSURL URLWithString:team.avatarUrl] forState:(UIControlState)UIControlStateNormal placeholderImage:[UIImage imageNamed:StringFromVertSizeData(kStr_dancingName)]];
        //: enterTeamCard.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width-15, [UIDevice vg_statusBarHeight]+10, width, width);
        enterTeamCard.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width-15, [UIDevice clear]+10, width, width);
    ...
    else if(self.session.sessionType == NIMSessionTypeP2P)
    {
        ...
        _btnBlock.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width*2-15*2, [UIDevice clear]+10, width, width);
        //: [_btnBlock addTarget:self action:@selector(handlerBtnBlock:) forControlEvents:UIControlEventTouchUpInside];
        [_btnBlock addTarget:self action:@selector(cutenessAction:) forControlEvents:UIControlEventTouchUpInside];
        //: [_btnBlock setImage:[UIImage imageNamed:@"ic_block"] forState:UIControlStateNormal];
        [_btnBlock setImage:[UIImage imageNamed:StringFromVertSizeData(kStr_revelationColorTitle)] forState:UIControlStateNormal];
        //: [_btnBlock setImage:[UIImage imageNamed:@"ic_block_no"] forState:UIControlStateSelected];
        [_btnBlock setImage:[UIImage imageNamed:StringFromVertSizeData(kStr_ayeEdictName)] forState:UIControlStateSelected];
        ...
        [infoBtn addTarget:self action:@selector(getInReply:) forControlEvents:UIControlEventTouchUpInside];
        //: [infoBtn setImage:[UIImage imageNamed:@"ic_more"] forState:UIControlStateNormal];
        [infoBtn setImage:[UIImage imageNamed:StringFromVertSizeData(kStr_evolutionaryPinionData)] forState:UIControlStateNormal];
        //: infoBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width-15, [UIDevice vg_statusBarHeight]+10, width, width);
        infoBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width-15, [UIDevice clear]+10, width, width);
...
- (void)cutenessAction:(UIButton *)sender
{
    ...
    [[NIMSDK sharedSDK].userManager updateNotifyState:sender.selected forUser:self.session.sessionId completion:^(NSError *error) {
            ...
            if (error) {
                ...
                [wself.view makeToast:[ItemManager sessionInformation:StringFromVertSizeData(kStr_theaterName)] duration:2.0f position:CSToastPositionCenter];
            }
        //: }];
        }];
}
...
- (void)colorTeamCard:(id)sender {
    ...
    if(team.type == NIMTeamTypeAdvanced){
            ...
            vc = [[PointViewController alloc] initWithSession:team
                                                                 //: session:self.session
                                                                 oldOption:self.session
                                                                  //: option:option];
                                                                  background:option];
            //: vc.delegate = self;
            vc.delegate = self;
...
- (void)table
{
    ...
    CGFloat safeAreaInsetsBottom = [UIDevice user];
    ...
    CGFloat containerSafeHeight = [UIScreen mainScreen].bounds.size.height - safeAreaInsetsBottom - (44.0f + [UIDevice clear]);
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, (44.0f + [UIDevice clear]), [UIScreen mainScreen].bounds.size.width, containerSafeHeight-51) style:UITableViewStylePlain];
...
//    self.tableView.backgroundColor = NEEKIT_UIColorFromRGB(0xe4e7ec);
    ...
    [self.tableViewTapGesture addTarget:self action:@selector(viewFormat:)];
...
- (void)detect
{
    ...
    if ([self atomicNumber85])
    {
        ...
        [self.sessionInputView setAt:self];
...
- (void)should
{
    ...
    _configurator = [[CommentMessage alloc] init];
    //: [_configurator setup:self];
    [_configurator info:self];

    //: BOOL needProximityMonitor = [self needProximityMonitor];
    BOOL needProximityMonitor = [self greenEnable];
...
- (void)viewDidDisappear:(BOOL)animated
{
    ...
    [self.interactor monthDisappear];
...
- (void)queryedScroll:(UIScrollView *)scrollView {
...
- (void)content:(NIMMessage *)message
{
    ...
    [self.interactor areaData:message selectDay:nil];
...
- (void)screen:(NIMMessage *)message team:(void(^)(NSError * err))completion
{
    ...
    [self.interactor cypher:message
                        //: toMessage:nil
                        label:nil
...
- (NSString *)disable
{
    ...
    switch (type) {
        ...
        case NIMSessionTypeP2P:{
            ...
            title = [PopUtil size:self.session.sessionId surplus:self.session];
        }
            //: break;
            break;
        //: case NIMSessionTypeSuperTeam: {
...
- (NIMKitSessionState)dateVoice {
    ...
    return [self.interactor markColor];
}
...
- (void)setDateVoice:(NIMKitSessionState)state {
    ...
    [self.interactor setMarkColor:state];
}
        ...
        if( message.messageType == NIMMessageTypeImage){
            ...
            if(data && urlString){
                ...
                [[SDImageCache sharedImageCache] storeImageData:data forKey:key completion:^{
                    ...
                    [weakSelf.interactor principal:message];
                //: }];
                }];
            }
        //: }else{
            ...
            [self.interactor principal:message];
//            [self.tableView reloadData];
        }
...
- (void)onRecvMessages:(NSArray *)messages
{
    ...
    if ([self quick])
    {
        ...
        UIViewController *topvc = [self crownControllerToTheHighestDegreeLease];
        //: if (![topvc isKindOfClass:NSClassFromString(@"NTESSessionViewController")] && ![topvc isKindOfClass:[FFFSessionViewController class]]) {
        if (![topvc isKindOfClass:NSClassFromString(@"RadiogramViewController")] && ![topvc isKindOfClass:[StopViewController class]]) {
            //: return;
            return;
        }
...
- (void)setDisplayPlaceholder:(BOOL)ban {
    //: if (ban){
    if (ban){
        ...
        [self.sessionInputView session:[ItemManager sessionInformation:StringFromVertSizeData(kStr_gasTitle)] count:[UIColor redColor]];
    ...
    //: } else {
        ...
        [self.sessionInputView session:[ItemManager sessionInformation:StringFromVertSizeData(kStr_biasName)] count:[UIColor grayColor]];
...
- (UIViewController *)crownControllerToTheHighestDegreeLease {
...
- (void)fetchMessageAttachment:(NIMMessage *)message didCompleteWithError:(NSError *)error
{
    ...
    if ([message.session isEqual:_session])
    {
        ...
        StochasticProcessTeam *model = [self.interactor isChild:message];
...
- (void)changeUponMultiplicity:(NIMRecentSession *)recentSession
         //: totalUnreadCount:(NSInteger)totalUnreadCount{
         voiceSegment:(NSInteger)totalUnreadCount{
...
- (void)recordAudio:(NSString *)filePath didCompletedWithError:(NSError *)error {
    ...
    if(!error) {
        ...
        if ([self picture:filePath]) {
            //: [self sendMessage:[FFFMessageMaker msgWithAudio:filePath]];
            [self content:[ThreadMaker insideInformation:filePath]];
        //: }else{
        }else{
...
- (void)recordAudioProgress:(NSTimeInterval)currentTime {
    ...
    [_sessionInputView imageExtra:currentTime];
}
...
//    [self praiseViewdidSelectIndex:index];
    ...
    __block NIMQuickComment *newComment = [CommentTingSailmakerMaker groundButton:index margin:@"" segment:@"扩展"];

    //: __weak typeof(self) weakSelf = self;
    __weak typeof(self) weakSelf = self;
            //: [weakSelf.interactor addQuickComment:newComment toMessage:message completion:^(NSError *error)
            [weakSelf.interactor view:newComment bottom:message icon:^(NSError *error)
            {
                //: if (error)
                if (error)
                {
                    ...
                    [weakSelf.view makeToast:[ItemManager sessionInformation:StringFromVertSizeData(kStr_theaterName)] duration:2 position:CSToastPositionCenter];
                }
...
- (void)trademark:(NSString *)text searched:(NSArray *)atUsers
{
    ...
    NIMMessage *message = [ThreadMaker cancel:text];
    //: if (atUsers.count)
    if (atUsers.count)
    {
        ...
        NSString *me = [[Afterwards blue].provider put:[NIMSDK sharedSDK].loginManager.currentAccount button:option].showName;
        //: apnsOption.apnsContent = [NSString stringWithFormat:@"%@在群里@了你".nim_localized, me];
        apnsOption.apnsContent = [NSString stringWithFormat:StringFromVertSizeData(kStr_tingReferText).textKey, me];
...
- (void)sleepingTablet:(NSString *)text title:(NSArray *)atUsers duringSend:(NIMMessage *)replymessage
{
    ...
    if(replymessage.messageType == NIMMessageTypeText){
        //: type = @"TEXT";
        type = StringFromVertSizeData(kStr_tingMumName);
        //: contents = replymessage.text;
        contents = replymessage.text;
    //: }else if (replymessage.messageType == NIMMessageTypeImage){
    }else if (replymessage.messageType == NIMMessageTypeImage){
        //: type = @"IMAGE";
        type = StringFromVertSizeData(kStr_martGroupTitle);
    ...
    //: }else if (replymessage.messageType == NIMMessageTypeVideo){
        ...
        //: type = @"VIDEO";
        type = StringFromVertSizeData(kStr_luteKeyData);
    ...
    //: }else if (replymessage.messageType == NIMMessageTypeAudio){
        ...
        //: type = @"AUDIO";
        type = StringFromVertSizeData(kStr_screenName);
    ...
    MarginThanInfo *info = [[Afterwards blue] put:replymessage.from button:option];

    //: NSDictionary *dic = @{
    NSDictionary *dic = @{
            //: @"type": type,//type:TEXT、IMAGE、VIDEO
            StringFromVertSizeData(kStr_suspectCorridorContent): type,//type:TEXT、IMAGE、VIDEO
            //: @"content": contents,//content:文本内容、图片url、视频url
            StringFromVertSizeData(kStr_tributeInvolvementContent): contents,//content:文本内容、图片url、视频url
            //: @"userName": info.showName,//消息发送者
            StringFromVertSizeData(kStr_requestHourData): info.showName,//消息发送者
            //: @"messageid": replymessage.messageId,//messageid：留着备用
            StringFromVertSizeData(kStr_decreaseContent): replymessage.messageId,//messageid：留着备用
    //: };
    };

    //: message.remoteExt = @{@"reply": dic };
    message.remoteExt = @{StringFromVertSizeData(kStr_fileDrivewayName): dic };
    ...
    [self screen:message team:^(NSError *err) {
        //: [self.tableView reloadData];
        [self.tableView reloadData];
    //: }];
    }];
...
- (void)with:(CommentToTemp *)emoticon
{
    ...
    __block NIMQuickComment *newComment = [CommentTingSailmakerMaker groundButton:number margin:emoticon.tag segment:@"扩展"];

    //: __weak typeof(self) weakSelf = self;
    __weak typeof(self) weakSelf = self;
    //: [self hadCommentThisMessage:self.messageForMenu type:number
    [self imageCompltion:self.messageForMenu objectColorCompltion:number
                      //: compltion:^(NSMapTable *result)
                      tingBy:^(NSMapTable *result)
     {
        //: NIMQuickComment *oldComment = [FFFKitQuickCommentUtil myCommentFromComments:0 keys:@[@(number)] comments:result];
        NIMQuickComment *oldComment = [ActionUtil tag:0 kit:@[@(number)] cut:result];
        ...
        if (!contains)
        {
            ...
            [weakSelf.interactor tempHide:newComment
                                  //: completion:^(NSError *error)
                                  lineContainer:^(NSError *error)
            {
//                [self.view hideToasts];
        ...
        else
        {
            ...
            [weakSelf.interactor packet:oldComment
                                   //: targetMessage:weakSelf.messageForMenu
                                   goopCompletion:weakSelf.messageForMenu
                                      //: completion:^(NSError *error)
                                      communication:^(NSError *error)
            {
//                [self.view hideToasts];
                //: if (error)
                if (error)
...
//
//    NIMMessage *message = [ThreadMaker msgWithImage:gif];
//    [self sendMessage:message];
//

    //: NIMMessage *message = [FFFMessageMaker msgWithImageData:imageData extension:@""];
    NIMMessage *message = [ThreadMaker human:imageData disable:@""];
...
//    NSData *imageData = UIImagePNGRepresentation(image);
    ...
    [self.sessionInputView.toolBar setMarshal:[ItemManager sessionInformation:StringFromVertSizeData(kStr_biasName)]];
...
//    [_sessionInputView endEditing:YES];
    ...
    NIMAudioType type = [self format];
    //: NSTimeInterval duration = [MyUserKit sharedKit].config.recordMaxDuration;
    NSTimeInterval duration = [Afterwards blue].config.recordMaxDuration;
...
- (void)onRecvQuickComment:(NIMQuickComment *)comment
{
    ...
    [self.interactor principal:comment.message];
}
...
- (BOOL)totalled:(KitOperation *)event{
    ...
    if ([eventName isEqualToString:kLet_trackName])
    {
        //: [self.interactor mediaAudioPressed:event.messageModel];
        [self.interactor audio:event.messageModel];
        //: handle = YES;
        handle = YES;
    }
    //: return handle;
                 ...
                 range:(UIView *)view
{
    ...
    if ([self picometre:message])
    {
        //: [FFFBubbleMenuView.shareMenuView removeFromSuperview];
        [PitchView.voice removeFromSuperview];
        //: [self showMenuWithMessage:message withView:view];
        [self label:message alongOf:view];
    }
    //: handle = YES;
    handle = YES;
    //: return handle;
               ...
               should:(BOOL)isSelected
{
    ...
    if (isSelected)
    {
        ...
        [self.interactor packet:comment
                           //: targetMessage:message
                           goopCompletion:message
                              //: completion:^(NSError *error)
                              communication:^(NSError *error)
         {
//            [self.view hideToasts];
...
- (void)unseeable:(id)sender
{
    ...
    [self.tillCustomSave deleteMessage:message];
}
...
- (void)announcementWith:(NSArray *)messages
{
    ...
    [self.interactor sessionOrientation:messages];
}
...
- (StochasticProcessTeam *)viewMore:(NIMMessage *)message{
    ...
    StochasticProcessTeam *model = [self.interactor value:message];
...
- (void)trapCell:(NIMMessage *)message
{
    ...
    [self.interactor cellHand:message];
}
...
- (void)yank:(NIMMessage *)message
{
    ...
    [self.interactor userView:message];
}

//: - (void)uiCheckReceipts:(NSArray<NIMMessageReceipt *> *)receipts
- (void)title:(NSArray<NIMMessageReceipt *> *)receipts
{
    //: [self.interactor checkReceipts:receipts];
    [self.interactor light:receipts];
}
...
//    [self.interactor mediaShootPressed];
    ...
    [self.customAlbumView.albumPickerView parentBar];
    ...
    [self.customAlbumView.confirmButton setTitle:[ItemManager sessionInformation:StringFromVertSizeData(kStr_comedyName)] forState:UIControlStateNormal];
    //: [self.customAlbumView animationShow];
    [self.customAlbumView searched];
...
- (void)locationGray
{
    ...
    [self.customAlbumView textLanguage];
    //: [self.interactor mediaShootPressed];
    [self.interactor financialCenter];
}
...
- (void)bared:(NSArray<PHAsset *> *)assets
{
    ...
    for (PHAsset *asset in assets) {
        ...
        if (asset.mediaType == PHAssetMediaTypeVideo) {
            ...
            [self umbra:asset page:^(NSString *path) {
                //: if (path) {
                if (path) {
                    //: NSLog(@"视频路径: %@", path);
                    // 使用路径...
        ...
        //: }else{
            ...
            [self impression:asset twentyFourHours:^(UIImage *image) {
                //: if (image) {
                if (image) {
...
//                    NSLog(@"图片路径: %@", path);
//                    // 使用路径...
//                    NIMMessage *message = [ThreadMaker msgWithImagePath:path];
//                    [self sendMessage:message];
//                } else {
//                    NSLog(@"获取图片路径失败");
//                }
...
- (void)impression:(PHAsset *)asset twentyFourHours:(void (^)(UIImage *image))completion {
...
- (void)joint:(PHAsset *)asset project:(void (^)(NSString *path))completion {
    ...
    [[PHImageManager defaultManager] requestImageDataForAsset:asset options:options resultHandler:^(NSData * _Nullable imageData, NSString * _Nullable dataUTI, UIImageOrientation orientation, NSDictionary * _Nullable info) {
        ...
        if (imageData) {
            ...
            NSString *filePath = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:StringFromVertSizeData(kStr_entitleText), [NSUUID UUID].UUIDString]];
...
- (void)umbra:(PHAsset *)asset page:(void (^)(NSString *path))completion {
    //: if (asset.mediaType != PHAssetMediaTypeVideo) {
    if (asset.mediaType != PHAssetMediaTypeVideo) {
        //: if (completion) completion(nil);
        if (completion) completion(nil);
    ...
    [[PHImageManager defaultManager] requestAVAssetForVideo:asset options:options resultHandler:^(AVAsset * _Nullable avAsset, AVAudioMix * _Nullable audioMix, NSDictionary * _Nullable info) {
        ...
        //: } else {
            ...
            [self presentMessage:avAsset color:completion];
        }
    //: }];
    }];
}
...
- (void)presentMessage:(AVAsset *)avAsset color:(void (^)(NSString *path))completion {
    ...
    if ([presets containsObject:AVAssetExportPresetHighestQuality]) {
        ...
        NSString *outputPath = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:StringFromVertSizeData(kStr_blindMootData), [NSUUID UUID].UUIDString]];
...
- (void)carte:(ImageRecent *)item
{
    //: [self.interactor mediaPicturePressed];
    [self.interactor dogTag];
}

//: - (void)onTapMediaItemShoot:(FFFMediaItem *)item
- (void)visualization:(ImageRecent *)item
{
    //: [self.interactor mediaShootPressed];
    [self.interactor financialCenter];
}
...
- (void)aggregation:(ImageRecent *)item
{
//    [self.interactor mediaLocationPressed];
    ...
    [self.audioContent endShow];

}

//: - (void)onTapTableView:(id)sender
- (void)viewFormat:(id)sender
{
//    PitchView.shareMenuView.praiseView.hidden = YES;
//    PitchView.shareMenuView.buttonsBgView.hidden = NO;
    //: [FFFBubbleMenuView.shareMenuView removeFromSuperview];
    [PitchView.voice removeFromSuperview];
    //: [self.sessionInputView endEditing:YES];
    [self.sessionInputView endEditing:YES];
        ...
        [coordinator animateAlongsideTransition:^(id <UIViewControllerTransitionCoordinatorContext> context)
         {
             ...
             [wself.interactor comment];
             //: [wself.sessionInputView reset];
             [wself.sessionInputView colorWith];
...
- (id<NIMConversationManager>)tillCustomSave{
...
- (void)betweenImage
{
    ...
    OpenView *titleView = (OpenView *)self.navigationItem.titleView;
    //: if (!titleView || ![titleView isKindOfClass:[FFFKitTitleView class]])
    if (!titleView || ![titleView isKindOfClass:[OpenView class]])
    {
        //: titleView = [[FFFKitTitleView alloc] initWithFrame:CGRectZero];
        titleView = [[OpenView alloc] initWithFrame:CGRectZero];
        //: self.navigationItem.titleView = titleView;
        self.navigationItem.titleView = titleView;

        //: titleView.titleLabel.text = self.sessionTitle;
        titleView.titleLabel.text = self.disable;
        //: titleView.subtitleLabel.text = self.sessionSubTitle;
        titleView.subtitleLabel.text = self.picture;
    ...
    self.subtitle.text = self.picture;
}
...
- (void)more:(NSString *)title
{
    ...
    if([title isEqualToString:@"离线".aboveMagnitude]){
        //: self.subtitle.textColor = [UIColor colorWithHexString:@"777777"];
        self.subtitle.textColor = [UIColor withMax:StringFromVertSizeData(kStr_mustDishData)];
    //: }else{
    }else{
        //: self.subtitle.textColor = [UIColor colorWithHexString:@"#00B01B"];
        self.subtitle.textColor = [UIColor withMax:StringFromVertSizeData(kStr_atValueText)];
    }
    //: [self setUpTitleView];
    [self betweenImage];
}
...
- (void)imageCompltion:(NIMMessage *)message
                         //: type:(int64_t)type
                         objectColorCompltion:(int64_t)type
                    //: compltion:(void(^)(NSMapTable *))completion
                    tingBy:(void(^)(NSMapTable *))completion
{
...
- (void)label:(NIMMessage *)message alongOf:(UIView *)view {

    //: [[FFFBubbleMenuView shareMenuView] removeFromSuperview];
    [[PitchView voice] removeFromSuperview];

    //: NSArray *btns = [self genMediaButtonsWithMessage:message];
    NSArray *btns = [self enable:message];
    ...
    if (btns.count > 0) {
        ...
        [[PitchView voice] fender:btns show:cursorStartRectToWindow red:tempRect corner:^(ImageRecent *item) {
            @
...
- (void)cuttingEdge:(NSInteger)index
{
    //: __block NIMQuickComment *newComment = [NIMCommentMaker commentWithType:index content:@"" ext:@"扩展"];
    __block NIMQuickComment *newComment = [CommentTingSailmakerMaker groundButton:index margin:@"" segment:@"扩展"];
    ...
    [self imageCompltion:self.messageForMenu objectColorCompltion:index
                      //: compltion:^(NSMapTable *result)
                      tingBy:^(NSMapTable *result)
     {
        //: NIMQuickComment *oldComment = [FFFKitQuickCommentUtil myCommentFromComments:0 keys:@[@(index)] comments:result];
        NIMQuickComment *oldComment = [ActionUtil tag:0 kit:@[@(index)] cut:result];
        //: BOOL contains = oldComment ? YES : NO;
        BOOL contains = oldComment ? YES : NO;
        //: if (!contains)
        if (!contains)
        {
            ...
            [weakSelf.interactor view:newComment bottom:self.messageForMenu icon:^(NSError *error)
            {
//                [self.view hideToasts];
                //: if (error)
                if (error)
...
- (NSArray *)enable:(NIMMessage *)message {
...
- (UIButton *)btnAudio
{
    ...
    if (!_btnAudio) {
        ...
        _btnAudio.frame = CGRectMake(12, ([[UIScreen mainScreen] bounds].size.height - (44.0f + [UIDevice clear]) - (({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom))-(({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom)-40, 40, 40);
        //: _btnAudio.backgroundColor = [UIColor colorWithHexString:@"#B391FF"];
        _btnAudio.backgroundColor = [UIColor withMax:StringFromVertSizeData(kStr_publicityText)];
        //: [_btnAudio setImage:[UIImage imageNamed:@"icon_toolview_voice_normal"] forState:UIControlStateNormal];
        [_btnAudio setImage:[UIImage imageNamed:StringFromVertSizeData(kStr_dateKeyData)] forState:UIControlStateNormal];
        ...
        [_btnAudio addTarget:self action:@selector(tempFor) forControlEvents:UIControlEventTouchUpInside];
...
- (ElectionView *)customAlbumView
{
    ...
    if(!_customAlbumView){
        ...
        _customAlbumView = [[ElectionView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
        ...
        _customAlbumView.delegate = self;
                ...
                UITapGestureRecognizer *singleTapclose = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(userCount)];
...
//        btnAlbum.backgroundColor = ThemeColor;
        ...
        [btnAlbum setImage:[UIImage imageNamed:StringFromVertSizeData(kStr_colorFlueText)] forState:UIControlStateNormal];
//        btnAlbum.layer.cornerRadius = 20;
        ...
        [btnAlbum addTarget:self action:@selector(commentGetToGrips) forControlEvents:UIControlEventTouchUpInside];
        ...
        [btnAlbum setTitle:[ItemManager sessionInformation:StringFromVertSizeData(kStr_apologyOxygenValue)] forState:UIControlStateNormal];
        //: [btnAlbum layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleTop) imageTitleSpace:10];
        [btnAlbum value:(MKButtonEdgeInsetsStyleTop) nameSelected:10];
...
//        btnShot.backgroundColor = ThemeColor;
        ...
        [btnShot setImage:[UIImage imageNamed:StringFromVertSizeData(kStr_approveContent)] forState:UIControlStateNormal];
//        btnShot.layer.cornerRadius = 20;
        ...
        [btnShot addTarget:self action:@selector(handleCell) forControlEvents:UIControlEventTouchUpInside];
        ...
        [btnShot setTitle:[ItemManager sessionInformation:StringFromVertSizeData(kStr_tingCellName)] forState:UIControlStateNormal];
        //: [btnShot layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleTop) imageTitleSpace:10];
        [btnShot value:(MKButtonEdgeInsetsStyleTop) nameSelected:10];
...
- (NumberView *)audioContent
{
    ...
    if(!_audioContent){
        ...
        _audioContent = [[NumberView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
Byte * VertSizeDataToCache(Byte *data) {
    int quantityerruptIre = data[0];
    int cellUntil = data[1];
    Byte theatreStage = data[2];
    int oftentimes = data[3];
    if (!quantityerruptIre) return data + oftentimes;
    for (int i = oftentimes; i < oftentimes + cellUntil; i++) {
        int value = data[i] - theatreStage;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[oftentimes + cellUntil] = 0;
    return data + oftentimes;
}

NSString *StringFromVertSizeData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)VertSizeDataToCache(data)];
}

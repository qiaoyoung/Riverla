...
//: reply
Byte kStr_respectBeachName[] = {94, 5, 10, 10, 151, 207, 246, 218, 221, 108, 104, 91, 102, 98, 111, 181};


//: VIDEO
Byte kStr_gnatValue[] = {90, 5, 87, 9, 252, 156, 71, 17, 47, 255, 242, 237, 238, 248, 15};


//: message_administrator_speak
Byte kStr_tablespoonData[] = {70, 27, 78, 13, 118, 229, 119, 186, 2, 11, 56, 5, 134, 31, 23, 37, 37, 19, 25, 23, 17, 19, 22, 31, 27, 32, 27, 37, 38, 36, 19, 38, 33, 36, 17, 37, 34, 23, 19, 29, 68};


//: group_info_activity_op_failed
Byte kStr_wagonContent[] = {39, 29, 36, 6, 235, 99, 67, 78, 75, 81, 76, 59, 69, 74, 66, 75, 59, 61, 63, 80, 69, 82, 69, 80, 85, 59, 75, 76, 59, 66, 61, 69, 72, 65, 64, 59};


//: #F6F7FA
Byte kStr_repeatedAvailGentlemanValue[] = {84, 7, 48, 14, 121, 75, 96, 141, 113, 101, 205, 205, 231, 175, 243, 22, 6, 22, 7, 22, 17, 66};


//: IMAGE
Byte kStr_absenceMortalText[] = {66, 5, 22, 12, 151, 159, 9, 174, 162, 36, 201, 232, 51, 55, 43, 49, 47, 53};


//: icon_toolview_voice_normal
Byte kStr_trimName[] = {27, 26, 18, 10, 123, 217, 62, 154, 97, 41, 87, 81, 93, 92, 77, 98, 93, 93, 90, 100, 87, 83, 101, 77, 100, 93, 87, 81, 83, 77, 92, 93, 96, 91, 79, 90, 158};


//: F6F7FA
Byte kStr_retailThemName[] = {30, 6, 72, 12, 245, 50, 56, 77, 81, 14, 43, 48, 254, 238, 254, 239, 254, 249, 49};


//: message_send_camera
Byte kStr_selectName[] = {15, 19, 17, 10, 75, 174, 192, 35, 10, 33, 92, 84, 98, 98, 80, 86, 84, 78, 98, 84, 93, 83, 78, 82, 80, 92, 84, 97, 80, 47};


//: back_arrow_bl
Byte kStr_cheekMouthTitle[] = {27, 13, 30, 6, 255, 147, 68, 67, 69, 77, 65, 67, 84, 84, 81, 89, 65, 68, 78, 163};


//: ic_block
Byte kStr_itemBlondValue[] = {2, 8, 81, 10, 228, 18, 131, 121, 160, 23, 24, 18, 14, 17, 27, 30, 18, 26, 188};


//: user_profile_avtivity_send
Byte kStr_crewExtremeName[] = {3, 26, 88, 10, 252, 61, 136, 2, 216, 130, 29, 27, 13, 26, 7, 24, 26, 23, 14, 17, 20, 13, 7, 9, 30, 28, 17, 30, 17, 28, 33, 7, 27, 13, 22, 12, 191};


//: temp_image_%@.jpg
Byte kStr_trimTitle[] = {38, 17, 41, 12, 103, 98, 184, 91, 102, 85, 90, 6, 75, 60, 68, 71, 54, 64, 68, 56, 62, 60, 54, 252, 23, 5, 65, 71, 62, 19};


//: #B391FF
Byte kStr_barSurroundingName[] = {44, 7, 4, 6, 111, 167, 31, 62, 47, 53, 45, 66, 66, 118};


//: type
Byte kStr_ahRecipientText[] = {29, 4, 56, 5, 226, 60, 65, 56, 45, 246};


//: icon_toolview_camera
Byte kStr_onPasseData[] = {14, 20, 55, 10, 113, 115, 102, 50, 17, 203, 50, 44, 56, 55, 40, 61, 56, 56, 53, 63, 50, 46, 64, 40, 44, 42, 54, 46, 59, 42, 211};


//: ic_block_no
Byte kStr_domesticText[] = {36, 11, 32, 14, 155, 42, 190, 242, 73, 168, 119, 55, 157, 132, 73, 67, 63, 66, 76, 79, 67, 75, 63, 78, 79, 58};


//: userName
Byte kStr_leaValue[] = {66, 8, 66, 14, 205, 46, 86, 207, 85, 55, 244, 75, 191, 205, 51, 49, 35, 48, 12, 31, 43, 35, 199};


//: 777777
Byte kStr_voterText[] = {53, 6, 26, 7, 255, 148, 180, 29, 29, 29, 29, 29, 29, 210};


//: icon_toolview_album
Byte kStr_assistantTitle[] = {76, 19, 36, 10, 138, 66, 7, 217, 44, 137, 69, 63, 75, 74, 59, 80, 75, 75, 72, 82, 69, 65, 83, 59, 61, 72, 62, 81, 73, 196};


//: TEXT
Byte kStr_launchName[] = {64, 4, 38, 10, 246, 222, 122, 44, 171, 12, 46, 31, 50, 46, 67};


//: temp_video_%@.mp4
Byte kStr_cellGratefulName[] = {60, 17, 62, 5, 70, 54, 39, 47, 50, 33, 56, 43, 38, 39, 49, 33, 231, 2, 240, 47, 50, 246, 28};


//: messageid
Byte kStr_intensityName[] = {23, 9, 17, 9, 112, 3, 80, 58, 160, 92, 84, 98, 98, 80, 86, 84, 88, 83, 55};


//: message_send_album
Byte kStr_looData[] = {22, 18, 44, 4, 65, 57, 71, 71, 53, 59, 57, 51, 71, 57, 66, 56, 51, 53, 64, 54, 73, 65, 100};


//: AUDIO
Byte kStr_tunaText[] = {4, 5, 57, 5, 82, 8, 28, 11, 16, 22, 23};


//: ic_more
Byte kStr_aimLureName[] = {72, 7, 88, 10, 139, 77, 133, 61, 173, 235, 17, 11, 7, 21, 23, 26, 13, 254};


//: #00B01B
Byte kStr_maxContent[] = {34, 7, 9, 9, 237, 205, 136, 107, 252, 26, 39, 39, 57, 39, 40, 57, 94};


//: %@在群里@了你
Byte kStr_barProgressValue[] = {47, 18, 30, 6, 21, 242, 7, 34, 199, 126, 138, 201, 160, 134, 203, 105, 110, 34, 198, 156, 104, 198, 159, 130, 218};


//: message_please_enter_content
Byte kStr_normEndlessData[] = {34, 28, 52, 13, 19, 103, 158, 193, 178, 179, 117, 40, 255, 57, 49, 63, 63, 45, 51, 49, 43, 60, 56, 49, 45, 63, 49, 43, 49, 58, 64, 49, 62, 43, 47, 59, 58, 64, 49, 58, 64, 103};


//: head_default_group
Byte kStr_perhapsValue[] = {22, 18, 89, 12, 55, 22, 92, 169, 92, 215, 4, 105, 15, 12, 8, 11, 6, 11, 12, 13, 8, 28, 19, 27, 6, 14, 25, 22, 28, 23, 34};


//: content
Byte kStr_fifteenRapData[] = {95, 7, 86, 13, 119, 85, 52, 30, 53, 82, 99, 34, 235, 13, 25, 24, 30, 15, 24, 30, 140};

// __DEBUG__
// __CLOSE_PRINT__
//
//  BarOriginViewController.m
// Notice
//
//  Created by NetEase.
...
@interface BarOriginViewController ()<NIMMediaManagerDelegate,CuttingEdgeDelegate,LengthLabel,NIMConversationManagerDelegate,CenterDelegate,UIGestureRecognizerDelegate>
...
@property (nonatomic,strong) PinConfigurator *configurator;
...
@property (nonatomic,strong) HeadView *badgeView;
...
@property (nonatomic, strong) ContainerShowView *audioContent;

//: @property (nonatomic, strong) UIView *photopicview;
@property (nonatomic, strong) UIView *photopicview;
//: @property (nonatomic, strong) PhotoContainerView *customAlbumView;
@property (nonatomic, strong) PastView *customAlbumView;
...
@implementation BarOriginViewController

//: - (instancetype)initWithSession:(NIMSession *)session{
- (instancetype)initWithScale:(NIMSession *)session{
...
{
    //: [self removeListener];
    [self launderDownWithoutAuditor];
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor isView:StringFromPhotographData(kStr_retailThemName)];
...
- (void)separate
{
    ...
    _topview = [[UIView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, (44.0f + [UIDevice table]))];
    //: _topview.backgroundColor = [UIColor colorWithHexString:@"#F6F7FA"];
    _topview.backgroundColor = [UIColor isView:StringFromPhotographData(kStr_repeatedAvailGentlemanValue)];
    ...
    [backBtn setImage:[UIImage imageNamed:StringFromPhotographData(kStr_cheekMouthTitle)] forState:UIControlStateNormal];
    ...
    self.sessionUnreadCount = [NIMSDK sharedSDK].conversationManager.allUnreadCount;
     ...
     _badgeView = [HeadView emotionRange:@""];
    ...
    _labtitle = [[UILabel alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-200)/2, [UIDevice table], 200, 40)];
...
//    }
    ...
    if (self.session.sessionType == NIMSessionTypeTeam)
    {
        ...
        [enterTeamCard addTarget:self action:@selector(bubbles:) forControlEvents:UIControlEventTouchUpInside];
        ...
        [enterTeamCard sd_setImageWithURL:[NSURL URLWithString:team.avatarUrl] forState:(UIControlState)UIControlStateNormal placeholderImage:[UIImage imageNamed:StringFromPhotographData(kStr_perhapsValue)]];
        //: enterTeamCard.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width-15, [UIDevice vg_statusBarHeight]+10, width, width);
        enterTeamCard.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width-15, [UIDevice table]+10, width, width);
    ...
    else if(self.session.sessionType == NIMSessionTypeP2P)
    {
        ...
        _btnBlock.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width*2-15*2, [UIDevice table]+10, width, width);
        //: [_btnBlock addTarget:self action:@selector(handlerBtnBlock:) forControlEvents:UIControlEventTouchUpInside];
        [_btnBlock addTarget:self action:@selector(sessions:) forControlEvents:UIControlEventTouchUpInside];
        //: [_btnBlock setImage:[UIImage imageNamed:@"ic_block"] forState:UIControlStateNormal];
        [_btnBlock setImage:[UIImage imageNamed:StringFromPhotographData(kStr_itemBlondValue)] forState:UIControlStateNormal];
        //: [_btnBlock setImage:[UIImage imageNamed:@"ic_block_no"] forState:UIControlStateSelected];
        [_btnBlock setImage:[UIImage imageNamed:StringFromPhotographData(kStr_domesticText)] forState:UIControlStateSelected];
        ...
        [infoBtn addTarget:self action:@selector(translated:) forControlEvents:UIControlEventTouchUpInside];
        //: [infoBtn setImage:[UIImage imageNamed:@"ic_more"] forState:UIControlStateNormal];
        [infoBtn setImage:[UIImage imageNamed:StringFromPhotographData(kStr_aimLureName)] forState:UIControlStateNormal];
        //: infoBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width-15, [UIDevice vg_statusBarHeight]+10, width, width);
        infoBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-width-15, [UIDevice table]+10, width, width);
...
- (void)sessions:(UIButton *)sender
{
    ...
    [[NIMSDK sharedSDK].userManager updateNotifyState:sender.selected forUser:self.session.sessionId completion:^(NSError *error) {
            ...
            if (error) {
                ...
                [wself.view makeToast:[TeamManager sizeKey:StringFromPhotographData(kStr_wagonContent)] duration:2.0f position:CSToastPositionCenter];
            }
        //: }];
        }];
}
...
- (void)bubbles:(id)sender {
    ...
    if(team.type == NIMTeamTypeAdvanced){
            ...
            vc = [[ClickTeamViewController alloc] initWithView:team
                                                                 //: session:self.session
                                                                 humanity:self.session
                                                                  //: option:option];
                                                                  quick:option];
            //: vc.delegate = self;
            vc.delegate = self;
...
- (void)to
{
    ...
    CGFloat safeAreaInsetsBottom = [UIDevice name];
    ...
    CGFloat containerSafeHeight = [UIScreen mainScreen].bounds.size.height - safeAreaInsetsBottom - (44.0f + [UIDevice table]);
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, (44.0f + [UIDevice table]), [UIScreen mainScreen].bounds.size.width, containerSafeHeight-51) style:UITableViewStylePlain];
...
//    self.tableView.backgroundColor = NEEKIT_UIColorFromRGB(0xe4e7ec);
    ...
    [self.tableViewTapGesture addTarget:self action:@selector(userContainerView:)];
...
- (void)clear
{
    ...
    if ([self value])
    {
        ...
        [self.sessionInputView setImage:self];
...
- (void)count
{
    ...
    _configurator = [[PinConfigurator alloc] init];
    //: [_configurator setup:self];
    [_configurator pastVerticalKit:self];

    //: BOOL needProximityMonitor = [self needProximityMonitor];
    BOOL needProximityMonitor = [self upLength];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //: [self addListener];
    [self addInsideEavesdropperListener];
...
//    [self changeLeftBarBadge:self.conversationManager.allUnreadCount];
    ...
    [self.interactor informationArea];
}
...
- (void)greenScroll:(UIScrollView *)scrollView {
...
- (void)ting:(NIMMessage *)message
{
    ...
    [self.interactor digitizer:message portion:nil];
...
- (void)date:(NIMMessage *)message tool:(void(^)(NSError * err))completion
{
    //: __weak typeof(self) weakSelf = self;
    __weak typeof(self) weakSelf = self;
    //: [self.interactor sendMessage:message
    [self.interactor disable:message
                        //: toMessage:nil
                        view:nil
...
- (void)placeWith
{
    ...
    [self cellName:self.name];
    //: [self refreshSessionSubTitle:self.sessionSubTitle];
    [self title:self.inputNumber];
    //: [self.tableView reloadData];
    [self.tableView reloadData];
}
...
- (NSString *)name
{
    ...
    switch (type) {
        ...
        case NIMSessionTypeP2P:{
            ...
            title = [UtilizerUtil along:self.session.sessionId toStop:self.session];
        }
            //: break;
            break;
        //: case NIMSessionTypeSuperTeam: {
...
- (NSString *)inputNumber{return @"";};

//: #pragma mark - 状态操作
#pragma mark - 状态操作
//: - (NIMKitSessionState)sessionState {
- (NIMKitSessionState)user {
    //: return [self.interactor sessionState];
    return [self.interactor visualImage];
}

//: - (void)setSessionState:(NIMKitSessionState)state {
- (void)setUser:(NIMKitSessionState)state {
    //: [self.interactor setSessionState:state];
    [self.interactor setVisualImage:state];
}
        ...
        if( message.messageType == NIMMessageTypeImage){
            ...
            if(data && urlString){
                ...
                [[SDImageCache sharedImageCache] storeImageData:data forKey:key completion:^{
                    ...
                    [weakSelf.interactor statusTip:message];
                //: }];
                }];
            }
        //: }else{
            ...
            [self.interactor statusTip:message];
//            [self.tableView reloadData];
        }
...
- (void)onRecvMessages:(NSArray *)messages
{
    ...
    if ([self disabled])
    {
        ...
        UIViewController *topvc = [self controller];
        //: if (![topvc isKindOfClass:NSClassFromString(@"NTESSessionViewController")] && ![topvc isKindOfClass:[FFFSessionViewController class]]) {
        if (![topvc isKindOfClass:NSClassFromString(@"SelectChildViewController")] && ![topvc isKindOfClass:[BarOriginViewController class]]) {
            //: return;
            return;
        }
        ...
        [self mentalRepresentation:messages];
        //: [self.interactor markRead:NO];
        [self.interactor show:NO];

        // 群禁言后输入框改变占位符文字
        //: [self setBannedSpeakingWithMessage:messages];
        [self setClearMessage:messages];
    }
}

//: - (void)setBannedSpeakingWithMessage:(NSArray <NIMMessage *>*)messages {
- (void)setClearMessage:(NSArray <NIMMessage *>*)messages {
...
- (void)setComment:(BOOL)ban {
    ...
    if (ban){
        ...
        [self.sessionInputView session:[TeamManager sizeKey:StringFromPhotographData(kStr_tablespoonData)] ting:[UIColor redColor]];
    ...
    //: } else {
        ...
        [self.sessionInputView session:[TeamManager sizeKey:StringFromPhotographData(kStr_normEndlessData)] ting:[UIColor grayColor]];
...
- (void)fetchMessageAttachment:(NIMMessage *)message didCompleteWithError:(NSError *)error
{
    ...
    if ([message.session isEqual:_session])
    {
        ...
        MaxLink *model = [self.interactor processor:message];
...
- (void)viewModel:(NIMRecentSession *)recentSession
         //: totalUnreadCount:(NSInteger)totalUnreadCount{
         title:(NSInteger)totalUnreadCount{
...
- (void)recordAudio:(NSString *)filePath didCompletedWithError:(NSError *)error {
    ...
    if(!error) {
        ...
        if ([self phaseOfTheMoon:filePath]) {
            //: [self sendMessage:[FFFMessageMaker msgWithAudio:filePath]];
            [self ting:[ElectronicImageLength withAudio:filePath]];
        //: }else{
        }else{
...
- (void)recordAudioProgress:(NSTimeInterval)currentTime {
    ...
    [_sessionInputView reloadOption:currentTime];
}
...
//    [self praiseViewdidSelectIndex:index];
    ...
    __block NIMQuickComment *newComment = [OriginVideo colorRange:index key:@"" view_strong:@"扩展"];

    //: __weak typeof(self) weakSelf = self;
    __weak typeof(self) weakSelf = self;
            //: [weakSelf.interactor addQuickComment:newComment toMessage:message completion:^(NSError *error)
            [weakSelf.interactor from:newComment content:message disable:^(NSError *error)
            {
                //: if (error)
                if (error)
                {
                    ...
                    [weakSelf.view makeToast:[TeamManager sizeKey:StringFromPhotographData(kStr_wagonContent)] duration:2 position:CSToastPositionCenter];
                }
...
- (void)visualAspect:(NSString *)text value:(NSArray *)atUsers
{
    ...
    NIMMessage *message = [ElectronicImageLength installment:text];
    //: if (atUsers.count)
    if (atUsers.count)
    {
        ...
        NSString *me = [[Notice fullKit].provider value:[NIMSDK sharedSDK].loginManager.currentAccount manager:option].showName;
        //: apnsOption.apnsContent = [NSString stringWithFormat:@"%@在群里@了你".nim_localized, me];
        apnsOption.apnsContent = [NSString stringWithFormat:StringFromPhotographData(kStr_barProgressValue).positionMenu, me];
...
- (void)manager:(NSString *)text start:(NSArray *)atUsers name:(NIMMessage *)replymessage
{
    ...
    if(replymessage.messageType == NIMMessageTypeText){
        //: type = @"TEXT";
        type = StringFromPhotographData(kStr_launchName);
        //: contents = replymessage.text;
        contents = replymessage.text;
    //: }else if (replymessage.messageType == NIMMessageTypeImage){
    }else if (replymessage.messageType == NIMMessageTypeImage){
        //: type = @"IMAGE";
        type = StringFromPhotographData(kStr_absenceMortalText);
    ...
    //: }else if (replymessage.messageType == NIMMessageTypeVideo){
        ...
        //: type = @"VIDEO";
        type = StringFromPhotographData(kStr_gnatValue);
    ...
    //: }else if (replymessage.messageType == NIMMessageTypeAudio){
        ...
        //: type = @"AUDIO";
        type = StringFromPhotographData(kStr_tunaText);
    ...
    OriginBy *info = [[Notice fullKit] value:replymessage.from manager:option];

    //: NSDictionary *dic = @{
    NSDictionary *dic = @{
            //: @"type": type,//type:TEXT、IMAGE、VIDEO
            StringFromPhotographData(kStr_ahRecipientText): type,//type:TEXT、IMAGE、VIDEO
            //: @"content": contents,//content:文本内容、图片url、视频url
            StringFromPhotographData(kStr_fifteenRapData): contents,//content:文本内容、图片url、视频url
            //: @"userName": info.showName,//消息发送者
            StringFromPhotographData(kStr_leaValue): info.showName,//消息发送者
            //: @"messageid": replymessage.messageId,//messageid：留着备用
            StringFromPhotographData(kStr_intensityName): replymessage.messageId,//messageid：留着备用
    //: };
    };

    //: message.remoteExt = @{@"reply": dic };
    message.remoteExt = @{StringFromPhotographData(kStr_respectBeachName): dic };
    ...
    [self date:message tool:^(NSError *err) {
        //: [self.tableView reloadData];
        [self.tableView reloadData];
    //: }];
    }];
...
- (void)globule:(CellEmoticon *)emoticon
{
    ...
    __block NIMQuickComment *newComment = [OriginVideo colorRange:number key:emoticon.tag view_strong:@"扩展"];

    //: __weak typeof(self) weakSelf = self;
    __weak typeof(self) weakSelf = self;
    //: [self hadCommentThisMessage:self.messageForMenu type:number
    [self text:self.messageForMenu team:number
                      //: compltion:^(NSMapTable *result)
                      searched:^(NSMapTable *result)
     {
        //: NIMQuickComment *oldComment = [FFFKitQuickCommentUtil myCommentFromComments:0 keys:@[@(number)] comments:result];
        NIMQuickComment *oldComment = [CommentIndex tableRead:0 share:@[@(number)] rangeComments:result];
        ...
        if (!contains)
        {
            ...
            [weakSelf.interactor behindFace:newComment
                                  //: completion:^(NSError *error)
                                  voicePressed:^(NSError *error)
            {
//                [self.view hideToasts];
        ...
        else
        {
            ...
            [weakSelf.interactor outLocation:oldComment
                                   //: targetMessage:weakSelf.messageForMenu
                                   color:weakSelf.messageForMenu
                                      //: completion:^(NSError *error)
                                      quick:^(NSError *error)
            {
//                [self.view hideToasts];
...
//
//    NIMMessage *message = [ElectronicImageLength msgWithImage:gif];
//    [self sendMessage:message];
//

    //: NIMMessage *message = [FFFMessageMaker msgWithImageData:imageData extension:@""];
    NIMMessage *message = [ElectronicImageLength deleteModel:imageData show:@""];
...
//    NSData *imageData = UIImagePNGRepresentation(image);
    ...
    [self.sessionInputView.toolBar setPin:[TeamManager sizeKey:StringFromPhotographData(kStr_normEndlessData)]];
...
//    [_sessionInputView endEditing:YES];
    ...
    NIMAudioType type = [self sendView];
    //: NSTimeInterval duration = [MyUserKit sharedKit].config.recordMaxDuration;
    NSTimeInterval duration = [Notice fullKit].config.recordMaxDuration;
...
- (void)onRecvQuickComment:(NIMQuickComment *)comment
{
    ...
    [self.interactor statusTip:comment.message];
}
...
- (void)onNotifyRemoveMessagePin:(NIMMessagePinItem *)item
{
    ...
    [self subordinate:message];
}

//: #pragma mark - FFFMessageCellDelegate
#pragma mark - RubricTing
...
- (BOOL)anyView:(IndexBar *)event{
    ...
    if ([eventName isEqualToString:let_managerTitle])
    {
        //: [self.interactor mediaAudioPressed:event.messageModel];
        [self.interactor bar:event.messageModel];
        //: handle = YES;
        handle = YES;
    }
    //: return handle;
                 ...
                 language:(UIView *)view
{
    ...
    if ([self arrayProviderMessage:message])
    {
        //: [FFFBubbleMenuView.shareMenuView removeFromSuperview];
        [StylePrixFixeView.can removeFromSuperview];
        //: [self showMenuWithMessage:message withView:view];
        [self streetSmart:message device:view];
    }
    //: handle = YES;
    handle = YES;
    //: return handle;
               ...
               text:(BOOL)isSelected
{
    ...
    if (isSelected)
    {
        ...
        [self.interactor outLocation:comment
...
- (void)window:(id)sender
{
    ...
    if (message.Blueish.length) {
        //: UIPasteboard *pasteboard = [UIPasteboard generalPasteboard];
        UIPasteboard *pasteboard = [UIPasteboard generalPasteboard];
        //: [pasteboard setString:message.tyl_internalIdentifier];
        [pasteboard setString:message.Blueish];
    }
...
- (void)key:(id)sender
{
    ...
    [self.cell deleteMessage:message];
}
...
- (void)atMessages:(NSArray *)messages
{
    //: [self.interactor addMessages:messages];
    [self.interactor state:messages];
}

//: - (void)uiInsertMessages:(NSArray *)messages
- (void)mentalRepresentation:(NSArray *)messages
{
    //: [self.interactor insertMessages:messages];
    [self.interactor shouldMessages:messages];
}

//: - (FFFMessageModel *)uiDeleteMessage:(NIMMessage *)message{
- (MaxLink *)sendOut:(NIMMessage *)message{
    //: FFFMessageModel *model = [self.interactor deleteMessage:message];
    MaxLink *model = [self.interactor message:message];
...
//    [self.interactor mediaShootPressed];
    ...
    [self.customAlbumView.confirmButton setTitle:[TeamManager sizeKey:StringFromPhotographData(kStr_crewExtremeName)] forState:UIControlStateNormal];
    //: [self.customAlbumView animationShow];
    [self.customAlbumView text];
...
- (void)lightCamera
{
    ...
    [self.customAlbumView randomShow];
    //: [self.interactor mediaShootPressed];
    [self.interactor underReply];
}
...
- (void)proposeView:(NSArray<PHAsset *> *)assets
{
    ...
    for (PHAsset *asset in assets) {
        ...
        if (asset.mediaType == PHAssetMediaTypeVideo) {
            ...
            [self transformCompletion:asset recordWarpath:^(NSString *path) {
                //: if (path) {
                if (path) {
                    //: NSLog(@"视频路径: %@", path);
                    // 使用路径...
        ...
        //: }else{
            ...
            [self original:asset tag:^(UIImage *image) {
                //: if (image) {
                if (image) {
...
//                    NSLog(@"图片路径: %@", path);
//                    // 使用路径...
//                    NIMMessage *message = [ElectronicImageLength msgWithImagePath:path];
//                    [self sendMessage:message];
//                } else {
//                    NSLog(@"获取图片路径失败");
//                }
...
- (void)original:(PHAsset *)asset tag:(void (^)(UIImage *image))completion {
...
- (void)getAllFace:(PHAsset *)asset aggregation:(void (^)(NSString *path))completion {
    ...
    [[PHImageManager defaultManager] requestImageDataForAsset:asset options:options resultHandler:^(NSData * _Nullable imageData, NSString * _Nullable dataUTI, UIImageOrientation orientation, NSDictionary * _Nullable info) {
        ...
        if (imageData) {
            ...
            NSString *filePath = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:StringFromPhotographData(kStr_trimTitle), [NSUUID UUID].UUIDString]];
...
- (void)transformCompletion:(PHAsset *)asset recordWarpath:(void (^)(NSString *path))completion {
    //: if (asset.mediaType != PHAssetMediaTypeVideo) {
    if (asset.mediaType != PHAssetMediaTypeVideo) {
        //: if (completion) completion(nil);
        if (completion) completion(nil);
    ...
    [[PHImageManager defaultManager] requestAVAssetForVideo:asset options:options resultHandler:^(AVAsset * _Nullable avAsset, AVAudioMix * _Nullable audioMix, NSDictionary * _Nullable info) {
        ...
        //: } else {
            ...
            [self towardLanguage:avAsset forefront:completion];
        }
    //: }];
    }];
}
...
- (void)towardLanguage:(AVAsset *)avAsset forefront:(void (^)(NSString *path))completion {
    ...
    if ([presets containsObject:AVAssetExportPresetHighestQuality]) {
        ...
        NSString *outputPath = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:StringFromPhotographData(kStr_cellGratefulName), [NSUUID UUID].UUIDString]];
...
- (void)enablePlaceSemblanceTapVehicle:(ChangeMax *)item
{
    //: [self.interactor mediaPicturePressed];
...
//    [self.interactor mediaLocationPressed];
    ...
    [self.audioContent path];

}

//: - (void)onTapTableView:(id)sender
- (void)userContainerView:(id)sender
{
//    StylePrixFixeView.shareMenuView.praiseView.hidden = YES;
//    StylePrixFixeView.shareMenuView.buttonsBgView.hidden = NO;
    //: [FFFBubbleMenuView.shareMenuView removeFromSuperview];
    [StylePrixFixeView.can removeFromSuperview];
    //: [self.sessionInputView endEditing:YES];
    [self.sessionInputView endEditing:YES];
        ...
        [coordinator animateAlongsideTransition:^(id <UIViewControllerTransitionCoordinatorContext> context)
         {
             ...
             [wself.interactor image];
             //: [wself.sessionInputView reset];
             [wself.sessionInputView tab];
...
//: - (void)addListener
- (void)addInsideEavesdropperListener
{
...
//: - (void)removeListener
- (void)launderDownWithoutAuditor
{
...
- (id<NIMConversationManager>)cell{
...
- (void)isMemberColor
{
    ...
    LayerView *titleView = (LayerView *)self.navigationItem.titleView;
    //: if (!titleView || ![titleView isKindOfClass:[FFFKitTitleView class]])
    if (!titleView || ![titleView isKindOfClass:[LayerView class]])
    {
        //: titleView = [[FFFKitTitleView alloc] initWithFrame:CGRectZero];
        titleView = [[LayerView alloc] initWithFrame:CGRectZero];
        ...
        titleView.subtitleLabel.text = self.inputNumber;
    ...
    self.subtitle.text = self.inputNumber;
}

//: - (void)refreshSessionTitle:(NSString *)title
- (void)cellName:(NSString *)title
{
...
- (void)title:(NSString *)title
{
    ...
    if([title isEqualToString:@"离线".titleLocalized]){
        //: self.subtitle.textColor = [UIColor colorWithHexString:@"777777"];
        self.subtitle.textColor = [UIColor isView:StringFromPhotographData(kStr_voterText)];
    //: }else{
    }else{
        //: self.subtitle.textColor = [UIColor colorWithHexString:@"#00B01B"];
        self.subtitle.textColor = [UIColor isView:StringFromPhotographData(kStr_maxContent)];
    }
    //: [self setUpTitleView];
    [self isMemberColor];
}
...
- (void)performanceWithInscription:(NIMMessage *)message
{
...
- (void)text:(NIMMessage *)message
                    ...
                    searched:(void(^)(NSMapTable *))completion
{
...
- (void)streetSmart:(NIMMessage *)message device:(UIView *)view {

    //: [[FFFBubbleMenuView shareMenuView] removeFromSuperview];
    [[StylePrixFixeView can] removeFromSuperview];

    //: NSArray *btns = [self genMediaButtonsWithMessage:message];
    NSArray *btns = [self date:message];
    ...
    if (btns.count > 0) {
        ...
        [[StylePrixFixeView can] message:btns item:cursorStartRectToWindow show:tempRect dittyBag:^(ChangeMax *item) {
            @
...
- (void)pillaged:(NSInteger)index
{
    ...
    [self text:self.messageForMenu team:index
                      //: compltion:^(NSMapTable *result)
                      searched:^(NSMapTable *result)
     {
        //: NIMQuickComment *oldComment = [FFFKitQuickCommentUtil myCommentFromComments:0 keys:@[@(index)] comments:result];
        NIMQuickComment *oldComment = [CommentIndex tableRead:0 share:@[@(index)] rangeComments:result];
        //: BOOL contains = oldComment ? YES : NO;
        BOOL contains = oldComment ? YES : NO;
        //: if (!contains)
        if (!contains)
        {
            ...
            [weakSelf.interactor from:newComment content:self.messageForMenu disable:^(NSError *error)
            {
//                [self.view hideToasts];
                //: if (error)
                if (error)
...
- (NSArray *)date:(NIMMessage *)message {
...
- (UIButton *)btnAudio
{
    ...
    if (!_btnAudio) {
        ...
        _btnAudio.frame = CGRectMake(12, ([[UIScreen mainScreen] bounds].size.height - (44.0f + [UIDevice table]) - (({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom))-(({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom)-40, 40, 40);
        //: _btnAudio.backgroundColor = [UIColor colorWithHexString:@"#B391FF"];
        _btnAudio.backgroundColor = [UIColor isView:StringFromPhotographData(kStr_barSurroundingName)];
        //: [_btnAudio setImage:[UIImage imageNamed:@"icon_toolview_voice_normal"] forState:UIControlStateNormal];
        [_btnAudio setImage:[UIImage imageNamed:StringFromPhotographData(kStr_trimName)] forState:UIControlStateNormal];
        ...
        [_btnAudio addTarget:self action:@selector(keyStart) forControlEvents:UIControlEventTouchUpInside];
...
- (PastView *)customAlbumView
{
    ...
    if(!_customAlbumView){
        ...
        _customAlbumView = [[PastView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
        ...
        _customAlbumView.delegate = self;
                ...
                UITapGestureRecognizer *singleTapclose = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(blockAt)];
...
//        btnAlbum.backgroundColor = ThemeColor;
        ...
        [btnAlbum setImage:[UIImage imageNamed:StringFromPhotographData(kStr_assistantTitle)] forState:UIControlStateNormal];
//        btnAlbum.layer.cornerRadius = 20;
        ...
        [btnAlbum addTarget:self action:@selector(addEnd) forControlEvents:UIControlEventTouchUpInside];
        ...
        [btnAlbum setTitle:[TeamManager sizeKey:StringFromPhotographData(kStr_looData)] forState:UIControlStateNormal];
        //: [btnAlbum layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleTop) imageTitleSpace:10];
        [btnAlbum barBackground:(MKButtonEdgeInsetsStyleTop) by:10];
...
//        btnShot.backgroundColor = ThemeColor;
        ...
        [btnShot setImage:[UIImage imageNamed:StringFromPhotographData(kStr_onPasseData)] forState:UIControlStateNormal];
//        btnShot.layer.cornerRadius = 20;
        ...
        [btnShot addTarget:self action:@selector(progressText) forControlEvents:UIControlEventTouchUpInside];
        ...
        [btnShot setTitle:[TeamManager sizeKey:StringFromPhotographData(kStr_selectName)] forState:UIControlStateNormal];
        //: [btnShot layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleTop) imageTitleSpace:10];
        [btnShot barBackground:(MKButtonEdgeInsetsStyleTop) by:10];
...
- (ContainerShowView *)audioContent
{
    //: if(!_audioContent){
    if(!_audioContent){
        ...
        _audioContent = [[ContainerShowView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
Byte * PhotographDataToCache(Byte *data) {
    int extremeDeny = data[0];
    int magnitudeegrated = data[1];
    Byte spireGray = data[2];
    int production = data[3];
    if (!extremeDeny) return data + production;
    for (int i = production; i < production + magnitudeegrated; i++) {
        int value = data[i] + spireGray;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[production + magnitudeegrated] = 0;
    return data + production;
}

NSString *StringFromPhotographData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)PhotographDataToCache(data)];
}

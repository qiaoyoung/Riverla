...
@interface TransformViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,NIMLoginManagerDelegate,NIMConversationManagerDelegate>
/**
 *  会话列表tableView
 */
...
- (void)message:(NIMRecentSession *)recent
             //: atIndexPath:(NSIndexPath *)indexPath;

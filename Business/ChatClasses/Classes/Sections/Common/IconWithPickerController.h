...
#import "LanguageMDelegate.h"

//: NS_ASSUME_NONNULL_BEGIN
NS_ASSUME_NONNULL_BEGIN

//: @interface FFFKitMediaPickerController : TZImagePickerController
@interface IconWithPickerController : TZImagePickerController
...
@property (nonatomic, weak) id<LanguageMDelegate> nim_delegate;

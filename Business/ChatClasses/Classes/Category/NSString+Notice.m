...
@implementation NSString (Notice)

//: - (CGSize)nim_stringSizeWithFont:(UIFont *)font{
- (CGSize)title:(UIFont *)font{
    //: return [self sizeWithAttributes:@{NSFontAttributeName:font}];
    return [self sizeWithAttributes:@{NSFontAttributeName:font}];
}

//: - (NSString *)nim_MD5String {
- (NSString *)addDisappear {

...
// __CLOSE_PRINT__
//
//  YYAnimatedImageView+CompartmentOn.m
// Notice
//
...
#import "YYAnimatedImageView+CompartmentOn.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (CompartmentOn)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(statusPressed:));
...
- (void)statusPressed:(CALayer *)layer {

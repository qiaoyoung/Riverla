...
+ (instancetype)with:(NSString *)badgeValue{
    ...
    ToView *instance = [[ToView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance smart:badgeValue];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self withContextCollectionDraw:rect tip:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self searched:rect level:context];
    }
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self smart:badgeValue];
...
- (CGSize)marginAcrossContainer:(NSString *)badgeValue{
...
- (CGRect)smart:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self marginAcrossContainer:badgeValue];
...
- (void)withContextCollectionDraw:(CGRect)rect tip:(CGContextRef)context{
...
- (void)searched:(CGRect)rect level:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;

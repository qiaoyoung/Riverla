...
@implementation NSDictionary (Afterwards)

//: - (NSString *)nimkit_jsonString: (NSString *)key
- (NSString *)my: (NSString *)key
{
...
- (NSDictionary *)numberIn: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSArray *)necessity: (NSString *)key
{
...
- (unsigned long long)backgroundLong:(NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||

...
- (void)updateConstraints{
    ...
    [self.contentView addConstraints:@[
        ...
        [NSLayoutConstraint constraintWithItem:self.button attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeWidth multiplier:1 constant:DialogRealW(24)],
        [NSLayoutConstraint constraintWithItem:self.button attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1 constant:DialogRealW(24)]
    ]];
    ...
    if([self.reuseIdentifier isEqualToString:DialogCellTextReuseIdentifier]){
        ...
        if(!self.params.wSelectShowChecked){
            ...
            [self.contentView addConstraints:@[
                [NSLayoutConstraint constraintWithItem:self.textLa attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual  toItem:self.contentView attribute:NSLayoutAttributeRight multiplier:1 constant:- DialogRealW(20) - 3],
                [NSLayoutConstraint constraintWithItem:self.textLa attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual  toItem:self.contentView attribute:NSLayoutAttributeLeft multiplier:1 constant: DialogRealW(20) + 3],
            ]];
        }
        ...
        if(!self.iconImage.isHidden){
            [self.bgView addConstraints:@[
                ...
                [NSLayoutConstraint constraintWithItem:self.iconImage attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeWidth multiplier:1 constant:20],
                [NSLayoutConstraint constraintWithItem:self.iconImage attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1 constant:20],
            ]];
        }

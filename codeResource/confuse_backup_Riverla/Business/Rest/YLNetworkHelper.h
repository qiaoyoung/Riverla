 ...
 *
 * 如果您在使用 YLNetworkHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
#ifndef kIsNetwork
#define kIsNetwork     [YLNetworkHelper isNetwork]  // 一次性判断是否有网的宏
#endif

#ifndef kIsWWANNetwork
#define kIsWWANNetwork [YLNetworkHelper isWWANNetwork]  // 一次性判断是否为手机网络的宏
#endif

#ifndef kIsWiFiNetwork
#define kIsWiFiNetwork [YLNetworkHelper isWiFiNetwork]  // 一次性判断是否为WiFi网络的宏
#endif

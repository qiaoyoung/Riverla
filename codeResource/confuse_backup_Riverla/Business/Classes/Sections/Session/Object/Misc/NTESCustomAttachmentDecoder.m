        ...
        if ([dict isKindOfClass:[NSDictionary class]])
        {
            ...
            switch (type) {
                ...
                case CustomMessageTypeRedPacket:
                {
                    ...
                    ((NTESRedPacketAttachment *)attachment).sendID = [data jsonString:CMRedPacketSendID];
                ...
                case CustomMessageTypeCard:
                {
                    ...
                    ((NTESShareCardAttachment *)attachment).title = [data jsonString:CMRedPacketTitle];
                    ((NTESShareCardAttachment *)attachment).type = [data jsonString:CMPersonCardtype];
                    ((NTESShareCardAttachment *)attachment).content = [data jsonString:CMRedPacketContent];
                    ((NTESShareCardAttachment *)attachment).personCardId = [data jsonString:CMPersonCardId];
                }
                    break;
                default:
                    break;
